...
import com.konfigthis.client.model.ActionsListResponse;
...
public class ActionsApiGenerated {
    ...
    private okhttp3.Call getCall(Integer actionId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/actions/{action_id}"
    ...
    private okhttp3.Call getValidateBeforeCall(Integer actionId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'actionId' is set
        if (actionId == null) {
            throw new ApiException("Missing the required parameter 'actionId' when calling get(Async)");
        }

        return getCall(actionId, _callback);

    }


    private ApiResponse<Object> getWithHttpInfo(Integer actionId) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(actionId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(Integer actionId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(actionId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
    ...
    public class GetRequestBuilder {
        ...
        private GetRequestBuilder(Integer actionId) {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> The result will be a JSON object with an action key.  This will be set to an action object containing the standard action attributes. </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
        ...
        public Object execute() throws ApiException {
            ApiResponse<Object> localVarResp = getWithHttpInfo(actionId);
        ...
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            return getWithHttpInfo(actionId);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            return getAsync(actionId, _callback);
        }
    }
     ...
     */
    public GetRequestBuilder get(Integer actionId) throws IllegalArgumentException {
        if (actionId == null) throw new IllegalArgumentException("\"actionId\" is required but got null");
        return new GetRequestBuilder(actionId);
    }
    ...
    private ApiResponse<ActionsListResponse> listWithHttpInfo(Integer perPage, Integer page) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(perPage, page, null);
        Type localVarReturnType = new TypeToken<ActionsListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer perPage, Integer page, final ApiCallback<ActionsListResponse> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         */
        public ActionsListResponse execute() throws ApiException {
            ApiResponse<ActionsListResponse> localVarResp = listWithHttpInfo(perPage, page);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;ActionsListResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<ActionsListResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ActionsListResponse> _callback) throws ApiException {
