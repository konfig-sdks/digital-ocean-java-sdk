...
import com.konfigthis.client.model.RegionsListResponse;
...
public class RegionsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RegionsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RegionsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<RegionsListResponse> listWithHttpInfo(Integer perPage, Integer page) throws ApiException {
    ...
    private okhttp3.Call listAsync(Integer perPage, Integer page, final ApiCallback<RegionsListResponse> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> A JSON object with a key set to &#x60;regions&#x60;. The value is an array of &#x60;region&#x60; objects, each of which contain the standard &#x60;region&#x60; attributes. </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
         ...
         */
        public RegionsListResponse execute() throws ApiException {
            ApiResponse<RegionsListResponse> localVarResp = listWithHttpInfo(perPage, page);
         ...
         */
        public ApiResponse<RegionsListResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RegionsListResponse> _callback) throws ApiException {
