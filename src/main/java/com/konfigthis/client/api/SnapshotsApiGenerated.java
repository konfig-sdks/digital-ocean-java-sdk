...
import com.konfigthis.client.model.SnapshotsListResponse;
...
public class SnapshotsApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SnapshotsApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public SnapshotsApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call deleteCall(Object snapshotId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/v2/snapshots/{snapshot_id}"
    ...
    private okhttp3.Call deleteValidateBeforeCall(Object snapshotId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'snapshotId' is set
        if (snapshotId == null) {
            throw new ApiException("Missing the required parameter 'snapshotId' when calling delete(Async)");
        }

        return deleteCall(snapshotId, _callback);

    }


    private ApiResponse<Void> deleteWithHttpInfo(Object snapshotId) throws ApiException {
        okhttp3.Call localVarCall = deleteValidateBeforeCall(snapshotId, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call deleteAsync(Object snapshotId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteValidateBeforeCall(snapshotId, _callback);
    ...
    public class DeleteRequestBuilder {
        ...
        private DeleteRequestBuilder(Object snapshotId) {
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return deleteWithHttpInfo(snapshotId);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return deleteAsync(snapshotId, _callback);
        }
    }
     ...
     */
    public DeleteRequestBuilder delete(Object snapshotId) throws IllegalArgumentException {
        if (snapshotId == null) throw new IllegalArgumentException("\"snapshotId\" is required but got null");
        return new DeleteRequestBuilder(snapshotId);
    }
    private okhttp3.Call getCall(Object snapshotId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getValidateBeforeCall(Object snapshotId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'snapshotId' is set
        if (snapshotId == null) {
            throw new ApiException("Missing the required parameter 'snapshotId' when calling get(Async)");
        }

        return getCall(snapshotId, _callback);

    }


    private ApiResponse<Object> getWithHttpInfo(Object snapshotId) throws ApiException {
        okhttp3.Call localVarCall = getValidateBeforeCall(snapshotId, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAsync(Object snapshotId, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = getValidateBeforeCall(snapshotId, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
    ...
    public class GetRequestBuilder {
        ...
        private GetRequestBuilder(Object snapshotId) {
            this.snapshotId = snapshotId;
        }
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> A JSON object with a key called &#x60;snapshot&#x60;.  </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
            <tr><td> 0 </td><td> Unexpected error </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
        ...
        public Object execute() throws ApiException {
            ApiResponse<Object> localVarResp = getWithHttpInfo(snapshotId);
        ...
        public ApiResponse<Object> executeWithHttpInfo() throws ApiException {
            return getWithHttpInfo(snapshotId);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Object> _callback) throws ApiException {
            return getAsync(snapshotId, _callback);
        }
    }
     ...
     */
    public GetRequestBuilder get(Object snapshotId) throws IllegalArgumentException {
        if (snapshotId == null) throw new IllegalArgumentException("\"snapshotId\" is required but got null");
        return new GetRequestBuilder(snapshotId);
    }
    private okhttp3.Call listCall(Integer perPage, Integer page, String resourceType, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listValidateBeforeCall(Integer perPage, Integer page, String resourceType, final ApiCallback _callback) throws ApiException {
        return listCall(perPage, page, resourceType, _callback);

    }


    private ApiResponse<SnapshotsListResponse> listWithHttpInfo(Integer perPage, Integer page, String resourceType) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(perPage, page, resourceType, null);
        Type localVarReturnType = new TypeToken<SnapshotsListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(Integer perPage, Integer page, String resourceType, final ApiCallback<SnapshotsListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(perPage, page, resourceType, _callback);
        Type localVarReturnType = new TypeToken<SnapshotsListResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class ListRequestBuilder {
         ...
         * @return ListRequestBuilder
         */
        public ListRequestBuilder resourceType(String resourceType) {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
            <tr><td> 200 </td><td> A JSON object with a key of &#x60;snapshots&#x60;. </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
            <tr><td> 0 </td><td> Unexpected error </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
         </table>
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
         ...
         */
        public SnapshotsListResponse execute() throws ApiException {
            ApiResponse<SnapshotsListResponse> localVarResp = listWithHttpInfo(perPage, page, resourceType);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute list request with HTTP info returned
         * @return ApiResponse&lt;SnapshotsListResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<SnapshotsListResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(perPage, page, resourceType);
        }
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SnapshotsListResponse> _callback) throws ApiException {
            return listAsync(perPage, page, resourceType, _callback);
        }
    }
