...
import com.konfigthis.client.model.SizesListResponse;
...
public class SizesApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public SizesApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public SizesApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<SizesListResponse> listWithHttpInfo(Integer perPage, Integer page) throws ApiException {
    ...
    private okhttp3.Call listAsync(Integer perPage, Integer page, final ApiCallback<SizesListResponse> _callback) throws ApiException {
    ...
    public class ListRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 200 </td><td> A JSON object with a key called &#x60;sizes&#x60;. The value of this will be an array of &#x60;size&#x60; objects each of which contain the standard size attributes. </td><td>  * ratelimit-limit -  <br>  * ratelimit-remaining -  <br>  * ratelimit-reset -  <br>  </td></tr>
         ...
         */
        public SizesListResponse execute() throws ApiException {
            ApiResponse<SizesListResponse> localVarResp = listWithHttpInfo(perPage, page);
         ...
         */
        public ApiResponse<SizesListResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SizesListResponse> _callback) throws ApiException {
