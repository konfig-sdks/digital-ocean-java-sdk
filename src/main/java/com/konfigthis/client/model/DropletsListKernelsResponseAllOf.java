...
public class DropletsListKernelsResponseAllOf {
  ...
  public DropletsListKernelsResponseAllOf() {
  }

  public DropletsListKernelsResponseAllOf kernels(List<Kernel> kernels) {
  ...
  public DropletsListKernelsResponseAllOf addKernelsItem(Kernel kernelsItem) {
  ...
  **/
   ...
   * @return the DropletsListKernelsResponseAllOf instance itself
   */
  public DropletsListKernelsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DropletsListKernelsResponseAllOf dropletsListKernelsResponseAllOf = (DropletsListKernelsResponseAllOf) o;
    return Objects.equals(this.kernels, dropletsListKernelsResponseAllOf.kernels)&&
        Objects.equals(this.additionalProperties, dropletsListKernelsResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kernels, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DropletsListKernelsResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletsListKernelsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletsListKernelsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletsListKernelsResponseAllOf is not found in the empty JSON string", DropletsListKernelsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletsListKernelsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletsListKernelsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletsListKernelsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletsListKernelsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletsListKernelsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DropletsListKernelsResponseAllOf value) throws IOException {
           ...
           @Override
           public DropletsListKernelsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletsListKernelsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletsListKernelsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletsListKernelsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletsListKernelsResponseAllOf
  */
  public static DropletsListKernelsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletsListKernelsResponseAllOf.class);
  }

 /**
  * Convert an instance of DropletsListKernelsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
