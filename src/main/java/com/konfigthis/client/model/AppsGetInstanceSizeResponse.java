...
public class AppsGetInstanceSizeResponse {
  ...
  **/
   ...
   * @return the AppsGetInstanceSizeResponse instance itself
   */
  public AppsGetInstanceSizeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instanceSize, appsGetInstanceSizeResponse.instanceSize)&&
        Objects.equals(this.additionalProperties, appsGetInstanceSizeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instanceSize, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("instance_size");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsGetInstanceSizeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsGetInstanceSizeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsGetInstanceSizeResponse is not found in the empty JSON string", AppsGetInstanceSizeResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `instance_size`
      if (jsonObj.get("instance_size") != null && !jsonObj.get("instance_size").isJsonNull()) {
        AppsInstanceSize.validateJsonObject(jsonObj.getAsJsonObject("instance_size"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsGetInstanceSizeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsGetInstanceSizeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsGetInstanceSizeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsGetInstanceSizeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsGetInstanceSizeResponse>() {
           @Override
           public void write(JsonWriter out, AppsGetInstanceSizeResponse value) throws IOException {
           ...
           @Override
           public AppsGetInstanceSizeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsGetInstanceSizeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsGetInstanceSizeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsGetInstanceSizeResponse
  * @throws IOException if the JSON string is invalid with respect to AppsGetInstanceSizeResponse
  */
  public static AppsGetInstanceSizeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsGetInstanceSizeResponse.class);
  }

 /**
  * Convert an instance of AppsGetInstanceSizeResponse to an JSON string
  *
  * @return JSON string
  */
