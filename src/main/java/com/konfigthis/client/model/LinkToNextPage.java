...
public class LinkToNextPage {
  ...
  **/
   ...
   * @return the LinkToNextPage instance itself
   */
  public LinkToNextPage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.next, linkToNextPage.next)&&
        Objects.equals(this.additionalProperties, linkToNextPage.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkToNextPage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkToNextPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkToNextPage is not found in the empty JSON string", LinkToNextPage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkToNextPage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkToNextPage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkToNextPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkToNextPage.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkToNextPage>() {
           @Override
           public void write(JsonWriter out, LinkToNextPage value) throws IOException {
           ...
           @Override
           public LinkToNextPage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LinkToNextPage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LinkToNextPage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkToNextPage
  * @throws IOException if the JSON string is invalid with respect to LinkToNextPage
  */
  public static LinkToNextPage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkToNextPage.class);
  }

 /**
  * Convert an instance of LinkToNextPage to an JSON string
  *
  * @return JSON string
  */
