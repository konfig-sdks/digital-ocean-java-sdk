...
public class DatabaseBackup {
  ...
  public static final String SERIALIZED_NAME_BACKUP_CREATED_AT = "backup_created_at";
  ...
  **/
   ...
   * @return the DatabaseBackup instance itself
   */
  public DatabaseBackup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.databaseName, databaseBackup.databaseName) &&
        ...
        Objects.equals(this.additionalProperties, databaseBackup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(databaseName, backupCreatedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("backup_created_at");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseBackup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseBackup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : DatabaseBackup.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DatabaseBackup>() {
           ...
           public DatabaseBackup read(JsonReader in) throws IOException {
             ...
             DatabaseBackup instance = thisAdapter.fromJsonTree(jsonObj);
