...
public class ListAlertPolicy {
  ...
  **/
   ...
   * @return the ListAlertPolicy instance itself
   */
  public ListAlertPolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.policies, listAlertPolicy.policies)&&
        Objects.equals(this.additionalProperties, listAlertPolicy.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListAlertPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListAlertPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListAlertPolicy is not found in the empty JSON string", ListAlertPolicy.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListAlertPolicy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListAlertPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListAlertPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListAlertPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListAlertPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<ListAlertPolicy>() {
           @Override
           public void write(JsonWriter out, ListAlertPolicy value) throws IOException {
           ...
           @Override
           public ListAlertPolicy read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListAlertPolicy instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListAlertPolicy given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListAlertPolicy
  * @throws IOException if the JSON string is invalid with respect to ListAlertPolicy
  */
  public static ListAlertPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListAlertPolicy.class);
  }

 /**
  * Convert an instance of ListAlertPolicy to an JSON string
  *
  * @return JSON string
  */
