...
public class TagsCreateResponse {
  ...
  public TagsCreateResponse tag(Tags tag) {
  ...
  **/
   ...
   * @return the TagsCreateResponse instance itself
   */
  public TagsCreateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TagsCreateResponse tagsCreateResponse = (TagsCreateResponse) o;
    return Objects.equals(this.tag, tagsCreateResponse.tag)&&
        Objects.equals(this.additionalProperties, tagsCreateResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TagsCreateResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagsCreateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagsCreateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagsCreateResponse is not found in the empty JSON string", TagsCreateResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `tag`
      if (jsonObj.get("tag") != null && !jsonObj.get("tag").isJsonNull()) {
        Tags.validateJsonObject(jsonObj.getAsJsonObject("tag"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagsCreateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagsCreateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagsCreateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagsCreateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TagsCreateResponse>() {
           @Override
           public void write(JsonWriter out, TagsCreateResponse value) throws IOException {
           ...
           @Override
           public TagsCreateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TagsCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TagsCreateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TagsCreateResponse
  * @throws IOException if the JSON string is invalid with respect to TagsCreateResponse
  */
  public static TagsCreateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagsCreateResponse.class);
  }

 /**
  * Convert an instance of TagsCreateResponse to an JSON string
  *
  * @return JSON string
  */
