...
import com.konfigthis.client.model.UserSettingsAclInner;
...
public class UserSettings {
  public static final String SERIALIZED_NAME_PG_ALLOW_REPLICATION = "pg_allow_replication";
  @SerializedName(SERIALIZED_NAME_PG_ALLOW_REPLICATION)
  private Boolean pgAllowReplication;

  public static final String SERIALIZED_NAME_ACL = "acl";
  @SerializedName(SERIALIZED_NAME_ACL)
  private List<UserSettingsAclInner> acl = null;

  public UserSettings() {
  }

  public UserSettings pgAllowReplication(Boolean pgAllowReplication) {
   ...
   * @return pgAllowReplication
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "true", value = "For Postgres clusters, set to `true` for a user with replication rights. This option is not currently supported for other database engines. ")
  ...
  public void setPgAllowReplication(Boolean pgAllowReplication) {
  ...
  public UserSettings acl(List<UserSettingsAclInner> acl) {
  ...
  public UserSettings addAclItem(UserSettingsAclInner aclItem) {
    if (this.acl == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ACLs (Access Control Lists) specifying permissions on topics within a Kafka cluster.")

  public List<UserSettingsAclInner> getAcl() {
    return acl;
  }


  public void setAcl(List<UserSettingsAclInner> acl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pgAllowReplication, userSettings.pgAllowReplication) &&
        Objects.equals(this.acl, userSettings.acl)&&
        Objects.equals(this.additionalProperties, userSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pgAllowReplication, acl, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    pgAllowReplication: ").append(toIndentedString(pgAllowReplication)).append("\n");
  ...
  static {
    ...
    openapiFields.add("pg_allow_replication");
      ...
      if (jsonObj.get("acl") != null && !jsonObj.get("acl").isJsonNull()) {
        ...
        if (jsonArrayacl != null) {
          ...
          for (int i = 0; i < jsonArrayacl.size(); i++) {
            UserSettingsAclInner.validateJsonObject(jsonArrayacl.get(i).getAsJsonObject());
          };
        }
      }
  }
