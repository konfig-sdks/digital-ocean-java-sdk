...
public class DropletSingleCreate {
  ...
  **/
  ...
  public DropletSingleCreate image(Object image) {
  ...
  **/
  ...
  public DropletSingleCreate sshKeys(List<Object> sshKeys) {
  ...
  public DropletSingleCreate addSshKeysItem(Object sshKeysItem) {
  ...
  **/
  ...
  public DropletSingleCreate volumes(List<String> volumes) {
  ...
  public DropletSingleCreate addVolumesItem(String volumesItem) {
  ...
  **/
   ...
   * @return the DropletSingleCreate instance itself
   */
  public DropletSingleCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dropletSingleCreate.name) &&
        ...
        Objects.equals(this.volumes, dropletSingleCreate.volumes) &&
        ...
        Objects.equals(this.additionalProperties, dropletSingleCreate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, tags, region, size, image, sshKeys, backups, ipv6, monitoring, userData, privateNetworking, volumes, vpcUuid, withDropletAgent, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletSingleCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletSingleCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletSingleCreate is not found in the empty JSON string", DropletSingleCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletSingleCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletSingleCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletSingleCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletSingleCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletSingleCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletSingleCreate>() {
           @Override
           public void write(JsonWriter out, DropletSingleCreate value) throws IOException {
           ...
           @Override
           public DropletSingleCreate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletSingleCreate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletSingleCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletSingleCreate
  * @throws IOException if the JSON string is invalid with respect to DropletSingleCreate
  */
  public static DropletSingleCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletSingleCreate.class);
  }

 /**
  * Convert an instance of DropletSingleCreate to an JSON string
  *
  * @return JSON string
  */
