...
import com.konfigthis.client.model.AppLogDestinationDatadogSpec;
import com.konfigthis.client.model.AppLogDestinationLogtailSpec;
import com.konfigthis.client.model.AppLogDestinationPapertrailSpec;
...
public class AppLogDestinationDefinition {
  ...
  public static final String SERIALIZED_NAME_PAPERTRAIL = "papertrail";
  @SerializedName(SERIALIZED_NAME_PAPERTRAIL)
  ...
  public static final String SERIALIZED_NAME_LOGTAIL = "logtail";
  @SerializedName(SERIALIZED_NAME_LOGTAIL)
  ...
  **/
   ...
   * @return the AppLogDestinationDefinition instance itself
   */
  public AppLogDestinationDefinition putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appLogDestinationDefinition.name) &&
        ...
        Objects.equals(this.additionalProperties, appLogDestinationDefinition.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, papertrail, datadog, logtail, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("papertrail");
    openapiFields.add("datadog");
    openapiFields.add("logtail");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppLogDestinationDefinition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppLogDestinationDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppLogDestinationDefinition is not found in the empty JSON string", AppLogDestinationDefinition.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppLogDestinationDefinition.openapiRequiredFields) {
      ...
      // validate the optional field `papertrail`
      if (jsonObj.get("papertrail") != null && !jsonObj.get("papertrail").isJsonNull()) {
        AppLogDestinationPapertrailSpec.validateJsonObject(jsonObj.getAsJsonObject("papertrail"));
      }
      // validate the optional field `datadog`
      if (jsonObj.get("datadog") != null && !jsonObj.get("datadog").isJsonNull()) {
        AppLogDestinationDatadogSpec.validateJsonObject(jsonObj.getAsJsonObject("datadog"));
      }
      // validate the optional field `logtail`
      if (jsonObj.get("logtail") != null && !jsonObj.get("logtail").isJsonNull()) {
        AppLogDestinationLogtailSpec.validateJsonObject(jsonObj.getAsJsonObject("logtail"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppLogDestinationDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppLogDestinationDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppLogDestinationDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppLogDestinationDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<AppLogDestinationDefinition>() {
           @Override
           public void write(JsonWriter out, AppLogDestinationDefinition value) throws IOException {
           ...
           @Override
           public AppLogDestinationDefinition read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppLogDestinationDefinition instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppLogDestinationDefinition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppLogDestinationDefinition
  * @throws IOException if the JSON string is invalid with respect to AppLogDestinationDefinition
  */
  public static AppLogDestinationDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppLogDestinationDefinition.class);
  }

 /**
  * Convert an instance of AppLogDestinationDefinition to an JSON string
  *
  * @return JSON string
  */
