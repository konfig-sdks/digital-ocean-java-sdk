...
public class SnapshotsListResponse {
  ...
  public SnapshotsListResponse snapshots(List<Snapshots> snapshots) {
  ...
  public SnapshotsListResponse addSnapshotsItem(Snapshots snapshotsItem) {
  ...
  **/
  ...
  public SnapshotsListResponse links(PageLinks links) {
  ...
  **/
  ...
  public SnapshotsListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the SnapshotsListResponse instance itself
   */
  public SnapshotsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnapshotsListResponse snapshotsListResponse = (SnapshotsListResponse) o;
    return Objects.equals(this.snapshots, snapshotsListResponse.snapshots) &&
        Objects.equals(this.links, snapshotsListResponse.links) &&
        Objects.equals(this.meta, snapshotsListResponse.meta)&&
        Objects.equals(this.additionalProperties, snapshotsListResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotsListResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnapshotsListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnapshotsListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnapshotsListResponse is not found in the empty JSON string", SnapshotsListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnapshotsListResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnapshotsListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnapshotsListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnapshotsListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnapshotsListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SnapshotsListResponse>() {
           @Override
           public void write(JsonWriter out, SnapshotsListResponse value) throws IOException {
           ...
           @Override
           public SnapshotsListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnapshotsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnapshotsListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnapshotsListResponse
  * @throws IOException if the JSON string is invalid with respect to SnapshotsListResponse
  */
  public static SnapshotsListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnapshotsListResponse.class);
  }

 /**
  * Convert an instance of SnapshotsListResponse to an JSON string
  *
  * @return JSON string
  */
