...
public class ImageNewCustom {
  ...
  **/
  ...
  @ApiModelProperty(example = "ubuntu-18.04-minimal", required = true, value = "")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "http://cloud-images.ubuntu.com/minimal/releases/bionic/release/ubuntu-18.04-minimal-cloudimg-amd64.img", required = true, value = "")
  ...
  public ImageNewCustom distribution(String distribution) {
  ...
  **/
  ...
  public ImageNewCustom region(String region) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "nyc3", required = true, value = "")
   ...
   * @return the ImageNewCustom instance itself
   */
  public ImageNewCustom putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, imageNewCustom.tags) &&
        Objects.equals(this.description, imageNewCustom.description) &&
        Objects.equals(this.name, imageNewCustom.name) &&
        Objects.equals(this.url, imageNewCustom.url) &&
        Objects.equals(this.distribution, imageNewCustom.distribution) &&
        Objects.equals(this.region, imageNewCustom.region)&&
        Objects.equals(this.additionalProperties, imageNewCustom.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, name, url, distribution, region, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageNewCustom
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageNewCustom.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageNewCustom is not found in the empty JSON string", ImageNewCustom.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageNewCustom.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageNewCustom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageNewCustom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageNewCustom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageNewCustom.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageNewCustom>() {
           @Override
           public void write(JsonWriter out, ImageNewCustom value) throws IOException {
           ...
           @Override
           public ImageNewCustom read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageNewCustom instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageNewCustom given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageNewCustom
  * @throws IOException if the JSON string is invalid with respect to ImageNewCustom
  */
  public static ImageNewCustom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageNewCustom.class);
  }

 /**
  * Convert an instance of ImageNewCustom to an JSON string
  *
  * @return JSON string
  */
