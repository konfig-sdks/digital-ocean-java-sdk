...
public class DropletActionChangeKernelAllOf {
  ...
  **/
   ...
   * @return the DropletActionChangeKernelAllOf instance itself
   */
  public DropletActionChangeKernelAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kernel, dropletActionChangeKernelAllOf.kernel)&&
        Objects.equals(this.additionalProperties, dropletActionChangeKernelAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(kernel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionChangeKernelAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionChangeKernelAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionChangeKernelAllOf is not found in the empty JSON string", DropletActionChangeKernelAllOf.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionChangeKernelAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionChangeKernelAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionChangeKernelAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionChangeKernelAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionChangeKernelAllOf>() {
           @Override
           public void write(JsonWriter out, DropletActionChangeKernelAllOf value) throws IOException {
           ...
           @Override
           public DropletActionChangeKernelAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionChangeKernelAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionChangeKernelAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionChangeKernelAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletActionChangeKernelAllOf
  */
  public static DropletActionChangeKernelAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionChangeKernelAllOf.class);
  }

 /**
  * Convert an instance of DropletActionChangeKernelAllOf to an JSON string
  *
  * @return JSON string
  */
