...
public class UpdateRegistry {
  ...
  **/
   ...
   * @return the UpdateRegistry instance itself
   */
  public UpdateRegistry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cancel, updateRegistry.cancel)&&
        Objects.equals(this.additionalProperties, updateRegistry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cancel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateRegistry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateRegistry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateRegistry is not found in the empty JSON string", UpdateRegistry.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateRegistry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateRegistry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateRegistry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateRegistry.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateRegistry>() {
           @Override
           public void write(JsonWriter out, UpdateRegistry value) throws IOException {
           ...
           @Override
           public UpdateRegistry read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UpdateRegistry instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UpdateRegistry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateRegistry
  * @throws IOException if the JSON string is invalid with respect to UpdateRegistry
  */
  public static UpdateRegistry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateRegistry.class);
  }

 /**
  * Convert an instance of UpdateRegistry to an JSON string
  *
  * @return JSON string
  */
