...
public class VpcsPatchRequest {
  ...
  public VpcsPatchRequest description(String description) {
  ...
  **/
  ...
  public VpcsPatchRequest name(String name) {
  ...
  **/
  ...
  public VpcsPatchRequest _default(Boolean _default) {
  ...
  **/
   ...
   * @return the VpcsPatchRequest instance itself
   */
  public VpcsPatchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VpcsPatchRequest vpcsPatchRequest = (VpcsPatchRequest) o;
    return Objects.equals(this.description, vpcsPatchRequest.description) &&
        Objects.equals(this.name, vpcsPatchRequest.name) &&
        Objects.equals(this._default, vpcsPatchRequest._default)&&
        Objects.equals(this.additionalProperties, vpcsPatchRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VpcsPatchRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcsPatchRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcsPatchRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcsPatchRequest is not found in the empty JSON string", VpcsPatchRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcsPatchRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcsPatchRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcsPatchRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcsPatchRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcsPatchRequest>() {
           @Override
           public void write(JsonWriter out, VpcsPatchRequest value) throws IOException {
           ...
           @Override
           public VpcsPatchRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcsPatchRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcsPatchRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcsPatchRequest
  * @throws IOException if the JSON string is invalid with respect to VpcsPatchRequest
  */
  public static VpcsPatchRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcsPatchRequest.class);
  }

 /**
  * Convert an instance of VpcsPatchRequest to an JSON string
  *
  * @return JSON string
  */
