...
public class AlertPolicy {
  ...
  **/
   ...
   * @return the AlertPolicy instance itself
   */
  public AlertPolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, alertPolicy.tags) &&
        Objects.equals(this.description, alertPolicy.description) &&
        Objects.equals(this.alerts, alertPolicy.alerts) &&
        Objects.equals(this.compare, alertPolicy.compare) &&
        Objects.equals(this.enabled, alertPolicy.enabled) &&
        Objects.equals(this.entities, alertPolicy.entities) &&
        Objects.equals(this.type, alertPolicy.type) &&
        Objects.equals(this.uuid, alertPolicy.uuid) &&
        Objects.equals(this.value, alertPolicy.value) &&
        Objects.equals(this.window, alertPolicy.window)&&
        Objects.equals(this.additionalProperties, alertPolicy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, description, alerts, compare, enabled, entities, type, uuid, value, window, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlertPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlertPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : AlertPolicy.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AlertPolicy>() {
           ...
           public AlertPolicy read(JsonReader in) throws IOException {
             ...
             AlertPolicy instance = thisAdapter.fromJsonTree(jsonObj);
