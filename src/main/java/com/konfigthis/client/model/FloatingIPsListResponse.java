...
import com.konfigthis.client.model.FloatingIp;
...
public class FloatingIPsListResponse {
  ...
  public FloatingIPsListResponse() {
  }

  public FloatingIPsListResponse floatingIps(List<FloatingIp> floatingIps) {
  ...
  public FloatingIPsListResponse addFloatingIpsItem(FloatingIp floatingIpsItem) {
  ...
  **/
  ...
  public FloatingIPsListResponse links(PageLinks links) {
  ...
  **/
  ...
  public FloatingIPsListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the FloatingIPsListResponse instance itself
   */
  public FloatingIPsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIPsListResponse floatingIPsListResponse = (FloatingIPsListResponse) o;
    return Objects.equals(this.floatingIps, floatingIPsListResponse.floatingIps) &&
        Objects.equals(this.links, floatingIPsListResponse.links) &&
        Objects.equals(this.meta, floatingIPsListResponse.meta)&&
        Objects.equals(this.additionalProperties, floatingIPsListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(floatingIps, links, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatingIPsListResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIPsListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIPsListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIPsListResponse is not found in the empty JSON string", FloatingIPsListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIPsListResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("floating_ips") != null && !jsonObj.get("floating_ips").isJsonNull()) {
        ...
        if (jsonArrayfloatingIps != null) {
          ...
          for (int i = 0; i < jsonArrayfloatingIps.size(); i++) {
            FloatingIp.validateJsonObject(jsonArrayfloatingIps.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIPsListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIPsListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIPsListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIPsListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIPsListResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIPsListResponse value) throws IOException {
           ...
           @Override
           public FloatingIPsListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIPsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIPsListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIPsListResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIPsListResponse
  */
  public static FloatingIPsListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIPsListResponse.class);
  }

 /**
  * Convert an instance of FloatingIPsListResponse to an JSON string
  *
  * @return JSON string
  */
