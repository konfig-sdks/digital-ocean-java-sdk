...
public class OnlineMigration {
  ...
  **/
  ...
  @ApiModelProperty(example = "77b28fc8-19ff-11eb-8c9c-c68e24557488", value = "The ID of the most recent migration.")
  ...
  public OnlineMigration status(StatusEnum status) {
  ...
  **/
   ...
   * @return the OnlineMigration instance itself
   */
  public OnlineMigration putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, onlineMigration.id) &&
        Objects.equals(this.status, onlineMigration.status) &&
        Objects.equals(this.createdAt, onlineMigration.createdAt)&&
        Objects.equals(this.additionalProperties, onlineMigration.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OnlineMigration
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OnlineMigration.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OnlineMigration is not found in the empty JSON string", OnlineMigration.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OnlineMigration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OnlineMigration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OnlineMigration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OnlineMigration.class));

       return (TypeAdapter<T>) new TypeAdapter<OnlineMigration>() {
           @Override
           public void write(JsonWriter out, OnlineMigration value) throws IOException {
           ...
           @Override
           public OnlineMigration read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OnlineMigration instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OnlineMigration given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OnlineMigration
  * @throws IOException if the JSON string is invalid with respect to OnlineMigration
  */
  public static OnlineMigration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OnlineMigration.class);
  }

 /**
  * Convert an instance of OnlineMigration to an JSON string
  *
  * @return JSON string
  */
