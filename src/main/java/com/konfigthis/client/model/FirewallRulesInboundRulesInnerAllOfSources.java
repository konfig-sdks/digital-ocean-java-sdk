...
public class FirewallRulesInboundRulesInnerAllOfSources {
  ...
  public FirewallRulesInboundRulesInnerAllOfSources tags(List tags) {
  ...
  **/
   ...
   * @return the FirewallRulesInboundRulesInnerAllOfSources instance itself
   */
  public FirewallRulesInboundRulesInnerAllOfSources putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, firewallRulesInboundRulesInnerAllOfSources.tags) &&
        Objects.equals(this.addresses, firewallRulesInboundRulesInnerAllOfSources.addresses) &&
        ...
        Objects.equals(this.additionalProperties, firewallRulesInboundRulesInnerAllOfSources.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRulesInboundRulesInnerAllOfSources
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRulesInboundRulesInnerAllOfSources.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRulesInboundRulesInnerAllOfSources is not found in the empty JSON string", FirewallRulesInboundRulesInnerAllOfSources.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRulesInboundRulesInnerAllOfSources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRulesInboundRulesInnerAllOfSources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRulesInboundRulesInnerAllOfSources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRulesInboundRulesInnerAllOfSources.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRulesInboundRulesInnerAllOfSources>() {
           @Override
           public void write(JsonWriter out, FirewallRulesInboundRulesInnerAllOfSources value) throws IOException {
           ...
           @Override
           public FirewallRulesInboundRulesInnerAllOfSources read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRulesInboundRulesInnerAllOfSources instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRulesInboundRulesInnerAllOfSources given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRulesInboundRulesInnerAllOfSources
  * @throws IOException if the JSON string is invalid with respect to FirewallRulesInboundRulesInnerAllOfSources
  */
  public static FirewallRulesInboundRulesInnerAllOfSources fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRulesInboundRulesInnerAllOfSources.class);
  }

 /**
  * Convert an instance of FirewallRulesInboundRulesInnerAllOfSources to an JSON string
  *
  * @return JSON string
  */
