...
public class AppWorkerSpec {
  ...
  **/
  ...
  public AppWorkerSpec autoscaling(AppComponentInstanceBaseAutoscaling autoscaling) {
  ...
  **/
   ...
   * @return the AppWorkerSpec instance itself
   */
  public AppWorkerSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appWorkerSpec.name) &&
        Objects.equals(this.git, appWorkerSpec.git) &&
        Objects.equals(this.github, appWorkerSpec.github) &&
        Objects.equals(this.gitlab, appWorkerSpec.gitlab) &&
        Objects.equals(this.image, appWorkerSpec.image) &&
        ...
        Objects.equals(this.autoscaling, appWorkerSpec.autoscaling)&&
        Objects.equals(this.additionalProperties, appWorkerSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, git, github, gitlab, image, dockerfilePath, buildCommand, runCommand, sourceDir, envs, environmentSlug, logDestinations, instanceCount, instanceSizeSlug, autoscaling, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppWorkerSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppWorkerSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppWorkerSpec is not found in the empty JSON string", AppWorkerSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppWorkerSpec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppWorkerSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppWorkerSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppWorkerSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppWorkerSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppWorkerSpec>() {
           @Override
           public void write(JsonWriter out, AppWorkerSpec value) throws IOException {
           ...
           @Override
           public AppWorkerSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppWorkerSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppWorkerSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppWorkerSpec
  * @throws IOException if the JSON string is invalid with respect to AppWorkerSpec
  */
  public static AppWorkerSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppWorkerSpec.class);
  }

 /**
  * Convert an instance of AppWorkerSpec to an JSON string
  *
  * @return JSON string
  */
