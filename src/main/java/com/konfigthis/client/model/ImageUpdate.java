...
public class ImageUpdate {
  ...
  **/
   ...
   * @return the ImageUpdate instance itself
   */
  public ImageUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, imageUpdate.description) &&
        Objects.equals(this.name, imageUpdate.name) &&
        Objects.equals(this.distribution, imageUpdate.distribution)&&
        Objects.equals(this.additionalProperties, imageUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, distribution, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImageUpdate>() {
           ...
           public ImageUpdate read(JsonReader in) throws IOException {
             ...
             ImageUpdate instance = thisAdapter.fromJsonTree(jsonObj);
