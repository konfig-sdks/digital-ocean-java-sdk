...
public class AppServiceSpecAllOf {
  ...
  **/
   ...
   * @return the AppServiceSpecAllOf instance itself
   */
  public AppServiceSpecAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cors, appServiceSpecAllOf.cors) &&
        ...
        Objects.equals(this.additionalProperties, appServiceSpecAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cors, healthCheck, httpPort, internalPorts, routes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppServiceSpecAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppServiceSpecAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppServiceSpecAllOf is not found in the empty JSON string", AppServiceSpecAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppServiceSpecAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppServiceSpecAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppServiceSpecAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppServiceSpecAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AppServiceSpecAllOf>() {
           @Override
           public void write(JsonWriter out, AppServiceSpecAllOf value) throws IOException {
           ...
           @Override
           public AppServiceSpecAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppServiceSpecAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppServiceSpecAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppServiceSpecAllOf
  * @throws IOException if the JSON string is invalid with respect to AppServiceSpecAllOf
  */
  public static AppServiceSpecAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppServiceSpecAllOf.class);
  }

 /**
  * Convert an instance of AppServiceSpecAllOf to an JSON string
  *
  * @return JSON string
  */
