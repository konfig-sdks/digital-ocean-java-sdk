...
import com.konfigthis.client.model.ProductChargeItem;
...
public class InvoiceSummaryProductCharges {
  ...
  **/
   ...
   * @return the InvoiceSummaryProductCharges instance itself
   */
  public InvoiceSummaryProductCharges putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, invoiceSummaryProductCharges.name) &&
        ...
        Objects.equals(this.additionalProperties, invoiceSummaryProductCharges.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, amount, items, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceSummaryProductCharges
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceSummaryProductCharges.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceSummaryProductCharges is not found in the empty JSON string", InvoiceSummaryProductCharges.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("items") != null && !jsonObj.get("items").isJsonNull()) {
        ...
        if (jsonArrayitems != null) {
          ...
          for (int i = 0; i < jsonArrayitems.size(); i++) {
            ProductChargeItem.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceSummaryProductCharges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceSummaryProductCharges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceSummaryProductCharges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceSummaryProductCharges.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceSummaryProductCharges>() {
           @Override
           public void write(JsonWriter out, InvoiceSummaryProductCharges value) throws IOException {
           ...
           @Override
           public InvoiceSummaryProductCharges read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceSummaryProductCharges instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceSummaryProductCharges given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceSummaryProductCharges
  * @throws IOException if the JSON string is invalid with respect to InvoiceSummaryProductCharges
  */
  public static InvoiceSummaryProductCharges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceSummaryProductCharges.class);
  }

 /**
  * Convert an instance of InvoiceSummaryProductCharges to an JSON string
  *
  * @return JSON string
  */
