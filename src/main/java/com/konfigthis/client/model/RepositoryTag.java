...
public class RepositoryTag {
  ...
  **/
   ...
   * @return the RepositoryTag instance itself
   */
  public RepositoryTag putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.registryName, repositoryTag.registryName) &&
        ...
        Objects.equals(this.additionalProperties, repositoryTag.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(registryName, repository, tag, manifestDigest, compressedSizeBytes, sizeBytes, updatedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("manifest_digest");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryTag
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryTag.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryTag is not found in the empty JSON string", RepositoryTag.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("manifest_digest") != null && !jsonObj.get("manifest_digest").isJsonNull()) && !jsonObj.get("manifest_digest").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `manifest_digest` to be a primitive type in the JSON string but got `%s`", jsonObj.get("manifest_digest").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryTag.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryTag' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryTag> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryTag.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryTag>() {
           @Override
           public void write(JsonWriter out, RepositoryTag value) throws IOException {
           ...
           @Override
           public RepositoryTag read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RepositoryTag instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RepositoryTag given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryTag
  * @throws IOException if the JSON string is invalid with respect to RepositoryTag
  */
  public static RepositoryTag fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryTag.class);
  }

 /**
  * Convert an instance of RepositoryTag to an JSON string
  *
  * @return JSON string
  */
