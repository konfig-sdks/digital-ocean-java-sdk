...
public class LoadBalancersAddForwardingRulesRequest {
  ...
  public LoadBalancersAddForwardingRulesRequest forwardingRules(List<ForwardingRule> forwardingRules) {
  ...
  public LoadBalancersAddForwardingRulesRequest addForwardingRulesItem(ForwardingRule forwardingRulesItem) {
  ...
  **/
   ...
   * @return the LoadBalancersAddForwardingRulesRequest instance itself
   */
  public LoadBalancersAddForwardingRulesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersAddForwardingRulesRequest loadBalancersAddForwardingRulesRequest = (LoadBalancersAddForwardingRulesRequest) o;
    return Objects.equals(this.forwardingRules, loadBalancersAddForwardingRulesRequest.forwardingRules)&&
        Objects.equals(this.additionalProperties, loadBalancersAddForwardingRulesRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersAddForwardingRulesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersAddForwardingRulesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersAddForwardingRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersAddForwardingRulesRequest is not found in the empty JSON string", LoadBalancersAddForwardingRulesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersAddForwardingRulesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersAddForwardingRulesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersAddForwardingRulesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersAddForwardingRulesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersAddForwardingRulesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersAddForwardingRulesRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersAddForwardingRulesRequest value) throws IOException {
           ...
           @Override
           public LoadBalancersAddForwardingRulesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersAddForwardingRulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersAddForwardingRulesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersAddForwardingRulesRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersAddForwardingRulesRequest
  */
  public static LoadBalancersAddForwardingRulesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersAddForwardingRulesRequest.class);
  }

 /**
  * Convert an instance of LoadBalancersAddForwardingRulesRequest to an JSON string
  *
  * @return JSON string
  */
