...
public class FirewallRule {
  ...
  **/
   ...
   * @return the FirewallRule instance itself
   */
  public FirewallRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, firewallRule.uuid) &&
        ...
        Objects.equals(this.value, firewallRule.value) &&
        Objects.equals(this.createdAt, firewallRule.createdAt)&&
        Objects.equals(this.additionalProperties, firewallRule.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FirewallRule>() {
           ...
           public FirewallRule read(JsonReader in) throws IOException {
             ...
             FirewallRule instance = thisAdapter.fromJsonTree(jsonObj);
