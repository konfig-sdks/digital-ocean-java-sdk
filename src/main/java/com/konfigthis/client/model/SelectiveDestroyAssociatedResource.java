 ...
 */
@ApiModel(description = "An object containing information about a resource to be scheduled for deletion.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SelectiveDestroyAssociatedResource {
  ...
  **/
   ...
   * @return the SelectiveDestroyAssociatedResource instance itself
   */
  public SelectiveDestroyAssociatedResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.floatingIps, selectiveDestroyAssociatedResource.floatingIps) &&
        ...
        Objects.equals(this.additionalProperties, selectiveDestroyAssociatedResource.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(floatingIps, reservedIps, snapshots, volumes, volumeSnapshots, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SelectiveDestroyAssociatedResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SelectiveDestroyAssociatedResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SelectiveDestroyAssociatedResource is not found in the empty JSON string", SelectiveDestroyAssociatedResource.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("floating_ips") != null && !jsonObj.get("floating_ips").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("snapshots") != null && !jsonObj.get("snapshots").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("volume_snapshots") != null && !jsonObj.get("volume_snapshots").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SelectiveDestroyAssociatedResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SelectiveDestroyAssociatedResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SelectiveDestroyAssociatedResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SelectiveDestroyAssociatedResource.class));

       return (TypeAdapter<T>) new TypeAdapter<SelectiveDestroyAssociatedResource>() {
           @Override
           public void write(JsonWriter out, SelectiveDestroyAssociatedResource value) throws IOException {
           ...
           @Override
           public SelectiveDestroyAssociatedResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SelectiveDestroyAssociatedResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SelectiveDestroyAssociatedResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SelectiveDestroyAssociatedResource
  * @throws IOException if the JSON string is invalid with respect to SelectiveDestroyAssociatedResource
  */
  public static SelectiveDestroyAssociatedResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SelectiveDestroyAssociatedResource.class);
  }

 /**
  * Convert an instance of SelectiveDestroyAssociatedResource to an JSON string
  *
  * @return JSON string
  */
