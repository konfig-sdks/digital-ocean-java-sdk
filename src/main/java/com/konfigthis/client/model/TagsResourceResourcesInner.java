...
public class TagsResourceResourcesInner {
 ...
 public enum ResourceTypeEnum {
  ...
  public TagsResourceResourcesInner() {
  }

  public TagsResourceResourcesInner resourceId(String resourceId) {
  ...
  **/
  ...
  public TagsResourceResourcesInner resourceType(ResourceTypeEnum resourceType) {
  ...
  **/
   ...
   * @return the TagsResourceResourcesInner instance itself
   */
  public TagsResourceResourcesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TagsResourceResourcesInner tagsResourceResourcesInner = (TagsResourceResourcesInner) o;
    return Objects.equals(this.resourceId, tagsResourceResourcesInner.resourceId) &&
        Objects.equals(this.resourceType, tagsResourceResourcesInner.resourceType)&&
        Objects.equals(this.additionalProperties, tagsResourceResourcesInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceId, resourceType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TagsResourceResourcesInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagsResourceResourcesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagsResourceResourcesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagsResourceResourcesInner is not found in the empty JSON string", TagsResourceResourcesInner.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagsResourceResourcesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagsResourceResourcesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagsResourceResourcesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagsResourceResourcesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<TagsResourceResourcesInner>() {
           @Override
           public void write(JsonWriter out, TagsResourceResourcesInner value) throws IOException {
           ...
           @Override
           public TagsResourceResourcesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TagsResourceResourcesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TagsResourceResourcesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TagsResourceResourcesInner
  * @throws IOException if the JSON string is invalid with respect to TagsResourceResourcesInner
  */
  public static TagsResourceResourcesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagsResourceResourcesInner.class);
  }

 /**
  * Convert an instance of TagsResourceResourcesInner to an JSON string
  *
  * @return JSON string
  */
