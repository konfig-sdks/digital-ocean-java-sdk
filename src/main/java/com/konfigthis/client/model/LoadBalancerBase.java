...
public class LoadBalancerBase {
  ...
  **/
  ...
  public LoadBalancerBase projectId(String projectId) {
  ...
  **/
  ...
  public LoadBalancerBase httpIdleTimeoutSeconds(Integer httpIdleTimeoutSeconds) {
  ...
  **/
  ...
  public LoadBalancerBase firewall(LbFirewall firewall) {
  ...
  **/
   ...
   * @return the LoadBalancerBase instance itself
   */
  public LoadBalancerBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, loadBalancerBase.id) &&
        Objects.equals(this.name, loadBalancerBase.name) &&
        Objects.equals(this.projectId, loadBalancerBase.projectId) &&
        ...
        Objects.equals(this.httpIdleTimeoutSeconds, loadBalancerBase.httpIdleTimeoutSeconds) &&
        ...
        Objects.equals(this.firewall, loadBalancerBase.firewall)&&
        Objects.equals(this.additionalProperties, loadBalancerBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, projectId, ip, sizeUnit, size, algorithm, status, createdAt, forwardingRules, healthCheck, stickySessions, redirectHttpToHttps, enableProxyProtocol, enableBackendKeepalive, httpIdleTimeoutSeconds, vpcUuid, disableLetsEncryptDnsRecords, firewall, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerBase is not found in the empty JSON string", LoadBalancerBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancerBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerBase.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerBase>() {
           @Override
           public void write(JsonWriter out, LoadBalancerBase value) throws IOException {
           ...
           @Override
           public LoadBalancerBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerBase
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerBase
  */
  public static LoadBalancerBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerBase.class);
  }

 /**
  * Convert an instance of LoadBalancerBase to an JSON string
  *
  * @return JSON string
  */
