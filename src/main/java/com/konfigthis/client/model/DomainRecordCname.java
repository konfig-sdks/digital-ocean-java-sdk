...
public class DomainRecordCname {
  ...
  **/
   ...
   * @return the DomainRecordCname instance itself
   */
  public DomainRecordCname putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordCname.id) &&
        Objects.equals(this.type, domainRecordCname.type) &&
        ...
        Objects.equals(this.port, domainRecordCname.port) &&
        Objects.equals(this.ttl, domainRecordCname.ttl) &&
        ...
        Objects.equals(this.additionalProperties, domainRecordCname.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordCname
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordCname.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordCname is not found in the empty JSON string", DomainRecordCname.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordCname.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordCname.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordCname' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordCname> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordCname.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordCname>() {
           @Override
           public void write(JsonWriter out, DomainRecordCname value) throws IOException {
           ...
           @Override
           public DomainRecordCname read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordCname instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordCname given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordCname
  * @throws IOException if the JSON string is invalid with respect to DomainRecordCname
  */
  public static DomainRecordCname fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordCname.class);
  }

 /**
  * Convert an instance of DomainRecordCname to an JSON string
  *
  * @return JSON string
  */
