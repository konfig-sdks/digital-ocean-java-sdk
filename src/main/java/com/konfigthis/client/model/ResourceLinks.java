 ...
 */
@ApiModel(description = "The links object contains the `self` object, which contains the resource relationship.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ResourceLinks {
  ...
  **/
   ...
   * @return the ResourceLinks instance itself
   */
  public ResourceLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, resourceLinks.self)&&
        Objects.equals(this.additionalProperties, resourceLinks.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResourceLinks
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResourceLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceLinks>() {
           ...
           public ResourceLinks read(JsonReader in) throws IOException {
             ...
             ResourceLinks instance = thisAdapter.fromJsonTree(jsonObj);
