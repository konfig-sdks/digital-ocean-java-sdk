...
public class DropletSnapshotAllOf {
  ...
  **/
   ...
   * @return the DropletSnapshotAllOf instance itself
   */
  public DropletSnapshotAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, dropletSnapshotAllOf.id)&&
        Objects.equals(this.additionalProperties, dropletSnapshotAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletSnapshotAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletSnapshotAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletSnapshotAllOf is not found in the empty JSON string", DropletSnapshotAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletSnapshotAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletSnapshotAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletSnapshotAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletSnapshotAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletSnapshotAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletSnapshotAllOf>() {
           @Override
           public void write(JsonWriter out, DropletSnapshotAllOf value) throws IOException {
           ...
           @Override
           public DropletSnapshotAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletSnapshotAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletSnapshotAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletSnapshotAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletSnapshotAllOf
  */
  public static DropletSnapshotAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletSnapshotAllOf.class);
  }

 /**
  * Convert an instance of DropletSnapshotAllOf to an JSON string
  *
  * @return JSON string
  */
