 ...
 */
@ApiModel(description = "An objects containing information about a resource associated with a Droplet.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AssociatedResource {
  ...
  **/
   ...
   * @return the AssociatedResource instance itself
   */
  public AssociatedResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, associatedResource.id) &&
        Objects.equals(this.name, associatedResource.name) &&
        Objects.equals(this.cost, associatedResource.cost)&&
        Objects.equals(this.additionalProperties, associatedResource.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, cost, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AssociatedResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssociatedResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociatedResource is not found in the empty JSON string", AssociatedResource.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociatedResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociatedResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociatedResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociatedResource.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociatedResource>() {
           @Override
           public void write(JsonWriter out, AssociatedResource value) throws IOException {
           ...
           @Override
           public AssociatedResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AssociatedResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AssociatedResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AssociatedResource
  * @throws IOException if the JSON string is invalid with respect to AssociatedResource
  */
  public static AssociatedResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociatedResource.class);
  }

 /**
  * Convert an instance of AssociatedResource to an JSON string
  *
  * @return JSON string
  */
