...
public class CertificateCreateBase {
  ...
  **/
   ...
   * @return the CertificateCreateBase instance itself
   */
  public CertificateCreateBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, certificateCreateBase.name) &&
        ...
        Objects.equals(this.additionalProperties, certificateCreateBase.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateCreateBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateCreateBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateCreateBase is not found in the empty JSON string", CertificateCreateBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateCreateBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateCreateBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateCreateBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateCreateBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateCreateBase.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateCreateBase>() {
           @Override
           public void write(JsonWriter out, CertificateCreateBase value) throws IOException {
           ...
           @Override
           public CertificateCreateBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateCreateBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateCreateBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateCreateBase
  * @throws IOException if the JSON string is invalid with respect to CertificateCreateBase
  */
  public static CertificateCreateBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateCreateBase.class);
  }

 /**
  * Convert an instance of CertificateCreateBase to an JSON string
  *
  * @return JSON string
  */
