...
public class SnapshotsAllOf1 {
 ...
 public enum ResourceTypeEnum {
  ...
  public SnapshotsAllOf1() {
  }

  public SnapshotsAllOf1 tags(List<String> tags) {
  ...
  public SnapshotsAllOf1 addTagsItem(String tagsItem) {
  ...
  **/
  ...
  public SnapshotsAllOf1 resourceId(String resourceId) {
  ...
  **/
  ...
  public SnapshotsAllOf1 resourceType(ResourceTypeEnum resourceType) {
  ...
  **/
   ...
   * @return the SnapshotsAllOf1 instance itself
   */
  public SnapshotsAllOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnapshotsAllOf1 snapshotsAllOf1 = (SnapshotsAllOf1) o;
    return Objects.equals(this.tags, snapshotsAllOf1.tags) &&
        Objects.equals(this.resourceId, snapshotsAllOf1.resourceId) &&
        Objects.equals(this.resourceType, snapshotsAllOf1.resourceType)&&
        Objects.equals(this.additionalProperties, snapshotsAllOf1.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, resourceId, resourceType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SnapshotsAllOf1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnapshotsAllOf1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnapshotsAllOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnapshotsAllOf1 is not found in the empty JSON string", SnapshotsAllOf1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnapshotsAllOf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnapshotsAllOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnapshotsAllOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnapshotsAllOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnapshotsAllOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<SnapshotsAllOf1>() {
           @Override
           public void write(JsonWriter out, SnapshotsAllOf1 value) throws IOException {
           ...
           @Override
           public SnapshotsAllOf1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnapshotsAllOf1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnapshotsAllOf1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnapshotsAllOf1
  * @throws IOException if the JSON string is invalid with respect to SnapshotsAllOf1
  */
  public static SnapshotsAllOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnapshotsAllOf1.class);
  }

 /**
  * Convert an instance of SnapshotsAllOf1 to an JSON string
  *
  * @return JSON string
  */
