...
public class VpcsCreateRequest {
  ...
  public VpcsCreateRequest description(String description) {
  ...
  **/
  ...
  public VpcsCreateRequest name(String name) {
  ...
  **/
  ...
  public VpcsCreateRequest region(String region) {
  ...
  **/
  ...
  public VpcsCreateRequest ipRange(String ipRange) {
  ...
  **/
   ...
   * @return the VpcsCreateRequest instance itself
   */
  public VpcsCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VpcsCreateRequest vpcsCreateRequest = (VpcsCreateRequest) o;
    return Objects.equals(this.description, vpcsCreateRequest.description) &&
        Objects.equals(this.name, vpcsCreateRequest.name) &&
        Objects.equals(this.region, vpcsCreateRequest.region) &&
        Objects.equals(this.ipRange, vpcsCreateRequest.ipRange)&&
        Objects.equals(this.additionalProperties, vpcsCreateRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, name, region, ipRange, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VpcsCreateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcsCreateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcsCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcsCreateRequest is not found in the empty JSON string", VpcsCreateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VpcsCreateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcsCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcsCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcsCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcsCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcsCreateRequest>() {
           @Override
           public void write(JsonWriter out, VpcsCreateRequest value) throws IOException {
           ...
           @Override
           public VpcsCreateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcsCreateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcsCreateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcsCreateRequest
  * @throws IOException if the JSON string is invalid with respect to VpcsCreateRequest
  */
  public static VpcsCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcsCreateRequest.class);
  }

 /**
  * Convert an instance of VpcsCreateRequest to an JSON string
  *
  * @return JSON string
  */
