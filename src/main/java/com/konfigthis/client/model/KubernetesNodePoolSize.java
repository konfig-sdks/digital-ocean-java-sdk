...
public class KubernetesNodePoolSize {
  ...
  **/
   ...
   * @return the KubernetesNodePoolSize instance itself
   */
  public KubernetesNodePoolSize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, kubernetesNodePoolSize.size)&&
        Objects.equals(this.additionalProperties, kubernetesNodePoolSize.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesNodePoolSize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesNodePoolSize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesNodePoolSize is not found in the empty JSON string", KubernetesNodePoolSize.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesNodePoolSize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesNodePoolSize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesNodePoolSize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesNodePoolSize.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesNodePoolSize>() {
           @Override
           public void write(JsonWriter out, KubernetesNodePoolSize value) throws IOException {
           ...
           @Override
           public KubernetesNodePoolSize read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesNodePoolSize instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesNodePoolSize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesNodePoolSize
  * @throws IOException if the JSON string is invalid with respect to KubernetesNodePoolSize
  */
  public static KubernetesNodePoolSize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesNodePoolSize.class);
  }

 /**
  * Convert an instance of KubernetesNodePoolSize to an JSON string
  *
  * @return JSON string
  */
