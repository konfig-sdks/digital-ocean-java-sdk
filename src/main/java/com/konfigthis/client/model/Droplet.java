...
public class Droplet {
  ...
  **/
   ...
   * @return the Droplet instance itself
   */
  public Droplet putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, droplet.tags) &&
        Objects.equals(this.id, droplet.id) &&
        Objects.equals(this.name, droplet.name) &&
        Objects.equals(this.memory, droplet.memory) &&
        Objects.equals(this.vcpus, droplet.vcpus) &&
        Objects.equals(this.disk, droplet.disk) &&
        Objects.equals(this.locked, droplet.locked) &&
        Objects.equals(this.status, droplet.status) &&
        Objects.equals(this.kernel, droplet.kernel) &&
        Objects.equals(this.createdAt, droplet.createdAt) &&
        Objects.equals(this.features, droplet.features) &&
        Objects.equals(this.backupIds, droplet.backupIds) &&
        Objects.equals(this.nextBackupWindow, droplet.nextBackupWindow) &&
        Objects.equals(this.snapshotIds, droplet.snapshotIds) &&
        Objects.equals(this.image, droplet.image) &&
        Objects.equals(this.volumeIds, droplet.volumeIds) &&
        Objects.equals(this.size, droplet.size) &&
        Objects.equals(this.sizeSlug, droplet.sizeSlug) &&
        Objects.equals(this.networks, droplet.networks) &&
        Objects.equals(this.region, droplet.region) &&
        Objects.equals(this.vpcUuid, droplet.vpcUuid)&&
        Objects.equals(this.additionalProperties, droplet.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("vcpus");
    openapiRequiredFields.add("disk");
    openapiRequiredFields.add("locked");
    openapiRequiredFields.add("status");
    openapiRequiredFields.add("created_at");
    openapiRequiredFields.add("features");
    openapiRequiredFields.add("backup_ids");
    openapiRequiredFields.add("next_backup_window");
    openapiRequiredFields.add("snapshot_ids");
    openapiRequiredFields.add("image");
    openapiRequiredFields.add("volume_ids");
    openapiRequiredFields.add("size");
    openapiRequiredFields.add("size_slug");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Droplet
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Droplet.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Droplet is not found in the empty JSON string", Droplet.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Droplet.openapiRequiredFields) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("backup_ids") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("backup_ids").isJsonArray()) {
      ...
      // validate the required field `next_backup_window`
      DropletNextBackupWindow.validateJsonObject(jsonObj.getAsJsonObject("next_backup_window"));
      // ensure the required json array is present
      if (jsonObj.get("snapshot_ids") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("snapshot_ids").isJsonArray()) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("volume_ids") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("volume_ids").isJsonArray()) {
      ...
      if (!jsonObj.get("size_slug").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Droplet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Droplet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Droplet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Droplet.class));

       return (TypeAdapter<T>) new TypeAdapter<Droplet>() {
           @Override
           public void write(JsonWriter out, Droplet value) throws IOException {
           ...
           @Override
           public Droplet read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Droplet instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Droplet given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Droplet
  * @throws IOException if the JSON string is invalid with respect to Droplet
  */
  public static Droplet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Droplet.class);
  }

 /**
  * Convert an instance of Droplet to an JSON string
  *
  * @return JSON string
  */
