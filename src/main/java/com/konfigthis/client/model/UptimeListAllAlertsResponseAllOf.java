...
public class UptimeListAllAlertsResponseAllOf {
  public static final String SERIALIZED_NAME_ALERTS = "alerts";
  @SerializedName(SERIALIZED_NAME_ALERTS)
  private List<Alert> alerts = null;

  public UptimeListAllAlertsResponseAllOf() {
  }

  public UptimeListAllAlertsResponseAllOf alerts(List<Alert> alerts) {
  ...
  public UptimeListAllAlertsResponseAllOf addAlertsItem(Alert alertsItem) {
    if (this.alerts == null) {
  ...
  **/
   ...
   * @return the UptimeListAllAlertsResponseAllOf instance itself
   */
  public UptimeListAllAlertsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UptimeListAllAlertsResponseAllOf uptimeListAllAlertsResponseAllOf = (UptimeListAllAlertsResponseAllOf) o;
    return Objects.equals(this.alerts, uptimeListAllAlertsResponseAllOf.alerts)&&
        Objects.equals(this.additionalProperties, uptimeListAllAlertsResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alerts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UptimeListAllAlertsResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UptimeListAllAlertsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UptimeListAllAlertsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UptimeListAllAlertsResponseAllOf is not found in the empty JSON string", UptimeListAllAlertsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UptimeListAllAlertsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UptimeListAllAlertsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UptimeListAllAlertsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UptimeListAllAlertsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<UptimeListAllAlertsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, UptimeListAllAlertsResponseAllOf value) throws IOException {
           ...
           @Override
           public UptimeListAllAlertsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UptimeListAllAlertsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UptimeListAllAlertsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UptimeListAllAlertsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to UptimeListAllAlertsResponseAllOf
  */
  public static UptimeListAllAlertsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UptimeListAllAlertsResponseAllOf.class);
  }

 /**
  * Convert an instance of UptimeListAllAlertsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
