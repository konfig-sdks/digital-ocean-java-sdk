...
public class DropletActionSnapshotAllOf {
  ...
  **/
   ...
   * @return the DropletActionSnapshotAllOf instance itself
   */
  public DropletActionSnapshotAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dropletActionSnapshotAllOf.name)&&
        Objects.equals(this.additionalProperties, dropletActionSnapshotAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionSnapshotAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionSnapshotAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionSnapshotAllOf is not found in the empty JSON string", DropletActionSnapshotAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionSnapshotAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionSnapshotAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionSnapshotAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionSnapshotAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionSnapshotAllOf>() {
           @Override
           public void write(JsonWriter out, DropletActionSnapshotAllOf value) throws IOException {
           ...
           @Override
           public DropletActionSnapshotAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionSnapshotAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionSnapshotAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionSnapshotAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletActionSnapshotAllOf
  */
  public static DropletActionSnapshotAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionSnapshotAllOf.class);
  }

 /**
  * Convert an instance of DropletActionSnapshotAllOf to an JSON string
  *
  * @return JSON string
  */
