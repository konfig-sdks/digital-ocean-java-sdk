...
public class AppsDeploymentsResponse {
  ...
  **/
   ...
   * @return the AppsDeploymentsResponse instance itself
   */
  public AppsDeploymentsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deployments, appsDeploymentsResponse.deployments) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deployments, links, meta, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentsResponse is not found in the empty JSON string", AppsDeploymentsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppsDeploymentsResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("deployments") != null && !jsonObj.get("deployments").isJsonNull()) {
        ...
        if (jsonArraydeployments != null) {
          ...
          for (int i = 0; i < jsonArraydeployments.size(); i++) {
            AppsDeployment.validateJsonObject(jsonArraydeployments.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentsResponse>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentsResponse value) throws IOException {
           ...
           @Override
           public AppsDeploymentsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentsResponse
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentsResponse
  */
  public static AppsDeploymentsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentsResponse.class);
  }

 /**
  * Convert an instance of AppsDeploymentsResponse to an JSON string
  *
  * @return JSON string
  */
