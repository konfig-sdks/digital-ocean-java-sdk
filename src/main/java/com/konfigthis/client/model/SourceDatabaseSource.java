...
public class SourceDatabaseSource {
  ...
  public SourceDatabaseSource host(String host) {
  ...
  **/
  ...
  public SourceDatabaseSource port(Integer port) {
  ...
  **/
  ...
  public SourceDatabaseSource dbname(String dbname) {
  ...
  **/
  ...
  public SourceDatabaseSource username(String username) {
  ...
  **/
  ...
  public SourceDatabaseSource password(String password) {
  ...
  **/
   ...
   * @return the SourceDatabaseSource instance itself
   */
  public SourceDatabaseSource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.host, sourceDatabaseSource.host) &&
        Objects.equals(this.port, sourceDatabaseSource.port) &&
        Objects.equals(this.dbname, sourceDatabaseSource.dbname) &&
        Objects.equals(this.username, sourceDatabaseSource.username) &&
        Objects.equals(this.password, sourceDatabaseSource.password)&&
        Objects.equals(this.additionalProperties, sourceDatabaseSource.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(host, port, dbname, username, password, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SourceDatabaseSource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SourceDatabaseSource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceDatabaseSource is not found in the empty JSON string", SourceDatabaseSource.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceDatabaseSource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceDatabaseSource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceDatabaseSource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceDatabaseSource.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceDatabaseSource>() {
           @Override
           public void write(JsonWriter out, SourceDatabaseSource value) throws IOException {
           ...
           @Override
           public SourceDatabaseSource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SourceDatabaseSource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SourceDatabaseSource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SourceDatabaseSource
  * @throws IOException if the JSON string is invalid with respect to SourceDatabaseSource
  */
  public static SourceDatabaseSource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceDatabaseSource.class);
  }

 /**
  * Convert an instance of SourceDatabaseSource to an JSON string
  *
  * @return JSON string
  */
