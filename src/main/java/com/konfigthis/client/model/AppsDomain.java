...
import com.konfigthis.client.model.AppDomainValidation;
import com.konfigthis.client.model.AppsDomainPhase;
import com.konfigthis.client.model.AppsDomainProgress;
...
public class AppsDomain {
  ...
  private List<AppDomainValidation> validations = null;

  public static final String SERIALIZED_NAME_ROTATE_VALIDATION_RECORDS = "rotate_validation_records";
  @SerializedName(SERIALIZED_NAME_ROTATE_VALIDATION_RECORDS)
  private Boolean rotateValidationRecords;

  public static final String SERIALIZED_NAME_CERTIFICATE_EXPIRES_AT = "certificate_expires_at";
  ...
  public AppsDomain(
     Boolean rotateValidationRecords, 
  ...
  **/
  ...
  public AppsDomain validations(List<AppDomainValidation> validations) {
  ...
  public AppsDomain addValidationsItem(AppDomainValidation validationsItem) {
  ...
  **/
  ...
  public List<AppDomainValidation> getValidations() {
    return validations;
  }


  public void setValidations(List<AppDomainValidation> validations) {
   ...
   /**
   * Get rotateValidationRecords
   * @return rotateValidationRecords
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Boolean getRotateValidationRecords() {
    return rotateValidationRecords;
  }
   ...
   /**
   * Get certificateExpiresAt
   * @return certificateExpiresAt
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2024-01-29T23:59:59Z", value = "")
   ...
   * @return the AppsDomain instance itself
   */
  public AppsDomain putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, appsDomain.id) &&
        Objects.equals(this.phase, appsDomain.phase) &&
        Objects.equals(this.progress, appsDomain.progress) &&
        Objects.equals(this.spec, appsDomain.spec) &&
        Objects.equals(this.validations, appsDomain.validations) &&
        Objects.equals(this.rotateValidationRecords, appsDomain.rotateValidationRecords) &&
        Objects.equals(this.certificateExpiresAt, appsDomain.certificateExpiresAt)&&
        Objects.equals(this.additionalProperties, appsDomain.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, phase, progress, spec, validations, rotateValidationRecords, certificateExpiresAt, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    rotateValidationRecords: ").append(toIndentedString(rotateValidationRecords)).append("\n");
  ...
  static {
    ...
    openapiFields.add("rotate_validation_records");
    openapiFields.add("certificate_expires_at");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDomain
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDomain.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDomain is not found in the empty JSON string", AppsDomain.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("progress") != null && !jsonObj.get("progress").isJsonNull()) {
        AppsDomainProgress.validateJsonObject(jsonObj.getAsJsonObject("progress"));
      }
      // validate the optional field `spec`
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        AppDomainSpec.validateJsonObject(jsonObj.getAsJsonObject("spec"));
      }
      if (jsonObj.get("validations") != null && !jsonObj.get("validations").isJsonNull()) {
        ...
        if (jsonArrayvalidations != null) {
          ...
          for (int i = 0; i < jsonArrayvalidations.size(); i++) {
            AppDomainValidation.validateJsonObject(jsonArrayvalidations.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDomain.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDomain' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDomain> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDomain.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDomain>() {
           @Override
           public void write(JsonWriter out, AppsDomain value) throws IOException {
           ...
           @Override
           public AppsDomain read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDomain instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDomain given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDomain
  * @throws IOException if the JSON string is invalid with respect to AppsDomain
  */
  public static AppsDomain fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDomain.class);
  }

 /**
  * Convert an instance of AppsDomain to an JSON string
  *
  * @return JSON string
  */
