...
import com.konfigthis.client.model.AppAlert;
...
public class AppsListAlertsResponse {
  ...
  **/
   ...
   * @return the AppsListAlertsResponse instance itself
   */
  public AppsListAlertsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alerts, appsListAlertsResponse.alerts)&&
        Objects.equals(this.additionalProperties, appsListAlertsResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsListAlertsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsListAlertsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsListAlertsResponse is not found in the empty JSON string", AppsListAlertsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("alerts") != null && !jsonObj.get("alerts").isJsonNull()) {
        ...
        if (jsonArrayalerts != null) {
          ...
          for (int i = 0; i < jsonArrayalerts.size(); i++) {
            AppAlert.validateJsonObject(jsonArrayalerts.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsListAlertsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsListAlertsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsListAlertsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsListAlertsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsListAlertsResponse>() {
           @Override
           public void write(JsonWriter out, AppsListAlertsResponse value) throws IOException {
           ...
           @Override
           public AppsListAlertsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsListAlertsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsListAlertsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsListAlertsResponse
  * @throws IOException if the JSON string is invalid with respect to AppsListAlertsResponse
  */
  public static AppsListAlertsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsListAlertsResponse.class);
  }

 /**
  * Convert an instance of AppsListAlertsResponse to an JSON string
  *
  * @return JSON string
  */
