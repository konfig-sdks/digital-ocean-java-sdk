...
public class AppsResponse {
  ...
  **/
   ...
   * @return the AppsResponse instance itself
   */
  public AppsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apps, appsResponse.apps) &&
        Objects.equals(this.links, appsResponse.links) &&
        Objects.equals(this.meta, appsResponse.meta)&&
        Objects.equals(this.additionalProperties, appsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apps, links, meta, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppsResponse>() {
           ...
           public AppsResponse read(JsonReader in) throws IOException {
             ...
             AppsResponse instance = thisAdapter.fromJsonTree(jsonObj);
