...
public class SlackDetails {
  ...
  **/
   ...
   * @return the SlackDetails instance itself
   */
  public SlackDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channel, slackDetails.channel) &&
        Objects.equals(this.url, slackDetails.url)&&
        Objects.equals(this.additionalProperties, slackDetails.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SlackDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SlackDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SlackDetails is not found in the empty JSON string", SlackDetails.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SlackDetails.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SlackDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SlackDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SlackDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SlackDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<SlackDetails>() {
           @Override
           public void write(JsonWriter out, SlackDetails value) throws IOException {
           ...
           @Override
           public SlackDetails read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SlackDetails instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SlackDetails given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SlackDetails
  * @throws IOException if the JSON string is invalid with respect to SlackDetails
  */
  public static SlackDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SlackDetails.class);
  }

 /**
  * Convert an instance of SlackDetails to an JSON string
  *
  * @return JSON string
  */
