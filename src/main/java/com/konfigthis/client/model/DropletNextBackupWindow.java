 ...
 */
@ApiModel(description = "The details of the Droplet's backups feature, if backups are configured for the Droplet. This object contains keys for the start and end times of the window during which the backup will start.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DropletNextBackupWindow {
  ...
  **/
   ...
   * @return the DropletNextBackupWindow instance itself
   */
  public DropletNextBackupWindow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, dropletNextBackupWindow.start) &&
        ...
        Objects.equals(this.additionalProperties, dropletNextBackupWindow.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletNextBackupWindow
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletNextBackupWindow.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletNextBackupWindow is not found in the empty JSON string", DropletNextBackupWindow.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletNextBackupWindow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletNextBackupWindow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletNextBackupWindow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletNextBackupWindow.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletNextBackupWindow>() {
           @Override
           public void write(JsonWriter out, DropletNextBackupWindow value) throws IOException {
           ...
           @Override
           public DropletNextBackupWindow read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletNextBackupWindow instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletNextBackupWindow given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletNextBackupWindow
  * @throws IOException if the JSON string is invalid with respect to DropletNextBackupWindow
  */
  public static DropletNextBackupWindow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletNextBackupWindow.class);
  }

 /**
  * Convert an instance of DropletNextBackupWindow to an JSON string
  *
  * @return JSON string
  */
