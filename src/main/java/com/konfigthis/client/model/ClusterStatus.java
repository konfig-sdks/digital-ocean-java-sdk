 ...
 */
@ApiModel(description = "An object containing a `state` attribute whose value is set to a string indicating the current status of the cluster.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ClusterStatus {
  ...
  **/
   ...
   * @return the ClusterStatus instance itself
   */
  public ClusterStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.state, clusterStatus.state) &&
        Objects.equals(this.message, clusterStatus.message)&&
        Objects.equals(this.additionalProperties, clusterStatus.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClusterStatus>() {
           ...
           public ClusterStatus read(JsonReader in) throws IOException {
             ...
             ClusterStatus instance = thisAdapter.fromJsonTree(jsonObj);
