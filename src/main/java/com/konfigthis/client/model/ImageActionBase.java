...
public class ImageActionBase {
  ...
  **/
   ...
   * @return the ImageActionBase instance itself
   */
  public ImageActionBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, imageActionBase.type)&&
        Objects.equals(this.additionalProperties, imageActionBase.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionBase is not found in the empty JSON string", ImageActionBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageActionBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionBase>() {
           @Override
           public void write(JsonWriter out, ImageActionBase value) throws IOException {
           ...
           @Override
           public ImageActionBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionBase
  * @throws IOException if the JSON string is invalid with respect to ImageActionBase
  */
  public static ImageActionBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionBase.class);
  }

 /**
  * Convert an instance of ImageActionBase to an JSON string
  *
  * @return JSON string
  */
