...
public class DropletActionResizeAllOf {
  ...
  **/
   ...
   * @return the DropletActionResizeAllOf instance itself
   */
  public DropletActionResizeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disk, dropletActionResizeAllOf.disk) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionResizeAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(disk, size, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionResizeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionResizeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionResizeAllOf is not found in the empty JSON string", DropletActionResizeAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionResizeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionResizeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionResizeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionResizeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionResizeAllOf>() {
           @Override
           public void write(JsonWriter out, DropletActionResizeAllOf value) throws IOException {
           ...
           @Override
           public DropletActionResizeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionResizeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionResizeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionResizeAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletActionResizeAllOf
  */
  public static DropletActionResizeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionResizeAllOf.class);
  }

 /**
  * Convert an instance of DropletActionResizeAllOf to an JSON string
  *
  * @return JSON string
  */
