...
import com.konfigthis.client.model.AppsDeploymentFunctions;
import com.konfigthis.client.model.AppsDeploymentJob;
import com.konfigthis.client.model.AppsDeploymentPhase;
import com.konfigthis.client.model.AppsDeploymentProgress;
import com.konfigthis.client.model.AppsDeploymentService;
import com.konfigthis.client.model.AppsDeploymentStaticSite;
import com.konfigthis.client.model.AppsDeploymentWorker;
...
public class AppPendingDeployment {
  ...
  public static final String SERIALIZED_NAME_PHASE_LAST_UPDATED_AT = "phase_last_updated_at";
  @SerializedName(SERIALIZED_NAME_PHASE_LAST_UPDATED_AT)
  ...
  public AppPendingDeployment cause(String cause) {
  ...
  **/
  ...
  public AppPendingDeployment clonedFrom(String clonedFrom) {
  ...
  **/
  ...
  public AppPendingDeployment createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public AppPendingDeployment id(String id) {
  ...
  **/
  ...
  public AppPendingDeployment jobs(List<AppsDeploymentJob> jobs) {
  ...
  public AppPendingDeployment addJobsItem(AppsDeploymentJob jobsItem) {
    if (this.jobs == null) {
  ...
  **/
  ...
  public AppPendingDeployment functions(List<AppsDeploymentFunctions> functions) {
  ...
  public AppPendingDeployment addFunctionsItem(AppsDeploymentFunctions functionsItem) {
  ...
  **/
  ...
  public AppPendingDeployment phase(AppsDeploymentPhase phase) {
  ...
  **/
  ...
  public AppPendingDeployment phaseLastUpdatedAt(OffsetDateTime phaseLastUpdatedAt) {
  ...
  **/
  ...
  public AppPendingDeployment progress(AppsDeploymentProgress progress) {
  ...
  **/
  ...
  public AppPendingDeployment services(List<AppsDeploymentService> services) {
  ...
  public AppPendingDeployment addServicesItem(AppsDeploymentService servicesItem) {
  ...
  **/
  ...
  public AppPendingDeployment spec(AppSpec spec) {
  ...
  **/
  ...
  public AppPendingDeployment staticSites(List<AppsDeploymentStaticSite> staticSites) {
  ...
  public AppPendingDeployment addStaticSitesItem(AppsDeploymentStaticSite staticSitesItem) {
  ...
  **/
  ...
  public AppPendingDeployment updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public AppPendingDeployment workers(List<AppsDeploymentWorker> workers) {
  ...
  public AppPendingDeployment addWorkersItem(AppsDeploymentWorker workersItem) {
  ...
  **/
   ...
   * @return the AppPendingDeployment instance itself
   */
  public AppPendingDeployment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppPendingDeployment appPendingDeployment = (AppPendingDeployment) o;
    return Objects.equals(this.cause, appPendingDeployment.cause) &&
        Objects.equals(this.clonedFrom, appPendingDeployment.clonedFrom) &&
        Objects.equals(this.createdAt, appPendingDeployment.createdAt) &&
        Objects.equals(this.id, appPendingDeployment.id) &&
        Objects.equals(this.jobs, appPendingDeployment.jobs) &&
        Objects.equals(this.functions, appPendingDeployment.functions) &&
        Objects.equals(this.phase, appPendingDeployment.phase) &&
        Objects.equals(this.phaseLastUpdatedAt, appPendingDeployment.phaseLastUpdatedAt) &&
        Objects.equals(this.progress, appPendingDeployment.progress) &&
        Objects.equals(this.services, appPendingDeployment.services) &&
        Objects.equals(this.spec, appPendingDeployment.spec) &&
        Objects.equals(this.staticSites, appPendingDeployment.staticSites) &&
        Objects.equals(this.tierSlug, appPendingDeployment.tierSlug) &&
        Objects.equals(this.updatedAt, appPendingDeployment.updatedAt) &&
        Objects.equals(this.workers, appPendingDeployment.workers)&&
        Objects.equals(this.additionalProperties, appPendingDeployment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cause, clonedFrom, createdAt, id, jobs, functions, phase, phaseLastUpdatedAt, progress, services, spec, staticSites, tierSlug, updatedAt, workers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppPendingDeployment {\n");
  ...
  static {
    ...
    openapiFields.add("phase_last_updated_at");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppPendingDeployment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppPendingDeployment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppPendingDeployment is not found in the empty JSON string", AppPendingDeployment.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("cloned_from") != null && !jsonObj.get("cloned_from").isJsonNull()) && !jsonObj.get("cloned_from").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `cloned_from` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cloned_from").toString()));
      }
      ...
      if (jsonObj.get("jobs") != null && !jsonObj.get("jobs").isJsonNull()) {
        ...
        if (jsonArrayjobs != null) {
          ...
          for (int i = 0; i < jsonArrayjobs.size(); i++) {
            AppsDeploymentJob.validateJsonObject(jsonArrayjobs.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("functions") != null && !jsonObj.get("functions").isJsonNull()) {
        ...
        if (jsonArrayfunctions != null) {
          ...
          for (int i = 0; i < jsonArrayfunctions.size(); i++) {
            AppsDeploymentFunctions.validateJsonObject(jsonArrayfunctions.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `progress`
      if (jsonObj.get("progress") != null && !jsonObj.get("progress").isJsonNull()) {
        AppsDeploymentProgress.validateJsonObject(jsonObj.getAsJsonObject("progress"));
      }
      if (jsonObj.get("services") != null && !jsonObj.get("services").isJsonNull()) {
        ...
        if (jsonArrayservices != null) {
          ...
          for (int i = 0; i < jsonArrayservices.size(); i++) {
            AppsDeploymentService.validateJsonObject(jsonArrayservices.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("static_sites") != null && !jsonObj.get("static_sites").isJsonNull()) {
        ...
        if (jsonArraystaticSites != null) {
          ...
          for (int i = 0; i < jsonArraystaticSites.size(); i++) {
            AppsDeploymentStaticSite.validateJsonObject(jsonArraystaticSites.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("workers") != null && !jsonObj.get("workers").isJsonNull()) {
        ...
        if (jsonArrayworkers != null) {
          ...
          for (int i = 0; i < jsonArrayworkers.size(); i++) {
            AppsDeploymentWorker.validateJsonObject(jsonArrayworkers.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppPendingDeployment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppPendingDeployment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppPendingDeployment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppPendingDeployment.class));

       return (TypeAdapter<T>) new TypeAdapter<AppPendingDeployment>() {
           @Override
           public void write(JsonWriter out, AppPendingDeployment value) throws IOException {
           ...
           @Override
           public AppPendingDeployment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppPendingDeployment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppPendingDeployment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppPendingDeployment
  * @throws IOException if the JSON string is invalid with respect to AppPendingDeployment
  */
  public static AppPendingDeployment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppPendingDeployment.class);
  }

 /**
  * Convert an instance of AppPendingDeployment to an JSON string
  *
  * @return JSON string
  */
