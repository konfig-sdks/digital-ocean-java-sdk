...
public class Credentials {
  ...
  public static final String SERIALIZED_NAME_CERTIFICATE_AUTHORITY_DATA = "certificate_authority_data";
  @SerializedName(SERIALIZED_NAME_CERTIFICATE_AUTHORITY_DATA)
  private byte[] certificateAuthorityData;

  public static final String SERIALIZED_NAME_CLIENT_CERTIFICATE_DATA = "client_certificate_data";
  @SerializedName(SERIALIZED_NAME_CLIENT_CERTIFICATE_DATA)
  private byte[] clientCertificateData;

  public static final String SERIALIZED_NAME_CLIENT_KEY_DATA = "client_key_data";
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[B@65cff806", value = "A base64 encoding of bytes representing the certificate authority data for accessing the cluster.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(server, Arrays.hashCode(certificateAuthorityData), Arrays.hashCode(clientCertificateData), Arrays.hashCode(clientKeyData), token, expiresAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("certificate_authority_data");
    openapiFields.add("client_certificate_data");
    openapiFields.add("client_key_data");
