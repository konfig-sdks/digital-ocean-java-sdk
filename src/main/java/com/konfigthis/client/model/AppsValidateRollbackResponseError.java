...
public class AppsValidateRollbackResponseError {
 ...
 public enum CodeEnum {
  ...
  public AppsValidateRollbackResponseError components(List<String> components) {
  ...
  public AppsValidateRollbackResponseError addComponentsItem(String componentsItem) {
  ...
  **/
  ...
  public AppsValidateRollbackResponseError code(CodeEnum code) {
  ...
  **/
  ...
  public AppsValidateRollbackResponseError message(String message) {
  ...
  **/
   ...
   * @return the AppsValidateRollbackResponseError instance itself
   */
  public AppsValidateRollbackResponseError putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppsValidateRollbackResponseError appsValidateRollbackResponseError = (AppsValidateRollbackResponseError) o;
    return Objects.equals(this.components, appsValidateRollbackResponseError.components) &&
        Objects.equals(this.code, appsValidateRollbackResponseError.code) &&
        Objects.equals(this.message, appsValidateRollbackResponseError.message)&&
        Objects.equals(this.additionalProperties, appsValidateRollbackResponseError.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(components, code, message, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppsValidateRollbackResponseError {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsValidateRollbackResponseError
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsValidateRollbackResponseError.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsValidateRollbackResponseError is not found in the empty JSON string", AppsValidateRollbackResponseError.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsValidateRollbackResponseError.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsValidateRollbackResponseError' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsValidateRollbackResponseError> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsValidateRollbackResponseError.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsValidateRollbackResponseError>() {
           @Override
           public void write(JsonWriter out, AppsValidateRollbackResponseError value) throws IOException {
           ...
           @Override
           public AppsValidateRollbackResponseError read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsValidateRollbackResponseError instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsValidateRollbackResponseError given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsValidateRollbackResponseError
  * @throws IOException if the JSON string is invalid with respect to AppsValidateRollbackResponseError
  */
  public static AppsValidateRollbackResponseError fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsValidateRollbackResponseError.class);
  }

 /**
  * Convert an instance of AppsValidateRollbackResponseError to an JSON string
  *
  * @return JSON string
  */
