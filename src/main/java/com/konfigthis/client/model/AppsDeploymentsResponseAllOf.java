...
public class AppsDeploymentsResponseAllOf {
  ...
  **/
   ...
   * @return the AppsDeploymentsResponseAllOf instance itself
   */
  public AppsDeploymentsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deployments, appsDeploymentsResponseAllOf.deployments)&&
        Objects.equals(this.additionalProperties, appsDeploymentsResponseAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentsResponseAllOf is not found in the empty JSON string", AppsDeploymentsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentsResponseAllOf value) throws IOException {
           ...
           @Override
           public AppsDeploymentsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentsResponseAllOf
  */
  public static AppsDeploymentsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentsResponseAllOf.class);
  }

 /**
  * Convert an instance of AppsDeploymentsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
