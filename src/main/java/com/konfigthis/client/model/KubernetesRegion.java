...
public class KubernetesRegion {
  ...
  **/
   ...
   * @return the KubernetesRegion instance itself
   */
  public KubernetesRegion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, kubernetesRegion.name) &&
        Objects.equals(this.slug, kubernetesRegion.slug)&&
        Objects.equals(this.additionalProperties, kubernetesRegion.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesRegion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesRegion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesRegion is not found in the empty JSON string", KubernetesRegion.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesRegion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesRegion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesRegion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesRegion.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesRegion>() {
           @Override
           public void write(JsonWriter out, KubernetesRegion value) throws IOException {
           ...
           @Override
           public KubernetesRegion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesRegion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesRegion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesRegion
  * @throws IOException if the JSON string is invalid with respect to KubernetesRegion
  */
  public static KubernetesRegion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesRegion.class);
  }

 /**
  * Convert an instance of KubernetesRegion to an JSON string
  *
  * @return JSON string
  */
