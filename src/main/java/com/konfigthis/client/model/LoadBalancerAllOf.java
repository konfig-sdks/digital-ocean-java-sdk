...
public class LoadBalancerAllOf {
  ...
  public LoadBalancerAllOf region(Object region) {
  ...
  public LoadBalancerAllOf putRegionItem(String key,  regionItem) {
    if (this.region == null) {
      this.region = ;
    }
  ...
  **/
   ...
   * @return the LoadBalancerAllOf instance itself
   */
  public LoadBalancerAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.region, loadBalancerAllOf.region)&&
        Objects.equals(this.additionalProperties, loadBalancerAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerAllOf is not found in the empty JSON string", LoadBalancerAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerAllOf>() {
           @Override
           public void write(JsonWriter out, LoadBalancerAllOf value) throws IOException {
           ...
           @Override
           public LoadBalancerAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerAllOf
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerAllOf
  */
  public static LoadBalancerAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerAllOf.class);
  }

 /**
  * Convert an instance of LoadBalancerAllOf to an JSON string
  *
  * @return JSON string
  */
