...
public class ProjectAllOf {
  ...
  **/
   ...
   * @return the ProjectAllOf instance itself
   */
  public ProjectAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isDefault, projectAllOf.isDefault)&&
        Objects.equals(this.additionalProperties, projectAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectAllOf is not found in the empty JSON string", ProjectAllOf.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectAllOf>() {
           @Override
           public void write(JsonWriter out, ProjectAllOf value) throws IOException {
           ...
           @Override
           public ProjectAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProjectAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProjectAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectAllOf
  * @throws IOException if the JSON string is invalid with respect to ProjectAllOf
  */
  public static ProjectAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectAllOf.class);
  }

 /**
  * Convert an instance of ProjectAllOf to an JSON string
  *
  * @return JSON string
  */
