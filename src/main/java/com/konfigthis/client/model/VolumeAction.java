...
public class VolumeAction {
  ...
  **/
   ...
   * @return the VolumeAction instance itself
   */
  public VolumeAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, volumeAction.type) &&
        Objects.equals(this.resourceId, volumeAction.resourceId) &&
        Objects.equals(this.id, volumeAction.id) &&
        Objects.equals(this.status, volumeAction.status) &&
        ...
        Objects.equals(this.additionalProperties, volumeAction.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, resourceId, id, status, startedAt, completedAt, resourceType, region, regionSlug, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeAction is not found in the empty JSON string", VolumeAction.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeAction.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeAction>() {
           @Override
           public void write(JsonWriter out, VolumeAction value) throws IOException {
           ...
           @Override
           public VolumeAction read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeAction instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeAction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeAction
  * @throws IOException if the JSON string is invalid with respect to VolumeAction
  */
  public static VolumeAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeAction.class);
  }

 /**
  * Convert an instance of VolumeAction to an JSON string
  *
  * @return JSON string
  */
