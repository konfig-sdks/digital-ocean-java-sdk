...
public class VolumeActionAllOf {
  ...
  **/
   ...
   * @return the VolumeActionAllOf instance itself
   */
  public VolumeActionAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, volumeActionAllOf.type) &&
        ...
        Objects.equals(this.additionalProperties, volumeActionAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, resourceId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionAllOf is not found in the empty JSON string", VolumeActionAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionAllOf>() {
           @Override
           public void write(JsonWriter out, VolumeActionAllOf value) throws IOException {
           ...
           @Override
           public VolumeActionAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionAllOf
  * @throws IOException if the JSON string is invalid with respect to VolumeActionAllOf
  */
  public static VolumeActionAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionAllOf.class);
  }

 /**
  * Convert an instance of VolumeActionAllOf to an JSON string
  *
  * @return JSON string
  */
