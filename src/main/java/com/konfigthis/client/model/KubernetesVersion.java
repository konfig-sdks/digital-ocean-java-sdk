...
public class KubernetesVersion {
  ...
  public static final String SERIALIZED_NAME_KUBERNETES_VERSION = "kubernetes_version";
  ...
  **/
   ...
   * @return the KubernetesVersion instance itself
   */
  public KubernetesVersion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.slug, kubernetesVersion.slug) &&
        ...
        Objects.equals(this.additionalProperties, kubernetesVersion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(slug, kubernetesVersion, supportedFeatures, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("kubernetes_version");
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesVersion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesVersion is not found in the empty JSON string", KubernetesVersion.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("slug") != null && !jsonObj.get("slug").isJsonNull()) && !jsonObj.get("slug").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `slug` to be a primitive type in the JSON string but got `%s`", jsonObj.get("slug").toString()));
      }
      if ((jsonObj.get("kubernetes_version") != null && !jsonObj.get("kubernetes_version").isJsonNull()) && !jsonObj.get("kubernetes_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `kubernetes_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kubernetes_version").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("supported_features") != null && !jsonObj.get("supported_features").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesVersion>() {
           @Override
           public void write(JsonWriter out, KubernetesVersion value) throws IOException {
           ...
           @Override
           public KubernetesVersion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesVersion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesVersion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesVersion
  * @throws IOException if the JSON string is invalid with respect to KubernetesVersion
  */
  public static KubernetesVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesVersion.class);
  }

 /**
  * Convert an instance of KubernetesVersion to an JSON string
  *
  * @return JSON string
  */
