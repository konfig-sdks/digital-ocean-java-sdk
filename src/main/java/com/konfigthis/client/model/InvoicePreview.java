 ...
 * The invoice preview.
 */
@ApiModel(description = "The invoice preview.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class InvoicePreview {
  ...
  **/
  ...
  public InvoicePreview invoiceId(String invoiceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456789", value = "ID of the invoice. Listed on the face of the invoice PDF as the \"Invoice number\".")
  ...
  **/
   ...
   * @return the InvoicePreview instance itself
   */
  public InvoicePreview putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoiceUuid, invoicePreview.invoiceUuid) &&
        Objects.equals(this.invoiceId, invoicePreview.invoiceId) &&
        ...
        Objects.equals(this.additionalProperties, invoicePreview.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceUuid, invoiceId, amount, invoicePeriod, updatedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoicePreview
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoicePreview.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoicePreview is not found in the empty JSON string", InvoicePreview.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("invoice_period") != null && !jsonObj.get("invoice_period").isJsonNull()) && !jsonObj.get("invoice_period").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoicePreview.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoicePreview' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoicePreview> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoicePreview.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoicePreview>() {
           @Override
           public void write(JsonWriter out, InvoicePreview value) throws IOException {
           ...
           @Override
           public InvoicePreview read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoicePreview instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoicePreview given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoicePreview
  * @throws IOException if the JSON string is invalid with respect to InvoicePreview
  */
  public static InvoicePreview fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoicePreview.class);
  }

 /**
  * Convert an instance of InvoicePreview to an JSON string
  *
  * @return JSON string
  */
