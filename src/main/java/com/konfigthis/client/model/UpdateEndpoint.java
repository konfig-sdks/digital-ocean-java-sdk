...
public class UpdateEndpoint {
  ...
  **/
   ...
   * @return the UpdateEndpoint instance itself
   */
  public UpdateEndpoint putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ttl, updateEndpoint.ttl) &&
        ...
        Objects.equals(this.additionalProperties, updateEndpoint.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ttl, certificateId, customDomain, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateEndpoint
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateEndpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateEndpoint>() {
           ...
           public UpdateEndpoint read(JsonReader in) throws IOException {
             ...
             UpdateEndpoint instance = thisAdapter.fromJsonTree(jsonObj);
