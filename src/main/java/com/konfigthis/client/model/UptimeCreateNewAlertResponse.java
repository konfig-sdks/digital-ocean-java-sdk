...
public class UptimeCreateNewAlertResponse {
  public static final String SERIALIZED_NAME_ALERT = "alert";
  @SerializedName(SERIALIZED_NAME_ALERT)
  private Alert alert;

  public UptimeCreateNewAlertResponse() {
  }

  public UptimeCreateNewAlertResponse alert(Alert alert) {
  ...
  **/
   ...
   * @return the UptimeCreateNewAlertResponse instance itself
   */
  public UptimeCreateNewAlertResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UptimeCreateNewAlertResponse uptimeCreateNewAlertResponse = (UptimeCreateNewAlertResponse) o;
    return Objects.equals(this.alert, uptimeCreateNewAlertResponse.alert)&&
        Objects.equals(this.additionalProperties, uptimeCreateNewAlertResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UptimeCreateNewAlertResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UptimeCreateNewAlertResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UptimeCreateNewAlertResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UptimeCreateNewAlertResponse is not found in the empty JSON string", UptimeCreateNewAlertResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `alert`
      if (jsonObj.get("alert") != null && !jsonObj.get("alert").isJsonNull()) {
        Alert.validateJsonObject(jsonObj.getAsJsonObject("alert"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UptimeCreateNewAlertResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UptimeCreateNewAlertResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UptimeCreateNewAlertResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UptimeCreateNewAlertResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UptimeCreateNewAlertResponse>() {
           @Override
           public void write(JsonWriter out, UptimeCreateNewAlertResponse value) throws IOException {
           ...
           @Override
           public UptimeCreateNewAlertResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UptimeCreateNewAlertResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UptimeCreateNewAlertResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UptimeCreateNewAlertResponse
  * @throws IOException if the JSON string is invalid with respect to UptimeCreateNewAlertResponse
  */
  public static UptimeCreateNewAlertResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UptimeCreateNewAlertResponse.class);
  }

 /**
  * Convert an instance of UptimeCreateNewAlertResponse to an JSON string
  *
  * @return JSON string
  */
