...
public class ImageNewCustomAllOf {
  ...
  **/
   ...
   * @return the ImageNewCustomAllOf instance itself
   */
  public ImageNewCustomAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, imageNewCustomAllOf.tags) &&
        Objects.equals(this.url, imageNewCustomAllOf.url) &&
        Objects.equals(this.region, imageNewCustomAllOf.region)&&
        Objects.equals(this.additionalProperties, imageNewCustomAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, url, region, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageNewCustomAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageNewCustomAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageNewCustomAllOf is not found in the empty JSON string", ImageNewCustomAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageNewCustomAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageNewCustomAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageNewCustomAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageNewCustomAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageNewCustomAllOf>() {
           @Override
           public void write(JsonWriter out, ImageNewCustomAllOf value) throws IOException {
           ...
           @Override
           public ImageNewCustomAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageNewCustomAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageNewCustomAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageNewCustomAllOf
  * @throws IOException if the JSON string is invalid with respect to ImageNewCustomAllOf
  */
  public static ImageNewCustomAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageNewCustomAllOf.class);
  }

 /**
  * Convert an instance of ImageNewCustomAllOf to an JSON string
  *
  * @return JSON string
  */
