 ...
 */
@ApiModel(description = "An object specifying the maintenance window policy for the Kubernetes cluster.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MaintenancePolicy {
  ...
  **/
  ...
  @ApiModelProperty(example = "720", value = "The start time in UTC of the maintenance window policy in 24-hour clock format / HH:MM notation (e.g., `15:00`).")
  ...
  **/
   ...
   * @return the MaintenancePolicy instance itself
   */
  public MaintenancePolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startTime, maintenancePolicy.startTime) &&
        ...
        Objects.equals(this.additionalProperties, maintenancePolicy.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MaintenancePolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MaintenancePolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MaintenancePolicy>() {
           ...
           public MaintenancePolicy read(JsonReader in) throws IOException {
             ...
             MaintenancePolicy instance = thisAdapter.fromJsonTree(jsonObj);
