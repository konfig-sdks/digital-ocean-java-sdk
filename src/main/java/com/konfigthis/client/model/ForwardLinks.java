...
public class ForwardLinks {
  ...
  **/
   ...
   * @return the ForwardLinks instance itself
   */
  public ForwardLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.last, forwardLinks.last) &&
        Objects.equals(this.next, forwardLinks.next)&&
        Objects.equals(this.additionalProperties, forwardLinks.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(last, next, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ForwardLinks
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ForwardLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ForwardLinks is not found in the empty JSON string", ForwardLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForwardLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForwardLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForwardLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForwardLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<ForwardLinks>() {
           @Override
           public void write(JsonWriter out, ForwardLinks value) throws IOException {
           ...
           @Override
           public ForwardLinks read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ForwardLinks instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ForwardLinks given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ForwardLinks
  * @throws IOException if the JSON string is invalid with respect to ForwardLinks
  */
  public static ForwardLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForwardLinks.class);
  }

 /**
  * Convert an instance of ForwardLinks to an JSON string
  *
  * @return JSON string
  */
