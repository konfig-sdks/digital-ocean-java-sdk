...
import com.konfigthis.client.model.SubscriptionTierBase;
...
public class RegistrySubscription {
  ...
  **/
   ...
   * @return the RegistrySubscription instance itself
   */
  public RegistrySubscription putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tier, registrySubscription.tier) &&
        ...
        Objects.equals(this.additionalProperties, registrySubscription.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tier, createdAt, updatedAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegistrySubscription
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegistrySubscription.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegistrySubscription is not found in the empty JSON string", RegistrySubscription.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `tier`
      if (jsonObj.get("tier") != null && !jsonObj.get("tier").isJsonNull()) {
        SubscriptionTierBase.validateJsonObject(jsonObj.getAsJsonObject("tier"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegistrySubscription.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegistrySubscription' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegistrySubscription> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegistrySubscription.class));

       return (TypeAdapter<T>) new TypeAdapter<RegistrySubscription>() {
           @Override
           public void write(JsonWriter out, RegistrySubscription value) throws IOException {
           ...
           @Override
           public RegistrySubscription read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RegistrySubscription instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RegistrySubscription given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RegistrySubscription
  * @throws IOException if the JSON string is invalid with respect to RegistrySubscription
  */
  public static RegistrySubscription fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegistrySubscription.class);
  }

 /**
  * Convert an instance of RegistrySubscription to an JSON string
  *
  * @return JSON string
  */
