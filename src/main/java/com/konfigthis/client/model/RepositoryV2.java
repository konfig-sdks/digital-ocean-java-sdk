...
public class RepositoryV2 {
  ...
  public static final String SERIALIZED_NAME_LATEST_MANIFEST = "latest_manifest";
  @SerializedName(SERIALIZED_NAME_LATEST_MANIFEST)
  ...
  public static final String SERIALIZED_NAME_MANIFEST_COUNT = "manifest_count";
  @SerializedName(SERIALIZED_NAME_MANIFEST_COUNT)
  ...
  **/
   ...
   * @return the RepositoryV2 instance itself
   */
  public RepositoryV2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.registryName, repositoryV2.registryName) &&
        ...
        Objects.equals(this.additionalProperties, repositoryV2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(registryName, name, latestManifest, tagCount, manifestCount, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("latest_manifest");
    openapiFields.add("tag_count");
    openapiFields.add("manifest_count");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryV2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryV2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryV2 is not found in the empty JSON string", RepositoryV2.openapiRequiredFields.toString()));
        }
      }
      ...
      // validate the optional field `latest_manifest`
      if (jsonObj.get("latest_manifest") != null && !jsonObj.get("latest_manifest").isJsonNull()) {
        RepositoryManifest.validateJsonObject(jsonObj.getAsJsonObject("latest_manifest"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryV2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryV2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryV2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryV2.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryV2>() {
           @Override
           public void write(JsonWriter out, RepositoryV2 value) throws IOException {
           ...
           @Override
           public RepositoryV2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RepositoryV2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RepositoryV2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryV2
  * @throws IOException if the JSON string is invalid with respect to RepositoryV2
  */
  public static RepositoryV2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryV2.class);
  }

 /**
  * Convert an instance of RepositoryV2 to an JSON string
  *
  * @return JSON string
  */
