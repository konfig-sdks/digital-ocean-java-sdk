...
public class TagsResourcesAllOf {
  ...
  public TagsResourcesAllOf() {
  }

  public TagsResourcesAllOf droplets(TagsMetadata droplets) {
  ...
  **/
  ...
  public TagsResourcesAllOf imgages(TagsMetadata imgages) {
  ...
  **/
  ...
  public TagsResourcesAllOf volumes(TagsMetadata volumes) {
  ...
  **/
  ...
  public TagsResourcesAllOf volumeSnapshots(TagsMetadata volumeSnapshots) {
  ...
  **/
  ...
  public TagsResourcesAllOf databases(TagsMetadata databases) {
  ...
  **/
   ...
   * @return the TagsResourcesAllOf instance itself
   */
  public TagsResourcesAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TagsResourcesAllOf tagsResourcesAllOf = (TagsResourcesAllOf) o;
    return Objects.equals(this.droplets, tagsResourcesAllOf.droplets) &&
        Objects.equals(this.imgages, tagsResourcesAllOf.imgages) &&
        Objects.equals(this.volumes, tagsResourcesAllOf.volumes) &&
        Objects.equals(this.volumeSnapshots, tagsResourcesAllOf.volumeSnapshots) &&
        Objects.equals(this.databases, tagsResourcesAllOf.databases)&&
        Objects.equals(this.additionalProperties, tagsResourcesAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(droplets, imgages, volumes, volumeSnapshots, databases, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TagsResourcesAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagsResourcesAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagsResourcesAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagsResourcesAllOf is not found in the empty JSON string", TagsResourcesAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagsResourcesAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagsResourcesAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagsResourcesAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagsResourcesAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<TagsResourcesAllOf>() {
           @Override
           public void write(JsonWriter out, TagsResourcesAllOf value) throws IOException {
           ...
           @Override
           public TagsResourcesAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TagsResourcesAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TagsResourcesAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TagsResourcesAllOf
  * @throws IOException if the JSON string is invalid with respect to TagsResourcesAllOf
  */
  public static TagsResourcesAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagsResourcesAllOf.class);
  }

 /**
  * Convert an instance of TagsResourcesAllOf to an JSON string
  *
  * @return JSON string
  */
