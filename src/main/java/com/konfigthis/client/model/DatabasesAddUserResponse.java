...
public class DatabasesAddUserResponse {
  ...
  public DatabasesAddUserResponse user(DatabaseUser user) {
  ...
  **/
   ...
   * @return the DatabasesAddUserResponse instance itself
   */
  public DatabasesAddUserResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabasesAddUserResponse databasesAddUserResponse = (DatabasesAddUserResponse) o;
    return Objects.equals(this.user, databasesAddUserResponse.user)&&
        Objects.equals(this.additionalProperties, databasesAddUserResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabasesAddUserResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabasesAddUserResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabasesAddUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasesAddUserResponse is not found in the empty JSON string", DatabasesAddUserResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabasesAddUserResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `user`
      DatabaseUser.validateJsonObject(jsonObj.getAsJsonObject("user"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasesAddUserResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasesAddUserResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasesAddUserResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasesAddUserResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasesAddUserResponse>() {
           @Override
           public void write(JsonWriter out, DatabasesAddUserResponse value) throws IOException {
           ...
           @Override
           public DatabasesAddUserResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabasesAddUserResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabasesAddUserResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabasesAddUserResponse
  * @throws IOException if the JSON string is invalid with respect to DatabasesAddUserResponse
  */
  public static DatabasesAddUserResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasesAddUserResponse.class);
  }

 /**
  * Convert an instance of DatabasesAddUserResponse to an JSON string
  *
  * @return JSON string
  */
