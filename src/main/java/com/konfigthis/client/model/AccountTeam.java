 ...
 */
@ApiModel(description = "When authorized in a team context, includes information about the current team.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AccountTeam {
  ...
  **/
   ...
   * @return the AccountTeam instance itself
   */
  public AccountTeam putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, accountTeam.uuid) &&
        Objects.equals(this.name, accountTeam.name)&&
        Objects.equals(this.additionalProperties, accountTeam.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AccountTeam
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AccountTeam.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccountTeam is not found in the empty JSON string", AccountTeam.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AccountTeam.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AccountTeam' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AccountTeam> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AccountTeam.class));

       return (TypeAdapter<T>) new TypeAdapter<AccountTeam>() {
           @Override
           public void write(JsonWriter out, AccountTeam value) throws IOException {
           ...
           @Override
           public AccountTeam read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AccountTeam instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AccountTeam given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AccountTeam
  * @throws IOException if the JSON string is invalid with respect to AccountTeam
  */
  public static AccountTeam fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AccountTeam.class);
  }

 /**
  * Convert an instance of AccountTeam to an JSON string
  *
  * @return JSON string
  */
