...
public class OneClicks {
  ...
  public OneClicks slug(String slug) {
  ...
  **/
  ...
  public OneClicks type(String type) {
  ...
  **/
   ...
   * @return the OneClicks instance itself
   */
  public OneClicks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OneClicks oneClicks = (OneClicks) o;
    return Objects.equals(this.slug, oneClicks.slug) &&
        Objects.equals(this.type, oneClicks.type)&&
        Objects.equals(this.additionalProperties, oneClicks.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to OneClicks
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OneClicks.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OneClicks is not found in the empty JSON string", OneClicks.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OneClicks.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OneClicks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OneClicks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OneClicks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OneClicks.class));

       return (TypeAdapter<T>) new TypeAdapter<OneClicks>() {
           @Override
           public void write(JsonWriter out, OneClicks value) throws IOException {
           ...
           @Override
           public OneClicks read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OneClicks instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OneClicks given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OneClicks
  * @throws IOException if the JSON string is invalid with respect to OneClicks
  */
  public static OneClicks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OneClicks.class);
  }

 /**
  * Convert an instance of OneClicks to an JSON string
  *
  * @return JSON string
  */
