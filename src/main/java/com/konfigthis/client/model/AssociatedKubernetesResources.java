...
import com.konfigthis.client.model.AssociatedKubernetesResource;
 ...
 */
@ApiModel(description = "An object containing the IDs of resources associated with a Kubernetes cluster.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AssociatedKubernetesResources {
  ...
  **/
   ...
   * @return the AssociatedKubernetesResources instance itself
   */
  public AssociatedKubernetesResources putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.loadBalancers, associatedKubernetesResources.loadBalancers) &&
        ...
        Objects.equals(this.additionalProperties, associatedKubernetesResources.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loadBalancers, volumes, volumeSnapshots, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AssociatedKubernetesResources
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssociatedKubernetesResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociatedKubernetesResources is not found in the empty JSON string", AssociatedKubernetesResources.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("load_balancers") != null && !jsonObj.get("load_balancers").isJsonNull()) {
        ...
        if (jsonArrayloadBalancers != null) {
          ...
          for (int i = 0; i < jsonArrayloadBalancers.size(); i++) {
            AssociatedKubernetesResource.validateJsonObject(jsonArrayloadBalancers.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("volumes") != null && !jsonObj.get("volumes").isJsonNull()) {
        ...
        if (jsonArrayvolumes != null) {
          ...
          for (int i = 0; i < jsonArrayvolumes.size(); i++) {
            AssociatedKubernetesResource.validateJsonObject(jsonArrayvolumes.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("volume_snapshots") != null && !jsonObj.get("volume_snapshots").isJsonNull()) {
        ...
        if (jsonArrayvolumeSnapshots != null) {
          ...
          for (int i = 0; i < jsonArrayvolumeSnapshots.size(); i++) {
            AssociatedKubernetesResource.validateJsonObject(jsonArrayvolumeSnapshots.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociatedKubernetesResources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociatedKubernetesResources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociatedKubernetesResources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociatedKubernetesResources.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociatedKubernetesResources>() {
           @Override
           public void write(JsonWriter out, AssociatedKubernetesResources value) throws IOException {
           ...
           @Override
           public AssociatedKubernetesResources read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AssociatedKubernetesResources instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AssociatedKubernetesResources given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AssociatedKubernetesResources
  * @throws IOException if the JSON string is invalid with respect to AssociatedKubernetesResources
  */
  public static AssociatedKubernetesResources fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociatedKubernetesResources.class);
  }

 /**
  * Convert an instance of AssociatedKubernetesResources to an JSON string
  *
  * @return JSON string
  */
