...
public class SshKeysListResponseAllOf {
  ...
  public SshKeysListResponseAllOf() {
  }

  public SshKeysListResponseAllOf sshKeys(List<SshKeys> sshKeys) {
  ...
  public SshKeysListResponseAllOf addSshKeysItem(SshKeys sshKeysItem) {
  ...
  **/
   ...
   * @return the SshKeysListResponseAllOf instance itself
   */
  public SshKeysListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysListResponseAllOf sshKeysListResponseAllOf = (SshKeysListResponseAllOf) o;
    return Objects.equals(this.sshKeys, sshKeysListResponseAllOf.sshKeys)&&
        Objects.equals(this.additionalProperties, sshKeysListResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysListResponseAllOf is not found in the empty JSON string", SshKeysListResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SshKeysListResponseAllOf value) throws IOException {
           ...
           @Override
           public SshKeysListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SshKeysListResponseAllOf
  */
  public static SshKeysListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysListResponseAllOf.class);
  }

 /**
  * Convert an instance of SshKeysListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
