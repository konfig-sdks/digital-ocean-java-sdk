...
public class DatabaseRegionOptions {
  ...
  **/
   ...
   * @return the DatabaseRegionOptions instance itself
   */
  public DatabaseRegionOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseRegionOptions databaseRegionOptions = (DatabaseRegionOptions) o;
    return Objects.equals(this.regions, databaseRegionOptions.regions)&&
        Objects.equals(this.additionalProperties, databaseRegionOptions.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseRegionOptions {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseRegionOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseRegionOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseRegionOptions is not found in the empty JSON string", DatabaseRegionOptions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseRegionOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseRegionOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseRegionOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseRegionOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseRegionOptions>() {
           @Override
           public void write(JsonWriter out, DatabaseRegionOptions value) throws IOException {
           ...
           @Override
           public DatabaseRegionOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseRegionOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseRegionOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseRegionOptions
  * @throws IOException if the JSON string is invalid with respect to DatabaseRegionOptions
  */
  public static DatabaseRegionOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseRegionOptions.class);
  }

 /**
  * Convert an instance of DatabaseRegionOptions to an JSON string
  *
  * @return JSON string
  */
