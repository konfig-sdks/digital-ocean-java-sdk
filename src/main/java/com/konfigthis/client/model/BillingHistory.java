...
public class BillingHistory {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2018-06-01T08:44:38Z", value = "Time the billing history entry occurred.")
  ...
  **/
   ...
   * @return the BillingHistory instance itself
   */
  public BillingHistory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, billingHistory.description) &&
        ...
        Objects.equals(this.date, billingHistory.date) &&
        Objects.equals(this.type, billingHistory.type)&&
        Objects.equals(this.additionalProperties, billingHistory.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, amount, invoiceId, invoiceUuid, date, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BillingHistory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BillingHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BillingHistory is not found in the empty JSON string", BillingHistory.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BillingHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BillingHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BillingHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BillingHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<BillingHistory>() {
           @Override
           public void write(JsonWriter out, BillingHistory value) throws IOException {
           ...
           @Override
           public BillingHistory read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BillingHistory instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BillingHistory given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BillingHistory
  * @throws IOException if the JSON string is invalid with respect to BillingHistory
  */
  public static BillingHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BillingHistory.class);
  }

 /**
  * Convert an instance of BillingHistory to an JSON string
  *
  * @return JSON string
  */
