...
import com.konfigthis.client.model.RegistrySubscription;
...
public class Registry {
  ...
  public static final String SERIALIZED_NAME_STORAGE_USAGE_BYTES = "storage_usage_bytes";
  @SerializedName(SERIALIZED_NAME_STORAGE_USAGE_BYTES)
  private Integer storageUsageBytes;

  public static final String SERIALIZED_NAME_STORAGE_USAGE_BYTES_UPDATED_AT = "storage_usage_bytes_updated_at";
  @SerializedName(SERIALIZED_NAME_STORAGE_USAGE_BYTES_UPDATED_AT)
  ...
  public Registry(
     ...
     Integer storageUsageBytes, 
     OffsetDateTime storageUsageBytesUpdatedAt
  ) {
    this();
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, createdAt, region, storageUsageBytes, storageUsageBytesUpdatedAt, subscription, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("storage_usage_bytes");
    openapiFields.add("storage_usage_bytes_updated_at");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Registry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Registry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("subscription") != null && !jsonObj.get("subscription").isJsonNull()) {
        RegistrySubscription.validateJsonObject(jsonObj.getAsJsonObject("subscription"));
      }
  }
