...
public class CertificatesGetResponse {
  ...
  public CertificatesGetResponse certificate(Certificate certificate) {
  ...
  **/
   ...
   * @return the CertificatesGetResponse instance itself
   */
  public CertificatesGetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesGetResponse certificatesGetResponse = (CertificatesGetResponse) o;
    return Objects.equals(this.certificate, certificatesGetResponse.certificate)&&
        Objects.equals(this.additionalProperties, certificatesGetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CertificatesGetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesGetResponse is not found in the empty JSON string", CertificatesGetResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesGetResponse>() {
           @Override
           public void write(JsonWriter out, CertificatesGetResponse value) throws IOException {
           ...
           @Override
           public CertificatesGetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesGetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesGetResponse
  * @throws IOException if the JSON string is invalid with respect to CertificatesGetResponse
  */
  public static CertificatesGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesGetResponse.class);
  }

 /**
  * Convert an instance of CertificatesGetResponse to an JSON string
  *
  * @return JSON string
  */
