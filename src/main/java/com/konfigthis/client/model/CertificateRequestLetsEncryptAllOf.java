...
public class CertificateRequestLetsEncryptAllOf {
  ...
  **/
   ...
   * @return the CertificateRequestLetsEncryptAllOf instance itself
   */
  public CertificateRequestLetsEncryptAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dnsNames, certificateRequestLetsEncryptAllOf.dnsNames)&&
        Objects.equals(this.additionalProperties, certificateRequestLetsEncryptAllOf.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("dns_names");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateRequestLetsEncryptAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateRequestLetsEncryptAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateRequestLetsEncryptAllOf is not found in the empty JSON string", CertificateRequestLetsEncryptAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateRequestLetsEncryptAllOf.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // ensure the required json array is present
      if (jsonObj.get("dns_names") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("dns_names").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateRequestLetsEncryptAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateRequestLetsEncryptAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateRequestLetsEncryptAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateRequestLetsEncryptAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateRequestLetsEncryptAllOf>() {
           @Override
           public void write(JsonWriter out, CertificateRequestLetsEncryptAllOf value) throws IOException {
           ...
           @Override
           public CertificateRequestLetsEncryptAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateRequestLetsEncryptAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateRequestLetsEncryptAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateRequestLetsEncryptAllOf
  * @throws IOException if the JSON string is invalid with respect to CertificateRequestLetsEncryptAllOf
  */
  public static CertificateRequestLetsEncryptAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateRequestLetsEncryptAllOf.class);
  }

 /**
  * Convert an instance of CertificateRequestLetsEncryptAllOf to an JSON string
  *
  * @return JSON string
  */
