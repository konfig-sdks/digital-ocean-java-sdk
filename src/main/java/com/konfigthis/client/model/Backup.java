...
public class Backup {
  ...
  **/
  ...
  public Backup sizeGigabytes(Double sizeGigabytes) {
  ...
  public Backup sizeGigabytes(Integer sizeGigabytes) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, sizeGigabytes, additionalProperties);
  }
