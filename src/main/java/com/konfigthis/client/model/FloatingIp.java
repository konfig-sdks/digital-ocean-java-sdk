...
import com.konfigthis.client.model.FloatingIpRegion;
import com.konfigthis.client.model.NullProperty;
...
public class FloatingIp {
  ...
  **/
  ...
  public FloatingIp droplet(NullProperty droplet) {
  ...
  **/
  ...
  public NullProperty getDroplet() {
    return droplet;
  }


  public void setDroplet(NullProperty droplet) {
  ...
  **/
  ...
  public FloatingIp projectId(UUID projectId) {
  ...
  **/
   ...
   * @return the FloatingIp instance itself
   */
  public FloatingIp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ip, floatingIp.ip) &&
        Objects.equals(this.region, floatingIp.region) &&
        Objects.equals(this.droplet, floatingIp.droplet) &&
        Objects.equals(this.locked, floatingIp.locked) &&
        Objects.equals(this.projectId, floatingIp.projectId)&&
        Objects.equals(this.additionalProperties, floatingIp.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ip, region, droplet, locked, projectId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIp
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIp.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("region") != null && !jsonObj.get("region").isJsonNull()) {
        FloatingIpRegion.validateJsonObject(jsonObj.getAsJsonObject("region"));
      }
      // validate the optional field `droplet`
      if (jsonObj.get("droplet") != null && !jsonObj.get("droplet").isJsonNull()) {
        NullProperty.validateJsonObject(jsonObj.getAsJsonObject("droplet"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FloatingIp>() {
           ...
           public FloatingIp read(JsonReader in) throws IOException {
             ...
             FloatingIp instance = thisAdapter.fromJsonTree(jsonObj);
