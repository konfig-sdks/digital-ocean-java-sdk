...
import com.konfigthis.client.model.OptionsOptions;
import com.konfigthis.client.model.OptionsVersionAvailability;
...
public class Options {
  ...
  private OptionsVersionAvailability versionAvailability;

  public Options() {
  }

  public Options options(OptionsOptions options) {
  ...
  **/
  ...
  public void setOptions(OptionsOptions options) {
  ...
  public Options versionAvailability(OptionsVersionAvailability versionAvailability) {
  ...
  **/
  ...
  public OptionsVersionAvailability getVersionAvailability() {
    return versionAvailability;
  }


  public void setVersionAvailability(OptionsVersionAvailability versionAvailability) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.options, options.options) &&
        Objects.equals(this.versionAvailability, options.versionAvailability)&&
        Objects.equals(this.additionalProperties, options.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(options, versionAvailability, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        OptionsOptions.validateJsonObject(jsonObj.getAsJsonObject("options"));
      }
      // validate the optional field `version_availability`
      if (jsonObj.get("version_availability") != null && !jsonObj.get("version_availability").isJsonNull()) {
        OptionsVersionAvailability.validateJsonObject(jsonObj.getAsJsonObject("version_availability"));
      }
  }
