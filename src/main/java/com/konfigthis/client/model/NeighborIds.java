...
public class NeighborIds {
  public static final String SERIALIZED_NAME_NEIGHBOR_IDS = "neighbor_ids";
  @SerializedName(SERIALIZED_NAME_NEIGHBOR_IDS)
  ...
  **/
   ...
   * @return the NeighborIds instance itself
   */
  public NeighborIds putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.neighborIds, neighborIds.neighborIds)&&
        Objects.equals(this.additionalProperties, neighborIds.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(neighborIds, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("neighbor_ids");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NeighborIds
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NeighborIds.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NeighborIds is not found in the empty JSON string", NeighborIds.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("neighbor_ids") != null && !jsonObj.get("neighbor_ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `neighbor_ids` to be an array in the JSON string but got `%s`", jsonObj.get("neighbor_ids").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NeighborIds.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NeighborIds' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NeighborIds> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NeighborIds.class));

       return (TypeAdapter<T>) new TypeAdapter<NeighborIds>() {
           @Override
           public void write(JsonWriter out, NeighborIds value) throws IOException {
           ...
           @Override
           public NeighborIds read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NeighborIds instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NeighborIds given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NeighborIds
  * @throws IOException if the JSON string is invalid with respect to NeighborIds
  */
  public static NeighborIds fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NeighborIds.class);
  }

 /**
  * Convert an instance of NeighborIds to an JSON string
  *
  * @return JSON string
  */
