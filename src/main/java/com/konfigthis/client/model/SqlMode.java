...
public class SqlMode {
  ...
  **/
   ...
   * @return the SqlMode instance itself
   */
  public SqlMode putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sqlMode, sqlMode.sqlMode)&&
        Objects.equals(this.additionalProperties, sqlMode.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sqlMode, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("sql_mode");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SqlMode
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SqlMode.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SqlMode is not found in the empty JSON string", SqlMode.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SqlMode.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("sql_mode").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SqlMode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SqlMode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SqlMode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SqlMode.class));

       return (TypeAdapter<T>) new TypeAdapter<SqlMode>() {
           @Override
           public void write(JsonWriter out, SqlMode value) throws IOException {
           ...
           @Override
           public SqlMode read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SqlMode instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SqlMode given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SqlMode
  * @throws IOException if the JSON string is invalid with respect to SqlMode
  */
  public static SqlMode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SqlMode.class);
  }

 /**
  * Convert an instance of SqlMode to an JSON string
  *
  * @return JSON string
  */
