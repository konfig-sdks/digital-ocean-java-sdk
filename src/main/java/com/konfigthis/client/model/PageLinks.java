...
public class PageLinks {
  ...
  public PageLinks pages(Object pages) {
  ...
  **/
   ...
   * @return the PageLinks instance itself
   */
  public PageLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pages, pageLinks.pages)&&
        Objects.equals(this.additionalProperties, pageLinks.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageLinks
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PageLinks>() {
           ...
           public PageLinks read(JsonReader in) throws IOException {
             ...
             PageLinks instance = thisAdapter.fromJsonTree(jsonObj);
