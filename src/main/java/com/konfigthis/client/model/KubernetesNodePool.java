...
public class KubernetesNodePool {
  ...
  **/
  ...
  @ApiModelProperty(example = "s-1vcpu-2gb", required = true, value = "")
  ...
  public KubernetesNodePool count(Double count) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "new-pool", required = true, value = "")
  ...
  **/
  ...
  public KubernetesNodePool minNodes(Double minNodes) {
  ...
  **/
  ...
  public KubernetesNodePool maxNodes(Double maxNodes) {
  ...
  **/
   ...
   * @return the KubernetesNodePool instance itself
   */
  public KubernetesNodePool putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, kubernetesNodePool.tags) &&
        Objects.equals(this.size, kubernetesNodePool.size) &&
        ...
        Objects.equals(this.id, kubernetesNodePool.id) &&
        ...
        Objects.equals(this.additionalProperties, kubernetesNodePool.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, size, count, name, autoScale, minNodes, maxNodes, id, labels, taints, nodes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesNodePool
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesNodePool.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesNodePool is not found in the empty JSON string", KubernetesNodePool.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KubernetesNodePool.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesNodePool.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesNodePool' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesNodePool> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesNodePool.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesNodePool>() {
           @Override
           public void write(JsonWriter out, KubernetesNodePool value) throws IOException {
           ...
           @Override
           public KubernetesNodePool read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesNodePool instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesNodePool given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesNodePool
  * @throws IOException if the JSON string is invalid with respect to KubernetesNodePool
  */
  public static KubernetesNodePool fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesNodePool.class);
  }

 /**
  * Convert an instance of KubernetesNodePool to an JSON string
  *
  * @return JSON string
  */
