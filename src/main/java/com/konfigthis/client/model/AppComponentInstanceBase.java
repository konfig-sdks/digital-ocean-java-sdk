...
public class AppComponentInstanceBase {
  ...
  **/
  ...
  public AppComponentInstanceBase autoscaling(AppComponentInstanceBaseAutoscaling autoscaling) {
  ...
  **/
   ...
   * @return the AppComponentInstanceBase instance itself
   */
  public AppComponentInstanceBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instanceCount, appComponentInstanceBase.instanceCount) &&
        ...
        Objects.equals(this.autoscaling, appComponentInstanceBase.autoscaling)&&
        Objects.equals(this.additionalProperties, appComponentInstanceBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(instanceCount, instanceSizeSlug, autoscaling, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppComponentInstanceBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppComponentInstanceBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppComponentInstanceBase is not found in the empty JSON string", AppComponentInstanceBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppComponentInstanceBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppComponentInstanceBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppComponentInstanceBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppComponentInstanceBase.class));

       return (TypeAdapter<T>) new TypeAdapter<AppComponentInstanceBase>() {
           @Override
           public void write(JsonWriter out, AppComponentInstanceBase value) throws IOException {
           ...
           @Override
           public AppComponentInstanceBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppComponentInstanceBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppComponentInstanceBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppComponentInstanceBase
  * @throws IOException if the JSON string is invalid with respect to AppComponentInstanceBase
  */
  public static AppComponentInstanceBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppComponentInstanceBase.class);
  }

 /**
  * Convert an instance of AppComponentInstanceBase to an JSON string
  *
  * @return JSON string
  */
