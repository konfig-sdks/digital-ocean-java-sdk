...
public class AppJobSpecAllOf {
  ...
  **/
   ...
   * @return the AppJobSpecAllOf instance itself
   */
  public AppJobSpecAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.kind, appJobSpecAllOf.kind)&&
        Objects.equals(this.additionalProperties, appJobSpecAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppJobSpecAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppJobSpecAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppJobSpecAllOf is not found in the empty JSON string", AppJobSpecAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppJobSpecAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppJobSpecAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppJobSpecAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppJobSpecAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AppJobSpecAllOf>() {
           @Override
           public void write(JsonWriter out, AppJobSpecAllOf value) throws IOException {
           ...
           @Override
           public AppJobSpecAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppJobSpecAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppJobSpecAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppJobSpecAllOf
  * @throws IOException if the JSON string is invalid with respect to AppJobSpecAllOf
  */
  public static AppJobSpecAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppJobSpecAllOf.class);
  }

 /**
  * Convert an instance of AppJobSpecAllOf to an JSON string
  *
  * @return JSON string
  */
