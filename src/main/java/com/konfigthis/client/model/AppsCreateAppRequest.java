...
public class AppsCreateAppRequest {
  ...
  **/
  ...
  public AppsCreateAppRequest projectId(String projectId) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The ID of the project the app should be assigned to. If omitted, it will be assigned to your default project.")
   ...
   * @return the AppsCreateAppRequest instance itself
   */
  public AppsCreateAppRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.spec, appsCreateAppRequest.spec) &&
        Objects.equals(this.projectId, appsCreateAppRequest.projectId)&&
        Objects.equals(this.additionalProperties, appsCreateAppRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(spec, projectId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsCreateAppRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsCreateAppRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsCreateAppRequest is not found in the empty JSON string", AppsCreateAppRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppsCreateAppRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsCreateAppRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsCreateAppRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsCreateAppRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsCreateAppRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsCreateAppRequest>() {
           @Override
           public void write(JsonWriter out, AppsCreateAppRequest value) throws IOException {
           ...
           @Override
           public AppsCreateAppRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsCreateAppRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsCreateAppRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsCreateAppRequest
  * @throws IOException if the JSON string is invalid with respect to AppsCreateAppRequest
  */
  public static AppsCreateAppRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsCreateAppRequest.class);
  }

 /**
  * Convert an instance of AppsCreateAppRequest to an JSON string
  *
  * @return JSON string
  */
