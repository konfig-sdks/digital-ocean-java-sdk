...
public class Timescaledb {
  ...
  public Timescaledb maxBackgroundWorkers(Integer maxBackgroundWorkers) {
  ...
  **/
   ...
   * @return the Timescaledb instance itself
   */
  public Timescaledb putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Timescaledb timescaledb = (Timescaledb) o;
    return Objects.equals(this.maxBackgroundWorkers, timescaledb.maxBackgroundWorkers)&&
        Objects.equals(this.additionalProperties, timescaledb.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Timescaledb
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Timescaledb.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Timescaledb is not found in the empty JSON string", Timescaledb.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Timescaledb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Timescaledb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Timescaledb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Timescaledb.class));

       return (TypeAdapter<T>) new TypeAdapter<Timescaledb>() {
           @Override
           public void write(JsonWriter out, Timescaledb value) throws IOException {
           ...
           @Override
           public Timescaledb read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Timescaledb instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Timescaledb given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Timescaledb
  * @throws IOException if the JSON string is invalid with respect to Timescaledb
  */
  public static Timescaledb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Timescaledb.class);
  }

 /**
  * Convert an instance of Timescaledb to an JSON string
  *
  * @return JSON string
  */
