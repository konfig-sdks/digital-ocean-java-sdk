...
public class DropletActionRebuildAllOf {
  ...
  public DropletActionRebuildAllOf image(Object image) {
  ...
  **/
   ...
   * @return the DropletActionRebuildAllOf instance itself
   */
  public DropletActionRebuildAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.image, dropletActionRebuildAllOf.image)&&
        Objects.equals(this.additionalProperties, dropletActionRebuildAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionRebuildAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionRebuildAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionRebuildAllOf is not found in the empty JSON string", DropletActionRebuildAllOf.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionRebuildAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionRebuildAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionRebuildAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionRebuildAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionRebuildAllOf>() {
           @Override
           public void write(JsonWriter out, DropletActionRebuildAllOf value) throws IOException {
           ...
           @Override
           public DropletActionRebuildAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionRebuildAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionRebuildAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionRebuildAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletActionRebuildAllOf
  */
  public static DropletActionRebuildAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionRebuildAllOf.class);
  }

 /**
  * Convert an instance of DropletActionRebuildAllOf to an JSON string
  *
  * @return JSON string
  */
