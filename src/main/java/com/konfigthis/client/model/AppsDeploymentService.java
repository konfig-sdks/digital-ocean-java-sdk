...
public class AppsDeploymentService {
  ...
  **/
   ...
   * @return the AppsDeploymentService instance itself
   */
  public AppsDeploymentService putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appsDeploymentService.name) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentService.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentService
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentService.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentService is not found in the empty JSON string", AppsDeploymentService.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentService.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentService' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentService> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentService.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentService>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentService value) throws IOException {
           ...
           @Override
           public AppsDeploymentService read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentService instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentService given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentService
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentService
  */
  public static AppsDeploymentService fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentService.class);
  }

 /**
  * Convert an instance of AppsDeploymentService to an JSON string
  *
  * @return JSON string
  */
