...
public class InvoicesListResponseAllOf {
  ...
  public InvoicesListResponseAllOf() {
  }

  public InvoicesListResponseAllOf invoices(List<InvoicePreview> invoices) {
  ...
  public InvoicesListResponseAllOf addInvoicesItem(InvoicePreview invoicesItem) {
  ...
  **/
  ...
  public InvoicesListResponseAllOf invoicePreview(InvoicePreview invoicePreview) {
  ...
  **/
   ...
   * @return the InvoicesListResponseAllOf instance itself
   */
  public InvoicesListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InvoicesListResponseAllOf invoicesListResponseAllOf = (InvoicesListResponseAllOf) o;
    return Objects.equals(this.invoices, invoicesListResponseAllOf.invoices) &&
        Objects.equals(this.invoicePreview, invoicesListResponseAllOf.invoicePreview)&&
        Objects.equals(this.additionalProperties, invoicesListResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoices, invoicePreview, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InvoicesListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoicesListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoicesListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoicesListResponseAllOf is not found in the empty JSON string", InvoicesListResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoicesListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoicesListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoicesListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoicesListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoicesListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, InvoicesListResponseAllOf value) throws IOException {
           ...
           @Override
           public InvoicesListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoicesListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoicesListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoicesListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to InvoicesListResponseAllOf
  */
  public static InvoicesListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoicesListResponseAllOf.class);
  }

 /**
  * Convert an instance of InvoicesListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
