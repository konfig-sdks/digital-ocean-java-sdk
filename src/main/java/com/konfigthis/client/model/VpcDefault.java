...
public class VpcDefault {
  ...
  **/
   ...
   * @return the VpcDefault instance itself
   */
  public VpcDefault putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._default, vpcDefault._default)&&
        Objects.equals(this.additionalProperties, vpcDefault.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcDefault
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcDefault.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcDefault is not found in the empty JSON string", VpcDefault.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcDefault.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcDefault' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcDefault> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcDefault.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcDefault>() {
           @Override
           public void write(JsonWriter out, VpcDefault value) throws IOException {
           ...
           @Override
           public VpcDefault read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcDefault instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcDefault given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcDefault
  * @throws IOException if the JSON string is invalid with respect to VpcDefault
  */
  public static VpcDefault fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcDefault.class);
  }

 /**
  * Convert an instance of VpcDefault to an JSON string
  *
  * @return JSON string
  */
