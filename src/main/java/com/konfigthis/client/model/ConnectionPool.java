...
public class ConnectionPool {
  ...
  **/
  ...
  public ConnectionPool standbyConnection(DatabaseClusterConnection standbyConnection) {
  ...
  **/
  ...
  public ConnectionPool standbyPrivateConnection(DatabaseClusterConnection standbyPrivateConnection) {
  ...
  **/
   ...
   * @return the ConnectionPool instance itself
   */
  public ConnectionPool putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, connectionPool.name) &&
        ...
        Objects.equals(this.db, connectionPool.db) &&
        ...
        Objects.equals(this.standbyConnection, connectionPool.standbyConnection) &&
        Objects.equals(this.standbyPrivateConnection, connectionPool.standbyPrivateConnection)&&
        Objects.equals(this.additionalProperties, connectionPool.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, mode, size, db, user, connection, privateConnection, standbyConnection, standbyPrivateConnection, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectionPool
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectionPool.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ConnectionPool.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConnectionPool>() {
           ...
           public ConnectionPool read(JsonReader in) throws IOException {
             ...
             ConnectionPool instance = thisAdapter.fromJsonTree(jsonObj);
