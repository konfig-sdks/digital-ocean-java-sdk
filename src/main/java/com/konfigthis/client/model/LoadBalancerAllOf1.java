...
public class LoadBalancerAllOf1 {
  ...
  **/
   ...
   * @return the LoadBalancerAllOf1 instance itself
   */
  public LoadBalancerAllOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletIds, loadBalancerAllOf1.dropletIds)&&
        Objects.equals(this.additionalProperties, loadBalancerAllOf1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerAllOf1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerAllOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerAllOf1 is not found in the empty JSON string", LoadBalancerAllOf1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerAllOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerAllOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerAllOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerAllOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerAllOf1>() {
           @Override
           public void write(JsonWriter out, LoadBalancerAllOf1 value) throws IOException {
           ...
           @Override
           public LoadBalancerAllOf1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerAllOf1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerAllOf1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerAllOf1
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerAllOf1
  */
  public static LoadBalancerAllOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerAllOf1.class);
  }

 /**
  * Convert an instance of LoadBalancerAllOf1 to an JSON string
  *
  * @return JSON string
  */
