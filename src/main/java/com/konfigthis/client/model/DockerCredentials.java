...
import com.konfigthis.client.model.DockerCredentialsAuths;
...
public class DockerCredentials {
  ...
  **/
   ...
   * @return the DockerCredentials instance itself
   */
  public DockerCredentials putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auths, dockerCredentials.auths)&&
        Objects.equals(this.additionalProperties, dockerCredentials.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(auths, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DockerCredentials
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DockerCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DockerCredentials is not found in the empty JSON string", DockerCredentials.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `auths`
      if (jsonObj.get("auths") != null && !jsonObj.get("auths").isJsonNull()) {
        DockerCredentialsAuths.validateJsonObject(jsonObj.getAsJsonObject("auths"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DockerCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DockerCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DockerCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DockerCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<DockerCredentials>() {
           @Override
           public void write(JsonWriter out, DockerCredentials value) throws IOException {
           ...
           @Override
           public DockerCredentials read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DockerCredentials instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DockerCredentials given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DockerCredentials
  * @throws IOException if the JSON string is invalid with respect to DockerCredentials
  */
  public static DockerCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DockerCredentials.class);
  }

 /**
  * Convert an instance of DockerCredentials to an JSON string
  *
  * @return JSON string
  */
