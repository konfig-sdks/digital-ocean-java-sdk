...
public class Exvolumes {
  ...
  public Exvolumes tags(List<String> tags) {
  ...
  public Exvolumes addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public Exvolumes description(String description) {
  ...
  **/
  ...
  public Exvolumes name(String name) {
  ...
  **/
  ...
  public Exvolumes sizeGigabytes(Integer sizeGigabytes) {
  ...
  **/
  ...
  public Exvolumes snapshotId(String snapshotId) {
  ...
  **/
  ...
  public Exvolumes filesystemType(String filesystemType) {
  ...
  **/
  ...
  public Exvolumes region(RegionSlug region) {
  ...
  **/
  ...
  public Exvolumes filesystemLabel(String filesystemLabel) {
  ...
  **/
   ...
   * @return the Exvolumes instance itself
   */
  public Exvolumes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Exvolumes exvolumes = (Exvolumes) o;
    return Objects.equals(this.tags, exvolumes.tags) &&
        Objects.equals(this.description, exvolumes.description) &&
        Objects.equals(this.id, exvolumes.id) &&
        Objects.equals(this.dropletIds, exvolumes.dropletIds) &&
        Objects.equals(this.name, exvolumes.name) &&
        Objects.equals(this.sizeGigabytes, exvolumes.sizeGigabytes) &&
        Objects.equals(this.createdAt, exvolumes.createdAt) &&
        Objects.equals(this.snapshotId, exvolumes.snapshotId) &&
        Objects.equals(this.filesystemType, exvolumes.filesystemType) &&
        Objects.equals(this.region, exvolumes.region) &&
        Objects.equals(this.filesystemLabel, exvolumes.filesystemLabel)&&
        Objects.equals(this.additionalProperties, exvolumes.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Exvolumes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Exvolumes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Exvolumes is not found in the empty JSON string", Exvolumes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Exvolumes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Exvolumes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Exvolumes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Exvolumes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Exvolumes.class));

       return (TypeAdapter<T>) new TypeAdapter<Exvolumes>() {
           @Override
           public void write(JsonWriter out, Exvolumes value) throws IOException {
           ...
           @Override
           public Exvolumes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Exvolumes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Exvolumes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Exvolumes
  * @throws IOException if the JSON string is invalid with respect to Exvolumes
  */
  public static Exvolumes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Exvolumes.class);
  }

 /**
  * Convert an instance of Exvolumes to an JSON string
  *
  * @return JSON string
  */
