...
public class VpcMember {
  ...
  **/
   ...
   * @return the VpcMember instance itself
   */
  public VpcMember putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, vpcMember.name) &&
        Objects.equals(this.urn, vpcMember.urn) &&
        Objects.equals(this.createdAt, vpcMember.createdAt)&&
        Objects.equals(this.additionalProperties, vpcMember.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, urn, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcMember
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcMember.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcMember is not found in the empty JSON string", VpcMember.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcMember.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcMember' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcMember> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcMember.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcMember>() {
           @Override
           public void write(JsonWriter out, VpcMember value) throws IOException {
           ...
           @Override
           public VpcMember read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcMember instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcMember given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcMember
  * @throws IOException if the JSON string is invalid with respect to VpcMember
  */
  public static VpcMember fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcMember.class);
  }

 /**
  * Convert an instance of VpcMember to an JSON string
  *
  * @return JSON string
  */
