...
public class AppsCreateDeploymentRequest {
  public static final String SERIALIZED_NAME_FORCE_BUILD = "force_build";
  @SerializedName(SERIALIZED_NAME_FORCE_BUILD)
  ...
  **/
   ...
   * @return the AppsCreateDeploymentRequest instance itself
   */
  public AppsCreateDeploymentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.forceBuild, appsCreateDeploymentRequest.forceBuild)&&
        Objects.equals(this.additionalProperties, appsCreateDeploymentRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forceBuild, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsCreateDeploymentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsCreateDeploymentRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsCreateDeploymentRequest is not found in the empty JSON string", AppsCreateDeploymentRequest.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsCreateDeploymentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsCreateDeploymentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsCreateDeploymentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsCreateDeploymentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsCreateDeploymentRequest>() {
           @Override
           public void write(JsonWriter out, AppsCreateDeploymentRequest value) throws IOException {
           ...
           @Override
           public AppsCreateDeploymentRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsCreateDeploymentRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsCreateDeploymentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsCreateDeploymentRequest
  * @throws IOException if the JSON string is invalid with respect to AppsCreateDeploymentRequest
  */
  public static AppsCreateDeploymentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsCreateDeploymentRequest.class);
  }

 /**
  * Convert an instance of AppsCreateDeploymentRequest to an JSON string
  *
  * @return JSON string
  */
