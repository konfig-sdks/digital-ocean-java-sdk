...
public class DomainRecordCaa {
  ...
  **/
   ...
   * @return the DomainRecordCaa instance itself
   */
  public DomainRecordCaa putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordCaa.id) &&
        Objects.equals(this.type, domainRecordCaa.type) &&
        Objects.equals(this.name, domainRecordCaa.name) &&
        Objects.equals(this.data, domainRecordCaa.data) &&
        Objects.equals(this.priority, domainRecordCaa.priority) &&
        Objects.equals(this.port, domainRecordCaa.port) &&
        Objects.equals(this.ttl, domainRecordCaa.ttl) &&
        Objects.equals(this.weight, domainRecordCaa.weight) &&
        Objects.equals(this.flags, domainRecordCaa.flags) &&
        Objects.equals(this.tag, domainRecordCaa.tag)&&
        Objects.equals(this.additionalProperties, domainRecordCaa.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordCaa
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordCaa.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordCaa is not found in the empty JSON string", DomainRecordCaa.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordCaa.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordCaa.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordCaa' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordCaa> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordCaa.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordCaa>() {
           @Override
           public void write(JsonWriter out, DomainRecordCaa value) throws IOException {
           ...
           @Override
           public DomainRecordCaa read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordCaa instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordCaa given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordCaa
  * @throws IOException if the JSON string is invalid with respect to DomainRecordCaa
  */
  public static DomainRecordCaa fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordCaa.class);
  }

 /**
  * Convert an instance of DomainRecordCaa to an JSON string
  *
  * @return JSON string
  */
