...
public class AppComponentBase {
  ...
  **/
   ...
   * @return the AppComponentBase instance itself
   */
  public AppComponentBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appComponentBase.name) &&
        Objects.equals(this.git, appComponentBase.git) &&
        ...
        Objects.equals(this.additionalProperties, appComponentBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, git, github, gitlab, image, dockerfilePath, buildCommand, runCommand, sourceDir, envs, environmentSlug, logDestinations, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppComponentBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppComponentBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppComponentBase is not found in the empty JSON string", AppComponentBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppComponentBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppComponentBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppComponentBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppComponentBase.class));

       return (TypeAdapter<T>) new TypeAdapter<AppComponentBase>() {
           @Override
           public void write(JsonWriter out, AppComponentBase value) throws IOException {
           ...
           @Override
           public AppComponentBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppComponentBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppComponentBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppComponentBase
  * @throws IOException if the JSON string is invalid with respect to AppComponentBase
  */
  public static AppComponentBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppComponentBase.class);
  }

 /**
  * Convert an instance of AppComponentBase to an JSON string
  *
  * @return JSON string
  */
