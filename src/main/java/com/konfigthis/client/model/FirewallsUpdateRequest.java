...
public class FirewallsUpdateRequest {
 ...
 public enum StatusEnum {
  ...
  public FirewallsUpdateRequest tags(List tags) {
  ...
  **/
  ...
  public FirewallsUpdateRequest name(String name) {
  ...
  **/
  ...
  public FirewallsUpdateRequest dropletIds(List<Integer> dropletIds) {
  ...
  public FirewallsUpdateRequest addDropletIdsItem(Integer dropletIdsItem) {
  ...
  **/
  ...
  public FirewallsUpdateRequest inboundRules(List<FirewallRulesInboundRulesInner> inboundRules) {
  ...
  public FirewallsUpdateRequest addInboundRulesItem(FirewallRulesInboundRulesInner inboundRulesItem) {
  ...
  **/
  ...
  public FirewallsUpdateRequest outboundRules(List<FirewallRulesOutboundRulesInner> outboundRules) {
  ...
  public FirewallsUpdateRequest addOutboundRulesItem(FirewallRulesOutboundRulesInner outboundRulesItem) {
  ...
  **/
   ...
   * @return the FirewallsUpdateRequest instance itself
   */
  public FirewallsUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsUpdateRequest firewallsUpdateRequest = (FirewallsUpdateRequest) o;
    return Objects.equals(this.tags, firewallsUpdateRequest.tags) &&
        Objects.equals(this.id, firewallsUpdateRequest.id) &&
        Objects.equals(this.status, firewallsUpdateRequest.status) &&
        Objects.equals(this.createdAt, firewallsUpdateRequest.createdAt) &&
        Objects.equals(this.pendingChanges, firewallsUpdateRequest.pendingChanges) &&
        Objects.equals(this.name, firewallsUpdateRequest.name) &&
        Objects.equals(this.dropletIds, firewallsUpdateRequest.dropletIds) &&
        Objects.equals(this.inboundRules, firewallsUpdateRequest.inboundRules) &&
        Objects.equals(this.outboundRules, firewallsUpdateRequest.outboundRules)&&
        Objects.equals(this.additionalProperties, firewallsUpdateRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsUpdateRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("inbound_rules");
    openapiRequiredFields.add("outbound_rules");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsUpdateRequest is not found in the empty JSON string", FirewallsUpdateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsUpdateRequest.openapiRequiredFields) {
      ...
      // validate the required field `inbound_rules` (array)
      ...
      // validate the required field `outbound_rules` (array)
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsUpdateRequest>() {
           @Override
           public void write(JsonWriter out, FirewallsUpdateRequest value) throws IOException {
           ...
           @Override
           public FirewallsUpdateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallsUpdateRequest
  */
  public static FirewallsUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsUpdateRequest.class);
  }

 /**
  * Convert an instance of FirewallsUpdateRequest to an JSON string
  *
  * @return JSON string
  */
