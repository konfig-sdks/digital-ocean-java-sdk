...
import com.konfigthis.client.model.NotificationSlackInner;
 ...
 */
@ApiModel(description = "The notification settings for a trigger alert.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Notification {
  ...
  private List<NotificationSlackInner> slack = new ArrayList<>();

  public Notification() {
  }

  public Notification email(List<String> email) {
  ...
  public Notification addEmailItem(String emailItem) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"bob@example.com\"]", required = true, value = "An email to notify on an alert trigger. The Email has to be one that is verified on that DigitalOcean account.")
  ...
  public Notification slack(List<NotificationSlackInner> slack) {
  ...
  public Notification addSlackItem(NotificationSlackInner slackItem) {
  ...
  **/
  ...
  public List<NotificationSlackInner> getSlack() {
    return slack;
  }


  public void setSlack(List<NotificationSlackInner> slack) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, notification.email) &&
        Objects.equals(this.slack, notification.slack)&&
        Objects.equals(this.additionalProperties, notification.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, slack, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("slack");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("slack").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `slack` to be an array in the JSON string but got `%s`", jsonObj.get("slack").toString()));
      }

      JsonArray jsonArrayslack = jsonObj.getAsJsonArray("slack");
      // validate the required field `slack` (array)
      for (int i = 0; i < jsonArrayslack.size(); i++) {
        NotificationSlackInner.validateJsonObject(jsonArrayslack.get(i).getAsJsonObject());
      };
  }
