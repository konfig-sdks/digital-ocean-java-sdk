...
public class AppsDeleteAppResponse {
  ...
  **/
   ...
   * @return the AppsDeleteAppResponse instance itself
   */
  public AppsDeleteAppResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, appsDeleteAppResponse.id)&&
        Objects.equals(this.additionalProperties, appsDeleteAppResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeleteAppResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeleteAppResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeleteAppResponse is not found in the empty JSON string", AppsDeleteAppResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeleteAppResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeleteAppResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeleteAppResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeleteAppResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeleteAppResponse>() {
           @Override
           public void write(JsonWriter out, AppsDeleteAppResponse value) throws IOException {
           ...
           @Override
           public AppsDeleteAppResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeleteAppResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeleteAppResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeleteAppResponse
  * @throws IOException if the JSON string is invalid with respect to AppsDeleteAppResponse
  */
  public static AppsDeleteAppResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeleteAppResponse.class);
  }

 /**
  * Convert an instance of AppsDeleteAppResponse to an JSON string
  *
  * @return JSON string
  */
