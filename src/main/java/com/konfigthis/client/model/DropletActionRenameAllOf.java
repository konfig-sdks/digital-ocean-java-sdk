...
public class DropletActionRenameAllOf {
  ...
  **/
   ...
   * @return the DropletActionRenameAllOf instance itself
   */
  public DropletActionRenameAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dropletActionRenameAllOf.name)&&
        Objects.equals(this.additionalProperties, dropletActionRenameAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionRenameAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionRenameAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionRenameAllOf is not found in the empty JSON string", DropletActionRenameAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionRenameAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionRenameAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionRenameAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionRenameAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionRenameAllOf>() {
           @Override
           public void write(JsonWriter out, DropletActionRenameAllOf value) throws IOException {
           ...
           @Override
           public DropletActionRenameAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionRenameAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionRenameAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionRenameAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletActionRenameAllOf
  */
  public static DropletActionRenameAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionRenameAllOf.class);
  }

 /**
  * Convert an instance of DropletActionRenameAllOf to an JSON string
  *
  * @return JSON string
  */
