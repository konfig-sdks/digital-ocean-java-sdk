...
public class DatabaseUser {
  ...
  **/
  ...
  public DatabaseUser settings(UserSettings settings) {
  ...
  **/
   ...
   * @return the DatabaseUser instance itself
   */
  public DatabaseUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, databaseUser.name) &&
        Objects.equals(this.role, databaseUser.role) &&
        Objects.equals(this.password, databaseUser.password) &&
        Objects.equals(this.accessCert, databaseUser.accessCert) &&
        Objects.equals(this.accessKey, databaseUser.accessKey) &&
        Objects.equals(this.mysqlSettings, databaseUser.mysqlSettings) &&
        Objects.equals(this.settings, databaseUser.settings)&&
        Objects.equals(this.additionalProperties, databaseUser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, role, password, accessCert, accessKey, mysqlSettings, settings, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : DatabaseUser.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DatabaseUser>() {
           ...
           public DatabaseUser read(JsonReader in) throws IOException {
             ...
             DatabaseUser instance = thisAdapter.fromJsonTree(jsonObj);
