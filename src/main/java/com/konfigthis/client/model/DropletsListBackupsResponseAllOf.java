...
public class DropletsListBackupsResponseAllOf {
  ...
  public DropletsListBackupsResponseAllOf() {
  }

  public DropletsListBackupsResponseAllOf backups(List<DropletSnapshot> backups) {
  ...
  public DropletsListBackupsResponseAllOf addBackupsItem(DropletSnapshot backupsItem) {
  ...
  **/
   ...
   * @return the DropletsListBackupsResponseAllOf instance itself
   */
  public DropletsListBackupsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DropletsListBackupsResponseAllOf dropletsListBackupsResponseAllOf = (DropletsListBackupsResponseAllOf) o;
    return Objects.equals(this.backups, dropletsListBackupsResponseAllOf.backups)&&
        Objects.equals(this.additionalProperties, dropletsListBackupsResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backups, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DropletsListBackupsResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletsListBackupsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletsListBackupsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletsListBackupsResponseAllOf is not found in the empty JSON string", DropletsListBackupsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletsListBackupsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletsListBackupsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletsListBackupsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletsListBackupsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletsListBackupsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DropletsListBackupsResponseAllOf value) throws IOException {
           ...
           @Override
           public DropletsListBackupsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletsListBackupsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletsListBackupsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletsListBackupsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletsListBackupsResponseAllOf
  */
  public static DropletsListBackupsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletsListBackupsResponseAllOf.class);
  }

 /**
  * Convert an instance of DropletsListBackupsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
