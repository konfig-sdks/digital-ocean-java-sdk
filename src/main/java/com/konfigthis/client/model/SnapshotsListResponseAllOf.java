...
public class SnapshotsListResponseAllOf {
  ...
  public SnapshotsListResponseAllOf() {
  }

  public SnapshotsListResponseAllOf snapshots(List<Snapshots> snapshots) {
  ...
  public SnapshotsListResponseAllOf addSnapshotsItem(Snapshots snapshotsItem) {
  ...
  **/
   ...
   * @return the SnapshotsListResponseAllOf instance itself
   */
  public SnapshotsListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnapshotsListResponseAllOf snapshotsListResponseAllOf = (SnapshotsListResponseAllOf) o;
    return Objects.equals(this.snapshots, snapshotsListResponseAllOf.snapshots)&&
        Objects.equals(this.additionalProperties, snapshotsListResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotsListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnapshotsListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnapshotsListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnapshotsListResponseAllOf is not found in the empty JSON string", SnapshotsListResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnapshotsListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnapshotsListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnapshotsListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnapshotsListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SnapshotsListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SnapshotsListResponseAllOf value) throws IOException {
           ...
           @Override
           public SnapshotsListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnapshotsListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnapshotsListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnapshotsListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SnapshotsListResponseAllOf
  */
  public static SnapshotsListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnapshotsListResponseAllOf.class);
  }

 /**
  * Convert an instance of SnapshotsListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
