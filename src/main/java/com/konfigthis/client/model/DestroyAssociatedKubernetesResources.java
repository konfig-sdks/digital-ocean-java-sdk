 ...
 */
@ApiModel(description = "An object containing the IDs of resources to be destroyed along with their associated with a Kubernetes cluster.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DestroyAssociatedKubernetesResources {
  ...
  **/
   ...
   * @return the DestroyAssociatedKubernetesResources instance itself
   */
  public DestroyAssociatedKubernetesResources putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.loadBalancers, destroyAssociatedKubernetesResources.loadBalancers) &&
        ...
        Objects.equals(this.additionalProperties, destroyAssociatedKubernetesResources.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DestroyAssociatedKubernetesResources
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestroyAssociatedKubernetesResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestroyAssociatedKubernetesResources is not found in the empty JSON string", DestroyAssociatedKubernetesResources.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestroyAssociatedKubernetesResources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestroyAssociatedKubernetesResources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestroyAssociatedKubernetesResources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestroyAssociatedKubernetesResources.class));

       return (TypeAdapter<T>) new TypeAdapter<DestroyAssociatedKubernetesResources>() {
           @Override
           public void write(JsonWriter out, DestroyAssociatedKubernetesResources value) throws IOException {
           ...
           @Override
           public DestroyAssociatedKubernetesResources read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DestroyAssociatedKubernetesResources instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DestroyAssociatedKubernetesResources given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DestroyAssociatedKubernetesResources
  * @throws IOException if the JSON string is invalid with respect to DestroyAssociatedKubernetesResources
  */
  public static DestroyAssociatedKubernetesResources fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestroyAssociatedKubernetesResources.class);
  }

 /**
  * Convert an instance of DestroyAssociatedKubernetesResources to an JSON string
  *
  * @return JSON string
  */
