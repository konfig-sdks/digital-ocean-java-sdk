...
public class AppsAlertResponse {
  ...
  **/
   ...
   * @return the AppsAlertResponse instance itself
   */
  public AppsAlertResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.alert, appsAlertResponse.alert)&&
        Objects.equals(this.additionalProperties, appsAlertResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsAlertResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsAlertResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsAlertResponse is not found in the empty JSON string", AppsAlertResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `alert`
      if (jsonObj.get("alert") != null && !jsonObj.get("alert").isJsonNull()) {
        AppAlert.validateJsonObject(jsonObj.getAsJsonObject("alert"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsAlertResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsAlertResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsAlertResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsAlertResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsAlertResponse>() {
           @Override
           public void write(JsonWriter out, AppsAlertResponse value) throws IOException {
           ...
           @Override
           public AppsAlertResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsAlertResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsAlertResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsAlertResponse
  * @throws IOException if the JSON string is invalid with respect to AppsAlertResponse
  */
  public static AppsAlertResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsAlertResponse.class);
  }

 /**
  * Convert an instance of AppsAlertResponse to an JSON string
  *
  * @return JSON string
  */
