...
public class ImagesGetResponse {
  ...
  public ImagesGetResponse image(Image image) {
  ...
  **/
   ...
   * @return the ImagesGetResponse instance itself
   */
  public ImagesGetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.image, imagesGetResponse.image)&&
        Objects.equals(this.additionalProperties, imagesGetResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesGetResponse is not found in the empty JSON string", ImagesGetResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesGetResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesGetResponse>() {
           @Override
           public void write(JsonWriter out, ImagesGetResponse value) throws IOException {
           ...
           @Override
           public ImagesGetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesGetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesGetResponse
  * @throws IOException if the JSON string is invalid with respect to ImagesGetResponse
  */
  public static ImagesGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesGetResponse.class);
  }

 /**
  * Convert an instance of ImagesGetResponse to an JSON string
  *
  * @return JSON string
  */
