...
public class DropletsListSnapshotsResponseAllOf {
  ...
  public DropletsListSnapshotsResponseAllOf() {
  }

  public DropletsListSnapshotsResponseAllOf snapshots(List<DropletSnapshot> snapshots) {
  ...
  public DropletsListSnapshotsResponseAllOf addSnapshotsItem(DropletSnapshot snapshotsItem) {
  ...
  **/
   ...
   * @return the DropletsListSnapshotsResponseAllOf instance itself
   */
  public DropletsListSnapshotsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DropletsListSnapshotsResponseAllOf dropletsListSnapshotsResponseAllOf = (DropletsListSnapshotsResponseAllOf) o;
    return Objects.equals(this.snapshots, dropletsListSnapshotsResponseAllOf.snapshots)&&
        Objects.equals(this.additionalProperties, dropletsListSnapshotsResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DropletsListSnapshotsResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletsListSnapshotsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletsListSnapshotsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletsListSnapshotsResponseAllOf is not found in the empty JSON string", DropletsListSnapshotsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletsListSnapshotsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletsListSnapshotsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletsListSnapshotsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletsListSnapshotsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletsListSnapshotsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DropletsListSnapshotsResponseAllOf value) throws IOException {
           ...
           @Override
           public DropletsListSnapshotsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletsListSnapshotsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletsListSnapshotsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletsListSnapshotsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletsListSnapshotsResponseAllOf
  */
  public static DropletsListSnapshotsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletsListSnapshotsResponseAllOf.class);
  }

 /**
  * Convert an instance of DropletsListSnapshotsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
