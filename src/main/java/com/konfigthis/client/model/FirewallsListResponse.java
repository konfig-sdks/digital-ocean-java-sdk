...
public class FirewallsListResponse {
  ...
  public FirewallsListResponse firewalls(List<Firewall> firewalls) {
  ...
  public FirewallsListResponse addFirewallsItem(Firewall firewallsItem) {
  ...
  **/
  ...
  public FirewallsListResponse links(PageLinks links) {
  ...
  **/
  ...
  public FirewallsListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the FirewallsListResponse instance itself
   */
  public FirewallsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsListResponse firewallsListResponse = (FirewallsListResponse) o;
    return Objects.equals(this.firewalls, firewallsListResponse.firewalls) &&
        Objects.equals(this.links, firewallsListResponse.links) &&
        Objects.equals(this.meta, firewallsListResponse.meta)&&
        Objects.equals(this.additionalProperties, firewallsListResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsListResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsListResponse is not found in the empty JSON string", FirewallsListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsListResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsListResponse>() {
           @Override
           public void write(JsonWriter out, FirewallsListResponse value) throws IOException {
           ...
           @Override
           public FirewallsListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsListResponse
  * @throws IOException if the JSON string is invalid with respect to FirewallsListResponse
  */
  public static FirewallsListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsListResponse.class);
  }

 /**
  * Convert an instance of FirewallsListResponse to an JSON string
  *
  * @return JSON string
  */
