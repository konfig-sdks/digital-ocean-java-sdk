...
public class VolumeSnapshotId {
  ...
  **/
   ...
   * @return the VolumeSnapshotId instance itself
   */
  public VolumeSnapshotId putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.snapshotId, volumeSnapshotId.snapshotId)&&
        Objects.equals(this.additionalProperties, volumeSnapshotId.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeSnapshotId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeSnapshotId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeSnapshotId is not found in the empty JSON string", VolumeSnapshotId.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeSnapshotId.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeSnapshotId' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeSnapshotId> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeSnapshotId.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeSnapshotId>() {
           @Override
           public void write(JsonWriter out, VolumeSnapshotId value) throws IOException {
           ...
           @Override
           public VolumeSnapshotId read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeSnapshotId instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeSnapshotId given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeSnapshotId
  * @throws IOException if the JSON string is invalid with respect to VolumeSnapshotId
  */
  public static VolumeSnapshotId fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeSnapshotId.class);
  }

 /**
  * Convert an instance of VolumeSnapshotId to an JSON string
  *
  * @return JSON string
  */
