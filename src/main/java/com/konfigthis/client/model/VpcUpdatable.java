...
public class VpcUpdatable {
  ...
  **/
   ...
   * @return the VpcUpdatable instance itself
   */
  public VpcUpdatable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, vpcUpdatable.description) &&
        Objects.equals(this.name, vpcUpdatable.name)&&
        Objects.equals(this.additionalProperties, vpcUpdatable.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcUpdatable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcUpdatable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcUpdatable is not found in the empty JSON string", VpcUpdatable.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcUpdatable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcUpdatable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcUpdatable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcUpdatable.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcUpdatable>() {
           @Override
           public void write(JsonWriter out, VpcUpdatable value) throws IOException {
           ...
           @Override
           public VpcUpdatable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcUpdatable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcUpdatable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcUpdatable
  * @throws IOException if the JSON string is invalid with respect to VpcUpdatable
  */
  public static VpcUpdatable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcUpdatable.class);
  }

 /**
  * Convert an instance of VpcUpdatable to an JSON string
  *
  * @return JSON string
  */
