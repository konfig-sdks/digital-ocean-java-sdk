...
public class InvoiceSummaryTaxes {
  ...
  **/
   ...
   * @return the InvoiceSummaryTaxes instance itself
   */
  public InvoiceSummaryTaxes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, invoiceSummaryTaxes.name) &&
        ...
        Objects.equals(this.additionalProperties, invoiceSummaryTaxes.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceSummaryTaxes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceSummaryTaxes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceSummaryTaxes is not found in the empty JSON string", InvoiceSummaryTaxes.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceSummaryTaxes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceSummaryTaxes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceSummaryTaxes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceSummaryTaxes.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceSummaryTaxes>() {
           @Override
           public void write(JsonWriter out, InvoiceSummaryTaxes value) throws IOException {
           ...
           @Override
           public InvoiceSummaryTaxes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceSummaryTaxes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceSummaryTaxes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceSummaryTaxes
  * @throws IOException if the JSON string is invalid with respect to InvoiceSummaryTaxes
  */
  public static InvoiceSummaryTaxes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceSummaryTaxes.class);
  }

 /**
  * Convert an instance of InvoiceSummaryTaxes to an JSON string
  *
  * @return JSON string
  */
