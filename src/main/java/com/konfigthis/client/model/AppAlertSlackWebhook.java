...
public class AppAlertSlackWebhook {
  ...
  **/
   ...
   * @return the AppAlertSlackWebhook instance itself
   */
  public AppAlertSlackWebhook putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, appAlertSlackWebhook.url) &&
        ...
        Objects.equals(this.additionalProperties, appAlertSlackWebhook.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, channel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppAlertSlackWebhook
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppAlertSlackWebhook.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAlertSlackWebhook is not found in the empty JSON string", AppAlertSlackWebhook.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAlertSlackWebhook.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAlertSlackWebhook' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAlertSlackWebhook> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAlertSlackWebhook.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAlertSlackWebhook>() {
           @Override
           public void write(JsonWriter out, AppAlertSlackWebhook value) throws IOException {
           ...
           @Override
           public AppAlertSlackWebhook read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppAlertSlackWebhook instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppAlertSlackWebhook given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppAlertSlackWebhook
  * @throws IOException if the JSON string is invalid with respect to AppAlertSlackWebhook
  */
  public static AppAlertSlackWebhook fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAlertSlackWebhook.class);
  }

 /**
  * Convert an instance of AppAlertSlackWebhook to an JSON string
  *
  * @return JSON string
  */
