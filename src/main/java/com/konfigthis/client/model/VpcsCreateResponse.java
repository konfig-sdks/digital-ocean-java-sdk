...
public class VpcsCreateResponse {
  ...
  public VpcsCreateResponse vpc(Vpc vpc) {
  ...
  **/
   ...
   * @return the VpcsCreateResponse instance itself
   */
  public VpcsCreateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VpcsCreateResponse vpcsCreateResponse = (VpcsCreateResponse) o;
    return Objects.equals(this.vpc, vpcsCreateResponse.vpc)&&
        Objects.equals(this.additionalProperties, vpcsCreateResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(vpc, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VpcsCreateResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcsCreateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcsCreateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcsCreateResponse is not found in the empty JSON string", VpcsCreateResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcsCreateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcsCreateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcsCreateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcsCreateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcsCreateResponse>() {
           @Override
           public void write(JsonWriter out, VpcsCreateResponse value) throws IOException {
           ...
           @Override
           public VpcsCreateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcsCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcsCreateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcsCreateResponse
  * @throws IOException if the JSON string is invalid with respect to VpcsCreateResponse
  */
  public static VpcsCreateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcsCreateResponse.class);
  }

 /**
  * Convert an instance of VpcsCreateResponse to an JSON string
  *
  * @return JSON string
  */
