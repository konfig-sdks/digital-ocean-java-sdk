...
public class SubscriptionTierExtended {
  ...
  **/
   ...
   * @return the SubscriptionTierExtended instance itself
   */
  public SubscriptionTierExtended putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eligible, subscriptionTierExtended.eligible) &&
        ...
        Objects.equals(this.additionalProperties, subscriptionTierExtended.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eligible, eligibilityReasons, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubscriptionTierExtended
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubscriptionTierExtended.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionTierExtended is not found in the empty JSON string", SubscriptionTierExtended.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionTierExtended.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionTierExtended' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionTierExtended> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionTierExtended.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionTierExtended>() {
           @Override
           public void write(JsonWriter out, SubscriptionTierExtended value) throws IOException {
           ...
           @Override
           public SubscriptionTierExtended read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubscriptionTierExtended instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubscriptionTierExtended given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubscriptionTierExtended
  * @throws IOException if the JSON string is invalid with respect to SubscriptionTierExtended
  */
  public static SubscriptionTierExtended fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionTierExtended.class);
  }

 /**
  * Convert an instance of SubscriptionTierExtended to an JSON string
  *
  * @return JSON string
  */
