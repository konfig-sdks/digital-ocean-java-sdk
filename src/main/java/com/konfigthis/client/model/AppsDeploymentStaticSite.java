...
public class AppsDeploymentStaticSite {
  ...
  public static final String SERIALIZED_NAME_SOURCE_COMMIT_HASH = "source_commit_hash";
  @SerializedName(SERIALIZED_NAME_SOURCE_COMMIT_HASH)
  ...
  **/
   ...
   * @return the AppsDeploymentStaticSite instance itself
   */
  public AppsDeploymentStaticSite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appsDeploymentStaticSite.name) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentStaticSite.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, sourceCommitHash, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("source_commit_hash");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentStaticSite
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentStaticSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentStaticSite is not found in the empty JSON string", AppsDeploymentStaticSite.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("name") != null && !jsonObj.get("name").isJsonNull()) && !jsonObj.get("name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("name").toString()));
      }
      if ((jsonObj.get("source_commit_hash") != null && !jsonObj.get("source_commit_hash").isJsonNull()) && !jsonObj.get("source_commit_hash").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `source_commit_hash` to be a primitive type in the JSON string but got `%s`", jsonObj.get("source_commit_hash").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentStaticSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentStaticSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentStaticSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentStaticSite.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentStaticSite>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentStaticSite value) throws IOException {
           ...
           @Override
           public AppsDeploymentStaticSite read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentStaticSite instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentStaticSite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentStaticSite
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentStaticSite
  */
  public static AppsDeploymentStaticSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentStaticSite.class);
  }

 /**
  * Convert an instance of AppsDeploymentStaticSite to an JSON string
  *
  * @return JSON string
  */
