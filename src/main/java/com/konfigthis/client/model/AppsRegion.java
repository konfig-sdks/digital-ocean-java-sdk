...
public class AppsRegion {
  ...
  public static final String SERIALIZED_NAME_DATA_CENTERS = "data_centers";
  ...
  **/
   ...
   * @return the AppsRegion instance itself
   */
  public AppsRegion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.continent, appsRegion.continent) &&
        ...
        Objects.equals(this.disabled, appsRegion.disabled) &&
        Objects.equals(this.flag, appsRegion.flag) &&
        Objects.equals(this.label, appsRegion.label) &&
        Objects.equals(this.reason, appsRegion.reason) &&
        Objects.equals(this.slug, appsRegion.slug)&&
        Objects.equals(this.additionalProperties, appsRegion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(continent, dataCenters, _default, disabled, flag, label, reason, slug, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("data_centers");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsRegion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsRegion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsRegion is not found in the empty JSON string", AppsRegion.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data_centers") != null && !jsonObj.get("data_centers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `data_centers` to be an array in the JSON string but got `%s`", jsonObj.get("data_centers").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsRegion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsRegion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsRegion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsRegion.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsRegion>() {
           @Override
           public void write(JsonWriter out, AppsRegion value) throws IOException {
           ...
           @Override
           public AppsRegion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsRegion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsRegion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsRegion
  * @throws IOException if the JSON string is invalid with respect to AppsRegion
  */
  public static AppsRegion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsRegion.class);
  }

 /**
  * Convert an instance of AppsRegion to an JSON string
  *
  * @return JSON string
  */
