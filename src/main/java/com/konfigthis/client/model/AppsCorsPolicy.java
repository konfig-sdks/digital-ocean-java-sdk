...
public class AppsCorsPolicy {
  ...
  **/
   ...
   * @return the AppsCorsPolicy instance itself
   */
  public AppsCorsPolicy putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowOrigins, appsCorsPolicy.allowOrigins) &&
        ...
        Objects.equals(this.additionalProperties, appsCorsPolicy.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsCorsPolicy
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsCorsPolicy.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsCorsPolicy is not found in the empty JSON string", AppsCorsPolicy.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsCorsPolicy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsCorsPolicy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsCorsPolicy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsCorsPolicy.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsCorsPolicy>() {
           @Override
           public void write(JsonWriter out, AppsCorsPolicy value) throws IOException {
           ...
           @Override
           public AppsCorsPolicy read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsCorsPolicy instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsCorsPolicy given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsCorsPolicy
  * @throws IOException if the JSON string is invalid with respect to AppsCorsPolicy
  */
  public static AppsCorsPolicy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsCorsPolicy.class);
  }

 /**
  * Convert an instance of AppsCorsPolicy to an JSON string
  *
  * @return JSON string
  */
