...
public class AppStaticSiteSpecAllOf {
  ...
  **/
   ...
   * @return the AppStaticSiteSpecAllOf instance itself
   */
  public AppStaticSiteSpecAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.indexDocument, appStaticSiteSpecAllOf.indexDocument) &&
        ...
        Objects.equals(this.additionalProperties, appStaticSiteSpecAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(indexDocument, errorDocument, catchallDocument, outputDir, cors, routes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppStaticSiteSpecAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppStaticSiteSpecAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppStaticSiteSpecAllOf is not found in the empty JSON string", AppStaticSiteSpecAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppStaticSiteSpecAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppStaticSiteSpecAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppStaticSiteSpecAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppStaticSiteSpecAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AppStaticSiteSpecAllOf>() {
           @Override
           public void write(JsonWriter out, AppStaticSiteSpecAllOf value) throws IOException {
           ...
           @Override
           public AppStaticSiteSpecAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppStaticSiteSpecAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppStaticSiteSpecAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppStaticSiteSpecAllOf
  * @throws IOException if the JSON string is invalid with respect to AppStaticSiteSpecAllOf
  */
  public static AppStaticSiteSpecAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppStaticSiteSpecAllOf.class);
  }

 /**
  * Convert an instance of AppStaticSiteSpecAllOf to an JSON string
  *
  * @return JSON string
  */
