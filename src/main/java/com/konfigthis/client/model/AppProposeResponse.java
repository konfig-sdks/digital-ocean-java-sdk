...
public class AppProposeResponse {
  public static final String SERIALIZED_NAME_APP_IS_STATIC = "app_is_static";
  @SerializedName(SERIALIZED_NAME_APP_IS_STATIC)
  private Boolean appIsStatic;

  public static final String SERIALIZED_NAME_APP_NAME_AVAILABLE = "app_name_available";
  @SerializedName(SERIALIZED_NAME_APP_NAME_AVAILABLE)
  private Boolean appNameAvailable;

  public static final String SERIALIZED_NAME_APP_NAME_SUGGESTION = "app_name_suggestion";
  @SerializedName(SERIALIZED_NAME_APP_NAME_SUGGESTION)
  private String appNameSuggestion;

  public static final String SERIALIZED_NAME_EXISTING_STATIC_APPS = "existing_static_apps";
  @SerializedName(SERIALIZED_NAME_EXISTING_STATIC_APPS)
  ...
  public static final String SERIALIZED_NAME_APP_COST = "app_cost";
  @SerializedName(SERIALIZED_NAME_APP_COST)
  private Integer appCost;

  public static final String SERIALIZED_NAME_APP_TIER_DOWNGRADE_COST = "app_tier_downgrade_cost";
  @SerializedName(SERIALIZED_NAME_APP_TIER_DOWNGRADE_COST)
  ...
  **/
   ...
   * @return the AppProposeResponse instance itself
   */
  public AppProposeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appIsStatic, appProposeResponse.appIsStatic) &&
        ...
        Objects.equals(this.additionalProperties, appProposeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(appIsStatic, appNameAvailable, appNameSuggestion, existingStaticApps, spec, appCost, appTierDowngradeCost, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("app_is_static");
    openapiFields.add("app_name_available");
    openapiFields.add("app_name_suggestion");
    openapiFields.add("existing_static_apps");
    openapiFields.add("spec");
    openapiFields.add("app_cost");
    openapiFields.add("app_tier_downgrade_cost");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppProposeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppProposeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppProposeResponse is not found in the empty JSON string", AppProposeResponse.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("app_name_suggestion") != null && !jsonObj.get("app_name_suggestion").isJsonNull()) && !jsonObj.get("app_name_suggestion").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `app_name_suggestion` to be a primitive type in the JSON string but got `%s`", jsonObj.get("app_name_suggestion").toString()));
      }
      if ((jsonObj.get("existing_static_apps") != null && !jsonObj.get("existing_static_apps").isJsonNull()) && !jsonObj.get("existing_static_apps").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `existing_static_apps` to be a primitive type in the JSON string but got `%s`", jsonObj.get("existing_static_apps").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppProposeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppProposeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppProposeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppProposeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppProposeResponse>() {
           @Override
           public void write(JsonWriter out, AppProposeResponse value) throws IOException {
           ...
           @Override
           public AppProposeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppProposeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppProposeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppProposeResponse
  * @throws IOException if the JSON string is invalid with respect to AppProposeResponse
  */
  public static AppProposeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppProposeResponse.class);
  }

 /**
  * Convert an instance of AppProposeResponse to an JSON string
  *
  * @return JSON string
  */
