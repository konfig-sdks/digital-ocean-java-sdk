...
public class AppDomainSpec {
 ...
 public enum MinimumTlsVersionEnum {
  ...
  public AppDomainSpec domain(String domain) {
    ...
    if (domain != null && domain.length() < 4) {
      throw new IllegalArgumentException("Invalid value for domain. Length must be greater than or equal to 4.");
    }
  ...
  **/
  ...
  public AppDomainSpec minimumTlsVersion(MinimumTlsVersionEnum minimumTlsVersion) {
    
    
    if (minimumTlsVersion != null && minimumTlsVersion.length() < 3) {
      throw new IllegalArgumentException("Invalid value for minimumTlsVersion. Length must be greater than or equal to 3.");
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "_1_3", value = "The minimum version of TLS a client application can use to access resources for the domain.  Must be one of the following values wrapped within quotations: `\"1.2\"` or `\"1.3\"`.")
   ...
   * @return the AppDomainSpec instance itself
   */
  public AppDomainSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.domain, appDomainSpec.domain) &&
        Objects.equals(this.type, appDomainSpec.type) &&
        ...
        Objects.equals(this.additionalProperties, appDomainSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, type, wildcard, zone, minimumTlsVersion, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppDomainSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppDomainSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppDomainSpec is not found in the empty JSON string", AppDomainSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppDomainSpec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppDomainSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppDomainSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppDomainSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppDomainSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppDomainSpec>() {
           @Override
           public void write(JsonWriter out, AppDomainSpec value) throws IOException {
           ...
           @Override
           public AppDomainSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppDomainSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppDomainSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppDomainSpec
  * @throws IOException if the JSON string is invalid with respect to AppDomainSpec
  */
  public static AppDomainSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppDomainSpec.class);
  }

 /**
  * Convert an instance of AppDomainSpec to an JSON string
  *
  * @return JSON string
  */
