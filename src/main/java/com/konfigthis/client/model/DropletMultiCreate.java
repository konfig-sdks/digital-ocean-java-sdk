...
public class DropletMultiCreate {
  ...
  **/
  ...
  public DropletMultiCreate image(Object image) {
  ...
  **/
  ...
  public DropletMultiCreate sshKeys(List<Object> sshKeys) {
  ...
  public DropletMultiCreate addSshKeysItem(Object sshKeysItem) {
  ...
  **/
  ...
  public DropletMultiCreate volumes(List<String> volumes) {
  ...
  public DropletMultiCreate addVolumesItem(String volumesItem) {
  ...
  **/
   ...
   * @return the DropletMultiCreate instance itself
   */
  public DropletMultiCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.names, dropletMultiCreate.names) &&
        ...
        Objects.equals(this.volumes, dropletMultiCreate.volumes) &&
        ...
        Objects.equals(this.additionalProperties, dropletMultiCreate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(names, tags, region, size, image, sshKeys, backups, ipv6, monitoring, userData, privateNetworking, volumes, vpcUuid, withDropletAgent, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletMultiCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletMultiCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletMultiCreate is not found in the empty JSON string", DropletMultiCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletMultiCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletMultiCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletMultiCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletMultiCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletMultiCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletMultiCreate>() {
           @Override
           public void write(JsonWriter out, DropletMultiCreate value) throws IOException {
           ...
           @Override
           public DropletMultiCreate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletMultiCreate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletMultiCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletMultiCreate
  * @throws IOException if the JSON string is invalid with respect to DropletMultiCreate
  */
  public static DropletMultiCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletMultiCreate.class);
  }

 /**
  * Convert an instance of DropletMultiCreate to an JSON string
  *
  * @return JSON string
  */
