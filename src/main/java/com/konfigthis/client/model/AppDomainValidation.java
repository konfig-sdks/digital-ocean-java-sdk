...
public class AppDomainValidation {
  ...
  **/
  ...
  @ApiModelProperty(example = "_acme-challenge.app.example.com", value = "")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "lXLOcN6cPv0nproViNcUHcahD9TrIPlNgdwesj0pYpk", value = "")
   ...
   * @return the AppDomainValidation instance itself
   */
  public AppDomainValidation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppDomainValidation appDomainValidation = (AppDomainValidation) o;
    return Objects.equals(this.txtName, appDomainValidation.txtName) &&
        Objects.equals(this.txtValue, appDomainValidation.txtValue)&&
        Objects.equals(this.additionalProperties, appDomainValidation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(txtName, txtValue, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppDomainValidation {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppDomainValidation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppDomainValidation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppDomainValidation is not found in the empty JSON string", AppDomainValidation.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppDomainValidation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppDomainValidation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppDomainValidation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppDomainValidation.class));

       return (TypeAdapter<T>) new TypeAdapter<AppDomainValidation>() {
           @Override
           public void write(JsonWriter out, AppDomainValidation value) throws IOException {
           ...
           @Override
           public AppDomainValidation read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppDomainValidation instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppDomainValidation given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppDomainValidation
  * @throws IOException if the JSON string is invalid with respect to AppDomainValidation
  */
  public static AppDomainValidation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppDomainValidation.class);
  }

 /**
  * Convert an instance of AppDomainValidation to an JSON string
  *
  * @return JSON string
  */
