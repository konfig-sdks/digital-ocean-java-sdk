...
public class ConnectionPoolUpdate {
  ...
  public ConnectionPoolUpdate mode(String mode) {
  ...
  **/
  ...
  public ConnectionPoolUpdate size(Integer size) {
  ...
  **/
  ...
  public ConnectionPoolUpdate db(String db) {
  ...
  **/
  ...
  public ConnectionPoolUpdate user(String user) {
  ...
  **/
  ...
  @ApiModelProperty(example = "doadmin", value = "The name of the user for use with the connection pool. When excluded, all sessions connect to the database as the inbound user.")
   ...
   * @return the ConnectionPoolUpdate instance itself
   */
  public ConnectionPoolUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectionPoolUpdate connectionPoolUpdate = (ConnectionPoolUpdate) o;
    return Objects.equals(this.mode, connectionPoolUpdate.mode) &&
        Objects.equals(this.size, connectionPoolUpdate.size) &&
        Objects.equals(this.db, connectionPoolUpdate.db) &&
        Objects.equals(this.user, connectionPoolUpdate.user)&&
        Objects.equals(this.additionalProperties, connectionPoolUpdate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mode, size, db, user, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConnectionPoolUpdate {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectionPoolUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectionPoolUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionPoolUpdate is not found in the empty JSON string", ConnectionPoolUpdate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConnectionPoolUpdate.openapiRequiredFields) {
      ...
      if (!jsonObj.get("db").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `db` to be a primitive type in the JSON string but got `%s`", jsonObj.get("db").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionPoolUpdate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionPoolUpdate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionPoolUpdate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionPoolUpdate.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionPoolUpdate>() {
           @Override
           public void write(JsonWriter out, ConnectionPoolUpdate value) throws IOException {
           ...
           @Override
           public ConnectionPoolUpdate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConnectionPoolUpdate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConnectionPoolUpdate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConnectionPoolUpdate
  * @throws IOException if the JSON string is invalid with respect to ConnectionPoolUpdate
  */
  public static ConnectionPoolUpdate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionPoolUpdate.class);
  }

 /**
  * Convert an instance of ConnectionPoolUpdate to an JSON string
  *
  * @return JSON string
  */
