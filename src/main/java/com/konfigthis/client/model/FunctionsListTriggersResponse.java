...
public class FunctionsListTriggersResponse {
  ...
  public FunctionsListTriggersResponse() {
  }

  public FunctionsListTriggersResponse triggers(List<TriggerInfo> triggers) {
  ...
  public FunctionsListTriggersResponse addTriggersItem(TriggerInfo triggersItem) {
  ...
  **/
   ...
   * @return the FunctionsListTriggersResponse instance itself
   */
  public FunctionsListTriggersResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FunctionsListTriggersResponse functionsListTriggersResponse = (FunctionsListTriggersResponse) o;
    return Objects.equals(this.triggers, functionsListTriggersResponse.triggers)&&
        Objects.equals(this.additionalProperties, functionsListTriggersResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FunctionsListTriggersResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FunctionsListTriggersResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FunctionsListTriggersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FunctionsListTriggersResponse is not found in the empty JSON string", FunctionsListTriggersResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FunctionsListTriggersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FunctionsListTriggersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FunctionsListTriggersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FunctionsListTriggersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FunctionsListTriggersResponse>() {
           @Override
           public void write(JsonWriter out, FunctionsListTriggersResponse value) throws IOException {
           ...
           @Override
           public FunctionsListTriggersResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FunctionsListTriggersResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FunctionsListTriggersResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FunctionsListTriggersResponse
  * @throws IOException if the JSON string is invalid with respect to FunctionsListTriggersResponse
  */
  public static FunctionsListTriggersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FunctionsListTriggersResponse.class);
  }

 /**
  * Convert an instance of FunctionsListTriggersResponse to an JSON string
  *
  * @return JSON string
  */
