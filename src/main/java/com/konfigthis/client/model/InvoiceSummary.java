...
import com.konfigthis.client.model.InvoiceSummaryCreditsAndAdjustments;
import com.konfigthis.client.model.InvoiceSummaryOverages;
import com.konfigthis.client.model.InvoiceSummaryProductCharges;
import com.konfigthis.client.model.InvoiceSummaryTaxes;
import com.konfigthis.client.model.InvoiceSummaryUserBillingAddress;
...
public class InvoiceSummary {
  ...
  public static final String SERIALIZED_NAME_USER_BILLING_ADDRESS = "user_billing_address";
  @SerializedName(SERIALIZED_NAME_USER_BILLING_ADDRESS)
  private InvoiceSummaryUserBillingAddress userBillingAddress;

  public static final String SERIALIZED_NAME_USER_COMPANY = "user_company";
  @SerializedName(SERIALIZED_NAME_USER_COMPANY)
  ...
  public static final String SERIALIZED_NAME_PRODUCT_CHARGES = "product_charges";
  @SerializedName(SERIALIZED_NAME_PRODUCT_CHARGES)
  ...
  public static final String SERIALIZED_NAME_CREDITS_AND_ADJUSTMENTS = "credits_and_adjustments";
  @SerializedName(SERIALIZED_NAME_CREDITS_AND_ADJUSTMENTS)
  ...
  **/
  ...
  public InvoiceSummary invoiceId(String invoiceId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "123456789", value = "ID of the invoice")
  ...
  **/
   ...
   * @return the InvoiceSummary instance itself
   */
  public InvoiceSummary putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.invoiceUuid, invoiceSummary.invoiceUuid) &&
        Objects.equals(this.invoiceId, invoiceSummary.invoiceId) &&
        ...
        Objects.equals(this.additionalProperties, invoiceSummary.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(invoiceUuid, invoiceId, billingPeriod, amount, userName, userBillingAddress, userCompany, userEmail, productCharges, overages, taxes, creditsAndAdjustments, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("user_billing_address");
    openapiFields.add("user_company");
    openapiFields.add("user_email");
    openapiFields.add("product_charges");
    openapiFields.add("overages");
    openapiFields.add("taxes");
    openapiFields.add("credits_and_adjustments");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceSummary
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceSummary.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      // validate the optional field `user_billing_address`
      if (jsonObj.get("user_billing_address") != null && !jsonObj.get("user_billing_address").isJsonNull()) {
        InvoiceSummaryUserBillingAddress.validateJsonObject(jsonObj.getAsJsonObject("user_billing_address"));
      }
      if ((jsonObj.get("user_company") != null && !jsonObj.get("user_company").isJsonNull()) && !jsonObj.get("user_company").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `user_company` to be a primitive type in the JSON string but got `%s`", jsonObj.get("user_company").toString()));
      }
      ...
      // validate the optional field `product_charges`
      if (jsonObj.get("product_charges") != null && !jsonObj.get("product_charges").isJsonNull()) {
        InvoiceSummaryProductCharges.validateJsonObject(jsonObj.getAsJsonObject("product_charges"));
      }
      // validate the optional field `overages`
      if (jsonObj.get("overages") != null && !jsonObj.get("overages").isJsonNull()) {
        InvoiceSummaryOverages.validateJsonObject(jsonObj.getAsJsonObject("overages"));
      }
      // validate the optional field `taxes`
      if (jsonObj.get("taxes") != null && !jsonObj.get("taxes").isJsonNull()) {
        InvoiceSummaryTaxes.validateJsonObject(jsonObj.getAsJsonObject("taxes"));
      }
      // validate the optional field `credits_and_adjustments`
      if (jsonObj.get("credits_and_adjustments") != null && !jsonObj.get("credits_and_adjustments").isJsonNull()) {
        InvoiceSummaryCreditsAndAdjustments.validateJsonObject(jsonObj.getAsJsonObject("credits_and_adjustments"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InvoiceSummary>() {
           ...
           public InvoiceSummary read(JsonReader in) throws IOException {
             ...
             InvoiceSummary instance = thisAdapter.fromJsonTree(jsonObj);
