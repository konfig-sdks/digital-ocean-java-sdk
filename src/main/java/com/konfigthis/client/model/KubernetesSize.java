...
public class KubernetesSize {
  ...
  **/
   ...
   * @return the KubernetesSize instance itself
   */
  public KubernetesSize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, kubernetesSize.name) &&
        Objects.equals(this.slug, kubernetesSize.slug)&&
        Objects.equals(this.additionalProperties, kubernetesSize.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesSize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesSize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesSize is not found in the empty JSON string", KubernetesSize.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesSize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesSize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesSize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesSize.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesSize>() {
           @Override
           public void write(JsonWriter out, KubernetesSize value) throws IOException {
           ...
           @Override
           public KubernetesSize read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesSize instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesSize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesSize
  * @throws IOException if the JSON string is invalid with respect to KubernetesSize
  */
  public static KubernetesSize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesSize.class);
  }

 /**
  * Convert an instance of KubernetesSize to an JSON string
  *
  * @return JSON string
  */
