...
import com.konfigthis.client.model.AppAlertPhase;
import com.konfigthis.client.model.AppAlertProgress;
import com.konfigthis.client.model.AppAlertSlackWebhook;
import com.konfigthis.client.model.AppAlertSpec;
...
public class AppAlert {
  ...
  public static final String SERIALIZED_NAME_SLACK_WEBHOOKS = "slack_webhooks";
  @SerializedName(SERIALIZED_NAME_SLACK_WEBHOOKS)
  ...
  **/
   ...
   * @return the AppAlert instance itself
   */
  public AppAlert putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, appAlert.id) &&
        Objects.equals(this.componentName, appAlert.componentName) &&
        Objects.equals(this.spec, appAlert.spec) &&
        Objects.equals(this.emails, appAlert.emails) &&
        Objects.equals(this.slackWebhooks, appAlert.slackWebhooks) &&
        Objects.equals(this.phase, appAlert.phase) &&
        Objects.equals(this.progress, appAlert.progress)&&
        Objects.equals(this.additionalProperties, appAlert.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, componentName, spec, emails, slackWebhooks, phase, progress, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("slack_webhooks");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppAlert
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppAlert.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAlert is not found in the empty JSON string", AppAlert.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("id") != null && !jsonObj.get("id").isJsonNull()) && !jsonObj.get("id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("id").toString()));
      }
      if ((jsonObj.get("component_name") != null && !jsonObj.get("component_name").isJsonNull()) && !jsonObj.get("component_name").isJsonPrimitive()) {
      ...
      if (jsonObj.get("spec") != null && !jsonObj.get("spec").isJsonNull()) {
        AppAlertSpec.validateJsonObject(jsonObj.getAsJsonObject("spec"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("emails") != null && !jsonObj.get("emails").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `emails` to be an array in the JSON string but got `%s`", jsonObj.get("emails").toString()));
      }
      if (jsonObj.get("slack_webhooks") != null && !jsonObj.get("slack_webhooks").isJsonNull()) {
        JsonArray jsonArrayslackWebhooks = jsonObj.getAsJsonArray("slack_webhooks");
        if (jsonArrayslackWebhooks != null) {
          // ensure the json data is an array
          if (!jsonObj.get("slack_webhooks").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `slack_webhooks` to be an array in the JSON string but got `%s`", jsonObj.get("slack_webhooks").toString()));
          }

          // validate the optional field `slack_webhooks` (array)
          for (int i = 0; i < jsonArrayslackWebhooks.size(); i++) {
            AppAlertSlackWebhook.validateJsonObject(jsonArrayslackWebhooks.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `progress`
      if (jsonObj.get("progress") != null && !jsonObj.get("progress").isJsonNull()) {
        AppAlertProgress.validateJsonObject(jsonObj.getAsJsonObject("progress"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAlert.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAlert' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAlert> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAlert.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAlert>() {
           @Override
           public void write(JsonWriter out, AppAlert value) throws IOException {
           ...
           @Override
           public AppAlert read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppAlert instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppAlert given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppAlert
  * @throws IOException if the JSON string is invalid with respect to AppAlert
  */
  public static AppAlert fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAlert.class);
  }

 /**
  * Convert an instance of AppAlert to an JSON string
  *
  * @return JSON string
  */
