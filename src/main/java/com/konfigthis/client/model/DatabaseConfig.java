...
public class DatabaseConfig {
  ...
  public DatabaseConfig config(Mpr config) {
  ...
  **/
  ...
  public Mpr getConfig() {
    return config;
  }


  public void setConfig(Mpr config) {
   ...
   * @return the DatabaseConfig instance itself
   */
  public DatabaseConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, databaseConfig.config)&&
        Objects.equals(this.additionalProperties, databaseConfig.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("config") != null && !jsonObj.get("config").isJsonNull()) {
        Mpr.validateJsonObject(jsonObj.getAsJsonObject("config"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DatabaseConfig>() {
           ...
           public DatabaseConfig read(JsonReader in) throws IOException {
             ...
             DatabaseConfig instance = thisAdapter.fromJsonTree(jsonObj);
