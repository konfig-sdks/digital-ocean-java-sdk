...
import com.konfigthis.client.model.KubernetesRegion;
import com.konfigthis.client.model.KubernetesSize;
...
public class KubernetesOptionsOptions {
  ...
  **/
   ...
   * @return the KubernetesOptionsOptions instance itself
   */
  public KubernetesOptionsOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.regions, kubernetesOptionsOptions.regions) &&
        ...
        Objects.equals(this.additionalProperties, kubernetesOptionsOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regions, versions, sizes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesOptionsOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesOptionsOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesOptionsOptions is not found in the empty JSON string", KubernetesOptionsOptions.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("regions") != null && !jsonObj.get("regions").isJsonNull()) {
        ...
        if (jsonArrayregions != null) {
          ...
          for (int i = 0; i < jsonArrayregions.size(); i++) {
            KubernetesRegion.validateJsonObject(jsonArrayregions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("versions") != null && !jsonObj.get("versions").isJsonNull()) {
        ...
        if (jsonArrayversions != null) {
          ...
          for (int i = 0; i < jsonArrayversions.size(); i++) {
            KubernetesVersion.validateJsonObject(jsonArrayversions.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("sizes") != null && !jsonObj.get("sizes").isJsonNull()) {
        ...
        if (jsonArraysizes != null) {
          ...
          for (int i = 0; i < jsonArraysizes.size(); i++) {
            KubernetesSize.validateJsonObject(jsonArraysizes.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesOptionsOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesOptionsOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesOptionsOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesOptionsOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesOptionsOptions>() {
           @Override
           public void write(JsonWriter out, KubernetesOptionsOptions value) throws IOException {
           ...
           @Override
           public KubernetesOptionsOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesOptionsOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesOptionsOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesOptionsOptions
  * @throws IOException if the JSON string is invalid with respect to KubernetesOptionsOptions
  */
  public static KubernetesOptionsOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesOptionsOptions.class);
  }

 /**
  * Convert an instance of KubernetesOptionsOptions to an JSON string
  *
  * @return JSON string
  */
