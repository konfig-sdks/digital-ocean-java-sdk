...
public class VolumeWriteFileSystemType {
  ...
  **/
   ...
   * @return the VolumeWriteFileSystemType instance itself
   */
  public VolumeWriteFileSystemType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filesystemType, volumeWriteFileSystemType.filesystemType)&&
        Objects.equals(this.additionalProperties, volumeWriteFileSystemType.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(filesystemType, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeWriteFileSystemType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeWriteFileSystemType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeWriteFileSystemType is not found in the empty JSON string", VolumeWriteFileSystemType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeWriteFileSystemType.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeWriteFileSystemType' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeWriteFileSystemType> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeWriteFileSystemType.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeWriteFileSystemType>() {
           @Override
           public void write(JsonWriter out, VolumeWriteFileSystemType value) throws IOException {
           ...
           @Override
           public VolumeWriteFileSystemType read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeWriteFileSystemType instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeWriteFileSystemType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeWriteFileSystemType
  * @throws IOException if the JSON string is invalid with respect to VolumeWriteFileSystemType
  */
  public static VolumeWriteFileSystemType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeWriteFileSystemType.class);
  }

 /**
  * Convert an instance of VolumeWriteFileSystemType to an JSON string
  *
  * @return JSON string
  */
