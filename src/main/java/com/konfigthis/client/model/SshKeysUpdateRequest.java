...
public class SshKeysUpdateRequest {
  ...
  public SshKeysUpdateRequest name(String name) {
  ...
  **/
   ...
   * @return the SshKeysUpdateRequest instance itself
   */
  public SshKeysUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysUpdateRequest sshKeysUpdateRequest = (SshKeysUpdateRequest) o;
    return Objects.equals(this.name, sshKeysUpdateRequest.name)&&
        Objects.equals(this.additionalProperties, sshKeysUpdateRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SshKeysUpdateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysUpdateRequest is not found in the empty JSON string", SshKeysUpdateRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysUpdateRequest>() {
           @Override
           public void write(JsonWriter out, SshKeysUpdateRequest value) throws IOException {
           ...
           @Override
           public SshKeysUpdateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to SshKeysUpdateRequest
  */
  public static SshKeysUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysUpdateRequest.class);
  }

 /**
  * Convert an instance of SshKeysUpdateRequest to an JSON string
  *
  * @return JSON string
  */
