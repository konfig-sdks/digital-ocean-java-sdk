...
import com.konfigthis.client.model.PreviousOutage;
import com.konfigthis.client.model.RegionalState;
...
public class State {
  ...
  private RegionalState regions;

  public static final String SERIALIZED_NAME_PREVIOUS_OUTAGE = "previous_outage";
  @SerializedName(SERIALIZED_NAME_PREVIOUS_OUTAGE)
  private PreviousOutage previousOutage;

  public State() {
  }

  public State regions(RegionalState regions) {
  ...
  **/
  ...
  public RegionalState getRegions() {
    return regions;
  }


  public void setRegions(RegionalState regions) {
  ...
  public State previousOutage(PreviousOutage previousOutage) {
  ...
  **/
  ...
  public PreviousOutage getPreviousOutage() {
    return previousOutage;
  }


  public void setPreviousOutage(PreviousOutage previousOutage) {
  ...
  public boolean equals(Object o) {
    ...
    State state = (State) o;
    return Objects.equals(this.regions, state.regions) &&
        Objects.equals(this.previousOutage, state.previousOutage)&&
        Objects.equals(this.additionalProperties, state.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regions, previousOutage, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    previousOutage: ").append(toIndentedString(previousOutage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("previous_outage");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("regions") != null && !jsonObj.get("regions").isJsonNull()) {
        RegionalState.validateJsonObject(jsonObj.getAsJsonObject("regions"));
      }
      // validate the optional field `previous_outage`
      if (jsonObj.get("previous_outage") != null && !jsonObj.get("previous_outage").isJsonNull()) {
        PreviousOutage.validateJsonObject(jsonObj.getAsJsonObject("previous_outage"));
      }
  }
