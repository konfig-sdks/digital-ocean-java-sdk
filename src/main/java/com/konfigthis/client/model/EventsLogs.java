...
public class EventsLogs {
 ...
 public enum EventTypeEnum {
  ...
  public EventsLogs id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "pe8u2huh", value = "ID of the particular event.")
  ...
  public EventsLogs clusterName(String clusterName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "sample_cluster", value = "The name of cluster.")
  ...
  public EventsLogs eventType(EventTypeEnum eventType) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CLUSTER_CREATE", value = "Type of the event.")
  ...
  public EventsLogs createTime(String createTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-10-29T15:57:38Z", value = "The time of the generation of a event.")
   ...
   * @return the EventsLogs instance itself
   */
  public EventsLogs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsLogs eventsLogs = (EventsLogs) o;
    return Objects.equals(this.id, eventsLogs.id) &&
        Objects.equals(this.clusterName, eventsLogs.clusterName) &&
        Objects.equals(this.eventType, eventsLogs.eventType) &&
        Objects.equals(this.createTime, eventsLogs.createTime)&&
        Objects.equals(this.additionalProperties, eventsLogs.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsLogs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsLogs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsLogs is not found in the empty JSON string", EventsLogs.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsLogs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsLogs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsLogs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsLogs.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsLogs>() {
           @Override
           public void write(JsonWriter out, EventsLogs value) throws IOException {
           ...
           @Override
           public EventsLogs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsLogs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsLogs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsLogs
  * @throws IOException if the JSON string is invalid with respect to EventsLogs
  */
  public static EventsLogs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsLogs.class);
  }

 /**
  * Convert an instance of EventsLogs to an JSON string
  *
  * @return JSON string
  */
