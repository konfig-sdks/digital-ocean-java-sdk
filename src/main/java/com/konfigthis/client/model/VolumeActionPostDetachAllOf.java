...
public class VolumeActionPostDetachAllOf {
  ...
  **/
   ...
   * @return the VolumeActionPostDetachAllOf instance itself
   */
  public VolumeActionPostDetachAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletId, volumeActionPostDetachAllOf.dropletId)&&
        Objects.equals(this.additionalProperties, volumeActionPostDetachAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostDetachAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostDetachAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostDetachAllOf is not found in the empty JSON string", VolumeActionPostDetachAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostDetachAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostDetachAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostDetachAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostDetachAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostDetachAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostDetachAllOf>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostDetachAllOf value) throws IOException {
           ...
           @Override
           public VolumeActionPostDetachAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostDetachAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostDetachAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostDetachAllOf
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostDetachAllOf
  */
  public static VolumeActionPostDetachAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostDetachAllOf.class);
  }

 /**
  * Convert an instance of VolumeActionPostDetachAllOf to an JSON string
  *
  * @return JSON string
  */
