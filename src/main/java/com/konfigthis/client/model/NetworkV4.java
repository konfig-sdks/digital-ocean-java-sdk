...
public class NetworkV4 {
  ...
  **/
   ...
   * @return the NetworkV4 instance itself
   */
  public NetworkV4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ipAddress, networkV4.ipAddress) &&
        Objects.equals(this.netmask, networkV4.netmask) &&
        Objects.equals(this.gateway, networkV4.gateway) &&
        Objects.equals(this.type, networkV4.type)&&
        Objects.equals(this.additionalProperties, networkV4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkV4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkV4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkV4 is not found in the empty JSON string", NetworkV4.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkV4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkV4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkV4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkV4.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkV4>() {
           @Override
           public void write(JsonWriter out, NetworkV4 value) throws IOException {
           ...
           @Override
           public NetworkV4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkV4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkV4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkV4
  * @throws IOException if the JSON string is invalid with respect to NetworkV4
  */
  public static NetworkV4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkV4.class);
  }

 /**
  * Convert an instance of NetworkV4 to an JSON string
  *
  * @return JSON string
  */
