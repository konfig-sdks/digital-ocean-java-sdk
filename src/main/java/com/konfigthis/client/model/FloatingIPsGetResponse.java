...
public class FloatingIPsGetResponse {
  public static final String SERIALIZED_NAME_FLOATING_IP = "floating_ip";
  @SerializedName(SERIALIZED_NAME_FLOATING_IP)
  private FloatingIp floatingIp;

  public FloatingIPsGetResponse() {
  }

  public FloatingIPsGetResponse floatingIp(FloatingIp floatingIp) {
  ...
  **/
   ...
   * @return the FloatingIPsGetResponse instance itself
   */
  public FloatingIPsGetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIPsGetResponse floatingIPsGetResponse = (FloatingIPsGetResponse) o;
    return Objects.equals(this.floatingIp, floatingIPsGetResponse.floatingIp)&&
        Objects.equals(this.additionalProperties, floatingIPsGetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIPsGetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIPsGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIPsGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIPsGetResponse is not found in the empty JSON string", FloatingIPsGetResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIPsGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIPsGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIPsGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIPsGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIPsGetResponse>() {
           @Override
           public void write(JsonWriter out, FloatingIPsGetResponse value) throws IOException {
           ...
           @Override
           public FloatingIPsGetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIPsGetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIPsGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIPsGetResponse
  * @throws IOException if the JSON string is invalid with respect to FloatingIPsGetResponse
  */
  public static FloatingIPsGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIPsGetResponse.class);
  }

 /**
  * Convert an instance of FloatingIPsGetResponse to an JSON string
  *
  * @return JSON string
  */
