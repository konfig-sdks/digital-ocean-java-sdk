...
public class LinkToPrevPage {
  ...
  **/
   ...
   * @return the LinkToPrevPage instance itself
   */
  public LinkToPrevPage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.prev, linkToPrevPage.prev)&&
        Objects.equals(this.additionalProperties, linkToPrevPage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prev, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkToPrevPage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkToPrevPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkToPrevPage is not found in the empty JSON string", LinkToPrevPage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkToPrevPage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkToPrevPage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkToPrevPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkToPrevPage.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkToPrevPage>() {
           @Override
           public void write(JsonWriter out, LinkToPrevPage value) throws IOException {
           ...
           @Override
           public LinkToPrevPage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LinkToPrevPage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LinkToPrevPage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkToPrevPage
  * @throws IOException if the JSON string is invalid with respect to LinkToPrevPage
  */
  public static LinkToPrevPage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkToPrevPage.class);
  }

 /**
  * Convert an instance of LinkToPrevPage to an JSON string
  *
  * @return JSON string
  */
