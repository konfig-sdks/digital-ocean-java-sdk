...
import com.konfigthis.client.model.DockerCredentialsAuthsRegistryDigitaloceanCom;
...
public class DockerCredentialsAuths {
  public static final String SERIALIZED_NAME_REGISTRY_DIGITALOCEAN_COM = "registry.digitalocean.com";
  @SerializedName(SERIALIZED_NAME_REGISTRY_DIGITALOCEAN_COM)
  private DockerCredentialsAuthsRegistryDigitaloceanCom registryDigitaloceanCom;

  public DockerCredentialsAuths() {
  }

  public DockerCredentialsAuths registryDigitaloceanCom(DockerCredentialsAuthsRegistryDigitaloceanCom registryDigitaloceanCom) {
  ...
  **/
   ...
   * @return the DockerCredentialsAuths instance itself
   */
  public DockerCredentialsAuths putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.registryDigitaloceanCom, dockerCredentialsAuths.registryDigitaloceanCom)&&
        Objects.equals(this.additionalProperties, dockerCredentialsAuths.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(registryDigitaloceanCom, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("registry.digitalocean.com");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DockerCredentialsAuths
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DockerCredentialsAuths.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DockerCredentialsAuths is not found in the empty JSON string", DockerCredentialsAuths.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `registry.digitalocean.com`
      if (jsonObj.get("registry.digitalocean.com") != null && !jsonObj.get("registry.digitalocean.com").isJsonNull()) {
        DockerCredentialsAuthsRegistryDigitaloceanCom.validateJsonObject(jsonObj.getAsJsonObject("registry.digitalocean.com"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DockerCredentialsAuths.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DockerCredentialsAuths' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DockerCredentialsAuths> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DockerCredentialsAuths.class));

       return (TypeAdapter<T>) new TypeAdapter<DockerCredentialsAuths>() {
           @Override
           public void write(JsonWriter out, DockerCredentialsAuths value) throws IOException {
           ...
           @Override
           public DockerCredentialsAuths read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DockerCredentialsAuths instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DockerCredentialsAuths given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DockerCredentialsAuths
  * @throws IOException if the JSON string is invalid with respect to DockerCredentialsAuths
  */
  public static DockerCredentialsAuths fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DockerCredentialsAuths.class);
  }

 /**
  * Convert an instance of DockerCredentialsAuths to an JSON string
  *
  * @return JSON string
  */
