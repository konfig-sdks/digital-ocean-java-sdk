...
public class VolumeActionPostResize {
  ...
  **/
   ...
   * @return the VolumeActionPostResize instance itself
   */
  public VolumeActionPostResize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, volumeActionPostResize.type) &&
        ...
        Objects.equals(this.additionalProperties, volumeActionPostResize.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, region, sizeGigabytes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostResize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostResize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostResize is not found in the empty JSON string", VolumeActionPostResize.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostResize.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostResize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostResize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostResize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostResize.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostResize>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostResize value) throws IOException {
           ...
           @Override
           public VolumeActionPostResize read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostResize instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostResize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostResize
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostResize
  */
  public static VolumeActionPostResize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostResize.class);
  }

 /**
  * Convert an instance of VolumeActionPostResize to an JSON string
  *
  * @return JSON string
  */
