...
public class AppAlertProgressStepReason {
  ...
  **/
   ...
   * @return the AppAlertProgressStepReason instance itself
   */
  public AppAlertProgressStepReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, appAlertProgressStepReason.code) &&
        ...
        Objects.equals(this.additionalProperties, appAlertProgressStepReason.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppAlertProgressStepReason
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppAlertProgressStepReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAlertProgressStepReason is not found in the empty JSON string", AppAlertProgressStepReason.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAlertProgressStepReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAlertProgressStepReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAlertProgressStepReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAlertProgressStepReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAlertProgressStepReason>() {
           @Override
           public void write(JsonWriter out, AppAlertProgressStepReason value) throws IOException {
           ...
           @Override
           public AppAlertProgressStepReason read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppAlertProgressStepReason instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppAlertProgressStepReason given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppAlertProgressStepReason
  * @throws IOException if the JSON string is invalid with respect to AppAlertProgressStepReason
  */
  public static AppAlertProgressStepReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAlertProgressStepReason.class);
  }

 /**
  * Convert an instance of AppAlertProgressStepReason to an JSON string
  *
  * @return JSON string
  */
