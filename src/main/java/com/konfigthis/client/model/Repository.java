...
public class Repository {
  ...
  public static final String SERIALIZED_NAME_LATEST_TAG = "latest_tag";
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.registryName, repository.registryName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(registryName, name, latestTag, tagCount, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `latest_tag`
      if (jsonObj.get("latest_tag") != null && !jsonObj.get("latest_tag").isJsonNull()) {
        RepositoryTag.validateJsonObject(jsonObj.getAsJsonObject("latest_tag"));
      }
  }
