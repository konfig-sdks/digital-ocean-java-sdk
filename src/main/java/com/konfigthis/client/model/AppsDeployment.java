...
public class AppsDeployment {
  ...
  **/
   ...
   * @return the AppsDeployment instance itself
   */
  public AppsDeployment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cause, appsDeployment.cause) &&
        ...
        Objects.equals(this.id, appsDeployment.id) &&
        Objects.equals(this.jobs, appsDeployment.jobs) &&
        ...
        Objects.equals(this.additionalProperties, appsDeployment.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeployment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeployment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeployment is not found in the empty JSON string", AppsDeployment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeployment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeployment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeployment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeployment.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeployment>() {
           @Override
           public void write(JsonWriter out, AppsDeployment value) throws IOException {
           ...
           @Override
           public AppsDeployment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeployment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeployment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeployment
  * @throws IOException if the JSON string is invalid with respect to AppsDeployment
  */
  public static AppsDeployment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeployment.class);
  }

 /**
  * Convert an instance of AppsDeployment to an JSON string
  *
  * @return JSON string
  */
