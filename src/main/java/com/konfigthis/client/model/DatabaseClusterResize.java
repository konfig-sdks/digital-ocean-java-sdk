...
public class DatabaseClusterResize {
  ...
  **/
  ...
  public DatabaseClusterResize storageSizeMib(Integer storageSizeMib) {
  ...
  **/
   ...
   * @return the DatabaseClusterResize instance itself
   */
  public DatabaseClusterResize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.size, databaseClusterResize.size) &&
        ...
        Objects.equals(this.storageSizeMib, databaseClusterResize.storageSizeMib)&&
        Objects.equals(this.additionalProperties, databaseClusterResize.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(size, numNodes, storageSizeMib, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseClusterResize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseClusterResize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseClusterResize is not found in the empty JSON string", DatabaseClusterResize.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseClusterResize.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseClusterResize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseClusterResize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseClusterResize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseClusterResize.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseClusterResize>() {
           @Override
           public void write(JsonWriter out, DatabaseClusterResize value) throws IOException {
           ...
           @Override
           public DatabaseClusterResize read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseClusterResize instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseClusterResize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseClusterResize
  * @throws IOException if the JSON string is invalid with respect to DatabaseClusterResize
  */
  public static DatabaseClusterResize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseClusterResize.class);
  }

 /**
  * Convert an instance of DatabaseClusterResize to an JSON string
  *
  * @return JSON string
  */
