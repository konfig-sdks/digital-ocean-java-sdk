...
public class ClusterlintRequest {
  ...
  public static final String SERIALIZED_NAME_INCLUDE_CHECKS = "include_checks";
  @SerializedName(SERIALIZED_NAME_INCLUDE_CHECKS)
  private List<String> includeChecks = null;

  public static final String SERIALIZED_NAME_EXCLUDE_GROUPS = "exclude_groups";
  @SerializedName(SERIALIZED_NAME_EXCLUDE_GROUPS)
  private List<String> excludeGroups = null;

  public static final String SERIALIZED_NAME_EXCLUDE_CHECKS = "exclude_checks";
  @SerializedName(SERIALIZED_NAME_EXCLUDE_CHECKS)
  ...
  **/
   ...
   * @return the ClusterlintRequest instance itself
   */
  public ClusterlintRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeGroups, clusterlintRequest.includeGroups) &&
        ...
        Objects.equals(this.additionalProperties, clusterlintRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(includeGroups, includeChecks, excludeGroups, excludeChecks, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("include_checks");
    openapiFields.add("exclude_groups");
    openapiFields.add("exclude_checks");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterlintRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterlintRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterlintRequest is not found in the empty JSON string", ClusterlintRequest.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("include_groups") != null && !jsonObj.get("include_groups").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `include_groups` to be an array in the JSON string but got `%s`", jsonObj.get("include_groups").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("include_checks") != null && !jsonObj.get("include_checks").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `include_checks` to be an array in the JSON string but got `%s`", jsonObj.get("include_checks").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("exclude_groups") != null && !jsonObj.get("exclude_groups").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `exclude_groups` to be an array in the JSON string but got `%s`", jsonObj.get("exclude_groups").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("exclude_checks") != null && !jsonObj.get("exclude_checks").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `exclude_checks` to be an array in the JSON string but got `%s`", jsonObj.get("exclude_checks").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterlintRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterlintRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterlintRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterlintRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterlintRequest>() {
           @Override
           public void write(JsonWriter out, ClusterlintRequest value) throws IOException {
           ...
           @Override
           public ClusterlintRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ClusterlintRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ClusterlintRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClusterlintRequest
  * @throws IOException if the JSON string is invalid with respect to ClusterlintRequest
  */
  public static ClusterlintRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterlintRequest.class);
  }

 /**
  * Convert an instance of ClusterlintRequest to an JSON string
  *
  * @return JSON string
  */
