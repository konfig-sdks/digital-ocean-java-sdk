...
public class DatabaseReplicaConnection {
  ...
  **/
   ...
   * @return the DatabaseReplicaConnection instance itself
   */
  public DatabaseReplicaConnection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uri, databaseReplicaConnection.uri) &&
        ...
        Objects.equals(this.additionalProperties, databaseReplicaConnection.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseReplicaConnection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseReplicaConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseReplicaConnection is not found in the empty JSON string", DatabaseReplicaConnection.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseReplicaConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseReplicaConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseReplicaConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseReplicaConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseReplicaConnection>() {
           @Override
           public void write(JsonWriter out, DatabaseReplicaConnection value) throws IOException {
           ...
           @Override
           public DatabaseReplicaConnection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseReplicaConnection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseReplicaConnection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseReplicaConnection
  * @throws IOException if the JSON string is invalid with respect to DatabaseReplicaConnection
  */
  public static DatabaseReplicaConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseReplicaConnection.class);
  }

 /**
  * Convert an instance of DatabaseReplicaConnection to an JSON string
  *
  * @return JSON string
  */
