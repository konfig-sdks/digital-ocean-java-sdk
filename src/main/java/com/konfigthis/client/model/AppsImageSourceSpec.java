...
import com.konfigthis.client.model.AppsImageSourceSpecDeployOnPush;
...
public class AppsImageSourceSpec {
 ...
 public enum RegistryTypeEnum {
  ...
  public static final String SERIALIZED_NAME_REGISTRY_CREDENTIALS = "registry_credentials";
  @SerializedName(SERIALIZED_NAME_REGISTRY_CREDENTIALS)
  ...
  public static final String SERIALIZED_NAME_DEPLOY_ON_PUSH = "deploy_on_push";
  @SerializedName(SERIALIZED_NAME_DEPLOY_ON_PUSH)
  private AppsImageSourceSpecDeployOnPush deployOnPush;
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DOCR", value = "- DOCKER_HUB: The DockerHub container registry type. - DOCR: The DigitalOcean container registry type. - GHCR: The Github container registry type.")
  ...
  public AppsImageSourceSpec registryCredentials(String registryCredentials) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "my-dockerhub-username:dckr_pat_the_access_token", value = "The credentials to be able to pull the image. The value will be encrypted on first submission. On following submissions, the encrypted value should be used. - \"$username:$access_token\" for registries of type `DOCKER_HUB`. - \"$username:$access_token\" for registries of type `GHCR`.")

  public String getRegistryCredentials() {
    return registryCredentials;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "latest", value = "The repository tag. Defaults to `latest` if not provided and no digest is provided. Cannot be specified if digest is provided.")
  ...
  public AppsImageSourceSpec digest(String digest) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "sha256:795e91610e9cccb7bb80893fbabf9c808df7d52ae1f39cd1158618b4a33041ac", value = "The image digest. Cannot be specified if tag is provided.")
  ...
  public AppsImageSourceSpec deployOnPush(AppsImageSourceSpecDeployOnPush deployOnPush) {
  ...
  **/
  ...
  public AppsImageSourceSpecDeployOnPush getDeployOnPush() {
    return deployOnPush;
  }


  public void setDeployOnPush(AppsImageSourceSpecDeployOnPush deployOnPush) {
   ...
   * @return the AppsImageSourceSpec instance itself
   */
  public AppsImageSourceSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.registry, appsImageSourceSpec.registry) &&
        ...
        Objects.equals(this.registryCredentials, appsImageSourceSpec.registryCredentials) &&
        Objects.equals(this.repository, appsImageSourceSpec.repository) &&
        Objects.equals(this.tag, appsImageSourceSpec.tag) &&
        Objects.equals(this.digest, appsImageSourceSpec.digest) &&
        Objects.equals(this.deployOnPush, appsImageSourceSpec.deployOnPush)&&
        Objects.equals(this.additionalProperties, appsImageSourceSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(registry, registryType, registryCredentials, repository, tag, digest, deployOnPush, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    registryCredentials: ").append(toIndentedString(registryCredentials)).append("\n");
  ...
  static {
    ...
    openapiFields.add("registry_credentials");
    openapiFields.add("repository");
    openapiFields.add("tag");
    openapiFields.add("digest");
    openapiFields.add("deploy_on_push");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsImageSourceSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsImageSourceSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsImageSourceSpec is not found in the empty JSON string", AppsImageSourceSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("registry_credentials") != null && !jsonObj.get("registry_credentials").isJsonNull()) && !jsonObj.get("registry_credentials").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `registry_credentials` to be a primitive type in the JSON string but got `%s`", jsonObj.get("registry_credentials").toString()));
      }
      ...
      // validate the optional field `deploy_on_push`
      if (jsonObj.get("deploy_on_push") != null && !jsonObj.get("deploy_on_push").isJsonNull()) {
        AppsImageSourceSpecDeployOnPush.validateJsonObject(jsonObj.getAsJsonObject("deploy_on_push"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsImageSourceSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsImageSourceSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsImageSourceSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsImageSourceSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsImageSourceSpec>() {
           @Override
           public void write(JsonWriter out, AppsImageSourceSpec value) throws IOException {
           ...
           @Override
           public AppsImageSourceSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsImageSourceSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsImageSourceSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsImageSourceSpec
  * @throws IOException if the JSON string is invalid with respect to AppsImageSourceSpec
  */
  public static AppsImageSourceSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsImageSourceSpec.class);
  }

 /**
  * Convert an instance of AppsImageSourceSpec to an JSON string
  *
  * @return JSON string
  */
