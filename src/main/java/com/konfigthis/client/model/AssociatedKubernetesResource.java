...
public class AssociatedKubernetesResource {
  ...
  **/
   ...
   * @return the AssociatedKubernetesResource instance itself
   */
  public AssociatedKubernetesResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, associatedKubernetesResource.id) &&
        ...
        Objects.equals(this.additionalProperties, associatedKubernetesResource.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AssociatedKubernetesResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssociatedKubernetesResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociatedKubernetesResource is not found in the empty JSON string", AssociatedKubernetesResource.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociatedKubernetesResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociatedKubernetesResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociatedKubernetesResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociatedKubernetesResource.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociatedKubernetesResource>() {
           @Override
           public void write(JsonWriter out, AssociatedKubernetesResource value) throws IOException {
           ...
           @Override
           public AssociatedKubernetesResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AssociatedKubernetesResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AssociatedKubernetesResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AssociatedKubernetesResource
  * @throws IOException if the JSON string is invalid with respect to AssociatedKubernetesResource
  */
  public static AssociatedKubernetesResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociatedKubernetesResource.class);
  }

 /**
  * Convert an instance of AssociatedKubernetesResource to an JSON string
  *
  * @return JSON string
  */
