...
public class Version2 {
  ...
  public Version2 version(String version) {
  ...
  **/
   ...
   * @return the Version2 instance itself
   */
  public Version2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Version2 version2 = (Version2) o;
    return Objects.equals(this.version, version2.version)&&
        Objects.equals(this.additionalProperties, version2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Version2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Version2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Version2 is not found in the empty JSON string", Version2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Version2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Version2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Version2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Version2.class));

       return (TypeAdapter<T>) new TypeAdapter<Version2>() {
           @Override
           public void write(JsonWriter out, Version2 value) throws IOException {
           ...
           @Override
           public Version2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Version2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Version2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Version2
  * @throws IOException if the JSON string is invalid with respect to Version2
  */
  public static Version2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Version2.class);
  }

 /**
  * Convert an instance of Version2 to an JSON string
  *
  * @return JSON string
  */
