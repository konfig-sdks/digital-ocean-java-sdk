...
public class VolumeFull {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "10", value = "The size of the block storage volume in GiB (1024^3). This field does not apply  when creating a volume from a snapshot.")
  ...
  **/
   ...
   * @return the VolumeFull instance itself
   */
  public VolumeFull putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, volumeFull.tags) &&
        Objects.equals(this.description, volumeFull.description) &&
        Objects.equals(this.id, volumeFull.id) &&
        Objects.equals(this.dropletIds, volumeFull.dropletIds) &&
        Objects.equals(this.name, volumeFull.name) &&
        Objects.equals(this.sizeGigabytes, volumeFull.sizeGigabytes) &&
        Objects.equals(this.createdAt, volumeFull.createdAt) &&
        ...
        Objects.equals(this.additionalProperties, volumeFull.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, id, dropletIds, name, sizeGigabytes, createdAt, region, filesystemType, filesystemLabel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeFull
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeFull.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeFull is not found in the empty JSON string", VolumeFull.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("filesystem_label") != null && !jsonObj.get("filesystem_label").isJsonNull()) && !jsonObj.get("filesystem_label").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `filesystem_label` to be a primitive type in the JSON string but got `%s`", jsonObj.get("filesystem_label").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeFull.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeFull' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeFull> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeFull.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeFull>() {
           @Override
           public void write(JsonWriter out, VolumeFull value) throws IOException {
           ...
           @Override
           public VolumeFull read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeFull instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeFull given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeFull
  * @throws IOException if the JSON string is invalid with respect to VolumeFull
  */
  public static VolumeFull fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeFull.class);
  }

 /**
  * Convert an instance of VolumeFull to an JSON string
  *
  * @return JSON string
  */
