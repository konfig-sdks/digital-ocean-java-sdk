...
public class AppsDeploymentResponse {
  ...
  **/
   ...
   * @return the AppsDeploymentResponse instance itself
   */
  public AppsDeploymentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deployment, appsDeploymentResponse.deployment)&&
        Objects.equals(this.additionalProperties, appsDeploymentResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentResponse is not found in the empty JSON string", AppsDeploymentResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `deployment`
      if (jsonObj.get("deployment") != null && !jsonObj.get("deployment").isJsonNull()) {
        AppsDeployment.validateJsonObject(jsonObj.getAsJsonObject("deployment"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentResponse>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentResponse value) throws IOException {
           ...
           @Override
           public AppsDeploymentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentResponse
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentResponse
  */
  public static AppsDeploymentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentResponse.class);
  }

 /**
  * Convert an instance of AppsDeploymentResponse to an JSON string
  *
  * @return JSON string
  */
