...
public class FirewallsAddTagsRequest {
  ...
  public FirewallsAddTagsRequest tags(List tags) {
  ...
  **/
   ...
   * @return the FirewallsAddTagsRequest instance itself
   */
  public FirewallsAddTagsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsAddTagsRequest firewallsAddTagsRequest = (FirewallsAddTagsRequest) o;
    return Objects.equals(this.tags, firewallsAddTagsRequest.tags)&&
        Objects.equals(this.additionalProperties, firewallsAddTagsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsAddTagsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsAddTagsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsAddTagsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsAddTagsRequest is not found in the empty JSON string", FirewallsAddTagsRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsAddTagsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsAddTagsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsAddTagsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsAddTagsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsAddTagsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsAddTagsRequest>() {
           @Override
           public void write(JsonWriter out, FirewallsAddTagsRequest value) throws IOException {
           ...
           @Override
           public FirewallsAddTagsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsAddTagsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsAddTagsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsAddTagsRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallsAddTagsRequest
  */
  public static FirewallsAddTagsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsAddTagsRequest.class);
  }

 /**
  * Convert an instance of FirewallsAddTagsRequest to an JSON string
  *
  * @return JSON string
  */
