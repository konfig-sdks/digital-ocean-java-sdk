...
public class InvoiceItem {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-02-01T00:00:00Z", value = "Time the invoice item stopped being billed for usage.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, product, resourceUuid, resourceId, groupDescription, amount, duration, durationUnit, startTime, endTime, projectName, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("group_description");
    openapiFields.add("amount");
    openapiFields.add("duration");
    openapiFields.add("duration_unit");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("group_description") != null && !jsonObj.get("group_description").isJsonNull()) && !jsonObj.get("group_description").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `group_description` to be a primitive type in the JSON string but got `%s`", jsonObj.get("group_description").toString()));
      }
      ...
      if ((jsonObj.get("duration_unit") != null && !jsonObj.get("duration_unit").isJsonNull()) && !jsonObj.get("duration_unit").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `duration_unit` to be a primitive type in the JSON string but got `%s`", jsonObj.get("duration_unit").toString()));
      }
