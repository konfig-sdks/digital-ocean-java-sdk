 ...
 */
@ApiModel(description = "Metadata about the Kubernetes API object the diagnostic is reported on.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ClusterlintResultsDiagnosticsInnerObject {
  ...
  **/
   ...
   * @return the ClusterlintResultsDiagnosticsInnerObject instance itself
   */
  public ClusterlintResultsDiagnosticsInnerObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, clusterlintResultsDiagnosticsInnerObject.name) &&
        ...
        Objects.equals(this.additionalProperties, clusterlintResultsDiagnosticsInnerObject.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, kind, namespace, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterlintResultsDiagnosticsInnerObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterlintResultsDiagnosticsInnerObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterlintResultsDiagnosticsInnerObject is not found in the empty JSON string", ClusterlintResultsDiagnosticsInnerObject.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterlintResultsDiagnosticsInnerObject.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterlintResultsDiagnosticsInnerObject' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterlintResultsDiagnosticsInnerObject> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterlintResultsDiagnosticsInnerObject.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterlintResultsDiagnosticsInnerObject>() {
           @Override
           public void write(JsonWriter out, ClusterlintResultsDiagnosticsInnerObject value) throws IOException {
           ...
           @Override
           public ClusterlintResultsDiagnosticsInnerObject read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ClusterlintResultsDiagnosticsInnerObject instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ClusterlintResultsDiagnosticsInnerObject given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClusterlintResultsDiagnosticsInnerObject
  * @throws IOException if the JSON string is invalid with respect to ClusterlintResultsDiagnosticsInnerObject
  */
  public static ClusterlintResultsDiagnosticsInnerObject fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterlintResultsDiagnosticsInnerObject.class);
  }

 /**
  * Convert an instance of ClusterlintResultsDiagnosticsInnerObject to an JSON string
  *
  * @return JSON string
  */
