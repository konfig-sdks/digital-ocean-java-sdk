...
public class FirewallRules {
  ...
  **/
   ...
   * @return the FirewallRules instance itself
   */
  public FirewallRules putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inboundRules, firewallRules.inboundRules) &&
        ...
        Objects.equals(this.additionalProperties, firewallRules.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRules
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FirewallRules>() {
           ...
           public FirewallRules read(JsonReader in) throws IOException {
             ...
             FirewallRules instance = thisAdapter.fromJsonTree(jsonObj);
