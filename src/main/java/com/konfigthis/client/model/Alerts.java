...
import com.konfigthis.client.model.SlackDetails;
...
public class Alerts {
  ...
  **/
   ...
   * @return the Alerts instance itself
   */
  public Alerts putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, alerts.email) &&
        Objects.equals(this.slack, alerts.slack)&&
        Objects.equals(this.additionalProperties, alerts.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Alerts
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Alerts.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Alerts.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayslack.size(); i++) {
        SlackDetails.validateJsonObject(jsonArrayslack.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Alerts>() {
           ...
           public Alerts read(JsonReader in) throws IOException {
             ...
             Alerts instance = thisAdapter.fromJsonTree(jsonObj);
