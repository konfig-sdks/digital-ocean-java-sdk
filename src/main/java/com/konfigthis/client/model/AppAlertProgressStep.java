...
import com.konfigthis.client.model.AppAlertProgressStepReason;
import com.konfigthis.client.model.AppAlertProgressStepStatus;
...
public class AppAlertProgressStep {
  ...
  **/
   ...
   * @return the AppAlertProgressStep instance itself
   */
  public AppAlertProgressStep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appAlertProgressStep.name) &&
        ...
        Objects.equals(this.additionalProperties, appAlertProgressStep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, status, startedAt, endedAt, reason, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppAlertProgressStep
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppAlertProgressStep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAlertProgressStep is not found in the empty JSON string", AppAlertProgressStep.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("reason") != null && !jsonObj.get("reason").isJsonNull()) {
        AppAlertProgressStepReason.validateJsonObject(jsonObj.getAsJsonObject("reason"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAlertProgressStep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAlertProgressStep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAlertProgressStep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAlertProgressStep.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAlertProgressStep>() {
           @Override
           public void write(JsonWriter out, AppAlertProgressStep value) throws IOException {
           ...
           @Override
           public AppAlertProgressStep read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppAlertProgressStep instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppAlertProgressStep given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppAlertProgressStep
  * @throws IOException if the JSON string is invalid with respect to AppAlertProgressStep
  */
  public static AppAlertProgressStep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAlertProgressStep.class);
  }

 /**
  * Convert an instance of AppAlertProgressStep to an JSON string
  *
  * @return JSON string
  */
