...
public class KafkaTopicCreateAllOf {
  public static final String SERIALIZED_NAME_CONFIG = "config";
  @SerializedName(SERIALIZED_NAME_CONFIG)
  private KafkaTopicConfig config;

  public KafkaTopicCreateAllOf() {
  }

  public KafkaTopicCreateAllOf config(KafkaTopicConfig config) {
  ...
  **/
   ...
   * @return the KafkaTopicCreateAllOf instance itself
   */
  public KafkaTopicCreateAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KafkaTopicCreateAllOf kafkaTopicCreateAllOf = (KafkaTopicCreateAllOf) o;
    return Objects.equals(this.config, kafkaTopicCreateAllOf.config)&&
        Objects.equals(this.additionalProperties, kafkaTopicCreateAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class KafkaTopicCreateAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to KafkaTopicCreateAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KafkaTopicCreateAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KafkaTopicCreateAllOf is not found in the empty JSON string", KafkaTopicCreateAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KafkaTopicCreateAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KafkaTopicCreateAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KafkaTopicCreateAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KafkaTopicCreateAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<KafkaTopicCreateAllOf>() {
           @Override
           public void write(JsonWriter out, KafkaTopicCreateAllOf value) throws IOException {
           ...
           @Override
           public KafkaTopicCreateAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KafkaTopicCreateAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KafkaTopicCreateAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KafkaTopicCreateAllOf
  * @throws IOException if the JSON string is invalid with respect to KafkaTopicCreateAllOf
  */
  public static KafkaTopicCreateAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KafkaTopicCreateAllOf.class);
  }

 /**
  * Convert an instance of KafkaTopicCreateAllOf to an JSON string
  *
  * @return JSON string
  */
