 ...
 */
@ApiModel(description = "An object specifying sticky sessions settings for the load balancer.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class StickySessions {
  ...
  **/
   ...
   * @return the StickySessions instance itself
   */
  public StickySessions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, stickySessions.type) &&
        ...
        Objects.equals(this.additionalProperties, stickySessions.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StickySessions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StickySessions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StickySessions is not found in the empty JSON string", StickySessions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StickySessions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StickySessions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StickySessions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StickySessions.class));

       return (TypeAdapter<T>) new TypeAdapter<StickySessions>() {
           @Override
           public void write(JsonWriter out, StickySessions value) throws IOException {
           ...
           @Override
           public StickySessions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             StickySessions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of StickySessions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StickySessions
  * @throws IOException if the JSON string is invalid with respect to StickySessions
  */
  public static StickySessions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StickySessions.class);
  }

 /**
  * Convert an instance of StickySessions to an JSON string
  *
  * @return JSON string
  */
