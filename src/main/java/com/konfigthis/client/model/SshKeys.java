...
public class SshKeys {
  ...
  **/
  ...
  public SshKeys publicKey(String publicKey) {
  ...
  **/
  ...
  public SshKeys name(String name) {
  ...
  **/
   ...
   * @return the SshKeys instance itself
   */
  public SshKeys putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeys sshKeys = (SshKeys) o;
    return Objects.equals(this.id, sshKeys.id) &&
        Objects.equals(this.fingerprint, sshKeys.fingerprint) &&
        Objects.equals(this.publicKey, sshKeys.publicKey) &&
        Objects.equals(this.name, sshKeys.name)&&
        Objects.equals(this.additionalProperties, sshKeys.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, fingerprint, publicKey, name, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeys {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeys
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeys.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeys is not found in the empty JSON string", SshKeys.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeys.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeys.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeys' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeys> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeys.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeys>() {
           @Override
           public void write(JsonWriter out, SshKeys value) throws IOException {
           ...
           @Override
           public SshKeys read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeys instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeys given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeys
  * @throws IOException if the JSON string is invalid with respect to SshKeys
  */
  public static SshKeys fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeys.class);
  }

 /**
  * Convert an instance of SshKeys to an JSON string
  *
  * @return JSON string
  */
