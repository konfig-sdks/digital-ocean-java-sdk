...
public class InvoiceSummaryCreditsAndAdjustments {
  ...
  **/
   ...
   * @return the InvoiceSummaryCreditsAndAdjustments instance itself
   */
  public InvoiceSummaryCreditsAndAdjustments putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, invoiceSummaryCreditsAndAdjustments.name) &&
        ...
        Objects.equals(this.additionalProperties, invoiceSummaryCreditsAndAdjustments.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceSummaryCreditsAndAdjustments
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceSummaryCreditsAndAdjustments.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceSummaryCreditsAndAdjustments is not found in the empty JSON string", InvoiceSummaryCreditsAndAdjustments.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceSummaryCreditsAndAdjustments.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceSummaryCreditsAndAdjustments' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceSummaryCreditsAndAdjustments> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceSummaryCreditsAndAdjustments.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceSummaryCreditsAndAdjustments>() {
           @Override
           public void write(JsonWriter out, InvoiceSummaryCreditsAndAdjustments value) throws IOException {
           ...
           @Override
           public InvoiceSummaryCreditsAndAdjustments read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceSummaryCreditsAndAdjustments instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceSummaryCreditsAndAdjustments given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceSummaryCreditsAndAdjustments
  * @throws IOException if the JSON string is invalid with respect to InvoiceSummaryCreditsAndAdjustments
  */
  public static InvoiceSummaryCreditsAndAdjustments fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceSummaryCreditsAndAdjustments.class);
  }

 /**
  * Convert an instance of InvoiceSummaryCreditsAndAdjustments to an JSON string
  *
  * @return JSON string
  */
