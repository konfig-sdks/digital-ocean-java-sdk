...
import com.konfigthis.client.model.ClusterlintResultsDiagnosticsInnerObject;
...
public class ClusterlintResultsDiagnosticsInner {
  ...
  **/
   ...
   * @return the ClusterlintResultsDiagnosticsInner instance itself
   */
  public ClusterlintResultsDiagnosticsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.checkName, clusterlintResultsDiagnosticsInner.checkName) &&
        ...
        Objects.equals(this.additionalProperties, clusterlintResultsDiagnosticsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checkName, severity, message, _object, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterlintResultsDiagnosticsInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterlintResultsDiagnosticsInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterlintResultsDiagnosticsInner is not found in the empty JSON string", ClusterlintResultsDiagnosticsInner.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("check_name") != null && !jsonObj.get("check_name").isJsonNull()) && !jsonObj.get("check_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `check_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("check_name").toString()));
      }
      ...
      if (jsonObj.get("object") != null && !jsonObj.get("object").isJsonNull()) {
        ClusterlintResultsDiagnosticsInnerObject.validateJsonObject(jsonObj.getAsJsonObject("object"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterlintResultsDiagnosticsInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterlintResultsDiagnosticsInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterlintResultsDiagnosticsInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterlintResultsDiagnosticsInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterlintResultsDiagnosticsInner>() {
           @Override
           public void write(JsonWriter out, ClusterlintResultsDiagnosticsInner value) throws IOException {
           ...
           @Override
           public ClusterlintResultsDiagnosticsInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ClusterlintResultsDiagnosticsInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ClusterlintResultsDiagnosticsInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClusterlintResultsDiagnosticsInner
  * @throws IOException if the JSON string is invalid with respect to ClusterlintResultsDiagnosticsInner
  */
  public static ClusterlintResultsDiagnosticsInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterlintResultsDiagnosticsInner.class);
  }

 /**
  * Convert an instance of ClusterlintResultsDiagnosticsInner to an JSON string
  *
  * @return JSON string
  */
