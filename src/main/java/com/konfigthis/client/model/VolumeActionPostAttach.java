...
public class VolumeActionPostAttach {
  ...
  **/
   ...
   * @return the VolumeActionPostAttach instance itself
   */
  public VolumeActionPostAttach putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, volumeActionPostAttach.type) &&
        ...
        Objects.equals(this.additionalProperties, volumeActionPostAttach.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostAttach
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostAttach.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostAttach is not found in the empty JSON string", VolumeActionPostAttach.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostAttach.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostAttach.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostAttach' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostAttach> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostAttach.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostAttach>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostAttach value) throws IOException {
           ...
           @Override
           public VolumeActionPostAttach read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostAttach instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostAttach given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostAttach
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostAttach
  */
  public static VolumeActionPostAttach fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostAttach.class);
  }

 /**
  * Convert an instance of VolumeActionPostAttach to an JSON string
  *
  * @return JSON string
  */
