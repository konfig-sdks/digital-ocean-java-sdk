...
public class VolumesCreateResponse {
  ...
  public VolumesCreateResponse volume(VolumeFull volume) {
  ...
  **/
   ...
   * @return the VolumesCreateResponse instance itself
   */
  public VolumesCreateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesCreateResponse volumesCreateResponse = (VolumesCreateResponse) o;
    return Objects.equals(this.volume, volumesCreateResponse.volume)&&
        Objects.equals(this.additionalProperties, volumesCreateResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(volume, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VolumesCreateResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesCreateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesCreateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesCreateResponse is not found in the empty JSON string", VolumesCreateResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `volume`
      if (jsonObj.get("volume") != null && !jsonObj.get("volume").isJsonNull()) {
        VolumeFull.validateJsonObject(jsonObj.getAsJsonObject("volume"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesCreateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesCreateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesCreateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesCreateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesCreateResponse>() {
           @Override
           public void write(JsonWriter out, VolumesCreateResponse value) throws IOException {
           ...
           @Override
           public VolumesCreateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesCreateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesCreateResponse
  * @throws IOException if the JSON string is invalid with respect to VolumesCreateResponse
  */
  public static VolumesCreateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesCreateResponse.class);
  }

 /**
  * Convert an instance of VolumesCreateResponse to an JSON string
  *
  * @return JSON string
  */
