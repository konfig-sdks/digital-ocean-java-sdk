...
public class FirewallRuleBase {
  ...
  **/
   ...
   * @return the FirewallRuleBase instance itself
   */
  public FirewallRuleBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.protocol, firewallRuleBase.protocol) &&
        ...
        Objects.equals(this.additionalProperties, firewallRuleBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(protocol, ports, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRuleBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRuleBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRuleBase is not found in the empty JSON string", FirewallRuleBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallRuleBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRuleBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRuleBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRuleBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRuleBase.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRuleBase>() {
           @Override
           public void write(JsonWriter out, FirewallRuleBase value) throws IOException {
           ...
           @Override
           public FirewallRuleBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRuleBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRuleBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRuleBase
  * @throws IOException if the JSON string is invalid with respect to FirewallRuleBase
  */
  public static FirewallRuleBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRuleBase.class);
  }

 /**
  * Convert an instance of FirewallRuleBase to an JSON string
  *
  * @return JSON string
  */
