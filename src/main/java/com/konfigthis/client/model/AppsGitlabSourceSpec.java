...
public class AppsGitlabSourceSpec {
  ...
  **/
   ...
   * @return the AppsGitlabSourceSpec instance itself
   */
  public AppsGitlabSourceSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branch, appsGitlabSourceSpec.branch) &&
        ...
        Objects.equals(this.additionalProperties, appsGitlabSourceSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branch, deployOnPush, repo, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsGitlabSourceSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsGitlabSourceSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsGitlabSourceSpec is not found in the empty JSON string", AppsGitlabSourceSpec.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsGitlabSourceSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsGitlabSourceSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsGitlabSourceSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsGitlabSourceSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsGitlabSourceSpec>() {
           @Override
           public void write(JsonWriter out, AppsGitlabSourceSpec value) throws IOException {
           ...
           @Override
           public AppsGitlabSourceSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsGitlabSourceSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsGitlabSourceSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsGitlabSourceSpec
  * @throws IOException if the JSON string is invalid with respect to AppsGitlabSourceSpec
  */
  public static AppsGitlabSourceSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsGitlabSourceSpec.class);
  }

 /**
  * Convert an instance of AppsGitlabSourceSpec to an JSON string
  *
  * @return JSON string
  */
