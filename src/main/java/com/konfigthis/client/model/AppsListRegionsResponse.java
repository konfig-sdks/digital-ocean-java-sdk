...
public class AppsListRegionsResponse {
  ...
  **/
   ...
   * @return the AppsListRegionsResponse instance itself
   */
  public AppsListRegionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.regions, appsListRegionsResponse.regions)&&
        Objects.equals(this.additionalProperties, appsListRegionsResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsListRegionsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsListRegionsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsListRegionsResponse is not found in the empty JSON string", AppsListRegionsResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("regions") != null && !jsonObj.get("regions").isJsonNull()) {
        ...
        if (jsonArrayregions != null) {
          ...
          for (int i = 0; i < jsonArrayregions.size(); i++) {
            AppsRegion.validateJsonObject(jsonArrayregions.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsListRegionsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsListRegionsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsListRegionsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsListRegionsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsListRegionsResponse>() {
           @Override
           public void write(JsonWriter out, AppsListRegionsResponse value) throws IOException {
           ...
           @Override
           public AppsListRegionsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsListRegionsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsListRegionsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsListRegionsResponse
  * @throws IOException if the JSON string is invalid with respect to AppsListRegionsResponse
  */
  public static AppsListRegionsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsListRegionsResponse.class);
  }

 /**
  * Convert an instance of AppsListRegionsResponse to an JSON string
  *
  * @return JSON string
  */
