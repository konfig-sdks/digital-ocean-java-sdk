 ...
 */
@ApiModel(description = "An object specifying allow and deny rules to control traffic to the load balancer.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class LbFirewall {
  ...
  public LbFirewall deny(List<String> deny) {
  ...
  public LbFirewall addDenyItem(String denyItem) {
    if (this.deny == null) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"ip:1.2.3.4\",\"cidr:2.3.0.0/16\"]", value = "the rules for denying traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')")
  ...
  public LbFirewall allow(List<String> allow) {
  ...
  public LbFirewall addAllowItem(String allowItem) {
    if (this.allow == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"ip:1.2.3.4\",\"cidr:2.3.0.0/16\"]", value = "the rules for allowing traffic to the load balancer (in the form 'ip:1.2.3.4' or 'cidr:1.2.0.0/16')")
   ...
   * @return the LbFirewall instance itself
   */
  public LbFirewall putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LbFirewall lbFirewall = (LbFirewall) o;
    return Objects.equals(this.deny, lbFirewall.deny) &&
        Objects.equals(this.allow, lbFirewall.allow)&&
        Objects.equals(this.additionalProperties, lbFirewall.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LbFirewall
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LbFirewall.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LbFirewall is not found in the empty JSON string", LbFirewall.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LbFirewall.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LbFirewall' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LbFirewall> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LbFirewall.class));

       return (TypeAdapter<T>) new TypeAdapter<LbFirewall>() {
           @Override
           public void write(JsonWriter out, LbFirewall value) throws IOException {
           ...
           @Override
           public LbFirewall read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LbFirewall instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LbFirewall given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LbFirewall
  * @throws IOException if the JSON string is invalid with respect to LbFirewall
  */
  public static LbFirewall fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LbFirewall.class);
  }

 /**
  * Convert an instance of LbFirewall to an JSON string
  *
  * @return JSON string
  */
