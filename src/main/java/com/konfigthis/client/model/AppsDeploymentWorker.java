...
public class AppsDeploymentWorker {
  ...
  **/
   ...
   * @return the AppsDeploymentWorker instance itself
   */
  public AppsDeploymentWorker putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appsDeploymentWorker.name) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentWorker.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentWorker
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentWorker.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentWorker is not found in the empty JSON string", AppsDeploymentWorker.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentWorker.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentWorker' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentWorker> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentWorker.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentWorker>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentWorker value) throws IOException {
           ...
           @Override
           public AppsDeploymentWorker read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentWorker instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentWorker given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentWorker
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentWorker
  */
  public static AppsDeploymentWorker fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentWorker.class);
  }

 /**
  * Convert an instance of AppsDeploymentWorker to an JSON string
  *
  * @return JSON string
  */
