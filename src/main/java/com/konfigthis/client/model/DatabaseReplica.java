...
public class DatabaseReplica {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "9cc10173-e9ea-4176-9dbc-a4cee4c4ff30", value = "A unique ID that can be used to identify and reference a database replica.")
  ...
  **/
  ...
  public DatabaseReplica storageSizeMib(Integer storageSizeMib) {
  ...
  **/
   ...
   * @return the DatabaseReplica instance itself
   */
  public DatabaseReplica putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, databaseReplica.tags) &&
        Objects.equals(this.id, databaseReplica.id) &&
        Objects.equals(this.name, databaseReplica.name) &&
        Objects.equals(this.region, databaseReplica.region) &&
        ...
        Objects.equals(this.storageSizeMib, databaseReplica.storageSizeMib)&&
        Objects.equals(this.additionalProperties, databaseReplica.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, id, name, region, size, status, createdAt, privateNetworkUuid, connection, privateConnection, storageSizeMib, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseReplica
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseReplica.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseReplica is not found in the empty JSON string", DatabaseReplica.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseReplica.openapiRequiredFields) {
      ...
      if (jsonObj.get("connection") != null && !jsonObj.get("connection").isJsonNull()) {
        DatabaseReplicaConnection.validateJsonObject(jsonObj.getAsJsonObject("connection"));
      }
      ...
      if (jsonObj.get("private_connection") != null && !jsonObj.get("private_connection").isJsonNull()) {
        DatabaseReplicaConnection.validateJsonObject(jsonObj.getAsJsonObject("private_connection"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseReplica.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseReplica' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseReplica> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseReplica.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseReplica>() {
           @Override
           public void write(JsonWriter out, DatabaseReplica value) throws IOException {
           ...
           @Override
           public DatabaseReplica read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseReplica instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseReplica given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseReplica
  * @throws IOException if the JSON string is invalid with respect to DatabaseReplica
  */
  public static DatabaseReplica fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseReplica.class);
  }

 /**
  * Convert an instance of DatabaseReplica to an JSON string
  *
  * @return JSON string
  */
