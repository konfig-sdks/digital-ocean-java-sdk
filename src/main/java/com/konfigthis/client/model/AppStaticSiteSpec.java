...
import com.konfigthis.client.model.AppRouteSpec;
import com.konfigthis.client.model.AppVariableDefinition;
import com.konfigthis.client.model.AppsCorsPolicy;
...
public class AppStaticSiteSpec {
  ...
  public static final String SERIALIZED_NAME_INDEX_DOCUMENT = "index_document";
  @SerializedName(SERIALIZED_NAME_INDEX_DOCUMENT)
  private String indexDocument = "index.html";

  public static final String SERIALIZED_NAME_ERROR_DOCUMENT = "error_document";
  @SerializedName(SERIALIZED_NAME_ERROR_DOCUMENT)
  private String errorDocument = "404.html";

  public static final String SERIALIZED_NAME_CATCHALL_DOCUMENT = "catchall_document";
  @SerializedName(SERIALIZED_NAME_CATCHALL_DOCUMENT)
  private String catchallDocument;

  public static final String SERIALIZED_NAME_OUTPUT_DIR = "output_dir";
  @SerializedName(SERIALIZED_NAME_OUTPUT_DIR)
  ...
  **/
  @Deprecated
  @javax.annotation.Nullable
  @ApiModelProperty(value = "(Deprecated - Use Ingress Rules instead). A list of HTTP routes that should be routed to this component.")
   ...
   * @return the AppStaticSiteSpec instance itself
   */
  public AppStaticSiteSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appStaticSiteSpec.name) &&
        Objects.equals(this.git, appStaticSiteSpec.git) &&
        ...
        Objects.equals(this.additionalProperties, appStaticSiteSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, git, github, gitlab, image, dockerfilePath, buildCommand, runCommand, sourceDir, envs, environmentSlug, logDestinations, indexDocument, errorDocument, catchallDocument, outputDir, cors, routes, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("index_document");
    openapiFields.add("error_document");
    openapiFields.add("catchall_document");
    openapiFields.add("output_dir");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppStaticSiteSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppStaticSiteSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppStaticSiteSpec is not found in the empty JSON string", AppStaticSiteSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppStaticSiteSpec.openapiRequiredFields) {
      ...
      if ((jsonObj.get("index_document") != null && !jsonObj.get("index_document").isJsonNull()) && !jsonObj.get("index_document").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `index_document` to be a primitive type in the JSON string but got `%s`", jsonObj.get("index_document").toString()));
      }
      if ((jsonObj.get("error_document") != null && !jsonObj.get("error_document").isJsonNull()) && !jsonObj.get("error_document").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `error_document` to be a primitive type in the JSON string but got `%s`", jsonObj.get("error_document").toString()));
      }
      if ((jsonObj.get("catchall_document") != null && !jsonObj.get("catchall_document").isJsonNull()) && !jsonObj.get("catchall_document").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `catchall_document` to be a primitive type in the JSON string but got `%s`", jsonObj.get("catchall_document").toString()));
      }
      if ((jsonObj.get("output_dir") != null && !jsonObj.get("output_dir").isJsonNull()) && !jsonObj.get("output_dir").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `output_dir` to be a primitive type in the JSON string but got `%s`", jsonObj.get("output_dir").toString()));
      }
      // validate the optional field `cors`
      if (jsonObj.get("cors") != null && !jsonObj.get("cors").isJsonNull()) {
        AppsCorsPolicy.validateJsonObject(jsonObj.getAsJsonObject("cors"));
      }
      if (jsonObj.get("routes") != null && !jsonObj.get("routes").isJsonNull()) {
        ...
        if (jsonArrayroutes != null) {
          ...
          for (int i = 0; i < jsonArrayroutes.size(); i++) {
            AppRouteSpec.validateJsonObject(jsonArrayroutes.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppStaticSiteSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppStaticSiteSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppStaticSiteSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppStaticSiteSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppStaticSiteSpec>() {
           @Override
           public void write(JsonWriter out, AppStaticSiteSpec value) throws IOException {
           ...
           @Override
           public AppStaticSiteSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppStaticSiteSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppStaticSiteSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppStaticSiteSpec
  * @throws IOException if the JSON string is invalid with respect to AppStaticSiteSpec
  */
  public static AppStaticSiteSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppStaticSiteSpec.class);
  }

 /**
  * Convert an instance of AppStaticSiteSpec to an JSON string
  *
  * @return JSON string
  */
