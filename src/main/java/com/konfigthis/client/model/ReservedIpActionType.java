...
public class ReservedIpActionType {
  ...
  **/
   ...
   * @return the ReservedIpActionType instance itself
   */
  public ReservedIpActionType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, reservedIpActionType.type)&&
        Objects.equals(this.additionalProperties, reservedIpActionType.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReservedIpActionType
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReservedIpActionType.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedIpActionType is not found in the empty JSON string", ReservedIpActionType.openapiRequiredFields.toString()));
        }
      }
      ...
      switch (discriminatorValue) {
        case "assign":
          ReservedIpActionAssign.validateJsonObject(jsonObj);
          break;
        case "reserved_ip_action_assign":
          ReservedIpActionAssign.validateJsonObject(jsonObj);
          break;
        case "reserved_ip_action_unassign":
          ReservedIpActionUnassign.validateJsonObject(jsonObj);
          break;
        case "unassign":
          ReservedIpActionUnassign.validateJsonObject(jsonObj);
          break;
 ...
 /**
  * Create an instance of ReservedIpActionType given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReservedIpActionType
  * @throws IOException if the JSON string is invalid with respect to ReservedIpActionType
  */
  public static ReservedIpActionType fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedIpActionType.class);
  }

 /**
  * Convert an instance of ReservedIpActionType to an JSON string
  *
  * @return JSON string
  */
