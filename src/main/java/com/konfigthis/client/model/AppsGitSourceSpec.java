...
public class AppsGitSourceSpec {
  ...
  public static final String SERIALIZED_NAME_REPO_CLONE_URL = "repo_clone_url";
  @SerializedName(SERIALIZED_NAME_REPO_CLONE_URL)
  ...
  **/
   ...
   * @return the AppsGitSourceSpec instance itself
   */
  public AppsGitSourceSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branch, appsGitSourceSpec.branch) &&
        ...
        Objects.equals(this.additionalProperties, appsGitSourceSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(branch, repoCloneUrl, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("repo_clone_url");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsGitSourceSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsGitSourceSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsGitSourceSpec is not found in the empty JSON string", AppsGitSourceSpec.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("repo_clone_url") != null && !jsonObj.get("repo_clone_url").isJsonNull()) && !jsonObj.get("repo_clone_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `repo_clone_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("repo_clone_url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsGitSourceSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsGitSourceSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsGitSourceSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsGitSourceSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsGitSourceSpec>() {
           @Override
           public void write(JsonWriter out, AppsGitSourceSpec value) throws IOException {
           ...
           @Override
           public AppsGitSourceSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsGitSourceSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsGitSourceSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsGitSourceSpec
  * @throws IOException if the JSON string is invalid with respect to AppsGitSourceSpec
  */
  public static AppsGitSourceSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsGitSourceSpec.class);
  }

 /**
  * Convert an instance of AppsGitSourceSpec to an JSON string
  *
  * @return JSON string
  */
