 ...
 */
@ApiModel(description = "Tagged Resource Statistics include metadata regarding the resource type that has been tagged.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class TagsMetadata {
  ...
  public TagsMetadata count(Integer count) {
  ...
  **/
  ...
  public TagsMetadata lastTaggedUri(String lastTaggedUri) {
  ...
  **/
   ...
   * @return the TagsMetadata instance itself
   */
  public TagsMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TagsMetadata tagsMetadata = (TagsMetadata) o;
    return Objects.equals(this.count, tagsMetadata.count) &&
        Objects.equals(this.lastTaggedUri, tagsMetadata.lastTaggedUri)&&
        Objects.equals(this.additionalProperties, tagsMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, lastTaggedUri, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TagsMetadata {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagsMetadata
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagsMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagsMetadata is not found in the empty JSON string", TagsMetadata.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagsMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagsMetadata' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagsMetadata> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagsMetadata.class));

       return (TypeAdapter<T>) new TypeAdapter<TagsMetadata>() {
           @Override
           public void write(JsonWriter out, TagsMetadata value) throws IOException {
           ...
           @Override
           public TagsMetadata read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TagsMetadata instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TagsMetadata given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TagsMetadata
  * @throws IOException if the JSON string is invalid with respect to TagsMetadata
  */
  public static TagsMetadata fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagsMetadata.class);
  }

 /**
  * Convert an instance of TagsMetadata to an JSON string
  *
  * @return JSON string
  */
