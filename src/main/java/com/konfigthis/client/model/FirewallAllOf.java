...
public class FirewallAllOf {
 ...
 public enum StatusEnum {
  ...
  public FirewallAllOf tags(List tags) {
  ...
  **/
   ...
   * @return the FirewallAllOf instance itself
   */
  public FirewallAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, firewallAllOf.tags) &&
        Objects.equals(this.id, firewallAllOf.id) &&
        Objects.equals(this.status, firewallAllOf.status) &&
        ...
        Objects.equals(this.additionalProperties, firewallAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, id, status, createdAt, pendingChanges, name, dropletIds, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallAllOf is not found in the empty JSON string", FirewallAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallAllOf>() {
           @Override
           public void write(JsonWriter out, FirewallAllOf value) throws IOException {
           ...
           @Override
           public FirewallAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallAllOf
  * @throws IOException if the JSON string is invalid with respect to FirewallAllOf
  */
  public static FirewallAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallAllOf.class);
  }

 /**
  * Convert an instance of FirewallAllOf to an JSON string
  *
  * @return JSON string
  */
