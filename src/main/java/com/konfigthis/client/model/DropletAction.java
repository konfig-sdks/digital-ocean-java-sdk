 ...
 */
@ApiModel(description = "Specifies the action that will be taken on the Droplet.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DropletAction {
 ...
 public enum TypeEnum {
  ...
  public DropletAction type(TypeEnum type) {
  ...
  **/
   ...
   * @return the DropletAction instance itself
   */
  public DropletAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DropletAction dropletAction = (DropletAction) o;
    return Objects.equals(this.type, dropletAction.type)&&
        Objects.equals(this.additionalProperties, dropletAction.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletAction is not found in the empty JSON string", DropletAction.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletAction.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletAction.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletAction' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletAction> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletAction.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletAction>() {
           @Override
           public void write(JsonWriter out, DropletAction value) throws IOException {
           ...
           @Override
           public DropletAction read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletAction instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletAction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletAction
  * @throws IOException if the JSON string is invalid with respect to DropletAction
  */
  public static DropletAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletAction.class);
  }

 /**
  * Convert an instance of DropletAction to an JSON string
  *
  * @return JSON string
  */
