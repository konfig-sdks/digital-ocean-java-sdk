...
public class LoadBalancersRemoveForwardingRulesRequest {
  ...
  public LoadBalancersRemoveForwardingRulesRequest forwardingRules(List<ForwardingRule> forwardingRules) {
  ...
  public LoadBalancersRemoveForwardingRulesRequest addForwardingRulesItem(ForwardingRule forwardingRulesItem) {
  ...
  **/
   ...
   * @return the LoadBalancersRemoveForwardingRulesRequest instance itself
   */
  public LoadBalancersRemoveForwardingRulesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersRemoveForwardingRulesRequest loadBalancersRemoveForwardingRulesRequest = (LoadBalancersRemoveForwardingRulesRequest) o;
    return Objects.equals(this.forwardingRules, loadBalancersRemoveForwardingRulesRequest.forwardingRules)&&
        Objects.equals(this.additionalProperties, loadBalancersRemoveForwardingRulesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forwardingRules, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LoadBalancersRemoveForwardingRulesRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersRemoveForwardingRulesRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersRemoveForwardingRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersRemoveForwardingRulesRequest is not found in the empty JSON string", LoadBalancersRemoveForwardingRulesRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LoadBalancersRemoveForwardingRulesRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersRemoveForwardingRulesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersRemoveForwardingRulesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersRemoveForwardingRulesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersRemoveForwardingRulesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersRemoveForwardingRulesRequest>() {
           @Override
           public void write(JsonWriter out, LoadBalancersRemoveForwardingRulesRequest value) throws IOException {
           ...
           @Override
           public LoadBalancersRemoveForwardingRulesRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersRemoveForwardingRulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersRemoveForwardingRulesRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersRemoveForwardingRulesRequest
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersRemoveForwardingRulesRequest
  */
  public static LoadBalancersRemoveForwardingRulesRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersRemoveForwardingRulesRequest.class);
  }

 /**
  * Convert an instance of LoadBalancersRemoveForwardingRulesRequest to an JSON string
  *
  * @return JSON string
  */
