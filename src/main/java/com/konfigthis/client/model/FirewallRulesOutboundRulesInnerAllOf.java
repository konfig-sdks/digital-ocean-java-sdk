...
public class FirewallRulesOutboundRulesInnerAllOf {
  ...
  public FirewallRulesOutboundRulesInnerAllOf destinations(FirewallRulesOutboundRulesInnerAllOfDestinations destinations) {
  ...
  **/
   ...
   * @return the FirewallRulesOutboundRulesInnerAllOf instance itself
   */
  public FirewallRulesOutboundRulesInnerAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.destinations, firewallRulesOutboundRulesInnerAllOf.destinations)&&
        Objects.equals(this.additionalProperties, firewallRulesOutboundRulesInnerAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRulesOutboundRulesInnerAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRulesOutboundRulesInnerAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRulesOutboundRulesInnerAllOf is not found in the empty JSON string", FirewallRulesOutboundRulesInnerAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallRulesOutboundRulesInnerAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRulesOutboundRulesInnerAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRulesOutboundRulesInnerAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRulesOutboundRulesInnerAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRulesOutboundRulesInnerAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRulesOutboundRulesInnerAllOf>() {
           @Override
           public void write(JsonWriter out, FirewallRulesOutboundRulesInnerAllOf value) throws IOException {
           ...
           @Override
           public FirewallRulesOutboundRulesInnerAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRulesOutboundRulesInnerAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRulesOutboundRulesInnerAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRulesOutboundRulesInnerAllOf
  * @throws IOException if the JSON string is invalid with respect to FirewallRulesOutboundRulesInnerAllOf
  */
  public static FirewallRulesOutboundRulesInnerAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRulesOutboundRulesInnerAllOf.class);
  }

 /**
  * Convert an instance of FirewallRulesOutboundRulesInnerAllOf to an JSON string
  *
  * @return JSON string
  */
