 ...
 */
@ApiModel(description = "An object containing a `state` attribute whose value is set to a string indicating the current status of the node.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class NodeStatus {
  ...
  **/
   ...
   * @return the NodeStatus instance itself
   */
  public NodeStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.state, nodeStatus.state)&&
        Objects.equals(this.additionalProperties, nodeStatus.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NodeStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NodeStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NodeStatus is not found in the empty JSON string", NodeStatus.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NodeStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NodeStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NodeStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NodeStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<NodeStatus>() {
           @Override
           public void write(JsonWriter out, NodeStatus value) throws IOException {
           ...
           @Override
           public NodeStatus read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NodeStatus instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NodeStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NodeStatus
  * @throws IOException if the JSON string is invalid with respect to NodeStatus
  */
  public static NodeStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NodeStatus.class);
  }

 /**
  * Convert an instance of NodeStatus to an JSON string
  *
  * @return JSON string
  */
