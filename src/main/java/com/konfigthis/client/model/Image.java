...
public class Image {
  ...
  **/
  ...
  public Image minDiskSize(Integer minDiskSize) {
    if (minDiskSize != null && minDiskSize < 0) {
      throw new IllegalArgumentException("Invalid value for minDiskSize. Must be greater than or equal to 0.");
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Image image = (Image) o;
    return Objects.equals(this.tags, image.tags) &&
        ...
        Objects.equals(this.distribution, image.distribution) &&
        Objects.equals(this.slug, image.slug) &&
        Objects.equals(this._public, image._public) &&
        ...
        Objects.equals(this.errorMessage, image.errorMessage)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, id, name, type, distribution, slug, _public, regions, createdAt, minDiskSize, sizeGigabytes, status, errorMessage, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("slug").isJsonNull() && (jsonObj.get("slug") != null && !jsonObj.get("slug").isJsonNull()) && !jsonObj.get("slug").isJsonPrimitive()) {
