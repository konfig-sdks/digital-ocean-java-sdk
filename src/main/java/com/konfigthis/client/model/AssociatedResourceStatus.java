...
import com.konfigthis.client.model.AssociatedResourceStatusResources;
 ...
 */
@ApiModel(description = "An objects containing information about a resources scheduled for deletion.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AssociatedResourceStatus {
  public static final String SERIALIZED_NAME_DROPLET = "droplet";
  @SerializedName(SERIALIZED_NAME_DROPLET)
  ...
  **/
   ...
   * @return the AssociatedResourceStatus instance itself
   */
  public AssociatedResourceStatus putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.droplet, associatedResourceStatus.droplet) &&
        ...
        Objects.equals(this.additionalProperties, associatedResourceStatus.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(droplet, resources, completedAt, failures, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AssociatedResourceStatus
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssociatedResourceStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociatedResourceStatus is not found in the empty JSON string", AssociatedResourceStatus.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `droplet`
      if (jsonObj.get("droplet") != null && !jsonObj.get("droplet").isJsonNull()) {
        DestroyedAssociatedResource.validateJsonObject(jsonObj.getAsJsonObject("droplet"));
      }
      // validate the optional field `resources`
      if (jsonObj.get("resources") != null && !jsonObj.get("resources").isJsonNull()) {
        AssociatedResourceStatusResources.validateJsonObject(jsonObj.getAsJsonObject("resources"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociatedResourceStatus.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociatedResourceStatus' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociatedResourceStatus> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociatedResourceStatus.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociatedResourceStatus>() {
           @Override
           public void write(JsonWriter out, AssociatedResourceStatus value) throws IOException {
           ...
           @Override
           public AssociatedResourceStatus read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AssociatedResourceStatus instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AssociatedResourceStatus given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AssociatedResourceStatus
  * @throws IOException if the JSON string is invalid with respect to AssociatedResourceStatus
  */
  public static AssociatedResourceStatus fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociatedResourceStatus.class);
  }

 /**
  * Convert an instance of AssociatedResourceStatus to an JSON string
  *
  * @return JSON string
  */
