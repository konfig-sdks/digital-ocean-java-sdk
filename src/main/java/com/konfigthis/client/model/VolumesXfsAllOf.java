...
public class VolumesXfsAllOf {
  ...
  public VolumesXfsAllOf() {
  }

  public VolumesXfsAllOf region(RegionSlug region) {
  ...
  **/
  ...
  public VolumesXfsAllOf filesystemLabel(String filesystemLabel) {
  ...
  **/
   ...
   * @return the VolumesXfsAllOf instance itself
   */
  public VolumesXfsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesXfsAllOf volumesXfsAllOf = (VolumesXfsAllOf) o;
    return Objects.equals(this.region, volumesXfsAllOf.region) &&
        Objects.equals(this.filesystemLabel, volumesXfsAllOf.filesystemLabel)&&
        Objects.equals(this.additionalProperties, volumesXfsAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VolumesXfsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesXfsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesXfsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesXfsAllOf is not found in the empty JSON string", VolumesXfsAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesXfsAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesXfsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesXfsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesXfsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesXfsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesXfsAllOf>() {
           @Override
           public void write(JsonWriter out, VolumesXfsAllOf value) throws IOException {
           ...
           @Override
           public VolumesXfsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesXfsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesXfsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesXfsAllOf
  * @throws IOException if the JSON string is invalid with respect to VolumesXfsAllOf
  */
  public static VolumesXfsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesXfsAllOf.class);
  }

 /**
  * Convert an instance of VolumesXfsAllOf to an JSON string
  *
  * @return JSON string
  */
