...
public class DomainRecordSrv {
  ...
  **/
   ...
   * @return the DomainRecordSrv instance itself
   */
  public DomainRecordSrv putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordSrv.id) &&
        Objects.equals(this.type, domainRecordSrv.type) &&
        Objects.equals(this.name, domainRecordSrv.name) &&
        Objects.equals(this.data, domainRecordSrv.data) &&
        Objects.equals(this.priority, domainRecordSrv.priority) &&
        Objects.equals(this.port, domainRecordSrv.port) &&
        Objects.equals(this.ttl, domainRecordSrv.ttl) &&
        Objects.equals(this.weight, domainRecordSrv.weight) &&
        Objects.equals(this.flags, domainRecordSrv.flags) &&
        Objects.equals(this.tag, domainRecordSrv.tag)&&
        Objects.equals(this.additionalProperties, domainRecordSrv.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, type, name, data, priority, port, ttl, weight, flags, tag, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordSrv
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordSrv.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordSrv is not found in the empty JSON string", DomainRecordSrv.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordSrv.openapiRequiredFields) {
      ...
      if (!jsonObj.get("tag").isJsonNull() && !jsonObj.get("tag").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordSrv.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordSrv' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordSrv> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordSrv.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordSrv>() {
           @Override
           public void write(JsonWriter out, DomainRecordSrv value) throws IOException {
           ...
           @Override
           public DomainRecordSrv read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordSrv instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordSrv given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordSrv
  * @throws IOException if the JSON string is invalid with respect to DomainRecordSrv
  */
  public static DomainRecordSrv fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordSrv.class);
  }

 /**
  * Convert an instance of DomainRecordSrv to an JSON string
  *
  * @return JSON string
  */
