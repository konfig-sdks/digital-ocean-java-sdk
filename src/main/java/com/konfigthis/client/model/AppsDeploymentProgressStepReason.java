...
public class AppsDeploymentProgressStepReason {
  ...
  **/
   ...
   * @return the AppsDeploymentProgressStepReason instance itself
   */
  public AppsDeploymentProgressStepReason putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, appsDeploymentProgressStepReason.code) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentProgressStepReason.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentProgressStepReason
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentProgressStepReason.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentProgressStepReason is not found in the empty JSON string", AppsDeploymentProgressStepReason.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentProgressStepReason.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentProgressStepReason' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentProgressStepReason> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentProgressStepReason.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentProgressStepReason>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentProgressStepReason value) throws IOException {
           ...
           @Override
           public AppsDeploymentProgressStepReason read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentProgressStepReason instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentProgressStepReason given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentProgressStepReason
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentProgressStepReason
  */
  public static AppsDeploymentProgressStepReason fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentProgressStepReason.class);
  }

 /**
  * Convert an instance of AppsDeploymentProgressStepReason to an JSON string
  *
  * @return JSON string
  */
