...
public class DropletActionRebuild {
  ...
  **/
  ...
  public DropletActionRebuild image(Object image) {
  ...
  **/
   ...
   * @return the DropletActionRebuild instance itself
   */
  public DropletActionRebuild putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletActionRebuild.type) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionRebuild.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionRebuild
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionRebuild.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionRebuild is not found in the empty JSON string", DropletActionRebuild.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletActionRebuild.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionRebuild.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionRebuild' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionRebuild> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionRebuild.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionRebuild>() {
           @Override
           public void write(JsonWriter out, DropletActionRebuild value) throws IOException {
           ...
           @Override
           public DropletActionRebuild read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionRebuild instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionRebuild given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionRebuild
  * @throws IOException if the JSON string is invalid with respect to DropletActionRebuild
  */
  public static DropletActionRebuild fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionRebuild.class);
  }

 /**
  * Convert an instance of DropletActionRebuild to an JSON string
  *
  * @return JSON string
  */
