...
public class AppDatabaseSpec {
  ...
  **/
   ...
   * @return the AppDatabaseSpec instance itself
   */
  public AppDatabaseSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, appDatabaseSpec.version) &&
        Objects.equals(this.clusterName, appDatabaseSpec.clusterName) &&
        ...
        Objects.equals(this.additionalProperties, appDatabaseSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, clusterName, dbName, dbUser, engine, name, production, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppDatabaseSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppDatabaseSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppDatabaseSpec is not found in the empty JSON string", AppDatabaseSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppDatabaseSpec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppDatabaseSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppDatabaseSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppDatabaseSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppDatabaseSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppDatabaseSpec>() {
           @Override
           public void write(JsonWriter out, AppDatabaseSpec value) throws IOException {
           ...
           @Override
           public AppDatabaseSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppDatabaseSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppDatabaseSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppDatabaseSpec
  * @throws IOException if the JSON string is invalid with respect to AppDatabaseSpec
  */
  public static AppDatabaseSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppDatabaseSpec.class);
  }

 /**
  * Convert an instance of AppDatabaseSpec to an JSON string
  *
  * @return JSON string
  */
