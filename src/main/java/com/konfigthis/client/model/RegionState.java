...
public class RegionState {
 ...
 public enum StatusEnum {
  ...
  public static final String SERIALIZED_NAME_THIRTY_DAY_UPTIME_PERCENTAGE = "thirty_day_uptime_percentage";
  @SerializedName(SERIALIZED_NAME_THIRTY_DAY_UPTIME_PERCENTAGE)
  private Double thirtyDayUptimePercentage;

  public RegionState() {
  }

  public RegionState status(StatusEnum status) {
  ...
  **/
  ...
  public RegionState statusChangedAt(String statusChangedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-03-17T22:28:51Z", value = "")
  ...
  public RegionState thirtyDayUptimePercentage(Double thirtyDayUptimePercentage) {
  ...
  public RegionState thirtyDayUptimePercentage(Integer thirtyDayUptimePercentage) {
    
    
    
    
    this.thirtyDayUptimePercentage = thirtyDayUptimePercentage.doubleValue();
    return this;
  }

   /**
   * Get thirtyDayUptimePercentage
   * @return thirtyDayUptimePercentage
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "97.99", value = "")

  public Double getThirtyDayUptimePercentage() {
    return thirtyDayUptimePercentage;
  }


  public void setThirtyDayUptimePercentage(Double thirtyDayUptimePercentage) {
   ...
   * @return the RegionState instance itself
   */
  public RegionState putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, regionState.status) &&
        Objects.equals(this.statusChangedAt, regionState.statusChangedAt) &&
        Objects.equals(this.thirtyDayUptimePercentage, regionState.thirtyDayUptimePercentage)&&
        Objects.equals(this.additionalProperties, regionState.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, statusChangedAt, thirtyDayUptimePercentage, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    thirtyDayUptimePercentage: ").append(toIndentedString(thirtyDayUptimePercentage)).append("\n");
  ...
  static {
    ...
    openapiFields.add("thirty_day_uptime_percentage");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegionState
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegionState.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegionState is not found in the empty JSON string", RegionState.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegionState.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegionState' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegionState> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegionState.class));

       return (TypeAdapter<T>) new TypeAdapter<RegionState>() {
           @Override
           public void write(JsonWriter out, RegionState value) throws IOException {
           ...
           @Override
           public RegionState read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RegionState instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RegionState given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RegionState
  * @throws IOException if the JSON string is invalid with respect to RegionState
  */
  public static RegionState fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegionState.class);
  }

 /**
  * Convert an instance of RegionState to an JSON string
  *
  * @return JSON string
  */
