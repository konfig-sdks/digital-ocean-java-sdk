...
public class Ca {
  ...
  **/
   ...
   * @return the Ca instance itself
   */
  public Ca putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificate, ca.certificate)&&
        Objects.equals(this.additionalProperties, ca.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (String requiredField : Ca.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Ca>() {
           ...
           public Ca read(JsonReader in) throws IOException {
             ...
             Ca instance = thisAdapter.fromJsonTree(jsonObj);
