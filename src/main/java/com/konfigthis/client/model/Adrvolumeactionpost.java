...
public class Adrvolumeactionpost {
  /**
 ...
 public enum TypeEnum {
  ...
  public Adrvolumeactionpost() {
  }

  public Adrvolumeactionpost type(TypeEnum type) {
  ...
  **/
  ...
  public Adrvolumeactionpost region(RegionSlug region) {
  ...
  **/
  ...
  public Adrvolumeactionpost tags(List<String> tags) {
  ...
  public Adrvolumeactionpost addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public Adrvolumeactionpost dropletId(Integer dropletId) {
  ...
  **/
   ...
   * @return the Adrvolumeactionpost instance itself
   */
  public Adrvolumeactionpost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Adrvolumeactionpost adrvolumeactionpost = (Adrvolumeactionpost) o;
    return Objects.equals(this.type, adrvolumeactionpost.type) &&
        Objects.equals(this.region, adrvolumeactionpost.region) &&
        Objects.equals(this.tags, adrvolumeactionpost.tags) &&
        Objects.equals(this.dropletId, adrvolumeactionpost.dropletId)&&
        Objects.equals(this.additionalProperties, adrvolumeactionpost.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, region, tags, dropletId, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Adrvolumeactionpost {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("droplet_id");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Adrvolumeactionpost
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Adrvolumeactionpost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Adrvolumeactionpost is not found in the empty JSON string", Adrvolumeactionpost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Adrvolumeactionpost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Adrvolumeactionpost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Adrvolumeactionpost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Adrvolumeactionpost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Adrvolumeactionpost.class));

       return (TypeAdapter<T>) new TypeAdapter<Adrvolumeactionpost>() {
           @Override
           public void write(JsonWriter out, Adrvolumeactionpost value) throws IOException {
           ...
           @Override
           public Adrvolumeactionpost read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Adrvolumeactionpost instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Adrvolumeactionpost given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Adrvolumeactionpost
  * @throws IOException if the JSON string is invalid with respect to Adrvolumeactionpost
  */
  public static Adrvolumeactionpost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Adrvolumeactionpost.class);
  }

 /**
  * Convert an instance of Adrvolumeactionpost to an JSON string
  *
  * @return JSON string
  */
