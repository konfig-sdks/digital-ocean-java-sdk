...
public class VpcCreate {
  ...
  **/
   ...
   * @return the VpcCreate instance itself
   */
  public VpcCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.region, vpcCreate.region) &&
        Objects.equals(this.ipRange, vpcCreate.ipRange)&&
        Objects.equals(this.additionalProperties, vpcCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, ipRange, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcCreate is not found in the empty JSON string", VpcCreate.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcCreate>() {
           @Override
           public void write(JsonWriter out, VpcCreate value) throws IOException {
           ...
           @Override
           public VpcCreate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcCreate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcCreate
  * @throws IOException if the JSON string is invalid with respect to VpcCreate
  */
  public static VpcCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcCreate.class);
  }

 /**
  * Convert an instance of VpcCreate to an JSON string
  *
  * @return JSON string
  */
