...
public class FloatingIpActionUnassign extends FloatingIPsAction {
   ...
   * @return the FloatingIpActionUnassign instance itself
   */
  public FloatingIpActionUnassign putAdditionalProperty(String key, Object value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionUnassign
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionUnassign.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionUnassign is not found in the empty JSON string", FloatingIpActionUnassign.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionUnassign.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionUnassign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionUnassign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionUnassign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionUnassign.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionUnassign>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionUnassign value) throws IOException {
           ...
           @Override
           public FloatingIpActionUnassign read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionUnassign instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionUnassign given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionUnassign
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionUnassign
  */
  public static FloatingIpActionUnassign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionUnassign.class);
  }

 /**
  * Convert an instance of FloatingIpActionUnassign to an JSON string
  *
  * @return JSON string
  */
