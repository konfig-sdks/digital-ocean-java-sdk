 ...
 */
@ApiModel(description = "DataDog configuration.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AppLogDestinationDatadogSpec {
  ...
  **/
   ...
   * @return the AppLogDestinationDatadogSpec instance itself
   */
  public AppLogDestinationDatadogSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpoint, appLogDestinationDatadogSpec.endpoint) &&
        ...
        Objects.equals(this.additionalProperties, appLogDestinationDatadogSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpoint, apiKey, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppLogDestinationDatadogSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppLogDestinationDatadogSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppLogDestinationDatadogSpec is not found in the empty JSON string", AppLogDestinationDatadogSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppLogDestinationDatadogSpec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppLogDestinationDatadogSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppLogDestinationDatadogSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppLogDestinationDatadogSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppLogDestinationDatadogSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppLogDestinationDatadogSpec>() {
           @Override
           public void write(JsonWriter out, AppLogDestinationDatadogSpec value) throws IOException {
           ...
           @Override
           public AppLogDestinationDatadogSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppLogDestinationDatadogSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppLogDestinationDatadogSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppLogDestinationDatadogSpec
  * @throws IOException if the JSON string is invalid with respect to AppLogDestinationDatadogSpec
  */
  public static AppLogDestinationDatadogSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppLogDestinationDatadogSpec.class);
  }

 /**
  * Convert an instance of AppLogDestinationDatadogSpec to an JSON string
  *
  * @return JSON string
  */
