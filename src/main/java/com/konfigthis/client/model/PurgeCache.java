...
public class PurgeCache {
  ...
  **/
   ...
   * @return the PurgeCache instance itself
   */
  public PurgeCache putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.files, purgeCache.files)&&
        Objects.equals(this.additionalProperties, purgeCache.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to PurgeCache
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PurgeCache.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PurgeCache is not found in the empty JSON string", PurgeCache.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PurgeCache.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PurgeCache.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PurgeCache' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PurgeCache> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PurgeCache.class));

       return (TypeAdapter<T>) new TypeAdapter<PurgeCache>() {
           @Override
           public void write(JsonWriter out, PurgeCache value) throws IOException {
           ...
           @Override
           public PurgeCache read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PurgeCache instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PurgeCache given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PurgeCache
  * @throws IOException if the JSON string is invalid with respect to PurgeCache
  */
  public static PurgeCache fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PurgeCache.class);
  }

 /**
  * Convert an instance of PurgeCache to an JSON string
  *
  * @return JSON string
  */
