...
public class FloatingIpActionAssignAllOf {
  ...
  **/
   ...
   * @return the FloatingIpActionAssignAllOf instance itself
   */
  public FloatingIpActionAssignAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletId, floatingIpActionAssignAllOf.dropletId)&&
        Objects.equals(this.additionalProperties, floatingIpActionAssignAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dropletId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpActionAssignAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpActionAssignAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpActionAssignAllOf is not found in the empty JSON string", FloatingIpActionAssignAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpActionAssignAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpActionAssignAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpActionAssignAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpActionAssignAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpActionAssignAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpActionAssignAllOf>() {
           @Override
           public void write(JsonWriter out, FloatingIpActionAssignAllOf value) throws IOException {
           ...
           @Override
           public FloatingIpActionAssignAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpActionAssignAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpActionAssignAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpActionAssignAllOf
  * @throws IOException if the JSON string is invalid with respect to FloatingIpActionAssignAllOf
  */
  public static FloatingIpActionAssignAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpActionAssignAllOf.class);
  }

 /**
  * Convert an instance of FloatingIpActionAssignAllOf to an JSON string
  *
  * @return JSON string
  */
