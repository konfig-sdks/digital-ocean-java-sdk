...
public class DatabaseLayoutOption {
  ...
  public DatabaseLayoutOption numNodes(Integer numNodes) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"db-s-1vcpu-1gb\",\"db-s-1vcpu-2gb\"]", value = "An array of objects containing the slugs available with various node counts")
   ...
   * @return the DatabaseLayoutOption instance itself
   */
  public DatabaseLayoutOption putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseLayoutOption databaseLayoutOption = (DatabaseLayoutOption) o;
    return Objects.equals(this.numNodes, databaseLayoutOption.numNodes) &&
        Objects.equals(this.sizes, databaseLayoutOption.sizes)&&
        Objects.equals(this.additionalProperties, databaseLayoutOption.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numNodes, sizes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseLayoutOption {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseLayoutOption
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseLayoutOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseLayoutOption is not found in the empty JSON string", DatabaseLayoutOption.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseLayoutOption.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseLayoutOption' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseLayoutOption> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseLayoutOption.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseLayoutOption>() {
           @Override
           public void write(JsonWriter out, DatabaseLayoutOption value) throws IOException {
           ...
           @Override
           public DatabaseLayoutOption read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseLayoutOption instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseLayoutOption given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseLayoutOption
  * @throws IOException if the JSON string is invalid with respect to DatabaseLayoutOption
  */
  public static DatabaseLayoutOption fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseLayoutOption.class);
  }

 /**
  * Convert an instance of DatabaseLayoutOption to an JSON string
  *
  * @return JSON string
  */
