...
public class AppResponse {
  ...
  **/
   ...
   * @return the AppResponse instance itself
   */
  public AppResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.app, appResponse.app)&&
        Objects.equals(this.additionalProperties, appResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppResponse>() {
           ...
           public AppResponse read(JsonReader in) throws IOException {
             ...
             AppResponse instance = thisAdapter.fromJsonTree(jsonObj);
