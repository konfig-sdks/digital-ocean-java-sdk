...
public class CdnEndpointsListAllResponseAllOf {
  public static final String SERIALIZED_NAME_ENDPOINTS = "endpoints";
  @SerializedName(SERIALIZED_NAME_ENDPOINTS)
  private List<CdnEndpoint> endpoints = null;

  public CdnEndpointsListAllResponseAllOf() {
  }

  public CdnEndpointsListAllResponseAllOf endpoints(List<CdnEndpoint> endpoints) {
  ...
  public CdnEndpointsListAllResponseAllOf addEndpointsItem(CdnEndpoint endpointsItem) {
  ...
  **/
   ...
   * @return the CdnEndpointsListAllResponseAllOf instance itself
   */
  public CdnEndpointsListAllResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CdnEndpointsListAllResponseAllOf cdnEndpointsListAllResponseAllOf = (CdnEndpointsListAllResponseAllOf) o;
    return Objects.equals(this.endpoints, cdnEndpointsListAllResponseAllOf.endpoints)&&
        Objects.equals(this.additionalProperties, cdnEndpointsListAllResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpoints, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CdnEndpointsListAllResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CdnEndpointsListAllResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CdnEndpointsListAllResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CdnEndpointsListAllResponseAllOf is not found in the empty JSON string", CdnEndpointsListAllResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CdnEndpointsListAllResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CdnEndpointsListAllResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CdnEndpointsListAllResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CdnEndpointsListAllResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CdnEndpointsListAllResponseAllOf>() {
           @Override
           public void write(JsonWriter out, CdnEndpointsListAllResponseAllOf value) throws IOException {
           ...
           @Override
           public CdnEndpointsListAllResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CdnEndpointsListAllResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CdnEndpointsListAllResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CdnEndpointsListAllResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to CdnEndpointsListAllResponseAllOf
  */
  public static CdnEndpointsListAllResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CdnEndpointsListAllResponseAllOf.class);
  }

 /**
  * Convert an instance of CdnEndpointsListAllResponseAllOf to an JSON string
  *
  * @return JSON string
  */
