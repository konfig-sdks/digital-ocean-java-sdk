...
public class ProductChargeItem {
  ...
  **/
   ...
   * @return the ProductChargeItem instance itself
   */
  public ProductChargeItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, productChargeItem.amount) &&
        ...
        Objects.equals(this.additionalProperties, productChargeItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, name, count, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductChargeItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductChargeItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductChargeItem is not found in the empty JSON string", ProductChargeItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductChargeItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductChargeItem' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductChargeItem> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductChargeItem.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductChargeItem>() {
           @Override
           public void write(JsonWriter out, ProductChargeItem value) throws IOException {
           ...
           @Override
           public ProductChargeItem read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductChargeItem instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductChargeItem given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductChargeItem
  * @throws IOException if the JSON string is invalid with respect to ProductChargeItem
  */
  public static ProductChargeItem fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductChargeItem.class);
  }

 /**
  * Convert an instance of ProductChargeItem to an JSON string
  *
  * @return JSON string
  */
