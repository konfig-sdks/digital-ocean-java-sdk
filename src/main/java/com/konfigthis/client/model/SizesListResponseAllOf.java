...
public class SizesListResponseAllOf {
  public static final String SERIALIZED_NAME_SIZES = "sizes";
  @SerializedName(SERIALIZED_NAME_SIZES)
  private List<Size> sizes = new ArrayList<>();

  public SizesListResponseAllOf() {
  }

  public SizesListResponseAllOf sizes(List<Size> sizes) {
  ...
  public SizesListResponseAllOf addSizesItem(Size sizesItem) {
  ...
  **/
   ...
   * @return the SizesListResponseAllOf instance itself
   */
  public SizesListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SizesListResponseAllOf sizesListResponseAllOf = (SizesListResponseAllOf) o;
    return Objects.equals(this.sizes, sizesListResponseAllOf.sizes)&&
        Objects.equals(this.additionalProperties, sizesListResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sizes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SizesListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SizesListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SizesListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SizesListResponseAllOf is not found in the empty JSON string", SizesListResponseAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SizesListResponseAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SizesListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SizesListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SizesListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SizesListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SizesListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SizesListResponseAllOf value) throws IOException {
           ...
           @Override
           public SizesListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SizesListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SizesListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SizesListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SizesListResponseAllOf
  */
  public static SizesListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SizesListResponseAllOf.class);
  }

 /**
  * Convert an instance of SizesListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
