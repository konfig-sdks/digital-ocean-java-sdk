...
public class DropletActionChangeKernel {
  ...
  **/
   ...
   * @return the DropletActionChangeKernel instance itself
   */
  public DropletActionChangeKernel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletActionChangeKernel.type) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionChangeKernel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, kernel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionChangeKernel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionChangeKernel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionChangeKernel is not found in the empty JSON string", DropletActionChangeKernel.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletActionChangeKernel.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionChangeKernel.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionChangeKernel' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionChangeKernel> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionChangeKernel.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionChangeKernel>() {
           @Override
           public void write(JsonWriter out, DropletActionChangeKernel value) throws IOException {
           ...
           @Override
           public DropletActionChangeKernel read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionChangeKernel instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionChangeKernel given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionChangeKernel
  * @throws IOException if the JSON string is invalid with respect to DropletActionChangeKernel
  */
  public static DropletActionChangeKernel fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionChangeKernel.class);
  }

 /**
  * Convert an instance of DropletActionChangeKernel to an JSON string
  *
  * @return JSON string
  */
