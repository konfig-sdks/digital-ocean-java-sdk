...
public class ClusterUpdate {
  ...
  **/
  ...
  public ClusterUpdate ha(Boolean ha) {
  ...
  **/
   ...
   * @return the ClusterUpdate instance itself
   */
  public ClusterUpdate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, clusterUpdate.tags) &&
        ...
        Objects.equals(this.ha, clusterUpdate.ha)&&
        Objects.equals(this.additionalProperties, clusterUpdate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, name, maintenancePolicy, autoUpgrade, surgeUpgrade, ha, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ClusterUpdate.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClusterUpdate>() {
           ...
           public ClusterUpdate read(JsonReader in) throws IOException {
             ...
             ClusterUpdate instance = thisAdapter.fromJsonTree(jsonObj);
