...
public class AppsGithubSourceSpec {
  ...
  **/
   ...
   * @return the AppsGithubSourceSpec instance itself
   */
  public AppsGithubSourceSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branch, appsGithubSourceSpec.branch) &&
        ...
        Objects.equals(this.additionalProperties, appsGithubSourceSpec.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsGithubSourceSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsGithubSourceSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsGithubSourceSpec is not found in the empty JSON string", AppsGithubSourceSpec.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsGithubSourceSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsGithubSourceSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsGithubSourceSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsGithubSourceSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsGithubSourceSpec>() {
           @Override
           public void write(JsonWriter out, AppsGithubSourceSpec value) throws IOException {
           ...
           @Override
           public AppsGithubSourceSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsGithubSourceSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsGithubSourceSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsGithubSourceSpec
  * @throws IOException if the JSON string is invalid with respect to AppsGithubSourceSpec
  */
  public static AppsGithubSourceSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsGithubSourceSpec.class);
  }

 /**
  * Convert an instance of AppsGithubSourceSpec to an JSON string
  *
  * @return JSON string
  */
