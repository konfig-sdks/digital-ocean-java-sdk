...
public class DomainRecordTxt {
  ...
  **/
   ...
   * @return the DomainRecordTxt instance itself
   */
  public DomainRecordTxt putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordTxt.id) &&
        Objects.equals(this.type, domainRecordTxt.type) &&
        Objects.equals(this.name, domainRecordTxt.name) &&
        Objects.equals(this.data, domainRecordTxt.data) &&
        Objects.equals(this.priority, domainRecordTxt.priority) &&
        Objects.equals(this.port, domainRecordTxt.port) &&
        Objects.equals(this.ttl, domainRecordTxt.ttl) &&
        Objects.equals(this.weight, domainRecordTxt.weight) &&
        Objects.equals(this.flags, domainRecordTxt.flags) &&
        Objects.equals(this.tag, domainRecordTxt.tag)&&
        Objects.equals(this.additionalProperties, domainRecordTxt.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordTxt
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordTxt.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordTxt is not found in the empty JSON string", DomainRecordTxt.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordTxt.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordTxt.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordTxt' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordTxt> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordTxt.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordTxt>() {
           @Override
           public void write(JsonWriter out, DomainRecordTxt value) throws IOException {
           ...
           @Override
           public DomainRecordTxt read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordTxt instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordTxt given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordTxt
  * @throws IOException if the JSON string is invalid with respect to DomainRecordTxt
  */
  public static DomainRecordTxt fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordTxt.class);
  }

 /**
  * Convert an instance of DomainRecordTxt to an JSON string
  *
  * @return JSON string
  */
