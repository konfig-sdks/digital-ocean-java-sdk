 ...
 */
@ApiModel(description = "An object specifying a forwarding rule for a load balancer.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ForwardingRule {
   ...
   */
  @JsonAdapter(EntryProtocolEnum.Adapter.class)
 public enum EntryProtocolEnum {
    ...
    public static class Adapter extends TypeAdapter<EntryProtocolEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final EntryProtocolEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public EntryProtocolEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return EntryProtocolEnum.fromValue(value);
      }
    }
  }
   ...
   */
  @JsonAdapter(TargetProtocolEnum.Adapter.class)
 public enum TargetProtocolEnum {
    ...
    public static class Adapter extends TypeAdapter<TargetProtocolEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TargetProtocolEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public TargetProtocolEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return TargetProtocolEnum.fromValue(value);
      }
    }
  }
  ...
  **/
  ...
  @ApiModelProperty(example = "HTTPS", required = true, value = "The protocol used for traffic to the load balancer. The possible values are: `http`, `https`, `http2`, `http3`, `tcp`, or `udp`. If you set the  `entry_protocol` to `udp`, the `target_protocol` must be set to `udp`.  When using UDP, the load balancer requires that you set up a health  check with a port that uses TCP, HTTP, or HTTPS to work properly. ")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "HTTP", required = true, value = "The protocol used for traffic from the load balancer to the backend Droplets. The possible values are: `http`, `https`, `http2`, `tcp`, or `udp`. If you set the `target_protocol` to `udp`, the `entry_protocol` must be set to  `udp`. When using UDP, the load balancer requires that you set up a health  check with a port that uses TCP, HTTP, or HTTPS to work properly. ")
  ...
  **/
   ...
   * @return the ForwardingRule instance itself
   */
  public ForwardingRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.entryProtocol, forwardingRule.entryProtocol) &&
        ...
        Objects.equals(this.additionalProperties, forwardingRule.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("entry_protocol");
    openapiRequiredFields.add("entry_port");
    openapiRequiredFields.add("target_protocol");
    openapiRequiredFields.add("target_port");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ForwardingRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ForwardingRule.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("entry_protocol").isJsonPrimitive()) {
      ...
      if (!jsonObj.get("target_protocol").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ForwardingRule>() {
           ...
           public ForwardingRule read(JsonReader in) throws IOException {
             ...
             ForwardingRule instance = thisAdapter.fromJsonTree(jsonObj);
