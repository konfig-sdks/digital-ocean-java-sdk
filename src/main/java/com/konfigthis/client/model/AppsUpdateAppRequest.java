...
public class AppsUpdateAppRequest {
  ...
  **/
   ...
   * @return the AppsUpdateAppRequest instance itself
   */
  public AppsUpdateAppRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.spec, appsUpdateAppRequest.spec)&&
        Objects.equals(this.additionalProperties, appsUpdateAppRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsUpdateAppRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsUpdateAppRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsUpdateAppRequest is not found in the empty JSON string", AppsUpdateAppRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppsUpdateAppRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsUpdateAppRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsUpdateAppRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsUpdateAppRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsUpdateAppRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsUpdateAppRequest>() {
           @Override
           public void write(JsonWriter out, AppsUpdateAppRequest value) throws IOException {
           ...
           @Override
           public AppsUpdateAppRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsUpdateAppRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsUpdateAppRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsUpdateAppRequest
  * @throws IOException if the JSON string is invalid with respect to AppsUpdateAppRequest
  */
  public static AppsUpdateAppRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsUpdateAppRequest.class);
  }

 /**
  * Convert an instance of AppsUpdateAppRequest to an JSON string
  *
  * @return JSON string
  */
