...
public class TagsGetResponse {
  ...
  public TagsGetResponse tag(Tags tag) {
  ...
  **/
   ...
   * @return the TagsGetResponse instance itself
   */
  public TagsGetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TagsGetResponse tagsGetResponse = (TagsGetResponse) o;
    return Objects.equals(this.tag, tagsGetResponse.tag)&&
        Objects.equals(this.additionalProperties, tagsGetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TagsGetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagsGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagsGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TagsGetResponse is not found in the empty JSON string", TagsGetResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TagsGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TagsGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TagsGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TagsGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TagsGetResponse>() {
           @Override
           public void write(JsonWriter out, TagsGetResponse value) throws IOException {
           ...
           @Override
           public TagsGetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TagsGetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TagsGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TagsGetResponse
  * @throws IOException if the JSON string is invalid with respect to TagsGetResponse
  */
  public static TagsGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TagsGetResponse.class);
  }

 /**
  * Convert an instance of TagsGetResponse to an JSON string
  *
  * @return JSON string
  */
