...
public class ProjectsListResponseAllOf {
  public static final String SERIALIZED_NAME_PROJECTS = "projects";
  @SerializedName(SERIALIZED_NAME_PROJECTS)
  private List<Project> projects = null;

  public ProjectsListResponseAllOf() {
  }

  public ProjectsListResponseAllOf projects(List<Project> projects) {
  ...
  public ProjectsListResponseAllOf addProjectsItem(Project projectsItem) {
  ...
  **/
   ...
   * @return the ProjectsListResponseAllOf instance itself
   */
  public ProjectsListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProjectsListResponseAllOf projectsListResponseAllOf = (ProjectsListResponseAllOf) o;
    return Objects.equals(this.projects, projectsListResponseAllOf.projects)&&
        Objects.equals(this.additionalProperties, projectsListResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectsListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectsListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectsListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectsListResponseAllOf is not found in the empty JSON string", ProjectsListResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectsListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectsListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectsListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectsListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectsListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ProjectsListResponseAllOf value) throws IOException {
           ...
           @Override
           public ProjectsListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProjectsListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProjectsListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectsListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ProjectsListResponseAllOf
  */
  public static ProjectsListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectsListResponseAllOf.class);
  }

 /**
  * Convert an instance of ProjectsListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
