...
public class Vpc {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, name, region, ipRange, _default, id, urn, createdAt, additionalProperties);
  }
