...
public class CertificatesListResponseAllOf {
  ...
  public CertificatesListResponseAllOf() {
  }

  public CertificatesListResponseAllOf certificates(List<Certificate> certificates) {
  ...
  public CertificatesListResponseAllOf addCertificatesItem(Certificate certificatesItem) {
  ...
  **/
   ...
   * @return the CertificatesListResponseAllOf instance itself
   */
  public CertificatesListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CertificatesListResponseAllOf certificatesListResponseAllOf = (CertificatesListResponseAllOf) o;
    return Objects.equals(this.certificates, certificatesListResponseAllOf.certificates)&&
        Objects.equals(this.additionalProperties, certificatesListResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(certificates, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CertificatesListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificatesListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificatesListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificatesListResponseAllOf is not found in the empty JSON string", CertificatesListResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificatesListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificatesListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificatesListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificatesListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificatesListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, CertificatesListResponseAllOf value) throws IOException {
           ...
           @Override
           public CertificatesListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificatesListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificatesListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificatesListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to CertificatesListResponseAllOf
  */
  public static CertificatesListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificatesListResponseAllOf.class);
  }

 /**
  * Convert an instance of CertificatesListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
