...
import com.konfigthis.client.model.AppsDeploymentProgressStep;
...
public class AppsDeploymentProgress {
  public static final String SERIALIZED_NAME_ERROR_STEPS = "error_steps";
  @SerializedName(SERIALIZED_NAME_ERROR_STEPS)
  private Integer errorSteps;

  public static final String SERIALIZED_NAME_PENDING_STEPS = "pending_steps";
  @SerializedName(SERIALIZED_NAME_PENDING_STEPS)
  private Integer pendingSteps;

  public static final String SERIALIZED_NAME_RUNNING_STEPS = "running_steps";
  @SerializedName(SERIALIZED_NAME_RUNNING_STEPS)
  ...
  public static final String SERIALIZED_NAME_SUCCESS_STEPS = "success_steps";
  @SerializedName(SERIALIZED_NAME_SUCCESS_STEPS)
  private Integer successSteps;

  public static final String SERIALIZED_NAME_SUMMARY_STEPS = "summary_steps";
  @SerializedName(SERIALIZED_NAME_SUMMARY_STEPS)
  private List<AppsDeploymentProgressStep> summarySteps = null;

  public static final String SERIALIZED_NAME_TOTAL_STEPS = "total_steps";
  ...
  **/
   ...
   * @return the AppsDeploymentProgress instance itself
   */
  public AppsDeploymentProgress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorSteps, appsDeploymentProgress.errorSteps) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentProgress.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(errorSteps, pendingSteps, runningSteps, steps, successSteps, summarySteps, totalSteps, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("error_steps");
    openapiFields.add("pending_steps");
    openapiFields.add("running_steps");
    openapiFields.add("steps");
    openapiFields.add("success_steps");
    openapiFields.add("summary_steps");
    openapiFields.add("total_steps");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentProgress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentProgress is not found in the empty JSON string", AppsDeploymentProgress.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("steps") != null && !jsonObj.get("steps").isJsonNull()) {
        ...
        if (jsonArraysteps != null) {
          ...
          for (int i = 0; i < jsonArraysteps.size(); i++) {
            AppsDeploymentProgressStep.validateJsonObject(jsonArraysteps.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("summary_steps") != null && !jsonObj.get("summary_steps").isJsonNull()) {
        JsonArray jsonArraysummarySteps = jsonObj.getAsJsonArray("summary_steps");
        if (jsonArraysummarySteps != null) {
          // ensure the json data is an array
          if (!jsonObj.get("summary_steps").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `summary_steps` to be an array in the JSON string but got `%s`", jsonObj.get("summary_steps").toString()));
          }

          // validate the optional field `summary_steps` (array)
          for (int i = 0; i < jsonArraysummarySteps.size(); i++) {
            AppsDeploymentProgressStep.validateJsonObject(jsonArraysummarySteps.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentProgress>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentProgress value) throws IOException {
           ...
           @Override
           public AppsDeploymentProgress read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentProgress instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentProgress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentProgress
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentProgress
  */
  public static AppsDeploymentProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentProgress.class);
  }

 /**
  * Convert an instance of AppsDeploymentProgress to an JSON string
  *
  * @return JSON string
  */
