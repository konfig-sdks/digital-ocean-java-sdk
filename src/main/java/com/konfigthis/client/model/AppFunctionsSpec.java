...
import com.konfigthis.client.model.AppFunctionsSpecCors;
...
public class AppFunctionsSpec {
  ...
  private AppFunctionsSpecCors cors;
  ...
  public AppFunctionsSpec cors(AppFunctionsSpecCors cors) {
  ...
  **/
  ...
  public AppFunctionsSpecCors getCors() {
    return cors;
  }


  public void setCors(AppFunctionsSpecCors cors) {
  ...
  **/
   ...
   * @return the AppFunctionsSpec instance itself
   */
  public AppFunctionsSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cors, appFunctionsSpec.cors) &&
        Objects.equals(this.routes, appFunctionsSpec.routes) &&
        ...
        Objects.equals(this.envs, appFunctionsSpec.envs) &&
        Objects.equals(this.git, appFunctionsSpec.git) &&
        ...
        Objects.equals(this.additionalProperties, appFunctionsSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cors, routes, name, sourceDir, alerts, envs, git, github, gitlab, logDestinations, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppFunctionsSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppFunctionsSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppFunctionsSpec is not found in the empty JSON string", AppFunctionsSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppFunctionsSpec.openapiRequiredFields) {
      ...
      if (jsonObj.get("cors") != null && !jsonObj.get("cors").isJsonNull()) {
        AppFunctionsSpecCors.validateJsonObject(jsonObj.getAsJsonObject("cors"));
      }
      ...
      if (jsonObj.get("alerts") != null && !jsonObj.get("alerts").isJsonNull()) {
        ...
        if (jsonArrayalerts != null) {
          ...
          for (int i = 0; i < jsonArrayalerts.size(); i++) {
            AppAlertSpec.validateJsonObject(jsonArrayalerts.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppFunctionsSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppFunctionsSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppFunctionsSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppFunctionsSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppFunctionsSpec>() {
           @Override
           public void write(JsonWriter out, AppFunctionsSpec value) throws IOException {
           ...
           @Override
           public AppFunctionsSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppFunctionsSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppFunctionsSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppFunctionsSpec
  * @throws IOException if the JSON string is invalid with respect to AppFunctionsSpec
  */
  public static AppFunctionsSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppFunctionsSpec.class);
  }

 /**
  * Convert an instance of AppFunctionsSpec to an JSON string
  *
  * @return JSON string
  */
