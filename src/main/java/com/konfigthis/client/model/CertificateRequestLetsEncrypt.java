...
public class CertificateRequestLetsEncrypt {
  ...
  **/
   ...
   * @return the CertificateRequestLetsEncrypt instance itself
   */
  public CertificateRequestLetsEncrypt putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, certificateRequestLetsEncrypt.name) &&
        ...
        Objects.equals(this.additionalProperties, certificateRequestLetsEncrypt.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, dnsNames, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateRequestLetsEncrypt
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateRequestLetsEncrypt.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateRequestLetsEncrypt is not found in the empty JSON string", CertificateRequestLetsEncrypt.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateRequestLetsEncrypt.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateRequestLetsEncrypt.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateRequestLetsEncrypt' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateRequestLetsEncrypt> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateRequestLetsEncrypt.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateRequestLetsEncrypt>() {
           @Override
           public void write(JsonWriter out, CertificateRequestLetsEncrypt value) throws IOException {
           ...
           @Override
           public CertificateRequestLetsEncrypt read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateRequestLetsEncrypt instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateRequestLetsEncrypt given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateRequestLetsEncrypt
  * @throws IOException if the JSON string is invalid with respect to CertificateRequestLetsEncrypt
  */
  public static CertificateRequestLetsEncrypt fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateRequestLetsEncrypt.class);
  }

 /**
  * Convert an instance of CertificateRequestLetsEncrypt to an JSON string
  *
  * @return JSON string
  */
