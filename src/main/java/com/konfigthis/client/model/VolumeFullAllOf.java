...
public class VolumeFullAllOf {
  ...
  **/
   ...
   * @return the VolumeFullAllOf instance itself
   */
  public VolumeFullAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.region, volumeFullAllOf.region) &&
        ...
        Objects.equals(this.additionalProperties, volumeFullAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, filesystemType, filesystemLabel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeFullAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeFullAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeFullAllOf is not found in the empty JSON string", VolumeFullAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeFullAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeFullAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeFullAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeFullAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeFullAllOf>() {
           @Override
           public void write(JsonWriter out, VolumeFullAllOf value) throws IOException {
           ...
           @Override
           public VolumeFullAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeFullAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeFullAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeFullAllOf
  * @throws IOException if the JSON string is invalid with respect to VolumeFullAllOf
  */
  public static VolumeFullAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeFullAllOf.class);
  }

 /**
  * Convert an instance of VolumeFullAllOf to an JSON string
  *
  * @return JSON string
  */
