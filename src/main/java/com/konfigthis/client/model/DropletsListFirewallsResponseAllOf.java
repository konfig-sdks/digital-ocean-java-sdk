...
public class DropletsListFirewallsResponseAllOf {
  ...
  public DropletsListFirewallsResponseAllOf() {
  }

  public DropletsListFirewallsResponseAllOf firewalls(List<Firewall> firewalls) {
  ...
  public DropletsListFirewallsResponseAllOf addFirewallsItem(Firewall firewallsItem) {
  ...
  **/
   ...
   * @return the DropletsListFirewallsResponseAllOf instance itself
   */
  public DropletsListFirewallsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DropletsListFirewallsResponseAllOf dropletsListFirewallsResponseAllOf = (DropletsListFirewallsResponseAllOf) o;
    return Objects.equals(this.firewalls, dropletsListFirewallsResponseAllOf.firewalls)&&
        Objects.equals(this.additionalProperties, dropletsListFirewallsResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(firewalls, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DropletsListFirewallsResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletsListFirewallsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletsListFirewallsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletsListFirewallsResponseAllOf is not found in the empty JSON string", DropletsListFirewallsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletsListFirewallsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletsListFirewallsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletsListFirewallsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletsListFirewallsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletsListFirewallsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DropletsListFirewallsResponseAllOf value) throws IOException {
           ...
           @Override
           public DropletsListFirewallsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletsListFirewallsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletsListFirewallsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletsListFirewallsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletsListFirewallsResponseAllOf
  */
  public static DropletsListFirewallsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletsListFirewallsResponseAllOf.class);
  }

 /**
  * Convert an instance of DropletsListFirewallsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
