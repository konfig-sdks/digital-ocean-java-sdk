...
public class DatabaseClusterConnection {
  ...
  **/
   ...
   * @return the DatabaseClusterConnection instance itself
   */
  public DatabaseClusterConnection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uri, databaseClusterConnection.uri) &&
        ...
        Objects.equals(this.additionalProperties, databaseClusterConnection.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseClusterConnection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseClusterConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseClusterConnection is not found in the empty JSON string", DatabaseClusterConnection.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseClusterConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseClusterConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseClusterConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseClusterConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseClusterConnection>() {
           @Override
           public void write(JsonWriter out, DatabaseClusterConnection value) throws IOException {
           ...
           @Override
           public DatabaseClusterConnection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseClusterConnection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseClusterConnection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseClusterConnection
  * @throws IOException if the JSON string is invalid with respect to DatabaseClusterConnection
  */
  public static DatabaseClusterConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseClusterConnection.class);
  }

 /**
  * Convert an instance of DatabaseClusterConnection to an JSON string
  *
  * @return JSON string
  */
