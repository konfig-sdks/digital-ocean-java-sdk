...
public class AppsGetTierResponse {
  ...
  **/
   ...
   * @return the AppsGetTierResponse instance itself
   */
  public AppsGetTierResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tier, appsGetTierResponse.tier)&&
        Objects.equals(this.additionalProperties, appsGetTierResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tier, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsGetTierResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsGetTierResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsGetTierResponse is not found in the empty JSON string", AppsGetTierResponse.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `tier`
      if (jsonObj.get("tier") != null && !jsonObj.get("tier").isJsonNull()) {
        AppsTier.validateJsonObject(jsonObj.getAsJsonObject("tier"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsGetTierResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsGetTierResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsGetTierResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsGetTierResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsGetTierResponse>() {
           @Override
           public void write(JsonWriter out, AppsGetTierResponse value) throws IOException {
           ...
           @Override
           public AppsGetTierResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsGetTierResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsGetTierResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsGetTierResponse
  * @throws IOException if the JSON string is invalid with respect to AppsGetTierResponse
  */
  public static AppsGetTierResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsGetTierResponse.class);
  }

 /**
  * Convert an instance of AppsGetTierResponse to an JSON string
  *
  * @return JSON string
  */
