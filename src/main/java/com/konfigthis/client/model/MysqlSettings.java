...
public class MysqlSettings {
   ...
   */
  @JsonAdapter(AuthPluginEnum.Adapter.class)
 public enum AuthPluginEnum {
    ...
    public static class Adapter extends TypeAdapter<AuthPluginEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AuthPluginEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AuthPluginEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return AuthPluginEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_AUTH_PLUGIN = "auth_plugin";
  @SerializedName(SERIALIZED_NAME_AUTH_PLUGIN)
  ...
  **/
   ...
   * @return the MysqlSettings instance itself
   */
  public MysqlSettings putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authPlugin, mysqlSettings.authPlugin)&&
        Objects.equals(this.additionalProperties, mysqlSettings.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authPlugin, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("auth_plugin");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("auth_plugin");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MysqlSettings
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MysqlSettings.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : MysqlSettings.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("auth_plugin").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `auth_plugin` to be a primitive type in the JSON string but got `%s`", jsonObj.get("auth_plugin").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MysqlSettings>() {
           ...
           public MysqlSettings read(JsonReader in) throws IOException {
             ...
             MysqlSettings instance = thisAdapter.fromJsonTree(jsonObj);
