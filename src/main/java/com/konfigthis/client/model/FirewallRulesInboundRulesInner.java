...
import com.konfigthis.client.model.FirewallRulesInboundRulesInnerAllOfSources;
...
public class FirewallRulesInboundRulesInner {
  ...
  **/
   ...
   * @return the FirewallRulesInboundRulesInner instance itself
   */
  public FirewallRulesInboundRulesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.protocol, firewallRulesInboundRulesInner.protocol) &&
        ...
        Objects.equals(this.additionalProperties, firewallRulesInboundRulesInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRulesInboundRulesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRulesInboundRulesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRulesInboundRulesInner is not found in the empty JSON string", FirewallRulesInboundRulesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallRulesInboundRulesInner.openapiRequiredFields) {
      ...
      FirewallRulesInboundRulesInnerAllOfSources.validateJsonObject(jsonObj.getAsJsonObject("sources"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRulesInboundRulesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRulesInboundRulesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRulesInboundRulesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRulesInboundRulesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRulesInboundRulesInner>() {
           @Override
           public void write(JsonWriter out, FirewallRulesInboundRulesInner value) throws IOException {
           ...
           @Override
           public FirewallRulesInboundRulesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRulesInboundRulesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRulesInboundRulesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRulesInboundRulesInner
  * @throws IOException if the JSON string is invalid with respect to FirewallRulesInboundRulesInner
  */
  public static FirewallRulesInboundRulesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRulesInboundRulesInner.class);
  }

 /**
  * Convert an instance of FirewallRulesInboundRulesInner to an JSON string
  *
  * @return JSON string
  */
