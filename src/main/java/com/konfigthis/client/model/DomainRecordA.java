...
public class DomainRecordA {
  ...
  **/
   ...
   * @return the DomainRecordA instance itself
   */
  public DomainRecordA putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordA.id) &&
        Objects.equals(this.type, domainRecordA.type) &&
        Objects.equals(this.name, domainRecordA.name) &&
        Objects.equals(this.data, domainRecordA.data) &&
        Objects.equals(this.priority, domainRecordA.priority) &&
        Objects.equals(this.port, domainRecordA.port) &&
        Objects.equals(this.ttl, domainRecordA.ttl) &&
        Objects.equals(this.weight, domainRecordA.weight) &&
        Objects.equals(this.flags, domainRecordA.flags) &&
        Objects.equals(this.tag, domainRecordA.tag)&&
        Objects.equals(this.additionalProperties, domainRecordA.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordA
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordA.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordA is not found in the empty JSON string", DomainRecordA.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordA.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordA.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordA' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordA> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordA.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordA>() {
           @Override
           public void write(JsonWriter out, DomainRecordA value) throws IOException {
           ...
           @Override
           public DomainRecordA read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordA instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordA given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordA
  * @throws IOException if the JSON string is invalid with respect to DomainRecordA
  */
  public static DomainRecordA fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordA.class);
  }

 /**
  * Convert an instance of DomainRecordA to an JSON string
  *
  * @return JSON string
  */
