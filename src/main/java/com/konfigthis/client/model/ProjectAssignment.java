...
public class ProjectAssignment {
  ...
  **/
   ...
   * @return the ProjectAssignment instance itself
   */
  public ProjectAssignment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resources, projectAssignment.resources)&&
        Objects.equals(this.additionalProperties, projectAssignment.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectAssignment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProjectAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectAssignment is not found in the empty JSON string", ProjectAssignment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectAssignment>() {
           @Override
           public void write(JsonWriter out, ProjectAssignment value) throws IOException {
           ...
           @Override
           public ProjectAssignment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProjectAssignment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProjectAssignment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectAssignment
  * @throws IOException if the JSON string is invalid with respect to ProjectAssignment
  */
  public static ProjectAssignment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectAssignment.class);
  }

 /**
  * Convert an instance of ProjectAssignment to an JSON string
  *
  * @return JSON string
  */
