...
public class AppsDomainProgress {
  ...
  **/
   ...
   * @return the AppsDomainProgress instance itself
   */
  public AppsDomainProgress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.steps, appsDomainProgress.steps)&&
        Objects.equals(this.additionalProperties, appsDomainProgress.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDomainProgress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDomainProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDomainProgress is not found in the empty JSON string", AppsDomainProgress.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDomainProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDomainProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDomainProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDomainProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDomainProgress>() {
           @Override
           public void write(JsonWriter out, AppsDomainProgress value) throws IOException {
           ...
           @Override
           public AppsDomainProgress read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDomainProgress instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDomainProgress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDomainProgress
  * @throws IOException if the JSON string is invalid with respect to AppsDomainProgress
  */
  public static AppsDomainProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDomainProgress.class);
  }

 /**
  * Convert an instance of AppsDomainProgress to an JSON string
  *
  * @return JSON string
  */
