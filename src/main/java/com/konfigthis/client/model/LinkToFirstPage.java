...
public class LinkToFirstPage {
  ...
  **/
   ...
   * @return the LinkToFirstPage instance itself
   */
  public LinkToFirstPage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.first, linkToFirstPage.first)&&
        Objects.equals(this.additionalProperties, linkToFirstPage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(first, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkToFirstPage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkToFirstPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkToFirstPage is not found in the empty JSON string", LinkToFirstPage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkToFirstPage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkToFirstPage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkToFirstPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkToFirstPage.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkToFirstPage>() {
           @Override
           public void write(JsonWriter out, LinkToFirstPage value) throws IOException {
           ...
           @Override
           public LinkToFirstPage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LinkToFirstPage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LinkToFirstPage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkToFirstPage
  * @throws IOException if the JSON string is invalid with respect to LinkToFirstPage
  */
  public static LinkToFirstPage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkToFirstPage.class);
  }

 /**
  * Convert an instance of LinkToFirstPage to an JSON string
  *
  * @return JSON string
  */
