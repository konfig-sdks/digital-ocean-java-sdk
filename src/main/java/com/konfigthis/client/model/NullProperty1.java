...
import com.konfigthis.client.model.DropletNetworks;
import com.konfigthis.client.model.DropletNextBackupWindow;
import com.konfigthis.client.model.Image;
import com.konfigthis.client.model.Kernel;
 ...
 */
@ApiModel(description = "If the reserved IP is not assigned to a Droplet, the value will be null.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class NullProperty1 {
 ...
 public enum StatusEnum {
  ...
  private List<Integer> backupIds = null;
  ...
  public NullProperty1() {
  }

  public NullProperty1 tags(List<String> tags) {
  ...
  public NullProperty1 addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"web\",\"env:prod\"]", value = "An array of Tags the Droplet has been tagged with.")
  ...
  public NullProperty1 id(Integer id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "3164444", value = "A unique identifier for each Droplet instance. This is automatically generated upon Droplet creation.")
  ...
  public NullProperty1 name(String name) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example.com", value = "The human-readable name set for the Droplet instance.")
  ...
  public NullProperty1 memory(Integer memory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1024", value = "Memory of the Droplet in megabytes.")
  ...
  public NullProperty1 vcpus(Integer vcpus) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The number of virtual CPUs.")
  ...
  public NullProperty1 disk(Integer disk) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "25", value = "The size of the Droplet's disk in gigabytes.")
  ...
  public NullProperty1 locked(Boolean locked) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "false", value = "A boolean value indicating whether the Droplet has been locked, preventing actions by users.")
  ...
  public NullProperty1 status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "ACTIVE", value = "A status string indicating the state of the Droplet instance. This may be \"new\", \"active\", \"off\", or \"archive\".")
  ...
  public NullProperty1 kernel(Kernel kernel) {
  ...
  **/
  ...
  public NullProperty1 createdAt(OffsetDateTime createdAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2020-07-21T18:37:44Z", value = "A time value given in ISO8601 combined date and time format that represents when the Droplet was created.")
  ...
  public NullProperty1 features(List<String> features) {
  ...
  public NullProperty1 addFeaturesItem(String featuresItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"backups\",\"private_networking\",\"ipv6\"]", value = "An array of features enabled on this Droplet.")
  ...
  public NullProperty1 backupIds(List<Integer> backupIds) {
  ...
  public NullProperty1 addBackupIdsItem(Integer backupIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[53893572]", value = "An array of backup IDs of any backups that have been taken of the Droplet instance.  Droplet backups are enabled at the time of the instance creation.")
  ...
  public NullProperty1 nextBackupWindow(DropletNextBackupWindow nextBackupWindow) {
  ...
  **/
  ...
  public NullProperty1 snapshotIds(List<Integer> snapshotIds) {
  ...
  public NullProperty1 addSnapshotIdsItem(Integer snapshotIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[67512819]", value = "An array of snapshot IDs of any snapshots created from the Droplet instance.")
  ...
  public NullProperty1 image(Image image) {
  ...
  **/
  ...
  public NullProperty1 volumeIds(List<String> volumeIds) {
  ...
  public NullProperty1 addVolumeIdsItem(String volumeIdsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"506f78a4-e098-11e5-ad9f-000f53306ae1\"]", value = "A flat array including the unique identifier for each Block Storage volume attached to the Droplet.")
  ...
  public NullProperty1 size(Size size) {
  ...
  **/
  ...
  public NullProperty1 sizeSlug(String sizeSlug) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "s-1vcpu-1gb", value = "The unique slug identifier for the size of this Droplet.")
  ...
  public NullProperty1 networks(DropletNetworks networks) {
  ...
  **/
  ...
  public NullProperty1 region(Region region) {
  ...
  **/
  ...
  public NullProperty1 vpcUuid(String vpcUuid) {
  ...
  **/
   ...
   * @return the NullProperty1 instance itself
   */
  public NullProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NullProperty1 nullProperty1 = (NullProperty1) o;
    return Objects.equals(this.tags, nullProperty1.tags) &&
        Objects.equals(this.id, nullProperty1.id) &&
        Objects.equals(this.name, nullProperty1.name) &&
        Objects.equals(this.memory, nullProperty1.memory) &&
        Objects.equals(this.vcpus, nullProperty1.vcpus) &&
        Objects.equals(this.disk, nullProperty1.disk) &&
        Objects.equals(this.locked, nullProperty1.locked) &&
        Objects.equals(this.status, nullProperty1.status) &&
        Objects.equals(this.kernel, nullProperty1.kernel) &&
        Objects.equals(this.createdAt, nullProperty1.createdAt) &&
        Objects.equals(this.features, nullProperty1.features) &&
        Objects.equals(this.backupIds, nullProperty1.backupIds) &&
        Objects.equals(this.nextBackupWindow, nullProperty1.nextBackupWindow) &&
        Objects.equals(this.snapshotIds, nullProperty1.snapshotIds) &&
        Objects.equals(this.image, nullProperty1.image) &&
        Objects.equals(this.volumeIds, nullProperty1.volumeIds) &&
        Objects.equals(this.size, nullProperty1.size) &&
        Objects.equals(this.sizeSlug, nullProperty1.sizeSlug) &&
        Objects.equals(this.networks, nullProperty1.networks) &&
        Objects.equals(this.region, nullProperty1.region) &&
        Objects.equals(this.vpcUuid, nullProperty1.vpcUuid)&&
        Objects.equals(this.additionalProperties, nullProperty1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NullProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NullProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NullProperty1 is not found in the empty JSON string", NullProperty1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("kernel") != null && !jsonObj.get("kernel").isJsonNull()) {
        Kernel.validateJsonObject(jsonObj.getAsJsonObject("kernel"));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("next_backup_window") != null && !jsonObj.get("next_backup_window").isJsonNull()) {
        DropletNextBackupWindow.validateJsonObject(jsonObj.getAsJsonObject("next_backup_window"));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("networks") != null && !jsonObj.get("networks").isJsonNull()) {
        DropletNetworks.validateJsonObject(jsonObj.getAsJsonObject("networks"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NullProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NullProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NullProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NullProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<NullProperty1>() {
           @Override
           public void write(JsonWriter out, NullProperty1 value) throws IOException {
           ...
           @Override
           public NullProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NullProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NullProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NullProperty1
  * @throws IOException if the JSON string is invalid with respect to NullProperty1
  */
  public static NullProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NullProperty1.class);
  }

 /**
  * Convert an instance of NullProperty1 to an JSON string
  *
  * @return JSON string
  */
