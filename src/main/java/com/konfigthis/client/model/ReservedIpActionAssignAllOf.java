...
public class ReservedIpActionAssignAllOf {
  ...
  **/
   ...
   * @return the ReservedIpActionAssignAllOf instance itself
   */
  public ReservedIpActionAssignAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletId, reservedIpActionAssignAllOf.dropletId)&&
        Objects.equals(this.additionalProperties, reservedIpActionAssignAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReservedIpActionAssignAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReservedIpActionAssignAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedIpActionAssignAllOf is not found in the empty JSON string", ReservedIpActionAssignAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReservedIpActionAssignAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedIpActionAssignAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedIpActionAssignAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedIpActionAssignAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedIpActionAssignAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedIpActionAssignAllOf>() {
           @Override
           public void write(JsonWriter out, ReservedIpActionAssignAllOf value) throws IOException {
           ...
           @Override
           public ReservedIpActionAssignAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReservedIpActionAssignAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReservedIpActionAssignAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReservedIpActionAssignAllOf
  * @throws IOException if the JSON string is invalid with respect to ReservedIpActionAssignAllOf
  */
  public static ReservedIpActionAssignAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedIpActionAssignAllOf.class);
  }

 /**
  * Convert an instance of ReservedIpActionAssignAllOf to an JSON string
  *
  * @return JSON string
  */
