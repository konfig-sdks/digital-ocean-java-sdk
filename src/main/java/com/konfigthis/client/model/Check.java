...
public class Check {
  ...
  **/
  ...
  @ApiModelProperty(example = "5a4981aa-9653-4bd1-bef5-d6bff52042e4", value = "A unique ID that can be used to identify and reference the check.")
  ...
  **/
  ...
  public Check target(String target) {
  ...
  **/
  ...
  public Check regions(List<RegionsEnum> regions) {
  ...
  public Check addRegionsItem(RegionsEnum regionsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, check.id) &&
        ...
        Objects.equals(this.target, check.target) &&
        Objects.equals(this.regions, check.regions) &&
        Objects.equals(this.enabled, check.enabled)&&
        Objects.equals(this.additionalProperties, check.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, type, target, regions, enabled, additionalProperties);
  }
