...
public class DomainRecordMx {
  ...
  **/
   ...
   * @return the DomainRecordMx instance itself
   */
  public DomainRecordMx putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordMx.id) &&
        Objects.equals(this.type, domainRecordMx.type) &&
        Objects.equals(this.name, domainRecordMx.name) &&
        Objects.equals(this.data, domainRecordMx.data) &&
        Objects.equals(this.priority, domainRecordMx.priority) &&
        Objects.equals(this.port, domainRecordMx.port) &&
        Objects.equals(this.ttl, domainRecordMx.ttl) &&
        Objects.equals(this.weight, domainRecordMx.weight) &&
        Objects.equals(this.flags, domainRecordMx.flags) &&
        Objects.equals(this.tag, domainRecordMx.tag)&&
        Objects.equals(this.additionalProperties, domainRecordMx.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordMx
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordMx.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordMx is not found in the empty JSON string", DomainRecordMx.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordMx.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordMx.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordMx' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordMx> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordMx.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordMx>() {
           @Override
           public void write(JsonWriter out, DomainRecordMx value) throws IOException {
           ...
           @Override
           public DomainRecordMx read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordMx instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordMx given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordMx
  * @throws IOException if the JSON string is invalid with respect to DomainRecordMx
  */
  public static DomainRecordMx fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordMx.class);
  }

 /**
  * Convert an instance of DomainRecordMx to an JSON string
  *
  * @return JSON string
  */
