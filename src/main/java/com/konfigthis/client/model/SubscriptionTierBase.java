...
public class SubscriptionTierBase {
  ...
  **/
   ...
   * @return the SubscriptionTierBase instance itself
   */
  public SubscriptionTierBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, subscriptionTierBase.name) &&
        ...
        Objects.equals(this.additionalProperties, subscriptionTierBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, slug, includedRepositories, includedStorageBytes, allowStorageOverage, includedBandwidthBytes, monthlyPriceInCents, storageOveragePriceInCents, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubscriptionTierBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubscriptionTierBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriptionTierBase is not found in the empty JSON string", SubscriptionTierBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubscriptionTierBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubscriptionTierBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubscriptionTierBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubscriptionTierBase.class));

       return (TypeAdapter<T>) new TypeAdapter<SubscriptionTierBase>() {
           @Override
           public void write(JsonWriter out, SubscriptionTierBase value) throws IOException {
           ...
           @Override
           public SubscriptionTierBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubscriptionTierBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubscriptionTierBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubscriptionTierBase
  * @throws IOException if the JSON string is invalid with respect to SubscriptionTierBase
  */
  public static SubscriptionTierBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubscriptionTierBase.class);
  }

 /**
  * Convert an instance of SubscriptionTierBase to an JSON string
  *
  * @return JSON string
  */
