...
public class VpcsUpdateRequest {
  ...
  public VpcsUpdateRequest description(String description) {
  ...
  **/
  ...
  public VpcsUpdateRequest name(String name) {
  ...
  **/
  ...
  public VpcsUpdateRequest _default(Boolean _default) {
  ...
  **/
   ...
   * @return the VpcsUpdateRequest instance itself
   */
  public VpcsUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VpcsUpdateRequest vpcsUpdateRequest = (VpcsUpdateRequest) o;
    return Objects.equals(this.description, vpcsUpdateRequest.description) &&
        Objects.equals(this.name, vpcsUpdateRequest.name) &&
        Objects.equals(this._default, vpcsUpdateRequest._default)&&
        Objects.equals(this.additionalProperties, vpcsUpdateRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VpcsUpdateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcsUpdateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcsUpdateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcsUpdateRequest is not found in the empty JSON string", VpcsUpdateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VpcsUpdateRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcsUpdateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcsUpdateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcsUpdateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcsUpdateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcsUpdateRequest>() {
           @Override
           public void write(JsonWriter out, VpcsUpdateRequest value) throws IOException {
           ...
           @Override
           public VpcsUpdateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcsUpdateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcsUpdateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcsUpdateRequest
  * @throws IOException if the JSON string is invalid with respect to VpcsUpdateRequest
  */
  public static VpcsUpdateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcsUpdateRequest.class);
  }

 /**
  * Convert an instance of VpcsUpdateRequest to an JSON string
  *
  * @return JSON string
  */
