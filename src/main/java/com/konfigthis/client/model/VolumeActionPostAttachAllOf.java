...
public class VolumeActionPostAttachAllOf {
  ...
  **/
   ...
   * @return the VolumeActionPostAttachAllOf instance itself
   */
  public VolumeActionPostAttachAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, volumeActionPostAttachAllOf.tags) &&
        Objects.equals(this.dropletId, volumeActionPostAttachAllOf.dropletId)&&
        Objects.equals(this.additionalProperties, volumeActionPostAttachAllOf.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, dropletId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostAttachAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostAttachAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostAttachAllOf is not found in the empty JSON string", VolumeActionPostAttachAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostAttachAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostAttachAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostAttachAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostAttachAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostAttachAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostAttachAllOf>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostAttachAllOf value) throws IOException {
           ...
           @Override
           public VolumeActionPostAttachAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostAttachAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostAttachAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostAttachAllOf
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostAttachAllOf
  */
  public static VolumeActionPostAttachAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostAttachAllOf.class);
  }

 /**
  * Convert an instance of VolumeActionPostAttachAllOf to an JSON string
  *
  * @return JSON string
  */
