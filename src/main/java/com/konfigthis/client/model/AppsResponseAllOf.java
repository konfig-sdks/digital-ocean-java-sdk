...
public class AppsResponseAllOf {
  ...
  **/
   ...
   * @return the AppsResponseAllOf instance itself
   */
  public AppsResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apps, appsResponseAllOf.apps)&&
        Objects.equals(this.additionalProperties, appsResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apps, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsResponseAllOf is not found in the empty JSON string", AppsResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsResponseAllOf>() {
           @Override
           public void write(JsonWriter out, AppsResponseAllOf value) throws IOException {
           ...
           @Override
           public AppsResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to AppsResponseAllOf
  */
  public static AppsResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsResponseAllOf.class);
  }

 /**
  * Convert an instance of AppsResponseAllOf to an JSON string
  *
  * @return JSON string
  */
