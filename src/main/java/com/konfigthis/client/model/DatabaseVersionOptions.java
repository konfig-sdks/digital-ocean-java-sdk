...
public class DatabaseVersionOptions {
  ...
  **/
   ...
   * @return the DatabaseVersionOptions instance itself
   */
  public DatabaseVersionOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseVersionOptions databaseVersionOptions = (DatabaseVersionOptions) o;
    return Objects.equals(this.versions, databaseVersionOptions.versions)&&
        Objects.equals(this.additionalProperties, databaseVersionOptions.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseVersionOptions {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseVersionOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseVersionOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseVersionOptions is not found in the empty JSON string", DatabaseVersionOptions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseVersionOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseVersionOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseVersionOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseVersionOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseVersionOptions>() {
           @Override
           public void write(JsonWriter out, DatabaseVersionOptions value) throws IOException {
           ...
           @Override
           public DatabaseVersionOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseVersionOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseVersionOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseVersionOptions
  * @throws IOException if the JSON string is invalid with respect to DatabaseVersionOptions
  */
  public static DatabaseVersionOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseVersionOptions.class);
  }

 /**
  * Convert an instance of DatabaseVersionOptions to an JSON string
  *
  * @return JSON string
  */
