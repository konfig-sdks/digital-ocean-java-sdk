...
public class AppsAssignAppAlertDestinationsRequest {
  ...
  **/
   ...
   * @return the AppsAssignAppAlertDestinationsRequest instance itself
   */
  public AppsAssignAppAlertDestinationsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emails, appsAssignAppAlertDestinationsRequest.emails) &&
        ...
        Objects.equals(this.additionalProperties, appsAssignAppAlertDestinationsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emails, slackWebhooks, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsAssignAppAlertDestinationsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsAssignAppAlertDestinationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsAssignAppAlertDestinationsRequest is not found in the empty JSON string", AppsAssignAppAlertDestinationsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsAssignAppAlertDestinationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsAssignAppAlertDestinationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsAssignAppAlertDestinationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsAssignAppAlertDestinationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsAssignAppAlertDestinationsRequest>() {
           @Override
           public void write(JsonWriter out, AppsAssignAppAlertDestinationsRequest value) throws IOException {
           ...
           @Override
           public AppsAssignAppAlertDestinationsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsAssignAppAlertDestinationsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsAssignAppAlertDestinationsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsAssignAppAlertDestinationsRequest
  * @throws IOException if the JSON string is invalid with respect to AppsAssignAppAlertDestinationsRequest
  */
  public static AppsAssignAppAlertDestinationsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsAssignAppAlertDestinationsRequest.class);
  }

 /**
  * Convert an instance of AppsAssignAppAlertDestinationsRequest to an JSON string
  *
  * @return JSON string
  */
