...
public class LinkToLastPage {
  ...
  **/
   ...
   * @return the LinkToLastPage instance itself
   */
  public LinkToLastPage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.last, linkToLastPage.last)&&
        Objects.equals(this.additionalProperties, linkToLastPage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(last, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LinkToLastPage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LinkToLastPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LinkToLastPage is not found in the empty JSON string", LinkToLastPage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LinkToLastPage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LinkToLastPage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LinkToLastPage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LinkToLastPage.class));

       return (TypeAdapter<T>) new TypeAdapter<LinkToLastPage>() {
           @Override
           public void write(JsonWriter out, LinkToLastPage value) throws IOException {
           ...
           @Override
           public LinkToLastPage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LinkToLastPage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LinkToLastPage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LinkToLastPage
  * @throws IOException if the JSON string is invalid with respect to LinkToLastPage
  */
  public static LinkToLastPage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LinkToLastPage.class);
  }

 /**
  * Convert an instance of LinkToLastPage to an JSON string
  *
  * @return JSON string
  */
