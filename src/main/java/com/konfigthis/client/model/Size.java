...
public class Size {
  ...
  **/
  ...
  public Size memory(Integer memory) {
    if (memory != null && memory < 8) {
      throw new IllegalArgumentException("Invalid value for memory. Must be greater than or equal to 8.");
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Size size = (Size) o;
    return Objects.equals(this.description, size.description) &&
        Objects.equals(this.slug, size.slug) &&
        Objects.equals(this.memory, size.memory) &&
        Objects.equals(this.vcpus, size.vcpus) &&
        Objects.equals(this.disk, size.disk) &&
        Objects.equals(this.transfer, size.transfer) &&
        Objects.equals(this.priceMonthly, size.priceMonthly) &&
        Objects.equals(this.priceHourly, size.priceHourly) &&
        Objects.equals(this.regions, size.regions) &&
        Objects.equals(this.available, size.available)&&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (String requiredField : Size.openapiRequiredFields) {
