...
import com.konfigthis.client.model.FirewallRulesOutboundRulesInnerAllOfDestinations;
...
public class FirewallRulesOutboundRulesInner {
  ...
  **/
   ...
   * @return the FirewallRulesOutboundRulesInner instance itself
   */
  public FirewallRulesOutboundRulesInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.protocol, firewallRulesOutboundRulesInner.protocol) &&
        ...
        Objects.equals(this.additionalProperties, firewallRulesOutboundRulesInner.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRulesOutboundRulesInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRulesOutboundRulesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRulesOutboundRulesInner is not found in the empty JSON string", FirewallRulesOutboundRulesInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallRulesOutboundRulesInner.openapiRequiredFields) {
      ...
      if (!jsonObj.get("ports").isJsonPrimitive()) {
      ...
      FirewallRulesOutboundRulesInnerAllOfDestinations.validateJsonObject(jsonObj.getAsJsonObject("destinations"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRulesOutboundRulesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRulesOutboundRulesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRulesOutboundRulesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRulesOutboundRulesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRulesOutboundRulesInner>() {
           @Override
           public void write(JsonWriter out, FirewallRulesOutboundRulesInner value) throws IOException {
           ...
           @Override
           public FirewallRulesOutboundRulesInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRulesOutboundRulesInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRulesOutboundRulesInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRulesOutboundRulesInner
  * @throws IOException if the JSON string is invalid with respect to FirewallRulesOutboundRulesInner
  */
  public static FirewallRulesOutboundRulesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRulesOutboundRulesInner.class);
  }

 /**
  * Convert an instance of FirewallRulesOutboundRulesInner to an JSON string
  *
  * @return JSON string
  */
