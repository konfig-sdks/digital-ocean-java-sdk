...
import com.konfigthis.client.model.AppsInstanceSize;
...
public class AppsListInstanceSizesResponse {
  ...
  public static final String SERIALIZED_NAME_INSTANCE_SIZES = "instance_sizes";
  @SerializedName(SERIALIZED_NAME_INSTANCE_SIZES)
  ...
  **/
   ...
   * @return the AppsListInstanceSizesResponse instance itself
   */
  public AppsListInstanceSizesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.discountPercent, appsListInstanceSizesResponse.discountPercent) &&
        ...
        Objects.equals(this.additionalProperties, appsListInstanceSizesResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(discountPercent, instanceSizes, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("instance_sizes");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsListInstanceSizesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsListInstanceSizesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsListInstanceSizesResponse is not found in the empty JSON string", AppsListInstanceSizesResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("instance_sizes") != null && !jsonObj.get("instance_sizes").isJsonNull()) {
        JsonArray jsonArrayinstanceSizes = jsonObj.getAsJsonArray("instance_sizes");
        if (jsonArrayinstanceSizes != null) {
          // ensure the json data is an array
          if (!jsonObj.get("instance_sizes").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `instance_sizes` to be an array in the JSON string but got `%s`", jsonObj.get("instance_sizes").toString()));
          }

          // validate the optional field `instance_sizes` (array)
          for (int i = 0; i < jsonArrayinstanceSizes.size(); i++) {
            AppsInstanceSize.validateJsonObject(jsonArrayinstanceSizes.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsListInstanceSizesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsListInstanceSizesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsListInstanceSizesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsListInstanceSizesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsListInstanceSizesResponse>() {
           @Override
           public void write(JsonWriter out, AppsListInstanceSizesResponse value) throws IOException {
           ...
           @Override
           public AppsListInstanceSizesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsListInstanceSizesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsListInstanceSizesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsListInstanceSizesResponse
  * @throws IOException if the JSON string is invalid with respect to AppsListInstanceSizesResponse
  */
  public static AppsListInstanceSizesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsListInstanceSizesResponse.class);
  }

 /**
  * Convert an instance of AppsListInstanceSizesResponse to an JSON string
  *
  * @return JSON string
  */
