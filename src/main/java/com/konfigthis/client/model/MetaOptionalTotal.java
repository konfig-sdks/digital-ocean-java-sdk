...
public class MetaOptionalTotal {
  ...
  **/
   ...
   * @return the MetaOptionalTotal instance itself
   */
  public MetaOptionalTotal putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, metaOptionalTotal.meta)&&
        Objects.equals(this.additionalProperties, metaOptionalTotal.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetaOptionalTotal
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetaOptionalTotal.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetaOptionalTotal is not found in the empty JSON string", MetaOptionalTotal.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetaOptionalTotal.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetaOptionalTotal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetaOptionalTotal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetaOptionalTotal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetaOptionalTotal.class));

       return (TypeAdapter<T>) new TypeAdapter<MetaOptionalTotal>() {
           @Override
           public void write(JsonWriter out, MetaOptionalTotal value) throws IOException {
           ...
           @Override
           public MetaOptionalTotal read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetaOptionalTotal instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetaOptionalTotal given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetaOptionalTotal
  * @throws IOException if the JSON string is invalid with respect to MetaOptionalTotal
  */
  public static MetaOptionalTotal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetaOptionalTotal.class);
  }

 /**
  * Convert an instance of MetaOptionalTotal to an JSON string
  *
  * @return JSON string
  */
