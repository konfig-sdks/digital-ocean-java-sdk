...
public class SizesListResponse {
  ...
  **/
  ...
  public SizesListResponse links(PageLinks links) {
  ...
  **/
  ...
  public SizesListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the SizesListResponse instance itself
   */
  public SizesListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sizes, sizesListResponse.sizes) &&
        Objects.equals(this.links, sizesListResponse.links) &&
        Objects.equals(this.meta, sizesListResponse.meta)&&
        Objects.equals(this.additionalProperties, sizesListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sizes, links, meta, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SizesListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SizesListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : SizesListResponse.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SizesListResponse>() {
           ...
           public SizesListResponse read(JsonReader in) throws IOException {
             ...
             SizesListResponse instance = thisAdapter.fromJsonTree(jsonObj);
