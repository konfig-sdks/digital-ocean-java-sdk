...
public class VolumeActionPostResizeAllOf {
  ...
  public VolumeActionPostResizeAllOf sizeGigabytes(Integer sizeGigabytes) {
    ...
    if (sizeGigabytes != null && sizeGigabytes > 16384) {
      throw new IllegalArgumentException("Invalid value for sizeGigabytes. Must be less than or equal to 16384.");
    }
  ...
  **/
   ...
   * @return the VolumeActionPostResizeAllOf instance itself
   */
  public VolumeActionPostResizeAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sizeGigabytes, volumeActionPostResizeAllOf.sizeGigabytes)&&
        Objects.equals(this.additionalProperties, volumeActionPostResizeAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sizeGigabytes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostResizeAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostResizeAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostResizeAllOf is not found in the empty JSON string", VolumeActionPostResizeAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostResizeAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostResizeAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostResizeAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostResizeAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostResizeAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostResizeAllOf>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostResizeAllOf value) throws IOException {
           ...
           @Override
           public VolumeActionPostResizeAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostResizeAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostResizeAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostResizeAllOf
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostResizeAllOf
  */
  public static VolumeActionPostResizeAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostResizeAllOf.class);
  }

 /**
  * Convert an instance of VolumeActionPostResizeAllOf to an JSON string
  *
  * @return JSON string
  */
