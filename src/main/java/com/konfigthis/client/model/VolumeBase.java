...
public class VolumeBase {
  ...
  **/
   ...
   * @return the VolumeBase instance itself
   */
  public VolumeBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, volumeBase.tags) &&
        Objects.equals(this.description, volumeBase.description) &&
        Objects.equals(this.id, volumeBase.id) &&
        Objects.equals(this.dropletIds, volumeBase.dropletIds) &&
        Objects.equals(this.name, volumeBase.name) &&
        Objects.equals(this.sizeGigabytes, volumeBase.sizeGigabytes) &&
        Objects.equals(this.createdAt, volumeBase.createdAt)&&
        Objects.equals(this.additionalProperties, volumeBase.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, id, dropletIds, name, sizeGigabytes, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeBase is not found in the empty JSON string", VolumeBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeBase.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeBase>() {
           @Override
           public void write(JsonWriter out, VolumeBase value) throws IOException {
           ...
           @Override
           public VolumeBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeBase
  * @throws IOException if the JSON string is invalid with respect to VolumeBase
  */
  public static VolumeBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeBase.class);
  }

 /**
  * Convert an instance of VolumeBase to an JSON string
  *
  * @return JSON string
  */
