...
public class AppsDeploymentFunctions {
  ...
  **/
   ...
   * @return the AppsDeploymentFunctions instance itself
   */
  public AppsDeploymentFunctions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appsDeploymentFunctions.name) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentFunctions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, sourceCommitHash, namespace, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentFunctions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentFunctions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentFunctions is not found in the empty JSON string", AppsDeploymentFunctions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentFunctions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentFunctions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentFunctions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentFunctions.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentFunctions>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentFunctions value) throws IOException {
           ...
           @Override
           public AppsDeploymentFunctions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentFunctions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentFunctions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentFunctions
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentFunctions
  */
  public static AppsDeploymentFunctions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentFunctions.class);
  }

 /**
  * Convert an instance of AppsDeploymentFunctions to an JSON string
  *
  * @return JSON string
  */
