...
public class VpcBase {
  ...
  **/
   ...
   * @return the VpcBase instance itself
   */
  public VpcBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, vpcBase.id) &&
        Objects.equals(this.urn, vpcBase.urn) &&
        Objects.equals(this.createdAt, vpcBase.createdAt)&&
        Objects.equals(this.additionalProperties, vpcBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, urn, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VpcBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VpcBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VpcBase is not found in the empty JSON string", VpcBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VpcBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VpcBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VpcBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VpcBase.class));

       return (TypeAdapter<T>) new TypeAdapter<VpcBase>() {
           @Override
           public void write(JsonWriter out, VpcBase value) throws IOException {
           ...
           @Override
           public VpcBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VpcBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VpcBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VpcBase
  * @throws IOException if the JSON string is invalid with respect to VpcBase
  */
  public static VpcBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VpcBase.class);
  }

 /**
  * Convert an instance of VpcBase to an JSON string
  *
  * @return JSON string
  */
