...
public class RepositoryBlob {
  ...
  **/
   ...
   * @return the RepositoryBlob instance itself
   */
  public RepositoryBlob putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.digest, repositoryBlob.digest) &&
        ...
        Objects.equals(this.additionalProperties, repositoryBlob.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(digest, compressedSizeBytes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryBlob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryBlob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryBlob is not found in the empty JSON string", RepositoryBlob.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryBlob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryBlob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryBlob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryBlob.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryBlob>() {
           @Override
           public void write(JsonWriter out, RepositoryBlob value) throws IOException {
           ...
           @Override
           public RepositoryBlob read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RepositoryBlob instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RepositoryBlob given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryBlob
  * @throws IOException if the JSON string is invalid with respect to RepositoryBlob
  */
  public static RepositoryBlob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryBlob.class);
  }

 /**
  * Convert an instance of RepositoryBlob to an JSON string
  *
  * @return JSON string
  */
