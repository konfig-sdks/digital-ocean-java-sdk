...
public class CertificateRequestCustomAllOf {
  ...
  public static final String SERIALIZED_NAME_LEAF_CERTIFICATE = "leaf_certificate";
  @SerializedName(SERIALIZED_NAME_LEAF_CERTIFICATE)
  ...
  **/
   ...
   * @return the CertificateRequestCustomAllOf instance itself
   */
  public CertificateRequestCustomAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.privateKey, certificateRequestCustomAllOf.privateKey) &&
        ...
        Objects.equals(this.additionalProperties, certificateRequestCustomAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(privateKey, leafCertificate, certificateChain, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateRequestCustomAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateRequestCustomAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateRequestCustomAllOf is not found in the empty JSON string", CertificateRequestCustomAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateRequestCustomAllOf.openapiRequiredFields) {
      ...
      if (!jsonObj.get("leaf_certificate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `leaf_certificate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("leaf_certificate").toString()));
      }
      if ((jsonObj.get("certificate_chain") != null && !jsonObj.get("certificate_chain").isJsonNull()) && !jsonObj.get("certificate_chain").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `certificate_chain` to be a primitive type in the JSON string but got `%s`", jsonObj.get("certificate_chain").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateRequestCustomAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateRequestCustomAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateRequestCustomAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateRequestCustomAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateRequestCustomAllOf>() {
           @Override
           public void write(JsonWriter out, CertificateRequestCustomAllOf value) throws IOException {
           ...
           @Override
           public CertificateRequestCustomAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateRequestCustomAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateRequestCustomAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateRequestCustomAllOf
  * @throws IOException if the JSON string is invalid with respect to CertificateRequestCustomAllOf
  */
  public static CertificateRequestCustomAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateRequestCustomAllOf.class);
  }

 /**
  * Convert an instance of CertificateRequestCustomAllOf to an JSON string
  *
  * @return JSON string
  */
