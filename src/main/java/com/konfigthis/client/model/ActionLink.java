 ...
 */
@ApiModel(description = "The linked actions can be used to check the status of a Droplet's create event.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ActionLink {
  ...
  **/
   ...
   * @return the ActionLink instance itself
   */
  public ActionLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, actionLink.id) &&
        Objects.equals(this.rel, actionLink.rel) &&
        Objects.equals(this.href, actionLink.href)&&
        Objects.equals(this.additionalProperties, actionLink.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, rel, href, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActionLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActionLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ActionLink>() {
           ...
           public ActionLink read(JsonReader in) throws IOException {
             ...
             ActionLink instance = thisAdapter.fromJsonTree(jsonObj);
