...
public class AppPropose {
  ...
  **/
   ...
   * @return the AppPropose instance itself
   */
  public AppPropose putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.spec, appPropose.spec) &&
        Objects.equals(this.appId, appPropose.appId)&&
        Objects.equals(this.additionalProperties, appPropose.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(spec, appId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppPropose
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppPropose.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppPropose is not found in the empty JSON string", AppPropose.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppPropose.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppPropose.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppPropose' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppPropose> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppPropose.class));

       return (TypeAdapter<T>) new TypeAdapter<AppPropose>() {
           @Override
           public void write(JsonWriter out, AppPropose value) throws IOException {
           ...
           @Override
           public AppPropose read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppPropose instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppPropose given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppPropose
  * @throws IOException if the JSON string is invalid with respect to AppPropose
  */
  public static AppPropose fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppPropose.class);
  }

 /**
  * Convert an instance of AppPropose to an JSON string
  *
  * @return JSON string
  */
