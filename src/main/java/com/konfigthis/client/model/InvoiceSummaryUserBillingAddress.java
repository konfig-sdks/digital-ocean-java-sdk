...
public class InvoiceSummaryUserBillingAddress {
  ...
  public static final String SERIALIZED_NAME_COUNTRY_ISO2_CODE = "country_iso2_code";
  ...
  **/
   ...
   * @return the InvoiceSummaryUserBillingAddress instance itself
   */
  public InvoiceSummaryUserBillingAddress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressLine1, invoiceSummaryUserBillingAddress.addressLine1) &&
        ...
        Objects.equals(this.additionalProperties, invoiceSummaryUserBillingAddress.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressLine1, addressLine2, city, region, postalCode, countryIso2Code, createdAt, updatedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("country_iso2_code");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceSummaryUserBillingAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceSummaryUserBillingAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceSummaryUserBillingAddress is not found in the empty JSON string", InvoiceSummaryUserBillingAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("country_iso2_code") != null && !jsonObj.get("country_iso2_code").isJsonNull()) && !jsonObj.get("country_iso2_code").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `country_iso2_code` to be a primitive type in the JSON string but got `%s`", jsonObj.get("country_iso2_code").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceSummaryUserBillingAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceSummaryUserBillingAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceSummaryUserBillingAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceSummaryUserBillingAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceSummaryUserBillingAddress>() {
           @Override
           public void write(JsonWriter out, InvoiceSummaryUserBillingAddress value) throws IOException {
           ...
           @Override
           public InvoiceSummaryUserBillingAddress read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceSummaryUserBillingAddress instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceSummaryUserBillingAddress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceSummaryUserBillingAddress
  * @throws IOException if the JSON string is invalid with respect to InvoiceSummaryUserBillingAddress
  */
  public static InvoiceSummaryUserBillingAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceSummaryUserBillingAddress.class);
  }

 /**
  * Convert an instance of InvoiceSummaryUserBillingAddress to an JSON string
  *
  * @return JSON string
  */
