...
public class ImageActionTransfer {
  ...
  **/
   ...
   * @return the ImageActionTransfer instance itself
   */
  public ImageActionTransfer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, imageActionTransfer.type) &&
        ...
        Objects.equals(this.additionalProperties, imageActionTransfer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionTransfer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionTransfer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionTransfer is not found in the empty JSON string", ImageActionTransfer.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageActionTransfer.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionTransfer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionTransfer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionTransfer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionTransfer.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionTransfer>() {
           @Override
           public void write(JsonWriter out, ImageActionTransfer value) throws IOException {
           ...
           @Override
           public ImageActionTransfer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionTransfer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionTransfer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionTransfer
  * @throws IOException if the JSON string is invalid with respect to ImageActionTransfer
  */
  public static ImageActionTransfer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionTransfer.class);
  }

 /**
  * Convert an instance of ImageActionTransfer to an JSON string
  *
  * @return JSON string
  */
