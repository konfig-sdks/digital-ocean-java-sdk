...
public class DropletMultiCreateAllOf {
  ...
  **/
   ...
   * @return the DropletMultiCreateAllOf instance itself
   */
  public DropletMultiCreateAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.names, dropletMultiCreateAllOf.names)&&
        Objects.equals(this.additionalProperties, dropletMultiCreateAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletMultiCreateAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletMultiCreateAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletMultiCreateAllOf is not found in the empty JSON string", DropletMultiCreateAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletMultiCreateAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletMultiCreateAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletMultiCreateAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletMultiCreateAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletMultiCreateAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletMultiCreateAllOf>() {
           @Override
           public void write(JsonWriter out, DropletMultiCreateAllOf value) throws IOException {
           ...
           @Override
           public DropletMultiCreateAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletMultiCreateAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletMultiCreateAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletMultiCreateAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletMultiCreateAllOf
  */
  public static DropletMultiCreateAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletMultiCreateAllOf.class);
  }

 /**
  * Convert an instance of DropletMultiCreateAllOf to an JSON string
  *
  * @return JSON string
  */
