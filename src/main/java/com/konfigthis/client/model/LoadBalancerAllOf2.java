...
public class LoadBalancerAllOf2 {
  ...
  **/
   ...
   * @return the LoadBalancerAllOf2 instance itself
   */
  public LoadBalancerAllOf2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tag, loadBalancerAllOf2.tag)&&
        Objects.equals(this.additionalProperties, loadBalancerAllOf2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancerAllOf2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancerAllOf2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancerAllOf2 is not found in the empty JSON string", LoadBalancerAllOf2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancerAllOf2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancerAllOf2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancerAllOf2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancerAllOf2.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancerAllOf2>() {
           @Override
           public void write(JsonWriter out, LoadBalancerAllOf2 value) throws IOException {
           ...
           @Override
           public LoadBalancerAllOf2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancerAllOf2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancerAllOf2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancerAllOf2
  * @throws IOException if the JSON string is invalid with respect to LoadBalancerAllOf2
  */
  public static LoadBalancerAllOf2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancerAllOf2.class);
  }

 /**
  * Convert an instance of LoadBalancerAllOf2 to an JSON string
  *
  * @return JSON string
  */
