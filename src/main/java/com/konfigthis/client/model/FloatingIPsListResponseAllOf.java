...
public class FloatingIPsListResponseAllOf {
  ...
  public FloatingIPsListResponseAllOf() {
  }

  public FloatingIPsListResponseAllOf floatingIps(List<FloatingIp> floatingIps) {
  ...
  public FloatingIPsListResponseAllOf addFloatingIpsItem(FloatingIp floatingIpsItem) {
  ...
  **/
   ...
   * @return the FloatingIPsListResponseAllOf instance itself
   */
  public FloatingIPsListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIPsListResponseAllOf floatingIPsListResponseAllOf = (FloatingIPsListResponseAllOf) o;
    return Objects.equals(this.floatingIps, floatingIPsListResponseAllOf.floatingIps)&&
        Objects.equals(this.additionalProperties, floatingIPsListResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(floatingIps, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FloatingIPsListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIPsListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIPsListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIPsListResponseAllOf is not found in the empty JSON string", FloatingIPsListResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIPsListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIPsListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIPsListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIPsListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIPsListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, FloatingIPsListResponseAllOf value) throws IOException {
           ...
           @Override
           public FloatingIPsListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIPsListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIPsListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIPsListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to FloatingIPsListResponseAllOf
  */
  public static FloatingIPsListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIPsListResponseAllOf.class);
  }

 /**
  * Convert an instance of FloatingIPsListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
