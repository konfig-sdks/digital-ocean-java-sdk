...
public class AppPinnedDeployment {
  ...
  **/
   ...
   * @return the AppPinnedDeployment instance itself
   */
  public AppPinnedDeployment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cause, appPinnedDeployment.cause) &&
        ...
        Objects.equals(this.additionalProperties, appPinnedDeployment.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppPinnedDeployment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppPinnedDeployment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppPinnedDeployment is not found in the empty JSON string", AppPinnedDeployment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppPinnedDeployment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppPinnedDeployment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppPinnedDeployment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppPinnedDeployment.class));

       return (TypeAdapter<T>) new TypeAdapter<AppPinnedDeployment>() {
           @Override
           public void write(JsonWriter out, AppPinnedDeployment value) throws IOException {
           ...
           @Override
           public AppPinnedDeployment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppPinnedDeployment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppPinnedDeployment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppPinnedDeployment
  * @throws IOException if the JSON string is invalid with respect to AppPinnedDeployment
  */
  public static AppPinnedDeployment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppPinnedDeployment.class);
  }

 /**
  * Convert an instance of AppPinnedDeployment to an JSON string
  *
  * @return JSON string
  */
