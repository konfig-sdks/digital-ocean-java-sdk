...
import com.konfigthis.client.model.InstanceSizeCpuType;
...
public class AppsInstanceSize {
  ...
  public static final String SERIALIZED_NAME_MEMORY_BYTES = "memory_bytes";
  ...
  public static final String SERIALIZED_NAME_TIER_DOWNGRADE_TO = "tier_downgrade_to";
  @SerializedName(SERIALIZED_NAME_TIER_DOWNGRADE_TO)
  ...
  public static final String SERIALIZED_NAME_TIER_UPGRADE_TO = "tier_upgrade_to";
  @SerializedName(SERIALIZED_NAME_TIER_UPGRADE_TO)
  private String tierUpgradeTo;

  public static final String SERIALIZED_NAME_USD_PER_MONTH = "usd_per_month";
  @SerializedName(SERIALIZED_NAME_USD_PER_MONTH)
  private String usdPerMonth;

  public static final String SERIALIZED_NAME_USD_PER_SECOND = "usd_per_second";
  @SerializedName(SERIALIZED_NAME_USD_PER_SECOND)
  ...
  **/
   ...
   * @return the AppsInstanceSize instance itself
   */
  public AppsInstanceSize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cpuType, appsInstanceSize.cpuType) &&
        ...
        Objects.equals(this.name, appsInstanceSize.name) &&
        Objects.equals(this.slug, appsInstanceSize.slug) &&
        ...
        Objects.equals(this.additionalProperties, appsInstanceSize.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cpuType, cpus, memoryBytes, name, slug, tierDowngradeTo, tierSlug, tierUpgradeTo, usdPerMonth, usdPerSecond, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("memory_bytes");
    openapiFields.add("name");
    openapiFields.add("slug");
    openapiFields.add("tier_downgrade_to");
    openapiFields.add("tier_slug");
    openapiFields.add("tier_upgrade_to");
    openapiFields.add("usd_per_month");
    openapiFields.add("usd_per_second");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsInstanceSize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsInstanceSize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsInstanceSize is not found in the empty JSON string", AppsInstanceSize.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("memory_bytes") != null && !jsonObj.get("memory_bytes").isJsonNull()) && !jsonObj.get("memory_bytes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `memory_bytes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("memory_bytes").toString()));
      }
      ...
      if ((jsonObj.get("tier_downgrade_to") != null && !jsonObj.get("tier_downgrade_to").isJsonNull()) && !jsonObj.get("tier_downgrade_to").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tier_downgrade_to` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tier_downgrade_to").toString()));
      }
      ...
      if ((jsonObj.get("tier_upgrade_to") != null && !jsonObj.get("tier_upgrade_to").isJsonNull()) && !jsonObj.get("tier_upgrade_to").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `tier_upgrade_to` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tier_upgrade_to").toString()));
      }
      if ((jsonObj.get("usd_per_month") != null && !jsonObj.get("usd_per_month").isJsonNull()) && !jsonObj.get("usd_per_month").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `usd_per_month` to be a primitive type in the JSON string but got `%s`", jsonObj.get("usd_per_month").toString()));
      }
      if ((jsonObj.get("usd_per_second") != null && !jsonObj.get("usd_per_second").isJsonNull()) && !jsonObj.get("usd_per_second").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `usd_per_second` to be a primitive type in the JSON string but got `%s`", jsonObj.get("usd_per_second").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsInstanceSize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsInstanceSize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsInstanceSize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsInstanceSize.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsInstanceSize>() {
           @Override
           public void write(JsonWriter out, AppsInstanceSize value) throws IOException {
           ...
           @Override
           public AppsInstanceSize read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsInstanceSize instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsInstanceSize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsInstanceSize
  * @throws IOException if the JSON string is invalid with respect to AppsInstanceSize
  */
  public static AppsInstanceSize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsInstanceSize.class);
  }

 /**
  * Convert an instance of AppsInstanceSize to an JSON string
  *
  * @return JSON string
  */
