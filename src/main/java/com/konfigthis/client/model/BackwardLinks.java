...
public class BackwardLinks {
  ...
  **/
   ...
   * @return the BackwardLinks instance itself
   */
  public BackwardLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.first, backwardLinks.first) &&
        Objects.equals(this.prev, backwardLinks.prev)&&
        Objects.equals(this.additionalProperties, backwardLinks.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(first, prev, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to BackwardLinks
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BackwardLinks.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackwardLinks is not found in the empty JSON string", BackwardLinks.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackwardLinks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackwardLinks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackwardLinks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackwardLinks.class));

       return (TypeAdapter<T>) new TypeAdapter<BackwardLinks>() {
           @Override
           public void write(JsonWriter out, BackwardLinks value) throws IOException {
           ...
           @Override
           public BackwardLinks read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BackwardLinks instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BackwardLinks given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BackwardLinks
  * @throws IOException if the JSON string is invalid with respect to BackwardLinks
  */
  public static BackwardLinks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackwardLinks.class);
  }

 /**
  * Convert an instance of BackwardLinks to an JSON string
  *
  * @return JSON string
  */
