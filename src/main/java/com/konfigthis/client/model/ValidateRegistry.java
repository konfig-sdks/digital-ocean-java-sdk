...
public class ValidateRegistry {
  ...
  **/
   ...
   * @return the ValidateRegistry instance itself
   */
  public ValidateRegistry putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, validateRegistry.name)&&
        Objects.equals(this.additionalProperties, validateRegistry.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ValidateRegistry
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ValidateRegistry.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidateRegistry is not found in the empty JSON string", ValidateRegistry.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ValidateRegistry.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidateRegistry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidateRegistry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidateRegistry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidateRegistry.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidateRegistry>() {
           @Override
           public void write(JsonWriter out, ValidateRegistry value) throws IOException {
           ...
           @Override
           public ValidateRegistry read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ValidateRegistry instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ValidateRegistry given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ValidateRegistry
  * @throws IOException if the JSON string is invalid with respect to ValidateRegistry
  */
  public static ValidateRegistry fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ValidateRegistry.class);
  }

 /**
  * Convert an instance of ValidateRegistry to an JSON string
  *
  * @return JSON string
  */
