...
public class SshKeysListResponse {
  ...
  private List<SshKeys> sshKeys = null;
  ...
  public SshKeysListResponse sshKeys(List<SshKeys> sshKeys) {
  ...
  public SshKeysListResponse addSshKeysItem(SshKeys sshKeysItem) {
  ...
  **/
  ...
  public void setSshKeys(List<SshKeys> sshKeys) {
  ...
  public SshKeysListResponse links(PageLinks links) {
  ...
  **/
  ...
  public SshKeysListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the SshKeysListResponse instance itself
   */
  public SshKeysListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SshKeysListResponse sshKeysListResponse = (SshKeysListResponse) o;
    return Objects.equals(this.sshKeys, sshKeysListResponse.sshKeys) &&
        Objects.equals(this.links, sshKeysListResponse.links) &&
        Objects.equals(this.meta, sshKeysListResponse.meta)&&
        Objects.equals(this.additionalProperties, sshKeysListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sshKeys, links, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SshKeysListResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SshKeysListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SshKeysListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SshKeysListResponse is not found in the empty JSON string", SshKeysListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SshKeysListResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("ssh_keys") != null && !jsonObj.get("ssh_keys").isJsonNull()) {
        ...
        if (jsonArraysshKeys != null) {
          ...
          for (int i = 0; i < jsonArraysshKeys.size(); i++) {
            SshKeys.validateJsonObject(jsonArraysshKeys.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SshKeysListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SshKeysListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SshKeysListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SshKeysListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SshKeysListResponse>() {
           @Override
           public void write(JsonWriter out, SshKeysListResponse value) throws IOException {
           ...
           @Override
           public SshKeysListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SshKeysListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SshKeysListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SshKeysListResponse
  * @throws IOException if the JSON string is invalid with respect to SshKeysListResponse
  */
  public static SshKeysListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SshKeysListResponse.class);
  }

 /**
  * Convert an instance of SshKeysListResponse to an JSON string
  *
  * @return JSON string
  */
