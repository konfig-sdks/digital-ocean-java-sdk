...
public class GarbageCollection {
 ...
 public enum StatusEnum {
  ...
  public static final String SERIALIZED_NAME_BLOBS_DELETED = "blobs_deleted";
  @SerializedName(SERIALIZED_NAME_BLOBS_DELETED)
  private Integer blobsDeleted;

  public static final String SERIALIZED_NAME_FREED_BYTES = "freed_bytes";
  @SerializedName(SERIALIZED_NAME_FREED_BYTES)
  ...
  **/
   ...
   * @return the GarbageCollection instance itself
   */
  public GarbageCollection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, garbageCollection.uuid) &&
        ...
        Objects.equals(this.additionalProperties, garbageCollection.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, registryName, status, createdAt, updatedAt, blobsDeleted, freedBytes, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("blobs_deleted");
    openapiFields.add("freed_bytes");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GarbageCollection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GarbageCollection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GarbageCollection is not found in the empty JSON string", GarbageCollection.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GarbageCollection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GarbageCollection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GarbageCollection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GarbageCollection.class));

       return (TypeAdapter<T>) new TypeAdapter<GarbageCollection>() {
           @Override
           public void write(JsonWriter out, GarbageCollection value) throws IOException {
           ...
           @Override
           public GarbageCollection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GarbageCollection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GarbageCollection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GarbageCollection
  * @throws IOException if the JSON string is invalid with respect to GarbageCollection
  */
  public static GarbageCollection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GarbageCollection.class);
  }

 /**
  * Convert an instance of GarbageCollection to an JSON string
  *
  * @return JSON string
  */
