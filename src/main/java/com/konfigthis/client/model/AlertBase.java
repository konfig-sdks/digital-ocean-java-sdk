...
public class AlertBase {
  ...
  **/
  ...
  @ApiModelProperty(example = "5a4981aa-9653-4bd1-bef5-d6bff52042e4", value = "A unique ID that can be used to identify and reference the alert.")
   ...
   * @return the AlertBase instance itself
   */
  public AlertBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AlertBase alertBase = (AlertBase) o;
    return Objects.equals(this.id, alertBase.id)&&
        Objects.equals(this.additionalProperties, alertBase.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlertBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlertBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertBase is not found in the empty JSON string", AlertBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertBase.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertBase>() {
           @Override
           public void write(JsonWriter out, AlertBase value) throws IOException {
           ...
           @Override
           public AlertBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AlertBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AlertBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlertBase
  * @throws IOException if the JSON string is invalid with respect to AlertBase
  */
  public static AlertBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertBase.class);
  }

 /**
  * Convert an instance of AlertBase to an JSON string
  *
  * @return JSON string
  */
