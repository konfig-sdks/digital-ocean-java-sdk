 ...
 */
@ApiModel(description = "TimescaleDB extension configuration values")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MysqlTimescaledb {
  ...
  public MysqlTimescaledb() {
  }

  public MysqlTimescaledb maxBackgroundWorkers(Integer maxBackgroundWorkers) {
    if (maxBackgroundWorkers != null && maxBackgroundWorkers < 1) {
      throw new IllegalArgumentException("Invalid value for maxBackgroundWorkers. Must be greater than or equal to 1.");
    }
    if (maxBackgroundWorkers != null && maxBackgroundWorkers > 4096) {
      throw new IllegalArgumentException("Invalid value for maxBackgroundWorkers. Must be less than or equal to 4096.");
    }
  ...
  **/
  ...
  @ApiModelProperty(example = "8", value = "The number of background workers for timescaledb operations.  Set to the sum of your number of databases and the total number of concurrent background workers you want running at any given point in time.")
   ...
   * @return the MysqlTimescaledb instance itself
   */
  public MysqlTimescaledb putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MysqlTimescaledb mysqlTimescaledb = (MysqlTimescaledb) o;
    return Objects.equals(this.maxBackgroundWorkers, mysqlTimescaledb.maxBackgroundWorkers)&&
        Objects.equals(this.additionalProperties, mysqlTimescaledb.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(maxBackgroundWorkers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MysqlTimescaledb {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MysqlTimescaledb
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MysqlTimescaledb.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MysqlTimescaledb is not found in the empty JSON string", MysqlTimescaledb.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MysqlTimescaledb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MysqlTimescaledb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MysqlTimescaledb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MysqlTimescaledb.class));

       return (TypeAdapter<T>) new TypeAdapter<MysqlTimescaledb>() {
           @Override
           public void write(JsonWriter out, MysqlTimescaledb value) throws IOException {
           ...
           @Override
           public MysqlTimescaledb read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MysqlTimescaledb instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MysqlTimescaledb given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MysqlTimescaledb
  * @throws IOException if the JSON string is invalid with respect to MysqlTimescaledb
  */
  public static MysqlTimescaledb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MysqlTimescaledb.class);
  }

 /**
  * Convert an instance of MysqlTimescaledb to an JSON string
  *
  * @return JSON string
  */
