...
public class DropletActionRename {
  ...
  **/
   ...
   * @return the DropletActionRename instance itself
   */
  public DropletActionRename putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletActionRename.type) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionRename.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionRename
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionRename.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionRename is not found in the empty JSON string", DropletActionRename.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletActionRename.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionRename.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionRename' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionRename> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionRename.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionRename>() {
           @Override
           public void write(JsonWriter out, DropletActionRename value) throws IOException {
           ...
           @Override
           public DropletActionRename read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionRename instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionRename given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionRename
  * @throws IOException if the JSON string is invalid with respect to DropletActionRename
  */
  public static DropletActionRename fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionRename.class);
  }

 /**
  * Convert an instance of DropletActionRename to an JSON string
  *
  * @return JSON string
  */
