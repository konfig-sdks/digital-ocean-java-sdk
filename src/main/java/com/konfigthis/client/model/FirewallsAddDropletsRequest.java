...
public class FirewallsAddDropletsRequest {
  ...
  public FirewallsAddDropletsRequest() {
  }

  public FirewallsAddDropletsRequest dropletIds(List<Integer> dropletIds) {
  ...
  public FirewallsAddDropletsRequest addDropletIdsItem(Integer dropletIdsItem) {
  ...
  **/
   ...
   * @return the FirewallsAddDropletsRequest instance itself
   */
  public FirewallsAddDropletsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsAddDropletsRequest firewallsAddDropletsRequest = (FirewallsAddDropletsRequest) o;
    return Objects.equals(this.dropletIds, firewallsAddDropletsRequest.dropletIds)&&
        Objects.equals(this.additionalProperties, firewallsAddDropletsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsAddDropletsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsAddDropletsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsAddDropletsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsAddDropletsRequest is not found in the empty JSON string", FirewallsAddDropletsRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsAddDropletsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsAddDropletsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsAddDropletsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsAddDropletsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsAddDropletsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsAddDropletsRequest>() {
           @Override
           public void write(JsonWriter out, FirewallsAddDropletsRequest value) throws IOException {
           ...
           @Override
           public FirewallsAddDropletsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsAddDropletsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsAddDropletsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsAddDropletsRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallsAddDropletsRequest
  */
  public static FirewallsAddDropletsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsAddDropletsRequest.class);
  }

 /**
  * Convert an instance of FirewallsAddDropletsRequest to an JSON string
  *
  * @return JSON string
  */
