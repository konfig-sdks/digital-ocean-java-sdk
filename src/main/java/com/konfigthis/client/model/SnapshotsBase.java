...
public class SnapshotsBase {
  ...
  public SnapshotsBase() {
  }

  public SnapshotsBase name(String name) {
  ...
  **/
  ...
  public SnapshotsBase createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public SnapshotsBase regions(List<String> regions) {
  ...
  public SnapshotsBase addRegionsItem(String regionsItem) {
  ...
  **/
  ...
  public SnapshotsBase minDiskSize(Integer minDiskSize) {
  ...
  **/
  ...
  public SnapshotsBase sizeGigabytes(Float sizeGigabytes) {
  ...
  **/
   ...
   * @return the SnapshotsBase instance itself
   */
  public SnapshotsBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnapshotsBase snapshotsBase = (SnapshotsBase) o;
    return Objects.equals(this.name, snapshotsBase.name) &&
        Objects.equals(this.createdAt, snapshotsBase.createdAt) &&
        Objects.equals(this.regions, snapshotsBase.regions) &&
        Objects.equals(this.minDiskSize, snapshotsBase.minDiskSize) &&
        Objects.equals(this.sizeGigabytes, snapshotsBase.sizeGigabytes)&&
        Objects.equals(this.additionalProperties, snapshotsBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, createdAt, regions, minDiskSize, sizeGigabytes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SnapshotsBase {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnapshotsBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnapshotsBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnapshotsBase is not found in the empty JSON string", SnapshotsBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnapshotsBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnapshotsBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnapshotsBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnapshotsBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnapshotsBase.class));

       return (TypeAdapter<T>) new TypeAdapter<SnapshotsBase>() {
           @Override
           public void write(JsonWriter out, SnapshotsBase value) throws IOException {
           ...
           @Override
           public SnapshotsBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnapshotsBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnapshotsBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnapshotsBase
  * @throws IOException if the JSON string is invalid with respect to SnapshotsBase
  */
  public static SnapshotsBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnapshotsBase.class);
  }

 /**
  * Convert an instance of SnapshotsBase to an JSON string
  *
  * @return JSON string
  */
