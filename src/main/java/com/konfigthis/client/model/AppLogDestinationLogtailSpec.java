 ...
 */
@ApiModel(description = "Logtail configuration.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AppLogDestinationLogtailSpec {
  ...
  **/
   ...
   * @return the AppLogDestinationLogtailSpec instance itself
   */
  public AppLogDestinationLogtailSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, appLogDestinationLogtailSpec.token)&&
        Objects.equals(this.additionalProperties, appLogDestinationLogtailSpec.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppLogDestinationLogtailSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppLogDestinationLogtailSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppLogDestinationLogtailSpec is not found in the empty JSON string", AppLogDestinationLogtailSpec.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppLogDestinationLogtailSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppLogDestinationLogtailSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppLogDestinationLogtailSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppLogDestinationLogtailSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppLogDestinationLogtailSpec>() {
           @Override
           public void write(JsonWriter out, AppLogDestinationLogtailSpec value) throws IOException {
           ...
           @Override
           public AppLogDestinationLogtailSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppLogDestinationLogtailSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppLogDestinationLogtailSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppLogDestinationLogtailSpec
  * @throws IOException if the JSON string is invalid with respect to AppLogDestinationLogtailSpec
  */
  public static AppLogDestinationLogtailSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppLogDestinationLogtailSpec.class);
  }

 /**
  * Convert an instance of AppLogDestinationLogtailSpec to an JSON string
  *
  * @return JSON string
  */
