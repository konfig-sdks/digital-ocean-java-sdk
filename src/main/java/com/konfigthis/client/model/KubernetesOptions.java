...
import com.konfigthis.client.model.KubernetesOptionsOptions;
...
public class KubernetesOptions {
  ...
  **/
   ...
   * @return the KubernetesOptions instance itself
   */
  public KubernetesOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.options, kubernetesOptions.options)&&
        Objects.equals(this.additionalProperties, kubernetesOptions.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesOptions is not found in the empty JSON string", KubernetesOptions.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `options`
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        KubernetesOptionsOptions.validateJsonObject(jsonObj.getAsJsonObject("options"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesOptions>() {
           @Override
           public void write(JsonWriter out, KubernetesOptions value) throws IOException {
           ...
           @Override
           public KubernetesOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesOptions
  * @throws IOException if the JSON string is invalid with respect to KubernetesOptions
  */
  public static KubernetesOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesOptions.class);
  }

 /**
  * Convert an instance of KubernetesOptions to an JSON string
  *
  * @return JSON string
  */
