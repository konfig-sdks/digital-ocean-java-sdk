...
public class AppRollbackValidationCondition {
  ...
  **/
   ...
   * @return the AppRollbackValidationCondition instance itself
   */
  public AppRollbackValidationCondition putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.components, appRollbackValidationCondition.components) &&
        Objects.equals(this.code, appRollbackValidationCondition.code) &&
        Objects.equals(this.message, appRollbackValidationCondition.message)&&
        Objects.equals(this.additionalProperties, appRollbackValidationCondition.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppRollbackValidationCondition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppRollbackValidationCondition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppRollbackValidationCondition is not found in the empty JSON string", AppRollbackValidationCondition.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppRollbackValidationCondition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppRollbackValidationCondition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppRollbackValidationCondition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppRollbackValidationCondition.class));

       return (TypeAdapter<T>) new TypeAdapter<AppRollbackValidationCondition>() {
           @Override
           public void write(JsonWriter out, AppRollbackValidationCondition value) throws IOException {
           ...
           @Override
           public AppRollbackValidationCondition read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppRollbackValidationCondition instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppRollbackValidationCondition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppRollbackValidationCondition
  * @throws IOException if the JSON string is invalid with respect to AppRollbackValidationCondition
  */
  public static AppRollbackValidationCondition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppRollbackValidationCondition.class);
  }

 /**
  * Convert an instance of AppRollbackValidationCondition to an JSON string
  *
  * @return JSON string
  */
