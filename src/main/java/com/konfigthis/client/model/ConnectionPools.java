...
public class ConnectionPools {
  ...
  **/
   ...
   * @return the ConnectionPools instance itself
   */
  public ConnectionPools putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pools, connectionPools.pools)&&
        Objects.equals(this.additionalProperties, connectionPools.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pools, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectionPools
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectionPools.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectionPools is not found in the empty JSON string", ConnectionPools.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("pools") != null && !jsonObj.get("pools").isJsonNull()) {
        ...
        if (jsonArraypools != null) {
          ...
          for (int i = 0; i < jsonArraypools.size(); i++) {
            ConnectionPool.validateJsonObject(jsonArraypools.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectionPools.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectionPools' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectionPools> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectionPools.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectionPools>() {
           @Override
           public void write(JsonWriter out, ConnectionPools value) throws IOException {
           ...
           @Override
           public ConnectionPools read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConnectionPools instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConnectionPools given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConnectionPools
  * @throws IOException if the JSON string is invalid with respect to ConnectionPools
  */
  public static ConnectionPools fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectionPools.class);
  }

 /**
  * Convert an instance of ConnectionPools to an JSON string
  *
  * @return JSON string
  */
