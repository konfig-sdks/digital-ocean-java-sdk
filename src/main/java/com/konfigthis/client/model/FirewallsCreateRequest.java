...
public class FirewallsCreateRequest {
 ...
 public enum StatusEnum {
  ...
  public FirewallsCreateRequest(
     ...
     List<FirewallAllOfPendingChanges> pendingChanges
  ) {
    this();
    this.id = id;
    this.status = status;
  ...
  public FirewallsCreateRequest tags(List tags) {
  ...
  **/
  ...
  public FirewallsCreateRequest name(String name) {
  ...
  **/
  ...
  public FirewallsCreateRequest dropletIds(List<Integer> dropletIds) {
  ...
  public FirewallsCreateRequest addDropletIdsItem(Integer dropletIdsItem) {
  ...
  **/
  ...
  public FirewallsCreateRequest inboundRules(List<FirewallRulesInboundRulesInner> inboundRules) {
  ...
  public FirewallsCreateRequest addInboundRulesItem(FirewallRulesInboundRulesInner inboundRulesItem) {
  ...
  **/
  ...
  public FirewallsCreateRequest outboundRules(List<FirewallRulesOutboundRulesInner> outboundRules) {
  ...
  public FirewallsCreateRequest addOutboundRulesItem(FirewallRulesOutboundRulesInner outboundRulesItem) {
  ...
  **/
   ...
   * @return the FirewallsCreateRequest instance itself
   */
  public FirewallsCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FirewallsCreateRequest firewallsCreateRequest = (FirewallsCreateRequest) o;
    return Objects.equals(this.tags, firewallsCreateRequest.tags) &&
        Objects.equals(this.id, firewallsCreateRequest.id) &&
        Objects.equals(this.status, firewallsCreateRequest.status) &&
        Objects.equals(this.createdAt, firewallsCreateRequest.createdAt) &&
        Objects.equals(this.pendingChanges, firewallsCreateRequest.pendingChanges) &&
        Objects.equals(this.name, firewallsCreateRequest.name) &&
        Objects.equals(this.dropletIds, firewallsCreateRequest.dropletIds) &&
        Objects.equals(this.inboundRules, firewallsCreateRequest.inboundRules) &&
        Objects.equals(this.outboundRules, firewallsCreateRequest.outboundRules)&&
        Objects.equals(this.additionalProperties, firewallsCreateRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, id, status, createdAt, pendingChanges, name, dropletIds, inboundRules, outboundRules, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FirewallsCreateRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallsCreateRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallsCreateRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallsCreateRequest is not found in the empty JSON string", FirewallsCreateRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallsCreateRequest.openapiRequiredFields) {
      ...
      if (jsonObj.get("pending_changes") != null && !jsonObj.get("pending_changes").isJsonNull()) {
        ...
        if (jsonArraypendingChanges != null) {
          ...
          for (int i = 0; i < jsonArraypendingChanges.size(); i++) {
            FirewallAllOfPendingChanges.validateJsonObject(jsonArraypendingChanges.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("inbound_rules") != null && !jsonObj.get("inbound_rules").isJsonNull()) {
        ...
        if (jsonArrayinboundRules != null) {
          ...
          for (int i = 0; i < jsonArrayinboundRules.size(); i++) {
            FirewallRulesInboundRulesInner.validateJsonObject(jsonArrayinboundRules.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("outbound_rules") != null && !jsonObj.get("outbound_rules").isJsonNull()) {
        ...
        if (jsonArrayoutboundRules != null) {
          ...
          for (int i = 0; i < jsonArrayoutboundRules.size(); i++) {
            FirewallRulesOutboundRulesInner.validateJsonObject(jsonArrayoutboundRules.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallsCreateRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallsCreateRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallsCreateRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallsCreateRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallsCreateRequest>() {
           @Override
           public void write(JsonWriter out, FirewallsCreateRequest value) throws IOException {
           ...
           @Override
           public FirewallsCreateRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallsCreateRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallsCreateRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallsCreateRequest
  * @throws IOException if the JSON string is invalid with respect to FirewallsCreateRequest
  */
  public static FirewallsCreateRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallsCreateRequest.class);
  }

 /**
  * Convert an instance of FirewallsCreateRequest to an JSON string
  *
  * @return JSON string
  */
