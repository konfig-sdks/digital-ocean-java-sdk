...
public class VolumeActionPostDetach {
  ...
  **/
   ...
   * @return the VolumeActionPostDetach instance itself
   */
  public VolumeActionPostDetach putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, volumeActionPostDetach.type) &&
        ...
        Objects.equals(this.additionalProperties, volumeActionPostDetach.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, region, dropletId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostDetach
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostDetach.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostDetach is not found in the empty JSON string", VolumeActionPostDetach.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostDetach.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostDetach.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostDetach' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostDetach> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostDetach.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostDetach>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostDetach value) throws IOException {
           ...
           @Override
           public VolumeActionPostDetach read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostDetach instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostDetach given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostDetach
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostDetach
  */
  public static VolumeActionPostDetach fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostDetach.class);
  }

 /**
  * Convert an instance of VolumeActionPostDetach to an JSON string
  *
  * @return JSON string
  */
