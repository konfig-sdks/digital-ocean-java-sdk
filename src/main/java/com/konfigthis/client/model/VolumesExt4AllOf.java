...
public class VolumesExt4AllOf {
  ...
  public VolumesExt4AllOf() {
  }

  public VolumesExt4AllOf region(RegionSlug region) {
  ...
  **/
  ...
  public VolumesExt4AllOf filesystemLabel(String filesystemLabel) {
  ...
  **/
   ...
   * @return the VolumesExt4AllOf instance itself
   */
  public VolumesExt4AllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VolumesExt4AllOf volumesExt4AllOf = (VolumesExt4AllOf) o;
    return Objects.equals(this.region, volumesExt4AllOf.region) &&
        Objects.equals(this.filesystemLabel, volumesExt4AllOf.filesystemLabel)&&
        Objects.equals(this.additionalProperties, volumesExt4AllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, filesystemLabel, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VolumesExt4AllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumesExt4AllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumesExt4AllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumesExt4AllOf is not found in the empty JSON string", VolumesExt4AllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumesExt4AllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumesExt4AllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumesExt4AllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumesExt4AllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumesExt4AllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumesExt4AllOf>() {
           @Override
           public void write(JsonWriter out, VolumesExt4AllOf value) throws IOException {
           ...
           @Override
           public VolumesExt4AllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumesExt4AllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumesExt4AllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumesExt4AllOf
  * @throws IOException if the JSON string is invalid with respect to VolumesExt4AllOf
  */
  public static VolumesExt4AllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumesExt4AllOf.class);
  }

 /**
  * Convert an instance of VolumesExt4AllOf to an JSON string
  *
  * @return JSON string
  */
