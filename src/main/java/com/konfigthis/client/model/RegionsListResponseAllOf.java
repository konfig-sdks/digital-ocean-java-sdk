...
public class RegionsListResponseAllOf {
  public static final String SERIALIZED_NAME_REGIONS = "regions";
  @SerializedName(SERIALIZED_NAME_REGIONS)
  private List<Region> regions = new ArrayList<>();

  public RegionsListResponseAllOf() {
  }

  public RegionsListResponseAllOf regions(List<Region> regions) {
  ...
  public RegionsListResponseAllOf addRegionsItem(Region regionsItem) {
  ...
  **/
   ...
   * @return the RegionsListResponseAllOf instance itself
   */
  public RegionsListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RegionsListResponseAllOf regionsListResponseAllOf = (RegionsListResponseAllOf) o;
    return Objects.equals(this.regions, regionsListResponseAllOf.regions)&&
        Objects.equals(this.additionalProperties, regionsListResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RegionsListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegionsListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegionsListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegionsListResponseAllOf is not found in the empty JSON string", RegionsListResponseAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegionsListResponseAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegionsListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegionsListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegionsListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegionsListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<RegionsListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, RegionsListResponseAllOf value) throws IOException {
           ...
           @Override
           public RegionsListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RegionsListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RegionsListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RegionsListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to RegionsListResponseAllOf
  */
  public static RegionsListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegionsListResponseAllOf.class);
  }

 /**
  * Convert an instance of RegionsListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
