...
public class DropletCreate {
  ...
  private List<Object> sshKeys = null;
  ...
  public static final String SERIALIZED_NAME_PRIVATE_NETWORKING = "private_networking";
  @SerializedName(SERIALIZED_NAME_PRIVATE_NETWORKING)
  ...
  public static final String SERIALIZED_NAME_WITH_DROPLET_AGENT = "with_droplet_agent";
  @SerializedName(SERIALIZED_NAME_WITH_DROPLET_AGENT)
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "nyc3", value = "The slug identifier for the region that you wish to deploy the Droplet in. If the specific datacenter is not not important, a slug prefix (e.g. `nyc`) can be used to deploy the Droplet in any of the that region's locations (`nyc1`, `nyc2`, or `nyc3`). If the region is omitted from the create request completely, the Droplet may deploy in any region.")
  ...
  **/
  ...
  public DropletCreate image(Object image) {
  ...
  **/
  ...
  public DropletCreate sshKeys(List<Object> sshKeys) {
  ...
  public DropletCreate addSshKeysItem(Object sshKeysItem) {
  ...
  **/
  ...
  public void setSshKeys(List<Object> sshKeys) {
  ...
  **/
  ...
  public DropletCreate volumes(List<String> volumes) {
  ...
  public DropletCreate addVolumesItem(String volumesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"12e97116-7280-11ed-b3d0-0a58ac146812\"]", value = "An array of IDs for block storage volumes that will be attached to the Droplet once created. The volumes must not already be attached to an existing Droplet.")
  ...
  **/
   ...
   * @return the DropletCreate instance itself
   */
  public DropletCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, dropletCreate.tags) &&
        Objects.equals(this.region, dropletCreate.region) &&
        Objects.equals(this.size, dropletCreate.size) &&
        Objects.equals(this.image, dropletCreate.image) &&
        Objects.equals(this.sshKeys, dropletCreate.sshKeys) &&
        Objects.equals(this.backups, dropletCreate.backups) &&
        Objects.equals(this.ipv6, dropletCreate.ipv6) &&
        ...
        Objects.equals(this.volumes, dropletCreate.volumes) &&
        Objects.equals(this.vpcUuid, dropletCreate.vpcUuid) &&
        Objects.equals(this.withDropletAgent, dropletCreate.withDropletAgent)&&
        Objects.equals(this.additionalProperties, dropletCreate.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, region, size, image, sshKeys, backups, ipv6, monitoring, userData, privateNetworking, volumes, vpcUuid, withDropletAgent, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("private_networking");
    openapiFields.add("volumes");
    openapiFields.add("vpc_uuid");
    openapiFields.add("with_droplet_agent");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletCreate is not found in the empty JSON string", DropletCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletCreate.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletCreate>() {
           @Override
           public void write(JsonWriter out, DropletCreate value) throws IOException {
           ...
           @Override
           public DropletCreate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletCreate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletCreate
  * @throws IOException if the JSON string is invalid with respect to DropletCreate
  */
  public static DropletCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletCreate.class);
  }

 /**
  * Convert an instance of DropletCreate to an JSON string
  *
  * @return JSON string
  */
