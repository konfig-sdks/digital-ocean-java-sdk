...
public class DatabasesAddResponse {
  ...
  public DatabasesAddResponse db(Database db) {
  ...
  **/
   ...
   * @return the DatabasesAddResponse instance itself
   */
  public DatabasesAddResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabasesAddResponse databasesAddResponse = (DatabasesAddResponse) o;
    return Objects.equals(this.db, databasesAddResponse.db)&&
        Objects.equals(this.additionalProperties, databasesAddResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(db, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabasesAddResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabasesAddResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabasesAddResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasesAddResponse is not found in the empty JSON string", DatabasesAddResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabasesAddResponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `db`
      Database.validateJsonObject(jsonObj.getAsJsonObject("db"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasesAddResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasesAddResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasesAddResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasesAddResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasesAddResponse>() {
           @Override
           public void write(JsonWriter out, DatabasesAddResponse value) throws IOException {
           ...
           @Override
           public DatabasesAddResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabasesAddResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabasesAddResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabasesAddResponse
  * @throws IOException if the JSON string is invalid with respect to DatabasesAddResponse
  */
  public static DatabasesAddResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasesAddResponse.class);
  }

 /**
  * Convert an instance of DatabasesAddResponse to an JSON string
  *
  * @return JSON string
  */
