...
public class DropletActionResize {
  ...
  **/
   ...
   * @return the DropletActionResize instance itself
   */
  public DropletActionResize putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletActionResize.type) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionResize.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, disk, size, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionResize
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionResize.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionResize is not found in the empty JSON string", DropletActionResize.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletActionResize.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionResize.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionResize' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionResize> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionResize.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionResize>() {
           @Override
           public void write(JsonWriter out, DropletActionResize value) throws IOException {
           ...
           @Override
           public DropletActionResize read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionResize instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionResize given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionResize
  * @throws IOException if the JSON string is invalid with respect to DropletActionResize
  */
  public static DropletActionResize fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionResize.class);
  }

 /**
  * Convert an instance of DropletActionResize to an JSON string
  *
  * @return JSON string
  */
