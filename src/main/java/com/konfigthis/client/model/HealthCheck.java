 ...
 */
@ApiModel(description = "An object specifying health check settings for the load balancer.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class HealthCheck {
  ...
  **/
   ...
   * @return the HealthCheck instance itself
   */
  public HealthCheck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.protocol, healthCheck.protocol) &&
        ...
        Objects.equals(this.additionalProperties, healthCheck.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(protocol, port, path, checkIntervalSeconds, responseTimeoutSeconds, unhealthyThreshold, healthyThreshold, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HealthCheck>() {
           ...
           public HealthCheck read(JsonReader in) throws IOException {
             ...
             HealthCheck instance = thisAdapter.fromJsonTree(jsonObj);
