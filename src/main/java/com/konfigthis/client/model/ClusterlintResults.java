...
import com.konfigthis.client.model.ClusterlintResultsDiagnosticsInner;
...
public class ClusterlintResults {
  ...
  **/
   ...
   * @return the ClusterlintResults instance itself
   */
  public ClusterlintResults putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.runId, clusterlintResults.runId) &&
        ...
        Objects.equals(this.additionalProperties, clusterlintResults.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(runId, requestedAt, completedAt, diagnostics, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterlintResults
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterlintResults.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterlintResults is not found in the empty JSON string", ClusterlintResults.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("diagnostics") != null && !jsonObj.get("diagnostics").isJsonNull()) {
        ...
        if (jsonArraydiagnostics != null) {
          ...
          for (int i = 0; i < jsonArraydiagnostics.size(); i++) {
            ClusterlintResultsDiagnosticsInner.validateJsonObject(jsonArraydiagnostics.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterlintResults.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterlintResults' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterlintResults> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterlintResults.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterlintResults>() {
           @Override
           public void write(JsonWriter out, ClusterlintResults value) throws IOException {
           ...
           @Override
           public ClusterlintResults read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ClusterlintResults instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ClusterlintResults given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClusterlintResults
  * @throws IOException if the JSON string is invalid with respect to ClusterlintResults
  */
  public static ClusterlintResults fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterlintResults.class);
  }

 /**
  * Convert an instance of ClusterlintResults to an JSON string
  *
  * @return JSON string
  */
