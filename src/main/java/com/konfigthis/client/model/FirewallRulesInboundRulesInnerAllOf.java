...
public class FirewallRulesInboundRulesInnerAllOf {
  ...
  **/
   ...
   * @return the FirewallRulesInboundRulesInnerAllOf instance itself
   */
  public FirewallRulesInboundRulesInnerAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sources, firewallRulesInboundRulesInnerAllOf.sources)&&
        Objects.equals(this.additionalProperties, firewallRulesInboundRulesInnerAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRulesInboundRulesInnerAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRulesInboundRulesInnerAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRulesInboundRulesInnerAllOf is not found in the empty JSON string", FirewallRulesInboundRulesInnerAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FirewallRulesInboundRulesInnerAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRulesInboundRulesInnerAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRulesInboundRulesInnerAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRulesInboundRulesInnerAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRulesInboundRulesInnerAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRulesInboundRulesInnerAllOf>() {
           @Override
           public void write(JsonWriter out, FirewallRulesInboundRulesInnerAllOf value) throws IOException {
           ...
           @Override
           public FirewallRulesInboundRulesInnerAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRulesInboundRulesInnerAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRulesInboundRulesInnerAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRulesInboundRulesInnerAllOf
  * @throws IOException if the JSON string is invalid with respect to FirewallRulesInboundRulesInnerAllOf
  */
  public static FirewallRulesInboundRulesInnerAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRulesInboundRulesInnerAllOf.class);
  }

 /**
  * Convert an instance of FirewallRulesInboundRulesInnerAllOf to an JSON string
  *
  * @return JSON string
  */
