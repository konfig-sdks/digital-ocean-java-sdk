...
public class UserSettingsAclInner {
 ...
 public enum PermissionEnum {
  ...
  public UserSettingsAclInner() {
  }

  public UserSettingsAclInner id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(example = "aaa", value = "An identifier for the ACL. Will be computed after the ACL is created/updated.")
  ...
  public UserSettingsAclInner topic(String topic) {
  ...
  **/
  ...
  @ApiModelProperty(example = "topic-abc.*", required = true, value = "A regex for matching the topic(s) that this ACL should apply to.")
  ...
  public UserSettingsAclInner permission(PermissionEnum permission) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "CONSUME", required = true, value = "Permission set applied to the ACL. 'consume' allows for messages to be consumed from the topic. 'produce' allows for messages to be published to the topic. 'produceconsume' allows for both 'consume' and 'produce' permission. 'admin' allows for 'produceconsume' as well as any operations to administer the topic (delete, update).")
   ...
   * @return the UserSettingsAclInner instance itself
   */
  public UserSettingsAclInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserSettingsAclInner userSettingsAclInner = (UserSettingsAclInner) o;
    return Objects.equals(this.id, userSettingsAclInner.id) &&
        Objects.equals(this.topic, userSettingsAclInner.topic) &&
        Objects.equals(this.permission, userSettingsAclInner.permission)&&
        Objects.equals(this.additionalProperties, userSettingsAclInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, topic, permission, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserSettingsAclInner {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserSettingsAclInner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserSettingsAclInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserSettingsAclInner is not found in the empty JSON string", UserSettingsAclInner.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserSettingsAclInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserSettingsAclInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserSettingsAclInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserSettingsAclInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserSettingsAclInner.class));

       return (TypeAdapter<T>) new TypeAdapter<UserSettingsAclInner>() {
           @Override
           public void write(JsonWriter out, UserSettingsAclInner value) throws IOException {
           ...
           @Override
           public UserSettingsAclInner read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserSettingsAclInner instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserSettingsAclInner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserSettingsAclInner
  * @throws IOException if the JSON string is invalid with respect to UserSettingsAclInner
  */
  public static UserSettingsAclInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserSettingsAclInner.class);
  }

 /**
  * Convert an instance of UserSettingsAclInner to an JSON string
  *
  * @return JSON string
  */
