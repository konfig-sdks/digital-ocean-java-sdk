...
public class ReservedIpRegion {
  ...
  **/
   ...
   * @return the ReservedIpRegion instance itself
   */
  public ReservedIpRegion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, reservedIpRegion.name) &&
        Objects.equals(this.slug, reservedIpRegion.slug) &&
        ...
        Objects.equals(this.additionalProperties, reservedIpRegion.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReservedIpRegion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReservedIpRegion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedIpRegion is not found in the empty JSON string", ReservedIpRegion.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReservedIpRegion.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedIpRegion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedIpRegion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedIpRegion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedIpRegion.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedIpRegion>() {
           @Override
           public void write(JsonWriter out, ReservedIpRegion value) throws IOException {
           ...
           @Override
           public ReservedIpRegion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReservedIpRegion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReservedIpRegion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReservedIpRegion
  * @throws IOException if the JSON string is invalid with respect to ReservedIpRegion
  */
  public static ReservedIpRegion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedIpRegion.class);
  }

 /**
  * Convert an instance of ReservedIpRegion to an JSON string
  *
  * @return JSON string
  */
