...
public class SnapshotsAllOf {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private String id;

  public SnapshotsAllOf() {
  }

  public SnapshotsAllOf id(String id) {
  ...
  **/
   ...
   * @return the SnapshotsAllOf instance itself
   */
  public SnapshotsAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnapshotsAllOf snapshotsAllOf = (SnapshotsAllOf) o;
    return Objects.equals(this.id, snapshotsAllOf.id)&&
        Objects.equals(this.additionalProperties, snapshotsAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnapshotsAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnapshotsAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnapshotsAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnapshotsAllOf is not found in the empty JSON string", SnapshotsAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnapshotsAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnapshotsAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnapshotsAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnapshotsAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnapshotsAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SnapshotsAllOf>() {
           @Override
           public void write(JsonWriter out, SnapshotsAllOf value) throws IOException {
           ...
           @Override
           public SnapshotsAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnapshotsAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnapshotsAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnapshotsAllOf
  * @throws IOException if the JSON string is invalid with respect to SnapshotsAllOf
  */
  public static SnapshotsAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnapshotsAllOf.class);
  }

 /**
  * Convert an instance of SnapshotsAllOf to an JSON string
  *
  * @return JSON string
  */
