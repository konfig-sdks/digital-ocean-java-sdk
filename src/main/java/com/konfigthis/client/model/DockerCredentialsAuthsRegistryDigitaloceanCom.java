...
public class DockerCredentialsAuthsRegistryDigitaloceanCom {
  ...
  **/
   ...
   * @return the DockerCredentialsAuthsRegistryDigitaloceanCom instance itself
   */
  public DockerCredentialsAuthsRegistryDigitaloceanCom putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auth, dockerCredentialsAuthsRegistryDigitaloceanCom.auth)&&
        Objects.equals(this.additionalProperties, dockerCredentialsAuthsRegistryDigitaloceanCom.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DockerCredentialsAuthsRegistryDigitaloceanCom
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DockerCredentialsAuthsRegistryDigitaloceanCom.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DockerCredentialsAuthsRegistryDigitaloceanCom is not found in the empty JSON string", DockerCredentialsAuthsRegistryDigitaloceanCom.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DockerCredentialsAuthsRegistryDigitaloceanCom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DockerCredentialsAuthsRegistryDigitaloceanCom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DockerCredentialsAuthsRegistryDigitaloceanCom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DockerCredentialsAuthsRegistryDigitaloceanCom.class));

       return (TypeAdapter<T>) new TypeAdapter<DockerCredentialsAuthsRegistryDigitaloceanCom>() {
           @Override
           public void write(JsonWriter out, DockerCredentialsAuthsRegistryDigitaloceanCom value) throws IOException {
           ...
           @Override
           public DockerCredentialsAuthsRegistryDigitaloceanCom read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DockerCredentialsAuthsRegistryDigitaloceanCom instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DockerCredentialsAuthsRegistryDigitaloceanCom given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DockerCredentialsAuthsRegistryDigitaloceanCom
  * @throws IOException if the JSON string is invalid with respect to DockerCredentialsAuthsRegistryDigitaloceanCom
  */
  public static DockerCredentialsAuthsRegistryDigitaloceanCom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DockerCredentialsAuthsRegistryDigitaloceanCom.class);
  }

 /**
  * Convert an instance of DockerCredentialsAuthsRegistryDigitaloceanCom to an JSON string
  *
  * @return JSON string
  */
