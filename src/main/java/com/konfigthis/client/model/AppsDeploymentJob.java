...
public class AppsDeploymentJob {
  ...
  **/
   ...
   * @return the AppsDeploymentJob instance itself
   */
  public AppsDeploymentJob putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appsDeploymentJob.name) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentJob.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentJob
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentJob is not found in the empty JSON string", AppsDeploymentJob.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentJob.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentJob' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentJob> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentJob.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentJob>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentJob value) throws IOException {
           ...
           @Override
           public AppsDeploymentJob read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentJob instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentJob given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentJob
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentJob
  */
  public static AppsDeploymentJob fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentJob.class);
  }

 /**
  * Convert an instance of AppsDeploymentJob to an JSON string
  *
  * @return JSON string
  */
