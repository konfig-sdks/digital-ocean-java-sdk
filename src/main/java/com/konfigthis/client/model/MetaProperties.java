 ...
 */
@ApiModel(description = "Information about the response itself.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class MetaProperties {
  ...
  **/
   ...
   * @return the MetaProperties instance itself
   */
  public MetaProperties putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.total, metaProperties.total)&&
        Objects.equals(this.additionalProperties, metaProperties.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetaProperties
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetaProperties.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetaProperties is not found in the empty JSON string", MetaProperties.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetaProperties.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetaProperties' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetaProperties> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetaProperties.class));

       return (TypeAdapter<T>) new TypeAdapter<MetaProperties>() {
           @Override
           public void write(JsonWriter out, MetaProperties value) throws IOException {
           ...
           @Override
           public MetaProperties read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetaProperties instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetaProperties given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetaProperties
  * @throws IOException if the JSON string is invalid with respect to MetaProperties
  */
  public static MetaProperties fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetaProperties.class);
  }

 /**
  * Convert an instance of MetaProperties to an JSON string
  *
  * @return JSON string
  */
