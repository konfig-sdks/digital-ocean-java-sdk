...
public class AppsRollbackAppRequest {
  ...
  public static final String SERIALIZED_NAME_SKIP_PIN = "skip_pin";
  @SerializedName(SERIALIZED_NAME_SKIP_PIN)
  ...
  **/
   ...
   * @return the AppsRollbackAppRequest instance itself
   */
  public AppsRollbackAppRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deploymentId, appsRollbackAppRequest.deploymentId) &&
        ...
        Objects.equals(this.additionalProperties, appsRollbackAppRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deploymentId, skipPin, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsRollbackAppRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsRollbackAppRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsRollbackAppRequest is not found in the empty JSON string", AppsRollbackAppRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsRollbackAppRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsRollbackAppRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsRollbackAppRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsRollbackAppRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsRollbackAppRequest>() {
           @Override
           public void write(JsonWriter out, AppsRollbackAppRequest value) throws IOException {
           ...
           @Override
           public AppsRollbackAppRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsRollbackAppRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsRollbackAppRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsRollbackAppRequest
  * @throws IOException if the JSON string is invalid with respect to AppsRollbackAppRequest
  */
  public static AppsRollbackAppRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsRollbackAppRequest.class);
  }

 /**
  * Convert an instance of AppsRollbackAppRequest to an JSON string
  *
  * @return JSON string
  */
