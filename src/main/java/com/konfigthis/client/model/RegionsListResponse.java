...
public class RegionsListResponse {
  ...
  **/
  ...
  public RegionsListResponse links(PageLinks links) {
  ...
  **/
  ...
  public RegionsListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the RegionsListResponse instance itself
   */
  public RegionsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.regions, regionsListResponse.regions) &&
        Objects.equals(this.links, regionsListResponse.links) &&
        Objects.equals(this.meta, regionsListResponse.meta)&&
        Objects.equals(this.additionalProperties, regionsListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regions, links, meta, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegionsListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegionsListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : RegionsListResponse.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RegionsListResponse>() {
           ...
           public RegionsListResponse read(JsonReader in) throws IOException {
             ...
             RegionsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
