...
public class Advolumeactionpost {
  /**
 ...
 public enum TypeEnum {
  ...
  public Advolumeactionpost() {
  }

  public Advolumeactionpost type(TypeEnum type) {
  ...
  **/
  ...
  public Advolumeactionpost region(RegionSlug region) {
  ...
  **/
  ...
  public Advolumeactionpost tags(List<String> tags) {
  ...
  public Advolumeactionpost addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public Advolumeactionpost dropletId(Integer dropletId) {
  ...
  **/
   ...
   * @return the Advolumeactionpost instance itself
   */
  public Advolumeactionpost putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Advolumeactionpost advolumeactionpost = (Advolumeactionpost) o;
    return Objects.equals(this.type, advolumeactionpost.type) &&
        Objects.equals(this.region, advolumeactionpost.region) &&
        Objects.equals(this.tags, advolumeactionpost.tags) &&
        Objects.equals(this.dropletId, advolumeactionpost.dropletId)&&
        Objects.equals(this.additionalProperties, advolumeactionpost.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class Advolumeactionpost {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Advolumeactionpost
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Advolumeactionpost.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Advolumeactionpost is not found in the empty JSON string", Advolumeactionpost.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Advolumeactionpost.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Advolumeactionpost.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Advolumeactionpost' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Advolumeactionpost> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Advolumeactionpost.class));

       return (TypeAdapter<T>) new TypeAdapter<Advolumeactionpost>() {
           @Override
           public void write(JsonWriter out, Advolumeactionpost value) throws IOException {
           ...
           @Override
           public Advolumeactionpost read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Advolumeactionpost instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Advolumeactionpost given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Advolumeactionpost
  * @throws IOException if the JSON string is invalid with respect to Advolumeactionpost
  */
  public static Advolumeactionpost fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Advolumeactionpost.class);
  }

 /**
  * Convert an instance of Advolumeactionpost to an JSON string
  *
  * @return JSON string
  */
