...
import com.konfigthis.client.model.AppAlertProgressStep;
...
public class AppAlertProgress {
  ...
  **/
   ...
   * @return the AppAlertProgress instance itself
   */
  public AppAlertProgress putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.steps, appAlertProgress.steps)&&
        Objects.equals(this.additionalProperties, appAlertProgress.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppAlertProgress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppAlertProgress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAlertProgress is not found in the empty JSON string", AppAlertProgress.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("steps") != null && !jsonObj.get("steps").isJsonNull()) {
        ...
        if (jsonArraysteps != null) {
          ...
          for (int i = 0; i < jsonArraysteps.size(); i++) {
            AppAlertProgressStep.validateJsonObject(jsonArraysteps.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAlertProgress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAlertProgress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAlertProgress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAlertProgress.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAlertProgress>() {
           @Override
           public void write(JsonWriter out, AppAlertProgress value) throws IOException {
           ...
           @Override
           public AppAlertProgress read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppAlertProgress instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppAlertProgress given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppAlertProgress
  * @throws IOException if the JSON string is invalid with respect to AppAlertProgress
  */
  public static AppAlertProgress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAlertProgress.class);
  }

 /**
  * Convert an instance of AppAlertProgress to an JSON string
  *
  * @return JSON string
  */
