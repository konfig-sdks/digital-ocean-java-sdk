...
public class KubernetesNodePoolTaint {
  ...
  **/
   ...
   * @return the KubernetesNodePoolTaint instance itself
   */
  public KubernetesNodePoolTaint putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, kubernetesNodePoolTaint.key) &&
        ...
        Objects.equals(this.additionalProperties, kubernetesNodePoolTaint.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, value, effect, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to KubernetesNodePoolTaint
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KubernetesNodePoolTaint.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KubernetesNodePoolTaint is not found in the empty JSON string", KubernetesNodePoolTaint.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KubernetesNodePoolTaint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KubernetesNodePoolTaint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KubernetesNodePoolTaint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KubernetesNodePoolTaint.class));

       return (TypeAdapter<T>) new TypeAdapter<KubernetesNodePoolTaint>() {
           @Override
           public void write(JsonWriter out, KubernetesNodePoolTaint value) throws IOException {
           ...
           @Override
           public KubernetesNodePoolTaint read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KubernetesNodePoolTaint instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KubernetesNodePoolTaint given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KubernetesNodePoolTaint
  * @throws IOException if the JSON string is invalid with respect to KubernetesNodePoolTaint
  */
  public static KubernetesNodePoolTaint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KubernetesNodePoolTaint.class);
  }

 /**
  * Convert an instance of KubernetesNodePoolTaint to an JSON string
  *
  * @return JSON string
  */
