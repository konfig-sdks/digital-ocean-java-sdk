 ...
 */
@ApiModel(description = "Papertrail configuration.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AppLogDestinationPapertrailSpec {
  ...
  **/
   ...
   * @return the AppLogDestinationPapertrailSpec instance itself
   */
  public AppLogDestinationPapertrailSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpoint, appLogDestinationPapertrailSpec.endpoint)&&
        Objects.equals(this.additionalProperties, appLogDestinationPapertrailSpec.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppLogDestinationPapertrailSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppLogDestinationPapertrailSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppLogDestinationPapertrailSpec is not found in the empty JSON string", AppLogDestinationPapertrailSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppLogDestinationPapertrailSpec.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppLogDestinationPapertrailSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppLogDestinationPapertrailSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppLogDestinationPapertrailSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppLogDestinationPapertrailSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppLogDestinationPapertrailSpec>() {
           @Override
           public void write(JsonWriter out, AppLogDestinationPapertrailSpec value) throws IOException {
           ...
           @Override
           public AppLogDestinationPapertrailSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppLogDestinationPapertrailSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppLogDestinationPapertrailSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppLogDestinationPapertrailSpec
  * @throws IOException if the JSON string is invalid with respect to AppLogDestinationPapertrailSpec
  */
  public static AppLogDestinationPapertrailSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppLogDestinationPapertrailSpec.class);
  }

 /**
  * Convert an instance of AppLogDestinationPapertrailSpec to an JSON string
  *
  * @return JSON string
  */
