...
public class Balance {
  public static final String SERIALIZED_NAME_MONTH_TO_DATE_BALANCE = "month_to_date_balance";
  @SerializedName(SERIALIZED_NAME_MONTH_TO_DATE_BALANCE)
  ...
  public static final String SERIALIZED_NAME_MONTH_TO_DATE_USAGE = "month_to_date_usage";
  @SerializedName(SERIALIZED_NAME_MONTH_TO_DATE_USAGE)
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(monthToDateBalance, accountBalance, monthToDateUsage, generatedAt, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("month_to_date_balance");
    openapiFields.add("account_balance");
    openapiFields.add("month_to_date_usage");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if ((jsonObj.get("month_to_date_balance") != null && !jsonObj.get("month_to_date_balance").isJsonNull()) && !jsonObj.get("month_to_date_balance").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `month_to_date_balance` to be a primitive type in the JSON string but got `%s`", jsonObj.get("month_to_date_balance").toString()));
      }
      if ((jsonObj.get("account_balance") != null && !jsonObj.get("account_balance").isJsonNull()) && !jsonObj.get("account_balance").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `account_balance` to be a primitive type in the JSON string but got `%s`", jsonObj.get("account_balance").toString()));
      }
      if ((jsonObj.get("month_to_date_usage") != null && !jsonObj.get("month_to_date_usage").isJsonNull()) && !jsonObj.get("month_to_date_usage").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `month_to_date_usage` to be a primitive type in the JSON string but got `%s`", jsonObj.get("month_to_date_usage").toString()));
      }
  }
