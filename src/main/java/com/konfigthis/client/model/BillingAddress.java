...
public class BillingAddress {
  ...
  * @throws IOException if the JSON Object is invalid with respect to BillingAddress
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BillingAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
