...
public class FloatingIpRegion {
  ...
  **/
   ...
   * @return the FloatingIpRegion instance itself
   */
  public FloatingIpRegion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, floatingIpRegion.name) &&
        Objects.equals(this.slug, floatingIpRegion.slug) &&
        ...
        Objects.equals(this.additionalProperties, floatingIpRegion.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIpRegion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIpRegion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIpRegion is not found in the empty JSON string", FloatingIpRegion.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FloatingIpRegion.openapiRequiredFields) {
      ...
      if (jsonObj.get("sizes") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("sizes").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FloatingIpRegion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FloatingIpRegion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FloatingIpRegion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FloatingIpRegion.class));

       return (TypeAdapter<T>) new TypeAdapter<FloatingIpRegion>() {
           @Override
           public void write(JsonWriter out, FloatingIpRegion value) throws IOException {
           ...
           @Override
           public FloatingIpRegion read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FloatingIpRegion instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FloatingIpRegion given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIpRegion
  * @throws IOException if the JSON string is invalid with respect to FloatingIpRegion
  */
  public static FloatingIpRegion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIpRegion.class);
  }

 /**
  * Convert an instance of FloatingIpRegion to an JSON string
  *
  * @return JSON string
  */
