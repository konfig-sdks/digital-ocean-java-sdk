...
import com.konfigthis.client.model.DatabaseLayoutOption;
...
public class OptionsOptionsKafka {
  ...
  private List<DatabaseLayoutOption> layouts = null;
  ...
  public OptionsOptionsKafka(
     ...
     List<DatabaseLayoutOption> layouts
  ) {
    this();
  ...
  **/
  ...
  @ApiModelProperty(example = "[\"ams3\",\"blr1\"]", value = "An array of strings containing the names of available regions")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"4.4\",\"5.0\"]", value = "An array of strings containing the names of available regions")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An array of objects, each indicating the node sizes (otherwise referred to as slugs) that are available with various numbers of nodes in the database cluster. Each slugs denotes the node's identifier, CPU, and RAM (in that order).")
   ...
   * @return the OptionsOptionsKafka instance itself
   */
  public OptionsOptionsKafka putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OptionsOptionsKafka optionsOptionsKafka = (OptionsOptionsKafka) o;
    return Objects.equals(this.regions, optionsOptionsKafka.regions) &&
        Objects.equals(this.versions, optionsOptionsKafka.versions) &&
        Objects.equals(this.layouts, optionsOptionsKafka.layouts)&&
        Objects.equals(this.additionalProperties, optionsOptionsKafka.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regions, versions, layouts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OptionsOptionsKafka {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OptionsOptionsKafka
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OptionsOptionsKafka.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OptionsOptionsKafka is not found in the empty JSON string", OptionsOptionsKafka.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("layouts") != null && !jsonObj.get("layouts").isJsonNull()) {
        ...
        if (jsonArraylayouts != null) {
          ...
          for (int i = 0; i < jsonArraylayouts.size(); i++) {
            DatabaseLayoutOption.validateJsonObject(jsonArraylayouts.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OptionsOptionsKafka.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OptionsOptionsKafka' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OptionsOptionsKafka> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OptionsOptionsKafka.class));

       return (TypeAdapter<T>) new TypeAdapter<OptionsOptionsKafka>() {
           @Override
           public void write(JsonWriter out, OptionsOptionsKafka value) throws IOException {
           ...
           @Override
           public OptionsOptionsKafka read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OptionsOptionsKafka instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OptionsOptionsKafka given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OptionsOptionsKafka
  * @throws IOException if the JSON string is invalid with respect to OptionsOptionsKafka
  */
  public static OptionsOptionsKafka fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OptionsOptionsKafka.class);
  }

 /**
  * Convert an instance of OptionsOptionsKafka to an JSON string
  *
  * @return JSON string
  */
