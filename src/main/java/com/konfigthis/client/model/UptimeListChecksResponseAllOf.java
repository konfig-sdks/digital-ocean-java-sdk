...
public class UptimeListChecksResponseAllOf {
  public static final String SERIALIZED_NAME_CHECKS = "checks";
  @SerializedName(SERIALIZED_NAME_CHECKS)
  private List<Check> checks = null;

  public UptimeListChecksResponseAllOf() {
  }

  public UptimeListChecksResponseAllOf checks(List<Check> checks) {
  ...
  public UptimeListChecksResponseAllOf addChecksItem(Check checksItem) {
    if (this.checks == null) {
  ...
  **/
   ...
   * @return the UptimeListChecksResponseAllOf instance itself
   */
  public UptimeListChecksResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UptimeListChecksResponseAllOf uptimeListChecksResponseAllOf = (UptimeListChecksResponseAllOf) o;
    return Objects.equals(this.checks, uptimeListChecksResponseAllOf.checks)&&
        Objects.equals(this.additionalProperties, uptimeListChecksResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(checks, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UptimeListChecksResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UptimeListChecksResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UptimeListChecksResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UptimeListChecksResponseAllOf is not found in the empty JSON string", UptimeListChecksResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UptimeListChecksResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UptimeListChecksResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UptimeListChecksResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UptimeListChecksResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<UptimeListChecksResponseAllOf>() {
           @Override
           public void write(JsonWriter out, UptimeListChecksResponseAllOf value) throws IOException {
           ...
           @Override
           public UptimeListChecksResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UptimeListChecksResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UptimeListChecksResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UptimeListChecksResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to UptimeListChecksResponseAllOf
  */
  public static UptimeListChecksResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UptimeListChecksResponseAllOf.class);
  }

 /**
  * Convert an instance of UptimeListChecksResponseAllOf to an JSON string
  *
  * @return JSON string
  */
