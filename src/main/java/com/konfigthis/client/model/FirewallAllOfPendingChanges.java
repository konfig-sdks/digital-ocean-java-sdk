...
public class FirewallAllOfPendingChanges {
  ...
  **/
   ...
   * @return the FirewallAllOfPendingChanges instance itself
   */
  public FirewallAllOfPendingChanges putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletId, firewallAllOfPendingChanges.dropletId) &&
        ...
        Objects.equals(this.additionalProperties, firewallAllOfPendingChanges.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallAllOfPendingChanges
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallAllOfPendingChanges.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallAllOfPendingChanges is not found in the empty JSON string", FirewallAllOfPendingChanges.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallAllOfPendingChanges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallAllOfPendingChanges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallAllOfPendingChanges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallAllOfPendingChanges.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallAllOfPendingChanges>() {
           @Override
           public void write(JsonWriter out, FirewallAllOfPendingChanges value) throws IOException {
           ...
           @Override
           public FirewallAllOfPendingChanges read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallAllOfPendingChanges instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallAllOfPendingChanges given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallAllOfPendingChanges
  * @throws IOException if the JSON string is invalid with respect to FirewallAllOfPendingChanges
  */
  public static FirewallAllOfPendingChanges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallAllOfPendingChanges.class);
  }

 /**
  * Convert an instance of FirewallAllOfPendingChanges to an JSON string
  *
  * @return JSON string
  */
