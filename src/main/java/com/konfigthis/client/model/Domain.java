...
public class Domain {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, domain.name) &&
        Objects.equals(this.ipAddress, domain.ipAddress) &&
        Objects.equals(this.ttl, domain.ttl) &&
        Objects.equals(this.zoneFile, domain.zoneFile)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, ipAddress, ttl, zoneFile, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("zone_file").isJsonNull() && (jsonObj.get("zone_file") != null && !jsonObj.get("zone_file").isJsonNull()) && !jsonObj.get("zone_file").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `zone_file` to be a primitive type in the JSON string but got `%s`", jsonObj.get("zone_file").toString()));
      }
  }
