...
public class CertificateRequestCustom {
  ...
  **/
   ...
   * @return the CertificateRequestCustom instance itself
   */
  public CertificateRequestCustom putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, certificateRequestCustom.name) &&
        ...
        Objects.equals(this.additionalProperties, certificateRequestCustom.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, privateKey, leafCertificate, certificateChain, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CertificateRequestCustom
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CertificateRequestCustom.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CertificateRequestCustom is not found in the empty JSON string", CertificateRequestCustom.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CertificateRequestCustom.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CertificateRequestCustom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CertificateRequestCustom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CertificateRequestCustom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CertificateRequestCustom.class));

       return (TypeAdapter<T>) new TypeAdapter<CertificateRequestCustom>() {
           @Override
           public void write(JsonWriter out, CertificateRequestCustom value) throws IOException {
           ...
           @Override
           public CertificateRequestCustom read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CertificateRequestCustom instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CertificateRequestCustom given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CertificateRequestCustom
  * @throws IOException if the JSON string is invalid with respect to CertificateRequestCustom
  */
  public static CertificateRequestCustom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CertificateRequestCustom.class);
  }

 /**
  * Convert an instance of CertificateRequestCustom to an JSON string
  *
  * @return JSON string
  */
