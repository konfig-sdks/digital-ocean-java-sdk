...
public class AlertUpdatable {
 ...
 public enum PeriodEnum {
  ...
  public AlertUpdatable() {
  }

  public AlertUpdatable name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(example = "Landing page degraded performance", value = "A human-friendly display name.")
  ...
  public AlertUpdatable type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "LATENCY", value = "The type of alert.")
  ...
  public AlertUpdatable threshold(Integer threshold) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "300", value = "The threshold at which the alert will enter a trigger state. The specific threshold is dependent on the alert type.")
  ...
  public AlertUpdatable comparison(ComparisonEnum comparison) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "GREATER_THAN", value = "The comparison operator used against the alert's threshold.")
  ...
  public AlertUpdatable notifications(Notification notifications) {
  ...
  **/
  ...
  public AlertUpdatable period(PeriodEnum period) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "_2M", value = "Period of time the threshold must be exceeded to trigger the alert.")
   ...
   * @return the AlertUpdatable instance itself
   */
  public AlertUpdatable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AlertUpdatable alertUpdatable = (AlertUpdatable) o;
    return Objects.equals(this.name, alertUpdatable.name) &&
        Objects.equals(this.type, alertUpdatable.type) &&
        Objects.equals(this.threshold, alertUpdatable.threshold) &&
        Objects.equals(this.comparison, alertUpdatable.comparison) &&
        Objects.equals(this.notifications, alertUpdatable.notifications) &&
        Objects.equals(this.period, alertUpdatable.period)&&
        Objects.equals(this.additionalProperties, alertUpdatable.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, type, threshold, comparison, notifications, period, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AlertUpdatable {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlertUpdatable
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlertUpdatable.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertUpdatable is not found in the empty JSON string", AlertUpdatable.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("notifications") != null && !jsonObj.get("notifications").isJsonNull()) {
        Notification.validateJsonObject(jsonObj.getAsJsonObject("notifications"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertUpdatable.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertUpdatable' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertUpdatable> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertUpdatable.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertUpdatable>() {
           @Override
           public void write(JsonWriter out, AlertUpdatable value) throws IOException {
           ...
           @Override
           public AlertUpdatable read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AlertUpdatable instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AlertUpdatable given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlertUpdatable
  * @throws IOException if the JSON string is invalid with respect to AlertUpdatable
  */
  public static AlertUpdatable fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertUpdatable.class);
  }

 /**
  * Convert an instance of AlertUpdatable to an JSON string
  *
  * @return JSON string
  */
