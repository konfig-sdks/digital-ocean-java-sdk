...
public class DomainsCreateResponse {
  ...
  public DomainsCreateResponse domain(Domain domain) {
  ...
  **/
   ...
   * @return the DomainsCreateResponse instance itself
   */
  public DomainsCreateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DomainsCreateResponse domainsCreateResponse = (DomainsCreateResponse) o;
    return Objects.equals(this.domain, domainsCreateResponse.domain)&&
        Objects.equals(this.additionalProperties, domainsCreateResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainsCreateResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainsCreateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainsCreateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainsCreateResponse is not found in the empty JSON string", DomainsCreateResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainsCreateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainsCreateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainsCreateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainsCreateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainsCreateResponse>() {
           @Override
           public void write(JsonWriter out, DomainsCreateResponse value) throws IOException {
           ...
           @Override
           public DomainsCreateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainsCreateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainsCreateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainsCreateResponse
  * @throws IOException if the JSON string is invalid with respect to DomainsCreateResponse
  */
  public static DomainsCreateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainsCreateResponse.class);
  }

 /**
  * Convert an instance of DomainsCreateResponse to an JSON string
  *
  * @return JSON string
  */
