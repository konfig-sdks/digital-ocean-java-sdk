...
public class CdnEndpoint {
   ...
   */
  @JsonAdapter(TtlEnum.Adapter.class)
 public enum TtlEnum {
    NUMBER_60(60),
    ...
    public static class Adapter extends TypeAdapter<TtlEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TtlEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public TtlEnum read(final JsonReader jsonReader) throws IOException {
        Integer value =  jsonReader.nextInt();
        return TtlEnum.fromValue(value);
      }
    }
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "_3600", value = "The amount of time the content is cached by the CDN's edge servers in seconds. TTL must be one of 60, 600, 3600, 86400, or 604800. Defaults to 3600 (one hour) when excluded.")
  ...
  **/
   ...
   * @return the CdnEndpoint instance itself
   */
  public CdnEndpoint putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, cdnEndpoint.id) &&
        Objects.equals(this.origin, cdnEndpoint.origin) &&
        Objects.equals(this.endpoint, cdnEndpoint.endpoint) &&
        Objects.equals(this.ttl, cdnEndpoint.ttl) &&
        ...
        Objects.equals(this.additionalProperties, cdnEndpoint.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, origin, endpoint, ttl, certificateId, customDomain, createdAt, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CdnEndpoint
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CdnEndpoint.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CdnEndpoint is not found in the empty JSON string", CdnEndpoint.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CdnEndpoint.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CdnEndpoint.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CdnEndpoint' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CdnEndpoint> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CdnEndpoint.class));

       return (TypeAdapter<T>) new TypeAdapter<CdnEndpoint>() {
           @Override
           public void write(JsonWriter out, CdnEndpoint value) throws IOException {
           ...
           @Override
           public CdnEndpoint read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CdnEndpoint instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CdnEndpoint given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CdnEndpoint
  * @throws IOException if the JSON string is invalid with respect to CdnEndpoint
  */
  public static CdnEndpoint fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CdnEndpoint.class);
  }

 /**
  * Convert an instance of CdnEndpoint to an JSON string
  *
  * @return JSON string
  */
