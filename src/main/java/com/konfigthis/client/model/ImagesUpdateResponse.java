...
public class ImagesUpdateResponse {
  ...
  public ImagesUpdateResponse image(Image image) {
  ...
  **/
   ...
   * @return the ImagesUpdateResponse instance itself
   */
  public ImagesUpdateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.image, imagesUpdateResponse.image)&&
        Objects.equals(this.additionalProperties, imagesUpdateResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImagesUpdateResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImagesUpdateResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImagesUpdateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImagesUpdateResponse is not found in the empty JSON string", ImagesUpdateResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImagesUpdateResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImagesUpdateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImagesUpdateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImagesUpdateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImagesUpdateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ImagesUpdateResponse>() {
           @Override
           public void write(JsonWriter out, ImagesUpdateResponse value) throws IOException {
           ...
           @Override
           public ImagesUpdateResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImagesUpdateResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImagesUpdateResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImagesUpdateResponse
  * @throws IOException if the JSON string is invalid with respect to ImagesUpdateResponse
  */
  public static ImagesUpdateResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImagesUpdateResponse.class);
  }

 /**
  * Convert an instance of ImagesUpdateResponse to an JSON string
  *
  * @return JSON string
  */
