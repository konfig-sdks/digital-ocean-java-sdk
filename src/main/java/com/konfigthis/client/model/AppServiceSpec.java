...
import com.konfigthis.client.model.AppServiceSpecHealthCheck;
...
public class AppServiceSpec {
 ...
 public enum InstanceSizeSlugEnum {
  ...
  public static final String SERIALIZED_NAME_INTERNAL_PORTS = "internal_ports";
  @SerializedName(SERIALIZED_NAME_INTERNAL_PORTS)
  ...
  **/
  ...
  public AppServiceSpec autoscaling(AppComponentInstanceBaseAutoscaling autoscaling) {
  ...
  **/
  ...
  public AppServiceSpec httpPort(Long httpPort) {
    if (httpPort != null && httpPort < 1) {
      throw new IllegalArgumentException("Invalid value for httpPort. Must be greater than or equal to 1.");
    }
    if (httpPort != null && httpPort > 65535) {
      throw new IllegalArgumentException("Invalid value for httpPort. Must be less than or equal to 65535.");
    }
  ...
  **/
   ...
   * @return the AppServiceSpec instance itself
   */
  public AppServiceSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, appServiceSpec.name) &&
        Objects.equals(this.git, appServiceSpec.git) &&
        ...
        Objects.equals(this.autoscaling, appServiceSpec.autoscaling) &&
        ...
        Objects.equals(this.additionalProperties, appServiceSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, git, github, gitlab, image, dockerfilePath, buildCommand, runCommand, sourceDir, envs, environmentSlug, logDestinations, instanceCount, instanceSizeSlug, autoscaling, cors, healthCheck, httpPort, internalPorts, routes, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("internal_ports");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppServiceSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppServiceSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppServiceSpec is not found in the empty JSON string", AppServiceSpec.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppServiceSpec.openapiRequiredFields) {
      ...
      if (jsonObj.get("health_check") != null && !jsonObj.get("health_check").isJsonNull()) {
        AppServiceSpecHealthCheck.validateJsonObject(jsonObj.getAsJsonObject("health_check"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("internal_ports") != null && !jsonObj.get("internal_ports").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `internal_ports` to be an array in the JSON string but got `%s`", jsonObj.get("internal_ports").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppServiceSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppServiceSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppServiceSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppServiceSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppServiceSpec>() {
           @Override
           public void write(JsonWriter out, AppServiceSpec value) throws IOException {
           ...
           @Override
           public AppServiceSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppServiceSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppServiceSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppServiceSpec
  * @throws IOException if the JSON string is invalid with respect to AppServiceSpec
  */
  public static AppServiceSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppServiceSpec.class);
  }

 /**
  * Convert an instance of AppServiceSpec to an JSON string
  *
  * @return JSON string
  */
