...
public class AppsStringMatch {
  ...
  public AppsStringMatch exact(String exact) {
    ...
    if (exact != null && exact.length() < 1) {
      throw new IllegalArgumentException("Invalid value for exact. Length must be greater than or equal to 1.");
    }
  ...
  **/
  ...
  public AppsStringMatch prefix(String prefix) {
    ...
    if (prefix != null && prefix.length() < 1) {
      throw new IllegalArgumentException("Invalid value for prefix. Length must be greater than or equal to 1.");
    }
  ...
  **/
  ...
  public AppsStringMatch regex(String regex) {
    ...
    if (regex != null && regex.length() < 1) {
      throw new IllegalArgumentException("Invalid value for regex. Length must be greater than or equal to 1.");
    }
  ...
  **/
   ...
   * @return the AppsStringMatch instance itself
   */
  public AppsStringMatch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.exact, appsStringMatch.exact) &&
        Objects.equals(this.prefix, appsStringMatch.prefix) &&
        Objects.equals(this.regex, appsStringMatch.regex)&&
        Objects.equals(this.additionalProperties, appsStringMatch.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(exact, prefix, regex, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsStringMatch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsStringMatch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsStringMatch is not found in the empty JSON string", AppsStringMatch.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsStringMatch.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsStringMatch' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsStringMatch> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsStringMatch.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsStringMatch>() {
           @Override
           public void write(JsonWriter out, AppsStringMatch value) throws IOException {
           ...
           @Override
           public AppsStringMatch read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsStringMatch instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsStringMatch given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsStringMatch
  * @throws IOException if the JSON string is invalid with respect to AppsStringMatch
  */
  public static AppsStringMatch fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsStringMatch.class);
  }

 /**
  * Convert an instance of AppsStringMatch to an JSON string
  *
  * @return JSON string
  */
