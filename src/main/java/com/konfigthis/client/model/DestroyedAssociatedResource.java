 ...
 */
@ApiModel(description = "An object containing information about a resource scheduled for deletion.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class DestroyedAssociatedResource {
  ...
  public static final String SERIALIZED_NAME_DESTROYED_AT = "destroyed_at";
  @SerializedName(SERIALIZED_NAME_DESTROYED_AT)
  ...
  **/
   ...
   * @return the DestroyedAssociatedResource instance itself
   */
  public DestroyedAssociatedResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, destroyedAssociatedResource.id) &&
        ...
        Objects.equals(this.additionalProperties, destroyedAssociatedResource.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, destroyedAt, errorMessage, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("destroyed_at");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DestroyedAssociatedResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DestroyedAssociatedResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DestroyedAssociatedResource is not found in the empty JSON string", DestroyedAssociatedResource.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DestroyedAssociatedResource.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DestroyedAssociatedResource' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DestroyedAssociatedResource> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DestroyedAssociatedResource.class));

       return (TypeAdapter<T>) new TypeAdapter<DestroyedAssociatedResource>() {
           @Override
           public void write(JsonWriter out, DestroyedAssociatedResource value) throws IOException {
           ...
           @Override
           public DestroyedAssociatedResource read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DestroyedAssociatedResource instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DestroyedAssociatedResource given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DestroyedAssociatedResource
  * @throws IOException if the JSON string is invalid with respect to DestroyedAssociatedResource
  */
  public static DestroyedAssociatedResource fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DestroyedAssociatedResource.class);
  }

 /**
  * Convert an instance of DestroyedAssociatedResource to an JSON string
  *
  * @return JSON string
  */
