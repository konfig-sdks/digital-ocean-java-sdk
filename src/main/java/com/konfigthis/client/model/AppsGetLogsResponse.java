...
public class AppsGetLogsResponse {
  public static final String SERIALIZED_NAME_HISTORIC_URLS = "historic_urls";
  @SerializedName(SERIALIZED_NAME_HISTORIC_URLS)
  ...
  **/
   ...
   * @return the AppsGetLogsResponse instance itself
   */
  public AppsGetLogsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.historicUrls, appsGetLogsResponse.historicUrls) &&
        ...
        Objects.equals(this.additionalProperties, appsGetLogsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(historicUrls, liveUrl, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("historic_urls");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsGetLogsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsGetLogsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsGetLogsResponse is not found in the empty JSON string", AppsGetLogsResponse.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("historic_urls") != null && !jsonObj.get("historic_urls").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `historic_urls` to be an array in the JSON string but got `%s`", jsonObj.get("historic_urls").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsGetLogsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsGetLogsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsGetLogsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsGetLogsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsGetLogsResponse>() {
           @Override
           public void write(JsonWriter out, AppsGetLogsResponse value) throws IOException {
           ...
           @Override
           public AppsGetLogsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsGetLogsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsGetLogsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsGetLogsResponse
  * @throws IOException if the JSON string is invalid with respect to AppsGetLogsResponse
  */
  public static AppsGetLogsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsGetLogsResponse.class);
  }

 /**
  * Convert an instance of AppsGetLogsResponse to an JSON string
  *
  * @return JSON string
  */
