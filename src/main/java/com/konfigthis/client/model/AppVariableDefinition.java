...
public class AppVariableDefinition {
  ...
  **/
   ...
   * @return the AppVariableDefinition instance itself
   */
  public AppVariableDefinition putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, appVariableDefinition.key) &&
        ...
        Objects.equals(this.additionalProperties, appVariableDefinition.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, scope, type, value, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppVariableDefinition
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppVariableDefinition.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppVariableDefinition is not found in the empty JSON string", AppVariableDefinition.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppVariableDefinition.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppVariableDefinition.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppVariableDefinition' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppVariableDefinition> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppVariableDefinition.class));

       return (TypeAdapter<T>) new TypeAdapter<AppVariableDefinition>() {
           @Override
           public void write(JsonWriter out, AppVariableDefinition value) throws IOException {
           ...
           @Override
           public AppVariableDefinition read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppVariableDefinition instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppVariableDefinition given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppVariableDefinition
  * @throws IOException if the JSON string is invalid with respect to AppVariableDefinition
  */
  public static AppVariableDefinition fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppVariableDefinition.class);
  }

 /**
  * Convert an instance of AppVariableDefinition to an JSON string
  *
  * @return JSON string
  */
