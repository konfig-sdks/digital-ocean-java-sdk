...
public class SimpleCharge {
  ...
  **/
   ...
   * @return the SimpleCharge instance itself
   */
  public SimpleCharge putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, simpleCharge.name) &&
        Objects.equals(this.amount, simpleCharge.amount)&&
        Objects.equals(this.additionalProperties, simpleCharge.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimpleCharge
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimpleCharge.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimpleCharge is not found in the empty JSON string", SimpleCharge.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimpleCharge.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimpleCharge' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimpleCharge> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimpleCharge.class));

       return (TypeAdapter<T>) new TypeAdapter<SimpleCharge>() {
           @Override
           public void write(JsonWriter out, SimpleCharge value) throws IOException {
           ...
           @Override
           public SimpleCharge read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SimpleCharge instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SimpleCharge given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SimpleCharge
  * @throws IOException if the JSON string is invalid with respect to SimpleCharge
  */
  public static SimpleCharge fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimpleCharge.class);
  }

 /**
  * Convert an instance of SimpleCharge to an JSON string
  *
  * @return JSON string
  */
