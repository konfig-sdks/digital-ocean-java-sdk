...
public class DatabaseLayoutOptions {
  ...
  **/
   ...
   * @return the DatabaseLayoutOptions instance itself
   */
  public DatabaseLayoutOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabaseLayoutOptions databaseLayoutOptions = (DatabaseLayoutOptions) o;
    return Objects.equals(this.layouts, databaseLayoutOptions.layouts)&&
        Objects.equals(this.additionalProperties, databaseLayoutOptions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(layouts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabaseLayoutOptions {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseLayoutOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseLayoutOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseLayoutOptions is not found in the empty JSON string", DatabaseLayoutOptions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseLayoutOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseLayoutOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseLayoutOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseLayoutOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseLayoutOptions>() {
           @Override
           public void write(JsonWriter out, DatabaseLayoutOptions value) throws IOException {
           ...
           @Override
           public DatabaseLayoutOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseLayoutOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseLayoutOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseLayoutOptions
  * @throws IOException if the JSON string is invalid with respect to DatabaseLayoutOptions
  */
  public static DatabaseLayoutOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseLayoutOptions.class);
  }

 /**
  * Convert an instance of DatabaseLayoutOptions to an JSON string
  *
  * @return JSON string
  */
