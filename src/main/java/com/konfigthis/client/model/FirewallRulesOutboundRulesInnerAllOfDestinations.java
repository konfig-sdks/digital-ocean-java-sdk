...
public class FirewallRulesOutboundRulesInnerAllOfDestinations {
  ...
  public static final String SERIALIZED_NAME_KUBERNETES_IDS = "kubernetes_ids";
  @SerializedName(SERIALIZED_NAME_KUBERNETES_IDS)
  private List<String> kubernetesIds = null;

  public FirewallRulesOutboundRulesInnerAllOfDestinations() {
  }

  public FirewallRulesOutboundRulesInnerAllOfDestinations tags(List tags) {
  ...
  **/
   ...
   * @return the FirewallRulesOutboundRulesInnerAllOfDestinations instance itself
   */
  public FirewallRulesOutboundRulesInnerAllOfDestinations putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, firewallRulesOutboundRulesInnerAllOfDestinations.tags) &&
        Objects.equals(this.addresses, firewallRulesOutboundRulesInnerAllOfDestinations.addresses) &&
        Objects.equals(this.dropletIds, firewallRulesOutboundRulesInnerAllOfDestinations.dropletIds) &&
        Objects.equals(this.loadBalancerUids, firewallRulesOutboundRulesInnerAllOfDestinations.loadBalancerUids) &&
        Objects.equals(this.kubernetesIds, firewallRulesOutboundRulesInnerAllOfDestinations.kubernetesIds)&&
        Objects.equals(this.additionalProperties, firewallRulesOutboundRulesInnerAllOfDestinations.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, addresses, dropletIds, loadBalancerUids, kubernetesIds, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("kubernetes_ids");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRulesOutboundRulesInnerAllOfDestinations
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRulesOutboundRulesInnerAllOfDestinations.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRulesOutboundRulesInnerAllOfDestinations is not found in the empty JSON string", FirewallRulesOutboundRulesInnerAllOfDestinations.openapiRequiredFields.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("kubernetes_ids") != null && !jsonObj.get("kubernetes_ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `kubernetes_ids` to be an array in the JSON string but got `%s`", jsonObj.get("kubernetes_ids").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRulesOutboundRulesInnerAllOfDestinations.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRulesOutboundRulesInnerAllOfDestinations' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRulesOutboundRulesInnerAllOfDestinations> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRulesOutboundRulesInnerAllOfDestinations.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRulesOutboundRulesInnerAllOfDestinations>() {
           @Override
           public void write(JsonWriter out, FirewallRulesOutboundRulesInnerAllOfDestinations value) throws IOException {
           ...
           @Override
           public FirewallRulesOutboundRulesInnerAllOfDestinations read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRulesOutboundRulesInnerAllOfDestinations instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRulesOutboundRulesInnerAllOfDestinations given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRulesOutboundRulesInnerAllOfDestinations
  * @throws IOException if the JSON string is invalid with respect to FirewallRulesOutboundRulesInnerAllOfDestinations
  */
  public static FirewallRulesOutboundRulesInnerAllOfDestinations fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRulesOutboundRulesInnerAllOfDestinations.class);
  }

 /**
  * Convert an instance of FirewallRulesOutboundRulesInnerAllOfDestinations to an JSON string
  *
  * @return JSON string
  */
