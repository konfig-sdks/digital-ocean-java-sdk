...
public class AppServiceSpecHealthCheck {
  public static final String SERIALIZED_NAME_FAILURE_THRESHOLD = "failure_threshold";
  ...
  public static final String SERIALIZED_NAME_INITIAL_DELAY_SECONDS = "initial_delay_seconds";
  ...
  public static final String SERIALIZED_NAME_SUCCESS_THRESHOLD = "success_threshold";
  ...
  **/
   ...
   * @return the AppServiceSpecHealthCheck instance itself
   */
  public AppServiceSpecHealthCheck putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.failureThreshold, appServiceSpecHealthCheck.failureThreshold) &&
        ...
        Objects.equals(this.additionalProperties, appServiceSpecHealthCheck.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(failureThreshold, port, httpPath, initialDelaySeconds, periodSeconds, successThreshold, timeoutSeconds, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("failure_threshold");
    openapiFields.add("port");
    openapiFields.add("http_path");
    openapiFields.add("initial_delay_seconds");
    openapiFields.add("period_seconds");
    openapiFields.add("success_threshold");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppServiceSpecHealthCheck
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppServiceSpecHealthCheck.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppServiceSpecHealthCheck is not found in the empty JSON string", AppServiceSpecHealthCheck.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppServiceSpecHealthCheck.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppServiceSpecHealthCheck' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppServiceSpecHealthCheck> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppServiceSpecHealthCheck.class));

       return (TypeAdapter<T>) new TypeAdapter<AppServiceSpecHealthCheck>() {
           @Override
           public void write(JsonWriter out, AppServiceSpecHealthCheck value) throws IOException {
           ...
           @Override
           public AppServiceSpecHealthCheck read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppServiceSpecHealthCheck instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppServiceSpecHealthCheck given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppServiceSpecHealthCheck
  * @throws IOException if the JSON string is invalid with respect to AppServiceSpecHealthCheck
  */
  public static AppServiceSpecHealthCheck fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppServiceSpecHealthCheck.class);
  }

 /**
  * Convert an instance of AppServiceSpecHealthCheck to an JSON string
  *
  * @return JSON string
  */
