...
public class InvoiceSummaryOverages {
  ...
  **/
   ...
   * @return the InvoiceSummaryOverages instance itself
   */
  public InvoiceSummaryOverages putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, invoiceSummaryOverages.name) &&
        ...
        Objects.equals(this.additionalProperties, invoiceSummaryOverages.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to InvoiceSummaryOverages
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InvoiceSummaryOverages.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InvoiceSummaryOverages is not found in the empty JSON string", InvoiceSummaryOverages.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InvoiceSummaryOverages.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InvoiceSummaryOverages' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InvoiceSummaryOverages> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InvoiceSummaryOverages.class));

       return (TypeAdapter<T>) new TypeAdapter<InvoiceSummaryOverages>() {
           @Override
           public void write(JsonWriter out, InvoiceSummaryOverages value) throws IOException {
           ...
           @Override
           public InvoiceSummaryOverages read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InvoiceSummaryOverages instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InvoiceSummaryOverages given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InvoiceSummaryOverages
  * @throws IOException if the JSON string is invalid with respect to InvoiceSummaryOverages
  */
  public static InvoiceSummaryOverages fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InvoiceSummaryOverages.class);
  }

 /**
  * Convert an instance of InvoiceSummaryOverages to an JSON string
  *
  * @return JSON string
  */
