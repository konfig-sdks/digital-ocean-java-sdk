...
public class AppsTier {
  public static final String SERIALIZED_NAME_BUILD_SECONDS = "build_seconds";
  @SerializedName(SERIALIZED_NAME_BUILD_SECONDS)
  private String buildSeconds;

  public static final String SERIALIZED_NAME_EGRESS_BANDWIDTH_BYTES = "egress_bandwidth_bytes";
  @SerializedName(SERIALIZED_NAME_EGRESS_BANDWIDTH_BYTES)
  ...
  **/
   ...
   * @return the AppsTier instance itself
   */
  public AppsTier putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buildSeconds, appsTier.buildSeconds) &&
        ...
        Objects.equals(this.name, appsTier.name) &&
        Objects.equals(this.slug, appsTier.slug) &&
        Objects.equals(this.storageBytes, appsTier.storageBytes)&&
        Objects.equals(this.additionalProperties, appsTier.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(buildSeconds, egressBandwidthBytes, name, slug, storageBytes, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("build_seconds");
    openapiFields.add("egress_bandwidth_bytes");
    openapiFields.add("name");
    openapiFields.add("slug");
    openapiFields.add("storage_bytes");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsTier
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsTier.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsTier is not found in the empty JSON string", AppsTier.openapiRequiredFields.toString()));
        }
      }
      if ((jsonObj.get("build_seconds") != null && !jsonObj.get("build_seconds").isJsonNull()) && !jsonObj.get("build_seconds").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `build_seconds` to be a primitive type in the JSON string but got `%s`", jsonObj.get("build_seconds").toString()));
      }
      if ((jsonObj.get("egress_bandwidth_bytes") != null && !jsonObj.get("egress_bandwidth_bytes").isJsonNull()) && !jsonObj.get("egress_bandwidth_bytes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `egress_bandwidth_bytes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("egress_bandwidth_bytes").toString()));
      }
      ...
      if ((jsonObj.get("storage_bytes") != null && !jsonObj.get("storage_bytes").isJsonNull()) && !jsonObj.get("storage_bytes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `storage_bytes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("storage_bytes").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsTier.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsTier' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsTier> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsTier.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsTier>() {
           @Override
           public void write(JsonWriter out, AppsTier value) throws IOException {
           ...
           @Override
           public AppsTier read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsTier instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsTier given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsTier
  * @throws IOException if the JSON string is invalid with respect to AppsTier
  */
  public static AppsTier fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsTier.class);
  }

 /**
  * Convert an instance of AppsTier to an JSON string
  *
  * @return JSON string
  */
