...
import com.konfigthis.client.model.ReservedIpActionAssign;
import com.konfigthis.client.model.ReservedIpActionType;
import com.konfigthis.client.model.ReservedIpActionUnassign;
...
public class ReservedIpActionAssign extends ReservedIpActionType {
  ...
  **/
   ...
   * @return the ReservedIpActionAssign instance itself
   */
  public ReservedIpActionAssign putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletId, reservedIpActionAssign.dropletId)&&
        Objects.equals(this.additionalProperties, reservedIpActionAssign.additionalProperties) &&
        super.equals(o);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReservedIpActionAssign
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReservedIpActionAssign.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReservedIpActionAssign is not found in the empty JSON string", ReservedIpActionAssign.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReservedIpActionAssign.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReservedIpActionAssign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReservedIpActionAssign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReservedIpActionAssign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReservedIpActionAssign.class));

       return (TypeAdapter<T>) new TypeAdapter<ReservedIpActionAssign>() {
           @Override
           public void write(JsonWriter out, ReservedIpActionAssign value) throws IOException {
           ...
           @Override
           public ReservedIpActionAssign read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReservedIpActionAssign instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReservedIpActionAssign given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReservedIpActionAssign
  * @throws IOException if the JSON string is invalid with respect to ReservedIpActionAssign
  */
  public static ReservedIpActionAssign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReservedIpActionAssign.class);
  }

 /**
  * Convert an instance of ReservedIpActionAssign to an JSON string
  *
  * @return JSON string
  */
