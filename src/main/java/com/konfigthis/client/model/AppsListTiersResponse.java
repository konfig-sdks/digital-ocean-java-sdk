...
import com.konfigthis.client.model.AppsTier;
...
public class AppsListTiersResponse {
  ...
  **/
   ...
   * @return the AppsListTiersResponse instance itself
   */
  public AppsListTiersResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tiers, appsListTiersResponse.tiers)&&
        Objects.equals(this.additionalProperties, appsListTiersResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsListTiersResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsListTiersResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsListTiersResponse is not found in the empty JSON string", AppsListTiersResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("tiers") != null && !jsonObj.get("tiers").isJsonNull()) {
        ...
        if (jsonArraytiers != null) {
          ...
          for (int i = 0; i < jsonArraytiers.size(); i++) {
            AppsTier.validateJsonObject(jsonArraytiers.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsListTiersResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsListTiersResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsListTiersResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsListTiersResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsListTiersResponse>() {
           @Override
           public void write(JsonWriter out, AppsListTiersResponse value) throws IOException {
           ...
           @Override
           public AppsListTiersResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsListTiersResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsListTiersResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsListTiersResponse
  * @throws IOException if the JSON string is invalid with respect to AppsListTiersResponse
  */
  public static AppsListTiersResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsListTiersResponse.class);
  }

 /**
  * Convert an instance of AppsListTiersResponse to an JSON string
  *
  * @return JSON string
  */
