...
import com.konfigthis.client.model.DestroyedAssociatedResource;
 ...
 */
@ApiModel(description = "An object containing additional information about resource related to a Droplet requested to be destroyed.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class AssociatedResourceStatusResources {
  ...
  **/
   ...
   * @return the AssociatedResourceStatusResources instance itself
   */
  public AssociatedResourceStatusResources putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reservedIps, associatedResourceStatusResources.reservedIps) &&
        ...
        Objects.equals(this.additionalProperties, associatedResourceStatusResources.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AssociatedResourceStatusResources
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AssociatedResourceStatusResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AssociatedResourceStatusResources is not found in the empty JSON string", AssociatedResourceStatusResources.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("reserved_ips") != null && !jsonObj.get("reserved_ips").isJsonNull()) {
        ...
        if (jsonArrayreservedIps != null) {
          ...
          for (int i = 0; i < jsonArrayreservedIps.size(); i++) {
            DestroyedAssociatedResource.validateJsonObject(jsonArrayreservedIps.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("floating_ips") != null && !jsonObj.get("floating_ips").isJsonNull()) {
        ...
        if (jsonArrayfloatingIps != null) {
          ...
          for (int i = 0; i < jsonArrayfloatingIps.size(); i++) {
            DestroyedAssociatedResource.validateJsonObject(jsonArrayfloatingIps.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("snapshots") != null && !jsonObj.get("snapshots").isJsonNull()) {
        ...
        if (jsonArraysnapshots != null) {
          ...
          for (int i = 0; i < jsonArraysnapshots.size(); i++) {
            DestroyedAssociatedResource.validateJsonObject(jsonArraysnapshots.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("volumes") != null && !jsonObj.get("volumes").isJsonNull()) {
        ...
        if (jsonArrayvolumes != null) {
          ...
          for (int i = 0; i < jsonArrayvolumes.size(); i++) {
            DestroyedAssociatedResource.validateJsonObject(jsonArrayvolumes.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("volume_snapshots") != null && !jsonObj.get("volume_snapshots").isJsonNull()) {
        ...
        if (jsonArrayvolumeSnapshots != null) {
          ...
          for (int i = 0; i < jsonArrayvolumeSnapshots.size(); i++) {
            DestroyedAssociatedResource.validateJsonObject(jsonArrayvolumeSnapshots.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AssociatedResourceStatusResources.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AssociatedResourceStatusResources' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AssociatedResourceStatusResources> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AssociatedResourceStatusResources.class));

       return (TypeAdapter<T>) new TypeAdapter<AssociatedResourceStatusResources>() {
           @Override
           public void write(JsonWriter out, AssociatedResourceStatusResources value) throws IOException {
           ...
           @Override
           public AssociatedResourceStatusResources read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AssociatedResourceStatusResources instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AssociatedResourceStatusResources given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AssociatedResourceStatusResources
  * @throws IOException if the JSON string is invalid with respect to AssociatedResourceStatusResources
  */
  public static AssociatedResourceStatusResources fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AssociatedResourceStatusResources.class);
  }

 /**
  * Convert an instance of AssociatedResourceStatusResources to an JSON string
  *
  * @return JSON string
  */
