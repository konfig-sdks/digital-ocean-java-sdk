...
public class ProductUsageCharges {
  ...
  **/
   ...
   * @return the ProductUsageCharges instance itself
   */
  public ProductUsageCharges putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, productUsageCharges.name) &&
        ...
        Objects.equals(this.additionalProperties, productUsageCharges.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProductUsageCharges
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProductUsageCharges.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProductUsageCharges is not found in the empty JSON string", ProductUsageCharges.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProductUsageCharges.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProductUsageCharges' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProductUsageCharges> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProductUsageCharges.class));

       return (TypeAdapter<T>) new TypeAdapter<ProductUsageCharges>() {
           @Override
           public void write(JsonWriter out, ProductUsageCharges value) throws IOException {
           ...
           @Override
           public ProductUsageCharges read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProductUsageCharges instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProductUsageCharges given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProductUsageCharges
  * @throws IOException if the JSON string is invalid with respect to ProductUsageCharges
  */
  public static ProductUsageCharges fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProductUsageCharges.class);
  }

 /**
  * Convert an instance of ProductUsageCharges to an JSON string
  *
  * @return JSON string
  */
