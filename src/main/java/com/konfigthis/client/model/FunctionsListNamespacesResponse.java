...
public class FunctionsListNamespacesResponse {
  public static final String SERIALIZED_NAME_NAMESPACES = "namespaces";
  @SerializedName(SERIALIZED_NAME_NAMESPACES)
  private List<NamespaceInfo> namespaces = null;

  public FunctionsListNamespacesResponse() {
  }

  public FunctionsListNamespacesResponse namespaces(List<NamespaceInfo> namespaces) {
  ...
  public FunctionsListNamespacesResponse addNamespacesItem(NamespaceInfo namespacesItem) {
  ...
  **/
   ...
   * @return the FunctionsListNamespacesResponse instance itself
   */
  public FunctionsListNamespacesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FunctionsListNamespacesResponse functionsListNamespacesResponse = (FunctionsListNamespacesResponse) o;
    return Objects.equals(this.namespaces, functionsListNamespacesResponse.namespaces)&&
        Objects.equals(this.additionalProperties, functionsListNamespacesResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FunctionsListNamespacesResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FunctionsListNamespacesResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FunctionsListNamespacesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FunctionsListNamespacesResponse is not found in the empty JSON string", FunctionsListNamespacesResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FunctionsListNamespacesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FunctionsListNamespacesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FunctionsListNamespacesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FunctionsListNamespacesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FunctionsListNamespacesResponse>() {
           @Override
           public void write(JsonWriter out, FunctionsListNamespacesResponse value) throws IOException {
           ...
           @Override
           public FunctionsListNamespacesResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FunctionsListNamespacesResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FunctionsListNamespacesResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FunctionsListNamespacesResponse
  * @throws IOException if the JSON string is invalid with respect to FunctionsListNamespacesResponse
  */
  public static FunctionsListNamespacesResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FunctionsListNamespacesResponse.class);
  }

 /**
  * Convert an instance of FunctionsListNamespacesResponse to an JSON string
  *
  * @return JSON string
  */
