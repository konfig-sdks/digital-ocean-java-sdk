...
public class VolumeActionPostBase {
  ...
  **/
   ...
   * @return the VolumeActionPostBase instance itself
   */
  public VolumeActionPostBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, volumeActionPostBase.type) &&
        ...
        Objects.equals(this.additionalProperties, volumeActionPostBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, region, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to VolumeActionPostBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VolumeActionPostBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VolumeActionPostBase is not found in the empty JSON string", VolumeActionPostBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VolumeActionPostBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VolumeActionPostBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VolumeActionPostBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VolumeActionPostBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VolumeActionPostBase.class));

       return (TypeAdapter<T>) new TypeAdapter<VolumeActionPostBase>() {
           @Override
           public void write(JsonWriter out, VolumeActionPostBase value) throws IOException {
           ...
           @Override
           public VolumeActionPostBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VolumeActionPostBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VolumeActionPostBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VolumeActionPostBase
  * @throws IOException if the JSON string is invalid with respect to VolumeActionPostBase
  */
  public static VolumeActionPostBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VolumeActionPostBase.class);
  }

 /**
  * Convert an instance of VolumeActionPostBase to an JSON string
  *
  * @return JSON string
  */
