...
public class TagsResource {
  ...
  private List<TagsResourceResourcesInner> resources = new ArrayList<>();

  public TagsResource() {
  }

  public TagsResource resources(List<TagsResourceResourcesInner> resources) {
  ...
  public TagsResource addResourcesItem(TagsResourceResourcesInner resourcesItem) {
  ...
  **/
  ...
  public List<TagsResourceResourcesInner> getResources() {
    return resources;
  }


  public void setResources(List<TagsResourceResourcesInner> resources) {
   ...
   * @return the TagsResource instance itself
   */
  public TagsResource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resources, tagsResource.resources)&&
        Objects.equals(this.additionalProperties, tagsResource.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TagsResource
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TagsResource.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayresources.size(); i++) {
        TagsResourceResourcesInner.validateJsonObject(jsonArrayresources.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TagsResource>() {
           ...
           public TagsResource read(JsonReader in) throws IOException {
             ...
             TagsResource instance = thisAdapter.fromJsonTree(jsonObj);
