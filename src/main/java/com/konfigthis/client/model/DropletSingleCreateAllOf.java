...
public class DropletSingleCreateAllOf {
  ...
  **/
   ...
   * @return the DropletSingleCreateAllOf instance itself
   */
  public DropletSingleCreateAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, dropletSingleCreateAllOf.name)&&
        Objects.equals(this.additionalProperties, dropletSingleCreateAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletSingleCreateAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletSingleCreateAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletSingleCreateAllOf is not found in the empty JSON string", DropletSingleCreateAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletSingleCreateAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletSingleCreateAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletSingleCreateAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletSingleCreateAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletSingleCreateAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletSingleCreateAllOf>() {
           @Override
           public void write(JsonWriter out, DropletSingleCreateAllOf value) throws IOException {
           ...
           @Override
           public DropletSingleCreateAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletSingleCreateAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletSingleCreateAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletSingleCreateAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletSingleCreateAllOf
  */
  public static DropletSingleCreateAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletSingleCreateAllOf.class);
  }

 /**
  * Convert an instance of DropletSingleCreateAllOf to an JSON string
  *
  * @return JSON string
  */
