...
public class DropletSnapshotAllOf1 {
  ...
  **/
   ...
   * @return the DropletSnapshotAllOf1 instance itself
   */
  public DropletSnapshotAllOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletSnapshotAllOf1.type)&&
        Objects.equals(this.additionalProperties, dropletSnapshotAllOf1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletSnapshotAllOf1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletSnapshotAllOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletSnapshotAllOf1 is not found in the empty JSON string", DropletSnapshotAllOf1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletSnapshotAllOf1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletSnapshotAllOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletSnapshotAllOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletSnapshotAllOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletSnapshotAllOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletSnapshotAllOf1>() {
           @Override
           public void write(JsonWriter out, DropletSnapshotAllOf1 value) throws IOException {
           ...
           @Override
           public DropletSnapshotAllOf1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletSnapshotAllOf1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletSnapshotAllOf1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletSnapshotAllOf1
  * @throws IOException if the JSON string is invalid with respect to DropletSnapshotAllOf1
  */
  public static DropletSnapshotAllOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletSnapshotAllOf1.class);
  }

 /**
  * Convert an instance of DropletSnapshotAllOf1 to an JSON string
  *
  * @return JSON string
  */
