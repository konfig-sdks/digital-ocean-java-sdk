...
import com.konfigthis.client.model.AppsDeploymentProgressStepReason;
import com.konfigthis.client.model.AppsDeploymentProgressStepStatus;
...
public class AppsDeploymentProgressStep {
  ...
  public static final String SERIALIZED_NAME_MESSAGE_BASE = "message_base";
  ...
  **/
   ...
   * @return the AppsDeploymentProgressStep instance itself
   */
  public AppsDeploymentProgressStep putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.componentName, appsDeploymentProgressStep.componentName) &&
        ...
        Objects.equals(this.additionalProperties, appsDeploymentProgressStep.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(componentName, endedAt, messageBase, name, reason, startedAt, status, steps, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("message_base");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppsDeploymentProgressStep
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppsDeploymentProgressStep.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppsDeploymentProgressStep is not found in the empty JSON string", AppsDeploymentProgressStep.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("message_base") != null && !jsonObj.get("message_base").isJsonNull()) && !jsonObj.get("message_base").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `message_base` to be a primitive type in the JSON string but got `%s`", jsonObj.get("message_base").toString()));
      }
      ...
      if (jsonObj.get("reason") != null && !jsonObj.get("reason").isJsonNull()) {
        AppsDeploymentProgressStepReason.validateJsonObject(jsonObj.getAsJsonObject("reason"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppsDeploymentProgressStep.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppsDeploymentProgressStep' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppsDeploymentProgressStep> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppsDeploymentProgressStep.class));

       return (TypeAdapter<T>) new TypeAdapter<AppsDeploymentProgressStep>() {
           @Override
           public void write(JsonWriter out, AppsDeploymentProgressStep value) throws IOException {
           ...
           @Override
           public AppsDeploymentProgressStep read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppsDeploymentProgressStep instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppsDeploymentProgressStep given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppsDeploymentProgressStep
  * @throws IOException if the JSON string is invalid with respect to AppsDeploymentProgressStep
  */
  public static AppsDeploymentProgressStep fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppsDeploymentProgressStep.class);
  }

 /**
  * Convert an instance of AppsDeploymentProgressStep to an JSON string
  *
  * @return JSON string
  */
