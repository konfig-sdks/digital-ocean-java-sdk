...
public class DomainsGetResponse {
  ...
  public DomainsGetResponse domain(Domain domain) {
  ...
  **/
   ...
   * @return the DomainsGetResponse instance itself
   */
  public DomainsGetResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DomainsGetResponse domainsGetResponse = (DomainsGetResponse) o;
    return Objects.equals(this.domain, domainsGetResponse.domain)&&
        Objects.equals(this.additionalProperties, domainsGetResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainsGetResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainsGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainsGetResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainsGetResponse is not found in the empty JSON string", DomainsGetResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainsGetResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainsGetResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainsGetResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainsGetResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainsGetResponse>() {
           @Override
           public void write(JsonWriter out, DomainsGetResponse value) throws IOException {
           ...
           @Override
           public DomainsGetResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainsGetResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainsGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainsGetResponse
  * @throws IOException if the JSON string is invalid with respect to DomainsGetResponse
  */
  public static DomainsGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainsGetResponse.class);
  }

 /**
  * Convert an instance of DomainsGetResponse to an JSON string
  *
  * @return JSON string
  */
