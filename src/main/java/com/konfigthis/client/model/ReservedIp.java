...
import com.konfigthis.client.model.NullProperty1;
import com.konfigthis.client.model.ReservedIpRegion;
...
public class ReservedIp {
  ...
  **/
  ...
  public ReservedIp droplet(NullProperty1 droplet) {
  ...
  **/
  ...
  public NullProperty1 getDroplet() {
    return droplet;
  }


  public void setDroplet(NullProperty1 droplet) {
  ...
  **/
  ...
  public ReservedIp projectId(UUID projectId) {
  ...
  **/
   ...
   * @return the ReservedIp instance itself
   */
  public ReservedIp putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ip, reservedIp.ip) &&
        Objects.equals(this.region, reservedIp.region) &&
        Objects.equals(this.droplet, reservedIp.droplet) &&
        Objects.equals(this.locked, reservedIp.locked) &&
        Objects.equals(this.projectId, reservedIp.projectId)&&
        Objects.equals(this.additionalProperties, reservedIp.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReservedIp.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("region") != null && !jsonObj.get("region").isJsonNull()) {
        ReservedIpRegion.validateJsonObject(jsonObj.getAsJsonObject("region"));
      }
      // validate the optional field `droplet`
      if (jsonObj.get("droplet") != null && !jsonObj.get("droplet").isJsonNull()) {
        NullProperty1.validateJsonObject(jsonObj.getAsJsonObject("droplet"));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ReservedIp>() {
           ...
           public ReservedIp read(JsonReader in) throws IOException {
             ...
             ReservedIp instance = thisAdapter.fromJsonTree(jsonObj);
