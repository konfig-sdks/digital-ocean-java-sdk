...
import com.konfigthis.client.model.AccountTeam;
...
public class Account {
  public static final String SERIALIZED_NAME_DROPLET_LIMIT = "droplet_limit";
  @SerializedName(SERIALIZED_NAME_DROPLET_LIMIT)
  private Integer dropletLimit;

  public static final String SERIALIZED_NAME_FLOATING_IP_LIMIT = "floating_ip_limit";
  @SerializedName(SERIALIZED_NAME_FLOATING_IP_LIMIT)
  ...
  **/
  ...
  @ApiModelProperty(example = "Sammy the Shark", value = "The display name for the current user.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dropletLimit, account.dropletLimit) &&
        ...
        Objects.equals(this.statusMessage, account.statusMessage) &&
        Objects.equals(this.team, account.team)&&
        Objects.equals(this.additionalProperties, account.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dropletLimit, floatingIpLimit, email, name, uuid, emailVerified, status, statusMessage, team, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("droplet_limit");
    openapiFields.add("floating_ip_limit");
    ...
    openapiRequiredFields.add("droplet_limit");
    openapiRequiredFields.add("floating_ip_limit");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("team") != null && !jsonObj.get("team").isJsonNull()) {
        AccountTeam.validateJsonObject(jsonObj.getAsJsonObject("team"));
      }
  }
