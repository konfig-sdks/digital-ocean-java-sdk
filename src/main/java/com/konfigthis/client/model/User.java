...
import com.konfigthis.client.model.UserKubernetesClusterUser;
...
public class User {
  public static final String SERIALIZED_NAME_KUBERNETES_CLUSTER_USER = "kubernetes_cluster_user";
  @SerializedName(SERIALIZED_NAME_KUBERNETES_CLUSTER_USER)
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kubernetesClusterUser, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("kubernetes_cluster_user");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `kubernetes_cluster_user`
      if (jsonObj.get("kubernetes_cluster_user") != null && !jsonObj.get("kubernetes_cluster_user").isJsonNull()) {
        UserKubernetesClusterUser.validateJsonObject(jsonObj.getAsJsonObject("kubernetes_cluster_user"));
      }
  }
