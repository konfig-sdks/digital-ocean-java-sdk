...
import com.konfigthis.client.model.ResourceLinks;
...
public class Resource {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.urn, resource.urn) &&
        Objects.equals(this.assignedAt, resource.assignedAt) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(urn, assignedAt, links, status, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonObj.get("links") != null && !jsonObj.get("links").isJsonNull()) {
        ResourceLinks.validateJsonObject(jsonObj.getAsJsonObject("links"));
      }
