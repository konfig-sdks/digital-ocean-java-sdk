...
public class Pgbouncer {
  ...
  **/
   ...
   * @return the Pgbouncer instance itself
   */
  public Pgbouncer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serverResetQueryAlways, pgbouncer.serverResetQueryAlways) &&
        ...
        Objects.equals(this.additionalProperties, pgbouncer.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pgbouncer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pgbouncer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pgbouncer is not found in the empty JSON string", Pgbouncer.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pgbouncer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pgbouncer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pgbouncer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pgbouncer.class));

       return (TypeAdapter<T>) new TypeAdapter<Pgbouncer>() {
           @Override
           public void write(JsonWriter out, Pgbouncer value) throws IOException {
           ...
           @Override
           public Pgbouncer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pgbouncer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pgbouncer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pgbouncer
  * @throws IOException if the JSON string is invalid with respect to Pgbouncer
  */
  public static Pgbouncer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pgbouncer.class);
  }

 /**
  * Convert an instance of Pgbouncer to an JSON string
  *
  * @return JSON string
  */
