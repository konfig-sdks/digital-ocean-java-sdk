...
public class FirewallRuleTarget {
  ...
  public FirewallRuleTarget tags(List tags) {
  ...
  **/
   ...
   * @return the FirewallRuleTarget instance itself
   */
  public FirewallRuleTarget putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, firewallRuleTarget.tags) &&
        Objects.equals(this.addresses, firewallRuleTarget.addresses) &&
        ...
        Objects.equals(this.additionalProperties, firewallRuleTarget.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FirewallRuleTarget
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FirewallRuleTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FirewallRuleTarget is not found in the empty JSON string", FirewallRuleTarget.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FirewallRuleTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FirewallRuleTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FirewallRuleTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FirewallRuleTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<FirewallRuleTarget>() {
           @Override
           public void write(JsonWriter out, FirewallRuleTarget value) throws IOException {
           ...
           @Override
           public FirewallRuleTarget read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FirewallRuleTarget instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FirewallRuleTarget given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FirewallRuleTarget
  * @throws IOException if the JSON string is invalid with respect to FirewallRuleTarget
  */
  public static FirewallRuleTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FirewallRuleTarget.class);
  }

 /**
  * Convert an instance of FirewallRuleTarget to an JSON string
  *
  * @return JSON string
  */
