...
public class DropletActionSnapshot {
  ...
  **/
   ...
   * @return the DropletActionSnapshot instance itself
   */
  public DropletActionSnapshot putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletActionSnapshot.type) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionSnapshot.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionSnapshot
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionSnapshot.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionSnapshot is not found in the empty JSON string", DropletActionSnapshot.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletActionSnapshot.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionSnapshot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionSnapshot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionSnapshot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionSnapshot.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionSnapshot>() {
           @Override
           public void write(JsonWriter out, DropletActionSnapshot value) throws IOException {
           ...
           @Override
           public DropletActionSnapshot read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionSnapshot instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionSnapshot given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionSnapshot
  * @throws IOException if the JSON string is invalid with respect to DropletActionSnapshot
  */
  public static DropletActionSnapshot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionSnapshot.class);
  }

 /**
  * Convert an instance of DropletActionSnapshot to an JSON string
  *
  * @return JSON string
  */
