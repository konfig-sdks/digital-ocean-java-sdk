...
public class DatabaseConnection {
  ...
  **/
   ...
   * @return the DatabaseConnection instance itself
   */
  public DatabaseConnection putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uri, databaseConnection.uri) &&
        ...
        Objects.equals(this.additionalProperties, databaseConnection.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseConnection
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseConnection.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseConnection is not found in the empty JSON string", DatabaseConnection.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseConnection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseConnection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseConnection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseConnection.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseConnection>() {
           @Override
           public void write(JsonWriter out, DatabaseConnection value) throws IOException {
           ...
           @Override
           public DatabaseConnection read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseConnection instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseConnection given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseConnection
  * @throws IOException if the JSON string is invalid with respect to DatabaseConnection
  */
  public static DatabaseConnection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseConnection.class);
  }

 /**
  * Convert an instance of DatabaseConnection to an JSON string
  *
  * @return JSON string
  */
