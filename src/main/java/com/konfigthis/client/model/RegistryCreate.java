...
public class RegistryCreate {
   ...
   */
  @JsonAdapter(SubscriptionTierSlugEnum.Adapter.class)
 public enum SubscriptionTierSlugEnum {
    ...
    public static class Adapter extends TypeAdapter<SubscriptionTierSlugEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SubscriptionTierSlugEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SubscriptionTierSlugEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return SubscriptionTierSlugEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_SUBSCRIPTION_TIER_SLUG = "subscription_tier_slug";
  @SerializedName(SERIALIZED_NAME_SUBSCRIPTION_TIER_SLUG)
  ...
  **/
   ...
   * @return the RegistryCreate instance itself
   */
  public RegistryCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, registryCreate.name) &&
        ...
        Objects.equals(this.additionalProperties, registryCreate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, subscriptionTierSlug, region, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("subscription_tier_slug");
    openapiFields.add("region");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("name");
    openapiRequiredFields.add("subscription_tier_slug");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegistryCreate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegistryCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegistryCreate is not found in the empty JSON string", RegistryCreate.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegistryCreate.openapiRequiredFields) {
      ...
      if (!jsonObj.get("subscription_tier_slug").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `subscription_tier_slug` to be a primitive type in the JSON string but got `%s`", jsonObj.get("subscription_tier_slug").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegistryCreate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegistryCreate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegistryCreate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegistryCreate.class));

       return (TypeAdapter<T>) new TypeAdapter<RegistryCreate>() {
           @Override
           public void write(JsonWriter out, RegistryCreate value) throws IOException {
           ...
           @Override
           public RegistryCreate read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RegistryCreate instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RegistryCreate given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RegistryCreate
  * @throws IOException if the JSON string is invalid with respect to RegistryCreate
  */
  public static RegistryCreate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegistryCreate.class);
  }

 /**
  * Convert an instance of RegistryCreate to an JSON string
  *
  * @return JSON string
  */
