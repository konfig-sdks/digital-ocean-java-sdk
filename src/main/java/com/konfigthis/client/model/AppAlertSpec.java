...
import com.konfigthis.client.model.AppAlertSpecOperator;
import com.konfigthis.client.model.AppAlertSpecRule;
import com.konfigthis.client.model.AppAlertSpecWindow;
...
public class AppAlertSpec {
  ...
  **/
   ...
   * @return the AppAlertSpec instance itself
   */
  public AppAlertSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rule, appAlertSpec.rule) &&
        Objects.equals(this.disabled, appAlertSpec.disabled) &&
        Objects.equals(this.operator, appAlertSpec.operator) &&
        Objects.equals(this.value, appAlertSpec.value) &&
        Objects.equals(this.window, appAlertSpec.window)&&
        Objects.equals(this.additionalProperties, appAlertSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rule, disabled, operator, value, window, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppAlertSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppAlertSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppAlertSpec is not found in the empty JSON string", AppAlertSpec.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppAlertSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppAlertSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppAlertSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppAlertSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppAlertSpec>() {
           @Override
           public void write(JsonWriter out, AppAlertSpec value) throws IOException {
           ...
           @Override
           public AppAlertSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppAlertSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppAlertSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppAlertSpec
  * @throws IOException if the JSON string is invalid with respect to AppAlertSpec
  */
  public static AppAlertSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppAlertSpec.class);
  }

 /**
  * Convert an instance of AppAlertSpec to an JSON string
  *
  * @return JSON string
  */
