...
public class FloatingIPsAction {
 ...
 public enum TypeEnum {
  ...
  public FloatingIPsAction type(TypeEnum type) {
  ...
  **/
   ...
   * @return the FloatingIPsAction instance itself
   */
  public FloatingIPsAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FloatingIPsAction floatingIPsAction = (FloatingIPsAction) o;
    return Objects.equals(this.type, floatingIPsAction.type)&&
        Objects.equals(this.additionalProperties, floatingIPsAction.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FloatingIPsAction {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FloatingIPsAction
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FloatingIPsAction.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FloatingIPsAction is not found in the empty JSON string", FloatingIPsAction.openapiRequiredFields.toString()));
        }
      }
      ...
      switch (discriminatorValue) {
        case "assign":
          FloatingIpActionAssign.validateJsonObject(jsonObj);
          break;
        case "floating_ip_action_assign":
          FloatingIpActionAssign.validateJsonObject(jsonObj);
          break;
        case "floating_ip_action_unassign":
          FloatingIpActionUnassign.validateJsonObject(jsonObj);
          break;
        case "unassign":
          FloatingIpActionUnassign.validateJsonObject(jsonObj);
          break;
 ...
 /**
  * Create an instance of FloatingIPsAction given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FloatingIPsAction
  * @throws IOException if the JSON string is invalid with respect to FloatingIPsAction
  */
  public static FloatingIPsAction fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FloatingIPsAction.class);
  }

 /**
  * Convert an instance of FloatingIPsAction to an JSON string
  *
  * @return JSON string
  */
