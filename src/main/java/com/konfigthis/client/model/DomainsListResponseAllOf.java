...
public class DomainsListResponseAllOf {
  public static final String SERIALIZED_NAME_DOMAINS = "domains";
  @SerializedName(SERIALIZED_NAME_DOMAINS)
  private List<Domain> domains = new ArrayList<>();

  public DomainsListResponseAllOf() {
  }

  public DomainsListResponseAllOf domains(List<Domain> domains) {
  ...
  public DomainsListResponseAllOf addDomainsItem(Domain domainsItem) {
  ...
  **/
   ...
   * @return the DomainsListResponseAllOf instance itself
   */
  public DomainsListResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DomainsListResponseAllOf domainsListResponseAllOf = (DomainsListResponseAllOf) o;
    return Objects.equals(this.domains, domainsListResponseAllOf.domains)&&
        Objects.equals(this.additionalProperties, domainsListResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainsListResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainsListResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainsListResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainsListResponseAllOf is not found in the empty JSON string", DomainsListResponseAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainsListResponseAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainsListResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainsListResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainsListResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainsListResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainsListResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DomainsListResponseAllOf value) throws IOException {
           ...
           @Override
           public DomainsListResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainsListResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainsListResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainsListResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DomainsListResponseAllOf
  */
  public static DomainsListResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainsListResponseAllOf.class);
  }

 /**
  * Convert an instance of DomainsListResponseAllOf to an JSON string
  *
  * @return JSON string
  */
