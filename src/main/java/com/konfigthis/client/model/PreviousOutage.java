...
public class PreviousOutage {
  ...
  public PreviousOutage region(String region) {
  ...
  **/
  ...
  @ApiModelProperty(example = "us_east", value = "")
  ...
  public PreviousOutage startedAt(String startedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-03-17T18:04:55Z", value = "")
  ...
  public PreviousOutage endedAt(String endedAt) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2022-03-17T18:06:55Z", value = "")
  ...
  public PreviousOutage durationSeconds(Integer durationSeconds) {
  ...
  **/
   ...
   * @return the PreviousOutage instance itself
   */
  public PreviousOutage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PreviousOutage previousOutage = (PreviousOutage) o;
    return Objects.equals(this.region, previousOutage.region) &&
        Objects.equals(this.startedAt, previousOutage.startedAt) &&
        Objects.equals(this.endedAt, previousOutage.endedAt) &&
        Objects.equals(this.durationSeconds, previousOutage.durationSeconds)&&
        Objects.equals(this.additionalProperties, previousOutage.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, startedAt, endedAt, durationSeconds, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PreviousOutage {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PreviousOutage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PreviousOutage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PreviousOutage is not found in the empty JSON string", PreviousOutage.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PreviousOutage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PreviousOutage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PreviousOutage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PreviousOutage.class));

       return (TypeAdapter<T>) new TypeAdapter<PreviousOutage>() {
           @Override
           public void write(JsonWriter out, PreviousOutage value) throws IOException {
           ...
           @Override
           public PreviousOutage read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PreviousOutage instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PreviousOutage given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PreviousOutage
  * @throws IOException if the JSON string is invalid with respect to PreviousOutage
  */
  public static PreviousOutage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PreviousOutage.class);
  }

 /**
  * Convert an instance of PreviousOutage to an JSON string
  *
  * @return JSON string
  */
