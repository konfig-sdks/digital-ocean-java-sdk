...
public class DatabaseClusterMaintenanceWindow {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "840", required = true, value = "The hour in UTC at which maintenance updates will be applied in 24 hour format.")
  ...
  **/
   ...
   * @return the DatabaseClusterMaintenanceWindow instance itself
   */
  public DatabaseClusterMaintenanceWindow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, databaseClusterMaintenanceWindow.description) &&
        Objects.equals(this.day, databaseClusterMaintenanceWindow.day) &&
        ...
        Objects.equals(this.additionalProperties, databaseClusterMaintenanceWindow.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseClusterMaintenanceWindow
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseClusterMaintenanceWindow.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseClusterMaintenanceWindow is not found in the empty JSON string", DatabaseClusterMaintenanceWindow.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseClusterMaintenanceWindow.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseClusterMaintenanceWindow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseClusterMaintenanceWindow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseClusterMaintenanceWindow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseClusterMaintenanceWindow.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseClusterMaintenanceWindow>() {
           @Override
           public void write(JsonWriter out, DatabaseClusterMaintenanceWindow value) throws IOException {
           ...
           @Override
           public DatabaseClusterMaintenanceWindow read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseClusterMaintenanceWindow instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseClusterMaintenanceWindow given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseClusterMaintenanceWindow
  * @throws IOException if the JSON string is invalid with respect to DatabaseClusterMaintenanceWindow
  */
  public static DatabaseClusterMaintenanceWindow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseClusterMaintenanceWindow.class);
  }

 /**
  * Convert an instance of DatabaseClusterMaintenanceWindow to an JSON string
  *
  * @return JSON string
  */
