...
public class ClusterRegistries {
  public static final String SERIALIZED_NAME_CLUSTER_UUIDS = "cluster_uuids";
  @SerializedName(SERIALIZED_NAME_CLUSTER_UUIDS)
  ...
  **/
   ...
   * @return the ClusterRegistries instance itself
   */
  public ClusterRegistries putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clusterUuids, clusterRegistries.clusterUuids)&&
        Objects.equals(this.additionalProperties, clusterRegistries.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterUuids, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("cluster_uuids");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ClusterRegistries
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ClusterRegistries.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterRegistries is not found in the empty JSON string", ClusterRegistries.openapiRequiredFields.toString()));
        }
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("cluster_uuids") != null && !jsonObj.get("cluster_uuids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `cluster_uuids` to be an array in the JSON string but got `%s`", jsonObj.get("cluster_uuids").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterRegistries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterRegistries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ClusterRegistries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ClusterRegistries.class));

       return (TypeAdapter<T>) new TypeAdapter<ClusterRegistries>() {
           @Override
           public void write(JsonWriter out, ClusterRegistries value) throws IOException {
           ...
           @Override
           public ClusterRegistries read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ClusterRegistries instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ClusterRegistries given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ClusterRegistries
  * @throws IOException if the JSON string is invalid with respect to ClusterRegistries
  */
  public static ClusterRegistries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ClusterRegistries.class);
  }

 /**
  * Convert an instance of ClusterRegistries to an JSON string
  *
  * @return JSON string
  */
