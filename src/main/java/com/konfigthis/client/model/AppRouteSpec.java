...
public class AppRouteSpec {
  ...
  **/
  ...
  @ApiModelProperty(example = "/api", value = "(Deprecated - Use Ingress Rules instead). An HTTP path prefix. Paths must start with / and must be unique across all components within an app.")
  ...
  **/
   ...
   * @return the AppRouteSpec instance itself
   */
  public AppRouteSpec putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, appRouteSpec.path) &&
        ...
        Objects.equals(this.additionalProperties, appRouteSpec.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(path, preservePathPrefix, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppRouteSpec
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppRouteSpec.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppRouteSpec is not found in the empty JSON string", AppRouteSpec.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppRouteSpec.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppRouteSpec' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppRouteSpec> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppRouteSpec.class));

       return (TypeAdapter<T>) new TypeAdapter<AppRouteSpec>() {
           @Override
           public void write(JsonWriter out, AppRouteSpec value) throws IOException {
           ...
           @Override
           public AppRouteSpec read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppRouteSpec instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppRouteSpec given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppRouteSpec
  * @throws IOException if the JSON string is invalid with respect to AppRouteSpec
  */
  public static AppRouteSpec fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppRouteSpec.class);
  }

 /**
  * Convert an instance of AppRouteSpec to an JSON string
  *
  * @return JSON string
  */
