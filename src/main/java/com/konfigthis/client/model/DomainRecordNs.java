...
public class DomainRecordNs {
  ...
  **/
   ...
   * @return the DomainRecordNs instance itself
   */
  public DomainRecordNs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, domainRecordNs.id) &&
        Objects.equals(this.type, domainRecordNs.type) &&
        Objects.equals(this.name, domainRecordNs.name) &&
        Objects.equals(this.data, domainRecordNs.data) &&
        Objects.equals(this.priority, domainRecordNs.priority) &&
        Objects.equals(this.port, domainRecordNs.port) &&
        Objects.equals(this.ttl, domainRecordNs.ttl) &&
        Objects.equals(this.weight, domainRecordNs.weight) &&
        Objects.equals(this.flags, domainRecordNs.flags) &&
        Objects.equals(this.tag, domainRecordNs.tag)&&
        Objects.equals(this.additionalProperties, domainRecordNs.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainRecordNs
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainRecordNs.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainRecordNs is not found in the empty JSON string", DomainRecordNs.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainRecordNs.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainRecordNs.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainRecordNs' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainRecordNs> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainRecordNs.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainRecordNs>() {
           @Override
           public void write(JsonWriter out, DomainRecordNs value) throws IOException {
           ...
           @Override
           public DomainRecordNs read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainRecordNs instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainRecordNs given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainRecordNs
  * @throws IOException if the JSON string is invalid with respect to DomainRecordNs
  */
  public static DomainRecordNs fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainRecordNs.class);
  }

 /**
  * Convert an instance of DomainRecordNs to an JSON string
  *
  * @return JSON string
  */
