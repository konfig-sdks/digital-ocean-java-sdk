...
import com.konfigthis.client.model.RepositoryBlob;
...
public class RepositoryManifest {
  ...
  public static final String SERIALIZED_NAME_COMPRESSED_SIZE_BYTES = "compressed_size_bytes";
  ...
  **/
   ...
   * @return the RepositoryManifest instance itself
   */
  public RepositoryManifest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, repositoryManifest.tags) &&
        Objects.equals(this.registryName, repositoryManifest.registryName) &&
        ...
        Objects.equals(this.additionalProperties, repositoryManifest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, registryName, repository, digest, compressedSizeBytes, sizeBytes, updatedAt, blobs, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("compressed_size_bytes");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepositoryManifest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepositoryManifest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepositoryManifest is not found in the empty JSON string", RepositoryManifest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("blobs") != null && !jsonObj.get("blobs").isJsonNull()) {
        ...
        if (jsonArrayblobs != null) {
          ...
          for (int i = 0; i < jsonArrayblobs.size(); i++) {
            RepositoryBlob.validateJsonObject(jsonArrayblobs.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepositoryManifest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepositoryManifest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepositoryManifest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepositoryManifest.class));

       return (TypeAdapter<T>) new TypeAdapter<RepositoryManifest>() {
           @Override
           public void write(JsonWriter out, RepositoryManifest value) throws IOException {
           ...
           @Override
           public RepositoryManifest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RepositoryManifest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RepositoryManifest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepositoryManifest
  * @throws IOException if the JSON string is invalid with respect to RepositoryManifest
  */
  public static RepositoryManifest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepositoryManifest.class);
  }

 /**
  * Convert an instance of RepositoryManifest to an JSON string
  *
  * @return JSON string
  */
