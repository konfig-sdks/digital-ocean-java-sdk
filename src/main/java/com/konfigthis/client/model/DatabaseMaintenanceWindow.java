...
public class DatabaseMaintenanceWindow {
  ...
  **/
   ...
   * @return the DatabaseMaintenanceWindow instance itself
   */
  public DatabaseMaintenanceWindow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, databaseMaintenanceWindow.description) &&
        Objects.equals(this.day, databaseMaintenanceWindow.day) &&
        Objects.equals(this.hour, databaseMaintenanceWindow.hour) &&
        Objects.equals(this.pending, databaseMaintenanceWindow.pending)&&
        Objects.equals(this.additionalProperties, databaseMaintenanceWindow.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabaseMaintenanceWindow
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabaseMaintenanceWindow.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabaseMaintenanceWindow is not found in the empty JSON string", DatabaseMaintenanceWindow.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DatabaseMaintenanceWindow.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabaseMaintenanceWindow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabaseMaintenanceWindow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabaseMaintenanceWindow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabaseMaintenanceWindow.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabaseMaintenanceWindow>() {
           @Override
           public void write(JsonWriter out, DatabaseMaintenanceWindow value) throws IOException {
           ...
           @Override
           public DatabaseMaintenanceWindow read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabaseMaintenanceWindow instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabaseMaintenanceWindow given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabaseMaintenanceWindow
  * @throws IOException if the JSON string is invalid with respect to DatabaseMaintenanceWindow
  */
  public static DatabaseMaintenanceWindow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabaseMaintenanceWindow.class);
  }

 /**
  * Convert an instance of DatabaseMaintenanceWindow to an JSON string
  *
  * @return JSON string
  */
