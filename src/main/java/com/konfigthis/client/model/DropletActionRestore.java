...
public class DropletActionRestore {
  ...
  **/
   ...
   * @return the DropletActionRestore instance itself
   */
  public DropletActionRestore putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, dropletActionRestore.type) &&
        ...
        Objects.equals(this.additionalProperties, dropletActionRestore.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionRestore
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionRestore.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionRestore is not found in the empty JSON string", DropletActionRestore.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletActionRestore.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionRestore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionRestore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionRestore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionRestore.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionRestore>() {
           @Override
           public void write(JsonWriter out, DropletActionRestore value) throws IOException {
           ...
           @Override
           public DropletActionRestore read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionRestore instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionRestore given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionRestore
  * @throws IOException if the JSON string is invalid with respect to DropletActionRestore
  */
  public static DropletActionRestore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionRestore.class);
  }

 /**
  * Convert an instance of DropletActionRestore to an JSON string
  *
  * @return JSON string
  */
