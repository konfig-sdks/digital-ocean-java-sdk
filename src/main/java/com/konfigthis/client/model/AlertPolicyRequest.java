...
public class AlertPolicyRequest {
   ...
   */
  @JsonAdapter(CompareEnum.Adapter.class)
 public enum CompareEnum {
    ...
    public static class Adapter extends TypeAdapter<CompareEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final CompareEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public CompareEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return CompareEnum.fromValue(value);
      }
    }
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "V1_INSIGHTS_DROPLET_CPU", required = true, value = "")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "_5M", required = true, value = "")
   ...
   * @return the AlertPolicyRequest instance itself
   */
  public AlertPolicyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, alertPolicyRequest.tags) &&
        Objects.equals(this.description, alertPolicyRequest.description) &&
        Objects.equals(this.alerts, alertPolicyRequest.alerts) &&
        ...
        Objects.equals(this.additionalProperties, alertPolicyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, description, alerts, compare, enabled, entities, type, value, window, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlertPolicyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlertPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlertPolicyRequest is not found in the empty JSON string", AlertPolicyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlertPolicyRequest.openapiRequiredFields) {
      ...
      Alerts.validateJsonObject(jsonObj.getAsJsonObject("alerts"));
      ...
      if (!jsonObj.get("window").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlertPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlertPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlertPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlertPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AlertPolicyRequest>() {
           @Override
           public void write(JsonWriter out, AlertPolicyRequest value) throws IOException {
           ...
           @Override
           public AlertPolicyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AlertPolicyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AlertPolicyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlertPolicyRequest
  * @throws IOException if the JSON string is invalid with respect to AlertPolicyRequest
  */
  public static AlertPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlertPolicyRequest.class);
  }

 /**
  * Convert an instance of AlertPolicyRequest to an JSON string
  *
  * @return JSON string
  */
