...
public class KafkaTopicAllOf {
 ...
 public enum StateEnum {
  ...
  public KafkaTopicAllOf() {
  }

  public KafkaTopicAllOf state(StateEnum state) {
  ...
  **/
   ...
   * @return the KafkaTopicAllOf instance itself
   */
  public KafkaTopicAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KafkaTopicAllOf kafkaTopicAllOf = (KafkaTopicAllOf) o;
    return Objects.equals(this.state, kafkaTopicAllOf.state)&&
        Objects.equals(this.additionalProperties, kafkaTopicAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class KafkaTopicAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to KafkaTopicAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KafkaTopicAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KafkaTopicAllOf is not found in the empty JSON string", KafkaTopicAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KafkaTopicAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KafkaTopicAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KafkaTopicAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KafkaTopicAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<KafkaTopicAllOf>() {
           @Override
           public void write(JsonWriter out, KafkaTopicAllOf value) throws IOException {
           ...
           @Override
           public KafkaTopicAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KafkaTopicAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KafkaTopicAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KafkaTopicAllOf
  * @throws IOException if the JSON string is invalid with respect to KafkaTopicAllOf
  */
  public static KafkaTopicAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KafkaTopicAllOf.class);
  }

 /**
  * Convert an instance of KafkaTopicAllOf to an JSON string
  *
  * @return JSON string
  */
