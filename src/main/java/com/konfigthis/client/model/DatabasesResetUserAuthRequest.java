...
public class DatabasesResetUserAuthRequest {
  ...
  public DatabasesResetUserAuthRequest() {
  }

  public DatabasesResetUserAuthRequest mysqlSettings(MysqlSettings mysqlSettings) {
  ...
  **/
   ...
   * @return the DatabasesResetUserAuthRequest instance itself
   */
  public DatabasesResetUserAuthRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabasesResetUserAuthRequest databasesResetUserAuthRequest = (DatabasesResetUserAuthRequest) o;
    return Objects.equals(this.mysqlSettings, databasesResetUserAuthRequest.mysqlSettings)&&
        Objects.equals(this.additionalProperties, databasesResetUserAuthRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mysqlSettings, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabasesResetUserAuthRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabasesResetUserAuthRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabasesResetUserAuthRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasesResetUserAuthRequest is not found in the empty JSON string", DatabasesResetUserAuthRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasesResetUserAuthRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasesResetUserAuthRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasesResetUserAuthRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasesResetUserAuthRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasesResetUserAuthRequest>() {
           @Override
           public void write(JsonWriter out, DatabasesResetUserAuthRequest value) throws IOException {
           ...
           @Override
           public DatabasesResetUserAuthRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabasesResetUserAuthRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabasesResetUserAuthRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabasesResetUserAuthRequest
  * @throws IOException if the JSON string is invalid with respect to DatabasesResetUserAuthRequest
  */
  public static DatabasesResetUserAuthRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasesResetUserAuthRequest.class);
  }

 /**
  * Convert an instance of DatabasesResetUserAuthRequest to an JSON string
  *
  * @return JSON string
  */
