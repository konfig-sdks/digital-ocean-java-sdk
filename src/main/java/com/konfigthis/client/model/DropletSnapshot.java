...
public class DropletSnapshot {
  ...
  **/
   ...
   * @return the DropletSnapshot instance itself
   */
  public DropletSnapshot putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, dropletSnapshot.id) &&
        Objects.equals(this.name, dropletSnapshot.name) &&
        ...
        Objects.equals(this.additionalProperties, dropletSnapshot.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, createdAt, regions, minDiskSize, sizeGigabytes, type, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletSnapshot
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletSnapshot.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletSnapshot is not found in the empty JSON string", DropletSnapshot.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DropletSnapshot.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletSnapshot.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletSnapshot' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletSnapshot> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletSnapshot.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletSnapshot>() {
           @Override
           public void write(JsonWriter out, DropletSnapshot value) throws IOException {
           ...
           @Override
           public DropletSnapshot read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletSnapshot instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletSnapshot given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletSnapshot
  * @throws IOException if the JSON string is invalid with respect to DropletSnapshot
  */
  public static DropletSnapshot fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletSnapshot.class);
  }

 /**
  * Convert an instance of DropletSnapshot to an JSON string
  *
  * @return JSON string
  */
