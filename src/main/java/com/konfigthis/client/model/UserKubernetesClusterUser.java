...
public class UserKubernetesClusterUser {
  ...
  **/
   ...
   * @return the UserKubernetesClusterUser instance itself
   */
  public UserKubernetesClusterUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.username, userKubernetesClusterUser.username) &&
        ...
        Objects.equals(this.additionalProperties, userKubernetesClusterUser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(username, groups, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserKubernetesClusterUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserKubernetesClusterUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserKubernetesClusterUser is not found in the empty JSON string", UserKubernetesClusterUser.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserKubernetesClusterUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserKubernetesClusterUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserKubernetesClusterUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserKubernetesClusterUser.class));

       return (TypeAdapter<T>) new TypeAdapter<UserKubernetesClusterUser>() {
           @Override
           public void write(JsonWriter out, UserKubernetesClusterUser value) throws IOException {
           ...
           @Override
           public UserKubernetesClusterUser read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserKubernetesClusterUser instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserKubernetesClusterUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserKubernetesClusterUser
  * @throws IOException if the JSON string is invalid with respect to UserKubernetesClusterUser
  */
  public static UserKubernetesClusterUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserKubernetesClusterUser.class);
  }

 /**
  * Convert an instance of UserKubernetesClusterUser to an JSON string
  *
  * @return JSON string
  */
