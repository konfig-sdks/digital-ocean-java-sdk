...
public class ImageActionTransferAllOf {
  ...
  **/
   ...
   * @return the ImageActionTransferAllOf instance itself
   */
  public ImageActionTransferAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.region, imageActionTransferAllOf.region)&&
        Objects.equals(this.additionalProperties, imageActionTransferAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ImageActionTransferAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ImageActionTransferAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImageActionTransferAllOf is not found in the empty JSON string", ImageActionTransferAllOf.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ImageActionTransferAllOf.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImageActionTransferAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImageActionTransferAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImageActionTransferAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImageActionTransferAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ImageActionTransferAllOf>() {
           @Override
           public void write(JsonWriter out, ImageActionTransferAllOf value) throws IOException {
           ...
           @Override
           public ImageActionTransferAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ImageActionTransferAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ImageActionTransferAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ImageActionTransferAllOf
  * @throws IOException if the JSON string is invalid with respect to ImageActionTransferAllOf
  */
  public static ImageActionTransferAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImageActionTransferAllOf.class);
  }

 /**
  * Convert an instance of ImageActionTransferAllOf to an JSON string
  *
  * @return JSON string
  */
