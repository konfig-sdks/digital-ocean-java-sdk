...
public class Certificate {
  ...
  **/
   ...
   * @return the Certificate instance itself
   */
  public Certificate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, certificate.id) &&
        ...
        Objects.equals(this.additionalProperties, certificate.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, notAfter, sha1Fingerprint, createdAt, dnsNames, state, type, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Certificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("dns_names") != null && !jsonObj.get("dns_names").isJsonArray()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Certificate>() {
           ...
           public Certificate read(JsonReader in) throws IOException {
             ...
             Certificate instance = thisAdapter.fromJsonTree(jsonObj);
