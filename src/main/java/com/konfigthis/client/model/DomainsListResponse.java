...
public class DomainsListResponse {
  ...
  public DomainsListResponse domains(List<Domain> domains) {
  ...
  public DomainsListResponse addDomainsItem(Domain domainsItem) {
  ...
  **/
  ...
  public DomainsListResponse links(PageLinks links) {
  ...
  **/
  ...
  public DomainsListResponse meta(MetaMeta meta) {
  ...
  **/
   ...
   * @return the DomainsListResponse instance itself
   */
  public DomainsListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DomainsListResponse domainsListResponse = (DomainsListResponse) o;
    return Objects.equals(this.domains, domainsListResponse.domains) &&
        Objects.equals(this.links, domainsListResponse.links) &&
        Objects.equals(this.meta, domainsListResponse.meta)&&
        Objects.equals(this.additionalProperties, domainsListResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domains, links, meta, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DomainsListResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DomainsListResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DomainsListResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DomainsListResponse is not found in the empty JSON string", DomainsListResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DomainsListResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainsListResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainsListResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainsListResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainsListResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainsListResponse>() {
           @Override
           public void write(JsonWriter out, DomainsListResponse value) throws IOException {
           ...
           @Override
           public DomainsListResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DomainsListResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DomainsListResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DomainsListResponse
  * @throws IOException if the JSON string is invalid with respect to DomainsListResponse
  */
  public static DomainsListResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainsListResponse.class);
  }

 /**
  * Convert an instance of DomainsListResponse to an JSON string
  *
  * @return JSON string
  */
