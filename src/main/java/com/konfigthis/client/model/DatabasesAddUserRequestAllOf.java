...
public class DatabasesAddUserRequestAllOf {
  public static final String SERIALIZED_NAME_READONLY = "readonly";
  @SerializedName(SERIALIZED_NAME_READONLY)
  private Boolean readonly;

  public DatabasesAddUserRequestAllOf() {
  }

  public DatabasesAddUserRequestAllOf readonly(Boolean readonly) {
  ...
  **/
   ...
   * @return the DatabasesAddUserRequestAllOf instance itself
   */
  public DatabasesAddUserRequestAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DatabasesAddUserRequestAllOf databasesAddUserRequestAllOf = (DatabasesAddUserRequestAllOf) o;
    return Objects.equals(this.readonly, databasesAddUserRequestAllOf.readonly)&&
        Objects.equals(this.additionalProperties, databasesAddUserRequestAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(readonly, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DatabasesAddUserRequestAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DatabasesAddUserRequestAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DatabasesAddUserRequestAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DatabasesAddUserRequestAllOf is not found in the empty JSON string", DatabasesAddUserRequestAllOf.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DatabasesAddUserRequestAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DatabasesAddUserRequestAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DatabasesAddUserRequestAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DatabasesAddUserRequestAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DatabasesAddUserRequestAllOf>() {
           @Override
           public void write(JsonWriter out, DatabasesAddUserRequestAllOf value) throws IOException {
           ...
           @Override
           public DatabasesAddUserRequestAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DatabasesAddUserRequestAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DatabasesAddUserRequestAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DatabasesAddUserRequestAllOf
  * @throws IOException if the JSON string is invalid with respect to DatabasesAddUserRequestAllOf
  */
  public static DatabasesAddUserRequestAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DatabasesAddUserRequestAllOf.class);
  }

 /**
  * Convert an instance of DatabasesAddUserRequestAllOf to an JSON string
  *
  * @return JSON string
  */
