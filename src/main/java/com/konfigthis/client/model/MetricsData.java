...
import com.konfigthis.client.model.MetricsResult;
...
public class MetricsData {
  ...
  **/
   ...
   * @return the MetricsData instance itself
   */
  public MetricsData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, metricsData.result) &&
        ...
        Objects.equals(this.additionalProperties, metricsData.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(result, resultType, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetricsData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (int i = 0; i < jsonArrayresult.size(); i++) {
        MetricsResult.validateJsonObject(jsonArrayresult.get(i).getAsJsonObject());
      };
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetricsData>() {
           ...
           public MetricsData read(JsonReader in) throws IOException {
             ...
             MetricsData instance = thisAdapter.fromJsonTree(jsonObj);
