...
public class DropletActionRestoreAllOf {
  ...
  **/
   ...
   * @return the DropletActionRestoreAllOf instance itself
   */
  public DropletActionRestoreAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.image, dropletActionRestoreAllOf.image)&&
        Objects.equals(this.additionalProperties, dropletActionRestoreAllOf.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to DropletActionRestoreAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DropletActionRestoreAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DropletActionRestoreAllOf is not found in the empty JSON string", DropletActionRestoreAllOf.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DropletActionRestoreAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DropletActionRestoreAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DropletActionRestoreAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DropletActionRestoreAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DropletActionRestoreAllOf>() {
           @Override
           public void write(JsonWriter out, DropletActionRestoreAllOf value) throws IOException {
           ...
           @Override
           public DropletActionRestoreAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DropletActionRestoreAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DropletActionRestoreAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DropletActionRestoreAllOf
  * @throws IOException if the JSON string is invalid with respect to DropletActionRestoreAllOf
  */
  public static DropletActionRestoreAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DropletActionRestoreAllOf.class);
  }

 /**
  * Convert an instance of DropletActionRestoreAllOf to an JSON string
  *
  * @return JSON string
  */
