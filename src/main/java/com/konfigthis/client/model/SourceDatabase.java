...
public class SourceDatabase {
  ...
  public static final String SERIALIZED_NAME_DISABLE_SSL = "disable_ssl";
  @SerializedName(SERIALIZED_NAME_DISABLE_SSL)
  private Boolean disableSsl;

  public static final String SERIALIZED_NAME_IGNORE_DBS = "ignore_dbs";
  @SerializedName(SERIALIZED_NAME_IGNORE_DBS)
  private List<String> ignoreDbs = null;
  ...
  **/
  ...
  public SourceDatabase ignoreDbs(List<String> ignoreDbs) {
  ...
  public SourceDatabase addIgnoreDbsItem(String ignoreDbsItem) {
    if (this.ignoreDbs == null) {
      this.ignoreDbs = new ArrayList<>();
    }
    this.ignoreDbs.add(ignoreDbsItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"db0\",\"db1\"]", value = "List of databases that should be ignored during migration.")

  public List<String> getIgnoreDbs() {
    return ignoreDbs;
  }


  public void setIgnoreDbs(List<String> ignoreDbs) {
   ...
   * @return the SourceDatabase instance itself
   */
  public SourceDatabase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.source, sourceDatabase.source) &&
        ...
        Objects.equals(this.ignoreDbs, sourceDatabase.ignoreDbs)&&
        Objects.equals(this.additionalProperties, sourceDatabase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(source, disableSsl, ignoreDbs, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("disable_ssl");
    openapiFields.add("ignore_dbs");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SourceDatabase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SourceDatabase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SourceDatabase is not found in the empty JSON string", SourceDatabase.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `source`
      if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
        SourceDatabaseSource.validateJsonObject(jsonObj.getAsJsonObject("source"));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("ignore_dbs") != null && !jsonObj.get("ignore_dbs").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `ignore_dbs` to be an array in the JSON string but got `%s`", jsonObj.get("ignore_dbs").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SourceDatabase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SourceDatabase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SourceDatabase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SourceDatabase.class));

       return (TypeAdapter<T>) new TypeAdapter<SourceDatabase>() {
           @Override
           public void write(JsonWriter out, SourceDatabase value) throws IOException {
           ...
           @Override
           public SourceDatabase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SourceDatabase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SourceDatabase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SourceDatabase
  * @throws IOException if the JSON string is invalid with respect to SourceDatabase
  */
  public static SourceDatabase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SourceDatabase.class);
  }

 /**
  * Convert an instance of SourceDatabase to an JSON string
  *
  * @return JSON string
  */
