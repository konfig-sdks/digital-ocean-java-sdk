...
import com.konfigthis.client.model.LoadBalancersGetResponseLoadBalancerFirewall;
import com.konfigthis.client.model.LoadBalancersGetResponseLoadBalancerForwardingRulesInner;
import com.konfigthis.client.model.LoadBalancersGetResponseLoadBalancerHealthCheck;
import com.konfigthis.client.model.LoadBalancersGetResponseLoadBalancerRegion;
import com.konfigthis.client.model.LoadBalancersGetResponseLoadBalancerStickySessions;
...
public class LoadBalancersGetResponseLoadBalancer {
  ...
  private List<LoadBalancersGetResponseLoadBalancerForwardingRulesInner> forwardingRules = null;

  public static final String SERIALIZED_NAME_HEALTH_CHECK = "health_check";
  @SerializedName(SERIALIZED_NAME_HEALTH_CHECK)
  private LoadBalancersGetResponseLoadBalancerHealthCheck healthCheck;

  public static final String SERIALIZED_NAME_STICKY_SESSIONS = "sticky_sessions";
  @SerializedName(SERIALIZED_NAME_STICKY_SESSIONS)
  private LoadBalancersGetResponseLoadBalancerStickySessions stickySessions;

  public static final String SERIALIZED_NAME_REGION = "region";
  @SerializedName(SERIALIZED_NAME_REGION)
  private LoadBalancersGetResponseLoadBalancerRegion region;
  ...
  private LoadBalancersGetResponseLoadBalancerFirewall firewall;

  public LoadBalancersGetResponseLoadBalancer() {
  }

  public LoadBalancersGetResponseLoadBalancer id(String id) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer name(String name) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer ip(String ip) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer size(String size) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer algorithm(String algorithm) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer status(String status) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer createdAt(String createdAt) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer forwardingRules(List<LoadBalancersGetResponseLoadBalancerForwardingRulesInner> forwardingRules) {
  ...
  public LoadBalancersGetResponseLoadBalancer addForwardingRulesItem(LoadBalancersGetResponseLoadBalancerForwardingRulesInner forwardingRulesItem) {
  ...
  **/
  ...
  public List<LoadBalancersGetResponseLoadBalancerForwardingRulesInner> getForwardingRules() {
    return forwardingRules;
  }


  public void setForwardingRules(List<LoadBalancersGetResponseLoadBalancerForwardingRulesInner> forwardingRules) {
  ...
  public LoadBalancersGetResponseLoadBalancer healthCheck(LoadBalancersGetResponseLoadBalancerHealthCheck healthCheck) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancerHealthCheck getHealthCheck() {
    return healthCheck;
  }


  public void setHealthCheck(LoadBalancersGetResponseLoadBalancerHealthCheck healthCheck) {
  ...
  public LoadBalancersGetResponseLoadBalancer stickySessions(LoadBalancersGetResponseLoadBalancerStickySessions stickySessions) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancerStickySessions getStickySessions() {
    return stickySessions;
  }


  public void setStickySessions(LoadBalancersGetResponseLoadBalancerStickySessions stickySessions) {
  ...
  public LoadBalancersGetResponseLoadBalancer region(LoadBalancersGetResponseLoadBalancerRegion region) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancerRegion getRegion() {
    return region;
  }


  public void setRegion(LoadBalancersGetResponseLoadBalancerRegion region) {
  ...
  public LoadBalancersGetResponseLoadBalancer tag(String tag) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer dropletIds(List<Double> dropletIds) {
  ...
  public LoadBalancersGetResponseLoadBalancer addDropletIdsItem(Double dropletIdsItem) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer redirectHttpToHttps(Boolean redirectHttpToHttps) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer enableProxyProtocol(Boolean enableProxyProtocol) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer enableBackendKeepalive(Boolean enableBackendKeepalive) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer vpcUuid(String vpcUuid) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer disableLetsEncryptDnsRecords(Boolean disableLetsEncryptDnsRecords) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer projectId(String projectId) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer httpIdleTimeoutSeconds(Double httpIdleTimeoutSeconds) {
  ...
  public LoadBalancersGetResponseLoadBalancer httpIdleTimeoutSeconds(Integer httpIdleTimeoutSeconds) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancer firewall(LoadBalancersGetResponseLoadBalancerFirewall firewall) {
  ...
  **/
  ...
  public LoadBalancersGetResponseLoadBalancerFirewall getFirewall() {
    return firewall;
  }


  public void setFirewall(LoadBalancersGetResponseLoadBalancerFirewall firewall) {
   ...
   * @return the LoadBalancersGetResponseLoadBalancer instance itself
   */
  public LoadBalancersGetResponseLoadBalancer putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LoadBalancersGetResponseLoadBalancer loadBalancersGetResponseLoadBalancer = (LoadBalancersGetResponseLoadBalancer) o;
    return Objects.equals(this.id, loadBalancersGetResponseLoadBalancer.id) &&
        Objects.equals(this.name, loadBalancersGetResponseLoadBalancer.name) &&
        Objects.equals(this.ip, loadBalancersGetResponseLoadBalancer.ip) &&
        Objects.equals(this.size, loadBalancersGetResponseLoadBalancer.size) &&
        Objects.equals(this.algorithm, loadBalancersGetResponseLoadBalancer.algorithm) &&
        Objects.equals(this.status, loadBalancersGetResponseLoadBalancer.status) &&
        Objects.equals(this.createdAt, loadBalancersGetResponseLoadBalancer.createdAt) &&
        Objects.equals(this.forwardingRules, loadBalancersGetResponseLoadBalancer.forwardingRules) &&
        Objects.equals(this.healthCheck, loadBalancersGetResponseLoadBalancer.healthCheck) &&
        Objects.equals(this.stickySessions, loadBalancersGetResponseLoadBalancer.stickySessions) &&
        Objects.equals(this.region, loadBalancersGetResponseLoadBalancer.region) &&
        Objects.equals(this.tag, loadBalancersGetResponseLoadBalancer.tag) &&
        Objects.equals(this.dropletIds, loadBalancersGetResponseLoadBalancer.dropletIds) &&
        Objects.equals(this.redirectHttpToHttps, loadBalancersGetResponseLoadBalancer.redirectHttpToHttps) &&
        Objects.equals(this.enableProxyProtocol, loadBalancersGetResponseLoadBalancer.enableProxyProtocol) &&
        Objects.equals(this.enableBackendKeepalive, loadBalancersGetResponseLoadBalancer.enableBackendKeepalive) &&
        Objects.equals(this.vpcUuid, loadBalancersGetResponseLoadBalancer.vpcUuid) &&
        Objects.equals(this.disableLetsEncryptDnsRecords, loadBalancersGetResponseLoadBalancer.disableLetsEncryptDnsRecords) &&
        Objects.equals(this.projectId, loadBalancersGetResponseLoadBalancer.projectId) &&
        Objects.equals(this.httpIdleTimeoutSeconds, loadBalancersGetResponseLoadBalancer.httpIdleTimeoutSeconds) &&
        Objects.equals(this.firewall, loadBalancersGetResponseLoadBalancer.firewall)&&
        Objects.equals(this.additionalProperties, loadBalancersGetResponseLoadBalancer.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadBalancersGetResponseLoadBalancer {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LoadBalancersGetResponseLoadBalancer
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LoadBalancersGetResponseLoadBalancer.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LoadBalancersGetResponseLoadBalancer is not found in the empty JSON string", LoadBalancersGetResponseLoadBalancer.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("forwarding_rules") != null && !jsonObj.get("forwarding_rules").isJsonNull()) {
        ...
        if (jsonArrayforwardingRules != null) {
          ...
          for (int i = 0; i < jsonArrayforwardingRules.size(); i++) {
            LoadBalancersGetResponseLoadBalancerForwardingRulesInner.validateJsonObject(jsonArrayforwardingRules.get(i).getAsJsonObject());
          };
        }
      }
      // validate the optional field `health_check`
      if (jsonObj.get("health_check") != null && !jsonObj.get("health_check").isJsonNull()) {
        LoadBalancersGetResponseLoadBalancerHealthCheck.validateJsonObject(jsonObj.getAsJsonObject("health_check"));
      }
      // validate the optional field `sticky_sessions`
      if (jsonObj.get("sticky_sessions") != null && !jsonObj.get("sticky_sessions").isJsonNull()) {
        LoadBalancersGetResponseLoadBalancerStickySessions.validateJsonObject(jsonObj.getAsJsonObject("sticky_sessions"));
      }
      // validate the optional field `region`
      if (jsonObj.get("region") != null && !jsonObj.get("region").isJsonNull()) {
        LoadBalancersGetResponseLoadBalancerRegion.validateJsonObject(jsonObj.getAsJsonObject("region"));
      }
      ...
      if (jsonObj.get("firewall") != null && !jsonObj.get("firewall").isJsonNull()) {
        LoadBalancersGetResponseLoadBalancerFirewall.validateJsonObject(jsonObj.getAsJsonObject("firewall"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadBalancersGetResponseLoadBalancer.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadBalancersGetResponseLoadBalancer' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadBalancersGetResponseLoadBalancer> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadBalancersGetResponseLoadBalancer.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadBalancersGetResponseLoadBalancer>() {
           @Override
           public void write(JsonWriter out, LoadBalancersGetResponseLoadBalancer value) throws IOException {
           ...
           @Override
           public LoadBalancersGetResponseLoadBalancer read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LoadBalancersGetResponseLoadBalancer instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LoadBalancersGetResponseLoadBalancer given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LoadBalancersGetResponseLoadBalancer
  * @throws IOException if the JSON string is invalid with respect to LoadBalancersGetResponseLoadBalancer
  */
  public static LoadBalancersGetResponseLoadBalancer fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LoadBalancersGetResponseLoadBalancer.class);
  }

 /**
  * Convert an instance of LoadBalancersGetResponseLoadBalancer to an JSON string
  *
  * @return JSON string
  */
