...
public class NetworkV6 {
  ...
  **/
   ...
   * @return the NetworkV6 instance itself
   */
  public NetworkV6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ipAddress, networkV6.ipAddress) &&
        Objects.equals(this.netmask, networkV6.netmask) &&
        Objects.equals(this.gateway, networkV6.gateway) &&
        Objects.equals(this.type, networkV6.type)&&
        Objects.equals(this.additionalProperties, networkV6.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to NetworkV6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NetworkV6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NetworkV6 is not found in the empty JSON string", NetworkV6.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NetworkV6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NetworkV6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NetworkV6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NetworkV6.class));

       return (TypeAdapter<T>) new TypeAdapter<NetworkV6>() {
           @Override
           public void write(JsonWriter out, NetworkV6 value) throws IOException {
           ...
           @Override
           public NetworkV6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NetworkV6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NetworkV6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NetworkV6
  * @throws IOException if the JSON string is invalid with respect to NetworkV6
  */
  public static NetworkV6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NetworkV6.class);
  }

 /**
  * Convert an instance of NetworkV6 to an JSON string
  *
  * @return JSON string
  */
