...
/**
 * API tests for CdnEndpointsApi
 */
@Disabled
public class CdnEndpointsApiTest {

    private static CdnEndpointsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new CdnEndpointsApi(apiClient);
    }
     ...
     */
    @Test
    public void createNewEndpointTest() throws ApiException {
        String origin = null;
        UUID id = null;
        ...
        CdnEndpointsCreateNewEndpointResponse response = api.createNewEndpoint(origin)
                .id(id)
                .endpoint(endpoint)
                .ttl(ttl)
     ...
     */
    @Test
    public void getExistingEndpointTest() throws ApiException {
        UUID cdnId = null;
        CdnEndpointsCreateNewEndpointResponse response = api.getExistingEndpoint(cdnId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAllTest() throws ApiException {
        ...
        Integer page = null;
        CdnEndpointsListAllResponse response = api.listAll()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void purgeCacheTest() throws ApiException {
        List<String> files = null;
        UUID cdnId = null;
        api.purgeCache(files, cdnId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateEndpointTest() throws ApiException {
        ...
        UUID certificateId = null;
        String customDomain = null;
        CdnEndpointsCreateNewEndpointResponse response = api.updateEndpoint(cdnId)
                .ttl(ttl)
                .certificateId(certificateId)
                .customDomain(customDomain)
                .execute();
