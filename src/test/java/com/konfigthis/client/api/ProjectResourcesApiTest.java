...
/**
 * API tests for ProjectResourcesApi
 */
@Disabled
public class ProjectResourcesApiTest {

    private static ProjectResourcesApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new ProjectResourcesApi(apiClient);
    }
     ...
     */
    @Test
    public void assignResourcesToDefaultTest() throws ApiException {
        List<String> resources = null;
        ProjectResourcesAssignToProjectResponse response = api.assignResourcesToDefault()
                .resources(resources)
                .execute();
    ...
    public void assignToProjectTest() throws ApiException {
        UUID projectId = null;
        List<String> resources = null;
        ProjectResourcesAssignToProjectResponse response = api.assignToProject(projectId)
                .resources(resources)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        ProjectResourcesListResponse response = api.list(projectId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listDefaultTest() throws ApiException {
        ProjectResourcesListResponse response = api.listDefault()
                .execute();
        // TODO: test validations
    }
