...
public class KubernetesApiTest {
    ...
    public static void beforeClass() {
        ...
        api = new KubernetesApi(apiClient);
    }
     ...
     */
    @Test
    public void addContainerRegistryToClustersTest() throws ApiException {
        List<String> clusterUuids = null;
        api.addContainerRegistryToClusters()
     ...
     */
    @Test
    public void addNodePoolTest() throws ApiException {
        String size = null;
        String name = null;
        Integer count = null;
        UUID clusterId = null;
        ...
        UUID id = null;
        Object labels = null;
        List<KubernetesNodePoolTaint> taints = null;
        Boolean autoScale = null;
        Integer minNodes = null;
        Integer maxNodes = null;
        List<Node> nodes = null;
        KubernetesAddNodePoolResponse response = api.addNodePool(size, name, count, clusterId)
                .tags(tags)
                .id(id)
                .labels(labels)
                .taints(taints)
     ...
     */
    @Test
    public void createNewClusterTest() throws ApiException {
        String version = null;
        String name = null;
        String region = null;
        List<KubernetesNodePool> nodePools = null;
        List<String> tags = null;
        UUID id = null;
        ...
        Boolean autoUpgrade = null;
        ClusterStatus status = null;
        OffsetDateTime createdAt = null;
        OffsetDateTime updatedAt = null;
        Boolean surgeUpgrade = null;
        Boolean ha = null;
        Boolean registryEnabled = null;
        KubernetesCreateNewClusterResponse response = api.createNewCluster(version, name, region, nodePools)
                .tags(tags)
                .id(id)
     ...
     */
    @Test
    public void deleteClusterAssociatedResourcesDangerousTest() throws ApiException {
        UUID clusterId = null;
        api.deleteClusterAssociatedResourcesDangerous(clusterId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteNodeInNodePoolTest() throws ApiException {
        UUID clusterId = null;
        UUID nodePoolId = null;
        UUID nodeId = null;
        Integer skipDrain = null;
        Integer replace = null;
        api.deleteNodeInNodePool(clusterId, nodePoolId, nodeId)
                .skipDrain(skipDrain)
                .replace(replace)
                .execute();
        // TODO: test validations
    ...
    public void deleteNodePoolTest() throws ApiException {
        UUID clusterId = null;
        UUID nodePoolId = null;
        api.deleteNodePool(clusterId, nodePoolId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAvailableUpgradesTest() throws ApiException {
        UUID clusterId = null;
        KubernetesGetAvailableUpgradesResponse response = api.getAvailableUpgrades(clusterId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getClusterInfoTest() throws ApiException {
        UUID clusterId = null;
        KubernetesGetClusterInfoResponse response = api.getClusterInfo(clusterId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getClusterLintDiagnosticsTest() throws ApiException {
        UUID clusterId = null;
        UUID runId = null;
        ClusterlintResults response = api.getClusterLintDiagnostics(clusterId)
                .runId(runId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCredentialsByClusterIdTest() throws ApiException {
        UUID clusterId = null;
        Integer expirySeconds = null;
        Credentials response = api.getCredentialsByClusterId(clusterId)
     ...
     */
    @Test
    public void getKubeconfigTest() throws ApiException {
        UUID clusterId = null;
        Integer expirySeconds = null;
        api.getKubeconfig(clusterId)
                .expirySeconds(expirySeconds)
                .execute();
        // TODO: test validations
    }
    ...
    public void getNodePoolTest() throws ApiException {
        UUID clusterId = null;
        UUID nodePoolId = null;
        KubernetesGetNodePoolResponse response = api.getNodePool(clusterId, nodePoolId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getUserInformationTest() throws ApiException {
        UUID clusterId = null;
        User response = api.getUserInformation(clusterId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listAssociatedResourcesTest() throws ApiException {
        UUID clusterId = null;
        AssociatedKubernetesResources response = api.listAssociatedResources(clusterId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listClustersTest() throws ApiException {
        ...
        Integer page = null;
        KubernetesListClustersResponse response = api.listClusters()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listNodePoolsTest() throws ApiException {
        UUID clusterId = null;
        KubernetesListNodePoolsResponse response = api.listNodePools(clusterId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listOptionsTest() throws ApiException {
        KubernetesOptions response = api.listOptions()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void recycleNodePoolTest() throws ApiException {
        UUID clusterId = null;
        UUID nodePoolId = null;
        List<String> nodes = null;
        api.recycleNodePool(clusterId, nodePoolId)
                .nodes(nodes)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void removeRegistryTest() throws ApiException {
        List<String> clusterUuids = null;
        api.removeRegistry()
                .clusterUuids(clusterUuids)
                .execute();
     ...
     */
    @Test
    public void runClusterlintChecksTest() throws ApiException {
        UUID clusterId = null;
        List<String> includeGroups = null;
        List<String> includeChecks = null;
        List<String> excludeGroups = null;
        List<String> excludeChecks = null;
        Object response = api.runClusterlintChecks(clusterId)
     ...
     */
    @Test
    public void selectiveClusterDestroyTest() throws ApiException {
        UUID clusterId = null;
        List<String> loadBalancers = null;
        List<String> volumes = null;
        List<String> volumeSnapshots = null;
        api.selectiveClusterDestroy(clusterId)
    ...
    public void updateClusterTest() throws ApiException {
        ...
        Boolean surgeUpgrade = null;
        Boolean ha = null;
        KubernetesUpdateClusterResponse response = api.updateCluster(name, clusterId)
                .tags(tags)
                .maintenancePolicy(maintenancePolicy)
                .autoUpgrade(autoUpgrade)
                .surgeUpgrade(surgeUpgrade)
    ...
    public void updateNodePoolTest() throws ApiException {
        ...
        Integer maxNodes = null;
        List<Node> nodes = null;
        KubernetesUpdateNodePoolResponse response = api.updateNodePool(clusterId, nodePoolId)
                .tags(tags)
                .id(id)
                .name(name)
                .count(count)
     ...
     */
    @Test
    public void upgradeClusterTest() throws ApiException {
        UUID clusterId = null;
        String version = null;
        api.upgradeCluster(clusterId)
                .version(version)
                .execute();
        // TODO: test validations
    }
