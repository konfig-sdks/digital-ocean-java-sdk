...
public class VpcsApiTest {
    ...
    private static VpcsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new VpcsApi(apiClient);
    }
    ...
    public void createTest() throws ApiException {
        ...
        String ipRange = null;
        VpcsCreateResponse response = api.create(name, region)
    ...
    public void getTest() throws ApiException {
        UUID vpcId = null;
        VpcsCreateResponse response = api.get(vpcId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        VpcsListResponse response = api.list()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
    ...
    public void listMembersTest() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        VpCsListMembersResponse response = api.listMembers(vpcId)
    ...
    public void patchTest() throws ApiException {
        ...
        VpcsCreateResponse response = api.patch(vpcId)
                .description(description)
                .name(name)
                ._default(_default)
                .execute();
    ...
    public void updateTest() throws ApiException {
        ...
        String description = null;
        Boolean _default = null;
        VpcsCreateResponse response = api.update(name, vpcId)
                .description(description)
                ._default(_default)
                .execute();
        // TODO: test validations
