...
/**
 * API tests for DropletsApi
 */
@Disabled
public class DropletsApiTest {

    private static DropletsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new DropletsApi(apiClient);
    }
     ...
     */
    @Test
    public void checkDestroyStatusTest() throws ApiException {
        Integer dropletId = null;
        AssociatedResourceStatus response = api.checkDestroyStatus(dropletId)
                .execute();
     ...
     */
    @Test
    public void deleteByTagTest() throws ApiException {
        String tagName = null;
        api.deleteByTag(tagName)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteDangerousTest() throws ApiException {
        Integer dropletId = null;
        Boolean xDangerous = null;
        api.deleteDangerous(dropletId, xDangerous)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void destroyAssociatedResourcesSelectiveTest() throws ApiException {
        Integer dropletId = null;
        List<String> floatingIps = null;
        List<String> reservedIps = null;
        List<String> snapshots = null;
        List<String> volumes = null;
        List<String> volumeSnapshots = null;
        api.destroyAssociatedResourcesSelective(dropletId)
    ...
    public void getTest() throws ApiException {
        Integer dropletId = null;
        DropletsGetResponse response = api.get(dropletId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        String tagName = null;
        String name = null;
        DropletsListResponse response = api.list()
                .perPage(perPage)
                .page(page)
                .tagName(tagName)
                .name(name)
    ...
    public void listAssociatedResourcesTest() throws ApiException {
        Integer dropletId = null;
        DropletsListAssociatedResourcesResponse response = api.listAssociatedResources(dropletId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listBackupsTest() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        DropletsListBackupsResponse response = api.listBackups(dropletId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listDropletNeighborsTest() throws ApiException {
        NeighborIds response = api.listDropletNeighbors()
                .execute();
        // TODO: test validations
    }
    ...
    public void listFirewallsTest() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        DropletsListFirewallsResponse response = api.listFirewalls(dropletId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listKernelsTest() throws ApiException {
        Integer dropletId = null;
        Integer perPage = null;
        Integer page = null;
        DropletsListKernelsResponse response = api.listKernels(dropletId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listNeighborsTest() throws ApiException {
        Integer dropletId = null;
        DropletsListNeighborsResponse response = api.listNeighbors(dropletId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listSnapshotsTest() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        DropletsListSnapshotsResponse response = api.listSnapshots(dropletId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void retryDestroyWithAssociatedResourcesTest() throws ApiException {
        Integer dropletId = null;
        api.retryDestroyWithAssociatedResources(dropletId)
                .execute();
        // TODO: test validations
    }
