...
/**
 * API tests for DomainRecordsApi
 */
@Disabled
public class DomainRecordsApiTest {

    private static DomainRecordsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new DomainRecordsApi(apiClient);
    }
    ...
    public void createNewRecordTest() throws ApiException {
        ...
        DomainRecordsCreateNewRecordResponse response = api.createNewRecord(domainName)
                .execute();
    ...
    public void deleteByIdTest() throws ApiException {
        String domainName = null;
        Integer domainRecordId = null;
        api.deleteById(domainName, domainRecordId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getExistingRecordTest() throws ApiException {
        String domainName = null;
        Integer domainRecordId = null;
        DomainRecordsGetExistingRecordResponse response = api.getExistingRecord(domainName, domainRecordId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listAllRecordsTest() throws ApiException {
        String domainName = null;
        String name = null;
        String type = null;
        Integer perPage = null;
        Integer page = null;
        DomainRecordsListAllRecordsResponse response = api.listAllRecords(domainName)
                .name(name)
                .type(type)
                .perPage(perPage)
                .page(page)
     ...
     */
    @Test
    public void updateRecordByIdTest() throws ApiException {
        String type = null;
        String domainName = null;
        Integer domainRecordId = null;
        Integer id = null;
        ...
        Integer flags = null;
        String tag = null;
        DomainRecordsGetExistingRecordResponse response = api.updateRecordById(type, domainName, domainRecordId)
                .id(id)
                .name(name)
                .data(data)
                .priority(priority)
     ...
     */
    @Test
    public void updateRecordById_0Test() throws ApiException {
        String type = null;
        String domainName = null;
        Integer domainRecordId = null;
        Integer id = null;
        ...
        Integer flags = null;
        String tag = null;
        DomainRecordsGetExistingRecordResponse response = api.updateRecordById_0(type, domainName, domainRecordId)
                .id(id)
                .name(name)
                .data(data)
                .priority(priority)
