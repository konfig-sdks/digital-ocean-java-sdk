...
public class FunctionsApiTest {
    ...
    public void createNamespaceTest() throws ApiException {
        String region = null;
        String label = null;
        FunctionsCreateNamespaceResponse response = api.createNamespace(region, label)
                .execute();
     ...
     */
    @Test
    public void createTriggerInNamespaceTest() throws ApiException {
        String name = null;
        String function = null;
        String type = null;
        Boolean isEnabled = null;
        ScheduledDetails scheduledDetails = null;
        String namespaceId = null;
        FunctionsCreateTriggerInNamespaceResponse response = api.createTriggerInNamespace(name, function, type, isEnabled, scheduledDetails, namespaceId)
                .execute();
        // TODO: test validations
    }
    ...
    public void deleteTriggerTest() throws ApiException {
        ...
        api.deleteTrigger(namespaceId, triggerName)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getNamespaceDetailsTest() throws ApiException {
        String namespaceId = null;
        FunctionsCreateNamespaceResponse response = api.getNamespaceDetails(namespaceId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTriggerDetailsTest() throws ApiException {
        String namespaceId = null;
        String triggerName = null;
        FunctionsCreateTriggerInNamespaceResponse response = api.getTriggerDetails(namespaceId, triggerName)
                .execute();
        // TODO: test validations
    }
    ...
    public void listNamespacesTest() throws ApiException {
        FunctionsListNamespacesResponse response = api.listNamespaces()
                .execute();
        // TODO: test validations
    }
    ...
    public void listTriggersTest() throws ApiException {
        String namespaceId = null;
        FunctionsListTriggersResponse response = api.listTriggers(namespaceId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateTriggerDetailsTest() throws ApiException {
        String namespaceId = null;
        String triggerName = null;
        Boolean isEnabled = null;
        ScheduledDetails scheduledDetails = null;
        FunctionsCreateTriggerInNamespaceResponse response = api.updateTriggerDetails(namespaceId, triggerName)
                .isEnabled(isEnabled)
