...
public class AppsApiTest {
    ...
    public void cancelDeploymentTest() throws ApiException {
        ...
        AppsDeploymentResponse response = api.cancelDeployment(appId, deploymentId)
                .execute();
     ...
     */
    @Test
    public void commitRollbackTest() throws ApiException {
        String appId = null;
        api.commitRollback(appId)
                .execute();
        // TODO: test validations
    }
    ...
    public void createTest() throws ApiException {
        ...
        AppResponse response = api.create(spec)
                .projectId(projectId)
                .execute();
        // TODO: test validations
    }
    ...
    public void createDeploymentTest() throws ApiException {
        ...
        AppsDeploymentResponse response = api.createDeployment(appId)
    ...
    public void deleteTest() throws ApiException {
        String id = null;
        AppsDeleteAppResponse response = api.delete(id)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        String id = null;
        String name = null;
        AppResponse response = api.get(id)
                .name(name)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getActiveDeploymentLogsTest() throws ApiException {
        String appId = null;
        String componentName = null;
        String type = null;
        Boolean follow = null;
        String podConnectionTimeout = null;
        AppsGetLogsResponse response = api.getActiveDeploymentLogs(appId, componentName, type)
                .follow(follow)
     ...
     */
    @Test
    public void getActiveDeploymentLogs_0Test() throws ApiException {
        String appId = null;
        String type = null;
        Boolean follow = null;
        String podConnectionTimeout = null;
        AppsGetLogsResponse response = api.getActiveDeploymentLogs_0(appId, type)
                .follow(follow)
                .podConnectionTimeout(podConnectionTimeout)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getAggregateDeploymentLogsTest() throws ApiException {
        String appId = null;
        String deploymentId = null;
        String type = null;
        Boolean follow = null;
        String podConnectionTimeout = null;
        AppsGetLogsResponse response = api.getAggregateDeploymentLogs(appId, deploymentId, type)
                .follow(follow)
                .podConnectionTimeout(podConnectionTimeout)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getAppDailyBandwidthMetricsTest() throws ApiException {
        String appId = null;
        OffsetDateTime date = null;
        AppMetricsBandwidthUsage response = api.getAppDailyBandwidthMetrics(appId)
                .date(date)
                .execute();
        // TODO: test validations
    }
    ...
    public void getDeploymentInfoTest() throws ApiException {
        String appId = null;
        String deploymentId = null;
        AppsDeploymentResponse response = api.getDeploymentInfo(appId, deploymentId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getDeploymentLogsTest() throws ApiException {
        ...
        Boolean follow = null;
        String podConnectionTimeout = null;
        AppsGetLogsResponse response = api.getDeploymentLogs(appId, deploymentId, componentName, type)
                .follow(follow)
                .podConnectionTimeout(podConnectionTimeout)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void getInstanceSizeTest() throws ApiException {
        String slug = null;
        AppsGetInstanceSizeResponse response = api.getInstanceSize(slug)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getMultipleDailyMetricsTest() throws ApiException {
        List<String> appIds = null;
        OffsetDateTime date = null;
        AppMetricsBandwidthUsage response = api.getMultipleDailyMetrics(appIds)
                .date(date)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTierInfoTest() throws ApiException {
        String slug = null;
        AppsGetTierResponse response = api.getTierInfo(slug)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Boolean withProjects = null;
        AppsResponse response = api.list()
                .page(page)
                .perPage(perPage)
    ...
    public void listAlertsTest() throws ApiException {
        String appId = null;
        AppsListAlertsResponse response = api.listAlerts(appId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listDeploymentsTest() throws ApiException {
        ...
        Integer page = null;
        Integer perPage = null;
        AppsDeploymentsResponse response = api.listDeployments(appId)
                .page(page)
                .perPage(perPage)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void listInstanceSizesTest() throws ApiException {
        AppsListInstanceSizesResponse response = api.listInstanceSizes()
                .execute();
        // TODO: test validations
    }
    ...
    public void listRegionsTest() throws ApiException {
        AppsListRegionsResponse response = api.listRegions()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listTiersTest() throws ApiException {
        AppsListTiersResponse response = api.listTiers()
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void proposeAppSpecTest() throws ApiException {
        AppSpec spec = null;
        String appId = null;
        AppProposeResponse response = api.proposeAppSpec(spec)
                .appId(appId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void revertRollbackTest() throws ApiException {
        String appId = null;
        AppsDeploymentResponse response = api.revertRollback(appId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void rollbackDeploymentTest() throws ApiException {
        String appId = null;
        String deploymentId = null;
        Boolean skipPin = null;
        AppsDeploymentResponse response = api.rollbackDeployment(appId)
    ...
    public void updateTest() throws ApiException {
        AppSpec spec = null;
        String id = null;
        AppResponse response = api.update(spec, id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void updateDestinationsForAlertsTest() throws ApiException {
        String appId = null;
        String alertId = null;
        List<String> emails = null;
        List<AppAlertSlackWebhook> slackWebhooks = null;
        AppsAlertResponse response = api.updateDestinationsForAlerts(appId, alertId)
                .emails(emails)
     ...
     */
    @Test
    public void validateRollbackTest() throws ApiException {
        String appId = null;
        String deploymentId = null;
        Boolean skipPin = null;
        AppsValidateRollbackResponse response = api.validateRollback(appId)
                .deploymentId(deploymentId)
                .skipPin(skipPin)
                .execute();
        // TODO: test validations
