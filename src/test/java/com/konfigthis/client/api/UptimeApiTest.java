...
/**
 * API tests for UptimeApi
 */
@Disabled
public class UptimeApiTest {

    private static UptimeApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new UptimeApi(apiClient);
    }
    ...
    public void createCheckTest() throws ApiException {
        ...
        UptimeCreateCheckResponse response = api.createCheck()
                .name(name)
                .type(type)
                .target(target)
                .regions(regions)
     ...
     */
    @Test
    public void createNewAlertTest() throws ApiException {
        UUID checkId = null;
        UUID id = null;
        String name = null;
        String type = null;
        ...
        String period = null;
        UptimeCreateNewAlertResponse response = api.createNewAlert(checkId)
                .id(id)
                .name(name)
                .type(type)
                .threshold(threshold)
    ...
    public void deleteAlertTest() throws ApiException {
        UUID checkId = null;
        UUID alertId = null;
        api.deleteAlert(checkId, alertId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteCheckTest() throws ApiException {
        UUID checkId = null;
        api.deleteCheck(checkId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCheckByIdTest() throws ApiException {
        UUID checkId = null;
        UptimeCreateCheckResponse response = api.getCheckById(checkId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getCheckStateTest() throws ApiException {
        UUID checkId = null;
        UptimeGetCheckStateResponse response = api.getCheckState(checkId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getExistingAlertTest() throws ApiException {
        UUID checkId = null;
        UUID alertId = null;
        UptimeCreateNewAlertResponse response = api.getExistingAlert(checkId, alertId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listAllAlertsTest() throws ApiException {
        UUID checkId = null;
        Integer perPage = null;
        Integer page = null;
        UptimeListAllAlertsResponse response = api.listAllAlerts(checkId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
    ...
    public void listChecksTest() throws ApiException {
        Integer perPage = null;
        Integer page = null;
        UptimeListChecksResponse response = api.listChecks()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void updateAlertSettingsTest() throws ApiException {
        UUID checkId = null;
        UUID alertId = null;
        String name = null;
        String type = null;
        ...
        Notification notifications = null;
        String period = null;
        UptimeCreateNewAlertResponse response = api.updateAlertSettings(checkId, alertId)
                .name(name)
                .type(type)
                .threshold(threshold)
                .comparison(comparison)
     ...
     */
    @Test
    public void updateCheckSettingsTest() throws ApiException {
        UUID checkId = null;
        String name = null;
        String type = null;
        String target = null;
        List<String> regions = null;
        Boolean enabled = null;
        UptimeCreateCheckResponse response = api.updateCheckSettings(checkId)
                .name(name)
                .type(type)
                .target(target)
                .regions(regions)
