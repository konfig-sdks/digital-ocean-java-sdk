...
/**
 * API tests for BlockStorageActionsApi
 */
@Disabled
public class BlockStorageActionsApiTest {

    private static BlockStorageActionsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new BlockStorageActionsApi(apiClient);
    }
    ...
    public void getTest() throws ApiException {
        ...
        Integer page = null;
        VolumeActionsPostResponse response = api.get(volumeId, actionId)
                .perPage(perPage)
                .page(page)
                .execute();
     ...
     */
    @Test
    public void initiateAttachActionTest() throws ApiException {
        UUID volumeId = null;
        String type = null;
        ...
        Integer perPage = null;
        Integer page = null;
        VolumeActionsPostResponse response = api.initiateAttachAction(volumeId)
                .type(type)
                .region(region)
                .tags(tags)
                .dropletId(dropletId)
    ...
    public void listTest() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        VolumeActionsListResponse response = api.list(volumeId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
    ...
    public void postTest() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        VolumeActionsPostResponse response = api.post()
                .type(type)
                .region(region)
                .tags(tags)
                .dropletId(dropletId)
