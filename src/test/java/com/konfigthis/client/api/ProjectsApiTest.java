...
public class ProjectsApiTest {
    ...
    public void getTest() throws ApiException {
        UUID projectId = null;
        Object response = api.get(projectId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDefaultProjectTest() throws ApiException {
        ProjectsGetDefaultProjectResponse response = api.getDefaultProject()
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        ProjectsListResponse response = api.list()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
    ...
    public void patchTest() throws ApiException {
        ...
        Object response = api.patch(projectId)
                .description(description)
                .id(id)
                .ownerUuid(ownerUuid)
                .ownerId(ownerId)
    ...
    public void updateTest() throws ApiException {
        ...
        OffsetDateTime updatedAt = null;
        Boolean isDefault = null;
        Object response = api.update(projectId)
                .description(description)
                .id(id)
                .ownerUuid(ownerUuid)
                .ownerId(ownerId)
     ...
     */
    @Test
    public void updateDefaultProjectTest() throws ApiException {
        String description = null;
        UUID id = null;
        String ownerUuid = null;
        Integer ownerId = null;
        ...
        OffsetDateTime updatedAt = null;
        Boolean isDefault = null;
        Object response = api.updateDefaultProject()
                .description(description)
                .id(id)
                .ownerUuid(ownerUuid)
                .ownerId(ownerId)
     ...
     */
    @Test
    public void updateDefaultProjectAttributesTest() throws ApiException {
        String description = null;
        UUID id = null;
        String ownerUuid = null;
        Integer ownerId = null;
        ...
        OffsetDateTime updatedAt = null;
        Boolean isDefault = null;
        Object response = api.updateDefaultProjectAttributes()
                .description(description)
                .id(id)
                .ownerUuid(ownerUuid)
                .ownerId(ownerId)
