...
public class ImagesApiTest {
    ...
    public void getTest() throws ApiException {
        Object imageId = null;
        ImagesGetResponse response = api.get(imageId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void importCustomImageFromUrlTest() throws ApiException {
        String name = null;
        String url = null;
        ...
        ImagesImportCustomImageFromUrlResponse response = api.importCustomImageFromUrl(name, url, region)
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        ImagesListResponse response = api.list()
                .type(type)
                ._private(_private)
                .tagName(tagName)
                .perPage(perPage)
    ...
    public void updateTest() throws ApiException {
        ...
        String name = null;
        Distribution distribution = null;
        ImagesUpdateResponse response = api.update(imageId)
                .description(description)
                .name(name)
                .distribution(distribution)
                .execute();
