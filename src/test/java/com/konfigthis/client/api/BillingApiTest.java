...
public class BillingApiTest {
     ...
     */
    @Test
    public void getInvoiceByUuidTest() throws ApiException {
        String invoiceUuid = null;
        BillingGetInvoiceByUuidResponse response = api.getInvoiceByUuid(invoiceUuid)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getInvoiceCsvByUuidTest() throws ApiException {
        String invoiceUuid = null;
        String response = api.getInvoiceCsvByUuid(invoiceUuid)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getInvoiceSummaryByUuidTest() throws ApiException {
        String invoiceUuid = null;
        InvoiceSummary response = api.getInvoiceSummaryByUuid(invoiceUuid)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getPdfByUuidTest() throws ApiException {
        String invoiceUuid = null;
        File response = api.getPdfByUuid(invoiceUuid)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        BillingHistoryListResponse response = api.list()
                .execute();
        // TODO: test validations
    }
    ...
    public void list_0Test() throws ApiException {
        ...
        Integer page = null;
        InvoicesListResponse response = api.list_0()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
