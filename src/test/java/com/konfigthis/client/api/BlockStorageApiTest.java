...
public class BlockStorageApiTest {
    ...
    private static BlockStorageApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new BlockStorageApi(apiClient);
    }
    ...
    public void createTest() throws ApiException {
        ...
        String name = null;
        Integer sizeGigabytes = null;
        String createdAt = null;
        String snapshotId = null;
        String filesystemType = null;
        RegionSlug region = null;
        String filesystemLabel = null;
        VolumesCreateResponse response = api.create()
                .tags(tags)
    ...
    public void create_0Test() throws ApiException {
        ...
        UUID volumeId = null;
        List<String> tags = null;
        BlockStorageGetSnapshotDetailsResponse response = api.create_0(name, volumeId)
                .tags(tags)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void deleteByRegionAndNameTest() throws ApiException {
        String name = null;
        RegionSlug region = null;
        api.deleteByRegionAndName()
                .name(name)
                .region(region)
                .execute();
        // TODO: test validations
    ...
    public void deleteVolumeSnapshotTest() throws ApiException {
        ...
        api.deleteVolumeSnapshot(snapshotId)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        UUID volumeId = null;
        VolumesCreateResponse response = api.get(volumeId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getSnapshotDetailsTest() throws ApiException {
        Object snapshotId = null;
        BlockStorageGetSnapshotDetailsResponse response = api.getSnapshotDetails(snapshotId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        VolumesListResponse response = api.list()
                .name(name)
                .region(region)
                .perPage(perPage)
                .page(page)
    ...
    public void list_0Test() throws ApiException {
        ...
        Integer perPage = null;
        Integer page = null;
        VolumeSnapshotsListResponse response = api.list_0(volumeId)
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
