...
public class SshKeysApiTest {
    ...
    private static SshKeysApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new SshKeysApi(apiClient);
    }
    ...
    public void createTest() throws ApiException {
        ...
        Object response = api.create(publicKey, name)
                .id(id)
    ...
    public void deleteTest() throws ApiException {
        Object sshKeyIdentifier = null;
        api.delete(sshKeyIdentifier)
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        Object sshKeyIdentifier = null;
        Object response = api.get(sshKeyIdentifier)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        SshKeysListResponse response = api.list()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
    ...
    public void updateTest() throws ApiException {
        Object sshKeyIdentifier = null;
        String name = null;
        Object response = api.update(sshKeyIdentifier)
                .name(name)
                .execute();
        // TODO: test validations
    }
