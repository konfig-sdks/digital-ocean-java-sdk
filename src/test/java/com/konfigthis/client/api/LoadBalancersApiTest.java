...
public class LoadBalancersApiTest {
     ...
     */
    @Test
    public void addForwardingRulesTest() throws ApiException {
        List<ForwardingRule> forwardingRules = null;
        String lbId = null;
        api.addForwardingRules(forwardingRules, lbId)
                .execute();
     ...
     */
    @Test
    public void assignDropletsTest() throws ApiException {
        List<Integer> dropletIds = null;
        String lbId = null;
        api.assignDroplets(dropletIds, lbId)
                .execute();
        // TODO: test validations
    }
    ...
    public void createTest() throws ApiException {
        LoadBalancersCreateResponse response = api.create()
                .execute();
        // TODO: test validations
    }
    ...
    public void getTest() throws ApiException {
        String lbId = null;
        LoadBalancersGetResponse response = api.get(lbId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        LoadBalancersListResponse response = api.list()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void removeDropletsTest() throws ApiException {
        List<Integer> dropletIds = null;
        String lbId = null;
        api.removeDroplets(dropletIds, lbId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void removeForwardingRulesTest() throws ApiException {
        List<ForwardingRule> forwardingRules = null;
        String lbId = null;
        api.removeForwardingRules(forwardingRules, lbId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateTest() throws ApiException {
        String lbId = null;
        LoadBalancersUpdateResponse response = api.update(lbId)
                .execute();
        // TODO: test validations
    }
