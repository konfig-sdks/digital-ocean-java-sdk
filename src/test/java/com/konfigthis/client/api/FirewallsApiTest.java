...
public class FirewallsApiTest {
    ...
    private static FirewallsApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new FirewallsApi(apiClient);
    }
     ...
     */
    @Test
    public void addDropletsTest() throws ApiException {
        List<Integer> dropletIds = null;
        UUID firewallId = null;
        api.addDroplets(dropletIds, firewallId)
                .execute();
     ...
     */
    @Test
    public void addRulesTest() throws ApiException {
        UUID firewallId = null;
        List<FirewallRulesInboundRulesInner> inboundRules = null;
        List<FirewallRulesOutboundRulesInner> outboundRules = null;
        api.addRules(firewallId)
    ...
    public void createTest() throws ApiException {
        ...
        List<FirewallAllOfPendingChanges> pendingChanges = null;
        String name = null;
        List<Integer> dropletIds = null;
        List<FirewallRulesInboundRulesInner> inboundRules = null;
        List<FirewallRulesOutboundRulesInner> outboundRules = null;
        FirewallsCreateResponse response = api.create()
                .tags(tags)
                .id(id)
                .status(status)
                .createdAt(createdAt)
    ...
    public void getTest() throws ApiException {
        UUID firewallId = null;
        FirewallsGetResponse response = api.get(firewallId)
                .execute();
        // TODO: test validations
    }
    ...
    public void listTest() throws ApiException {
        ...
        Integer page = null;
        FirewallsListResponse response = api.list()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
    ...
    public void removeDropletsTest() throws ApiException {
        List<Integer> dropletIds = null;
        UUID firewallId = null;
        api.removeDroplets(dropletIds, firewallId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void removeRulesTest() throws ApiException {
        UUID firewallId = null;
        List<FirewallRulesInboundRulesInner> inboundRules = null;
        List<FirewallRulesOutboundRulesInner> outboundRules = null;
        api.removeRules(firewallId)
                .inboundRules(inboundRules)
                .outboundRules(outboundRules)
                .execute();
        // TODO: test validations
    ...
    public void removeTagsTest() throws ApiException {
        List tags = null;
        UUID firewallId = null;
        api.removeTags(tags, firewallId)
                .execute();
        // TODO: test validations
    }
    ...
    public void updateTest() throws ApiException {
        ...
        List<FirewallRulesInboundRulesInner> inboundRules = null;
        List<FirewallRulesOutboundRulesInner> outboundRules = null;
        FirewallsUpdateResponse response = api.update(name, firewallId)
                .tags(tags)
                .id(id)
                .status(status)
                .createdAt(createdAt)
