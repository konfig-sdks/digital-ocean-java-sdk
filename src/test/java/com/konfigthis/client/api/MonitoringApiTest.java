...
public class MonitoringApiTest {
    ...
    private static MonitoringApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new MonitoringApi(apiClient);
    }
     ...
     */
    @Test
    public void createAlertPolicyTest() throws ApiException {
        ...
        Float value = null;
        String window = null;
        Object response = api.createAlertPolicy(tags, description, alerts, compare, enabled, entities, type, value, window)
                .execute();
     ...
     */
    @Test
    public void deleteAlertPolicyTest() throws ApiException {
        String alertUuid = null;
        api.deleteAlertPolicy(alertUuid)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void dropletCpuMetricsgetTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.dropletCpuMetricsget(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void dropletLoad5MetricsGetTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.dropletLoad5MetricsGet(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void dropletMemoryCachedMetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.dropletMemoryCachedMetrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAppCpuPercentageMetricsTest() throws ApiException {
        String appId = null;
        String start = null;
        String end = null;
        String appComponent = null;
        Metrics response = api.getAppCpuPercentageMetrics(appId, start, end)
     ...
     */
    @Test
    public void getAppMemoryPercentageMetricsTest() throws ApiException {
        String appId = null;
        String start = null;
        String end = null;
        String appComponent = null;
        Metrics response = api.getAppMemoryPercentageMetrics(appId, start, end)
                .appComponent(appComponent)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getAppRestartCountMetricsTest() throws ApiException {
        String appId = null;
        String start = null;
        String end = null;
        String appComponent = null;
        Metrics response = api.getAppRestartCountMetrics(appId, start, end)
                .appComponent(appComponent)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletBandwidthMetricsTest() throws ApiException {
        String hostId = null;
        String _interface = null;
        String direction = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletBandwidthMetrics(hostId, _interface, direction, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletFilesystemFreeMetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletFilesystemFreeMetrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletFilesystemSizeMetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletFilesystemSizeMetrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletLoad15MetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletLoad15Metrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletLoad1MetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletLoad1Metrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletMemoryAvailableMetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletMemoryAvailableMetrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletMemoryFreeMetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletMemoryFreeMetrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getDropletMemoryTotalMetricsTest() throws ApiException {
        String hostId = null;
        String start = null;
        String end = null;
        Metrics response = api.getDropletMemoryTotalMetrics(hostId, start, end)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getExistingAlertPolicyTest() throws ApiException {
        String alertUuid = null;
        Object response = api.getExistingAlertPolicy(alertUuid)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void listAlertPoliciesTest() throws ApiException {
        Integer perPage = null;
        Integer page = null;
        MonitoringListAlertPoliciesResponse response = api.listAlertPolicies()
                .perPage(perPage)
                .page(page)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void updateAlertPolicyTest() throws ApiException {
        List<String> tags = null;
        String description = null;
        Alerts alerts = null;
        String compare = null;
        ...
        String window = null;
        String alertUuid = null;
        Object response = api.updateAlertPolicy(tags, description, alerts, compare, enabled, entities, type, value, window, alertUuid)
                .execute();
        // TODO: test validations
    }
